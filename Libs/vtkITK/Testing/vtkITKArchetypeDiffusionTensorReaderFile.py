...
"""
To run as test from cjyx python console, replace the following with your source tree path and paste:

exec(open('/Users/pieper/cjyx4/latest/Cjyx/Libs/vtkITK/Testing/vtkITKArchetypeDiffusionTensorReaderFile.py').read()); t = vtkITKReaderAgainstNRRDReader(); t.runTest()
