...
Program:   3D Cjyx
Module:    $RCSfile: vtkDMMLScene.cxx,v $
...
//#define DMMLSCENE_VERBOSE

#ifdef DMMLSCENE_VERBOSE
# include <vtkTimerLog.h>
#endif

vtkCxxSetObjectMacro(vtkDMMLScene, CacheManager, vtkCacheManager)
vtkCxxSetObjectMacro(vtkDMMLScene, DataIOManager, vtkDataIOManager)
vtkCxxSetObjectMacro(vtkDMMLScene, UserTagTable, vtkTagTable)
vtkCxxSetObjectMacro(vtkDMMLScene, URIHandlerCollection, vtkCollection)

//------------------------------------------------------------------------------
vtkDMMLScene::vtkDMMLScene()
{
  ...
  const int versionHexMajorMinorPatch = DMML_APPLICATION_VERSION;
  std::stringstream versionStream; // Example: Cjyx 4.11.0 123456
  versionStream << DMML_APPLICATION_NAME
    << " "
    << (versionHexMajorMinorPatch >> 16) << "."
    << ((versionHexMajorMinorPatch >> 8) & 0xFF) << "."
    << (versionHexMajorMinorPatch & 0xFF)
    << " "
    << DMML_APPLICATION_REVISION;
  ...
  this->DeleteEventCallback->SetCallback( vtkDMMLScene::SceneCallback );
  ...
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLScalarVolumeNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLModelNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLLinearTransformNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLModelStorageNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLModelDisplayNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLClipModelsNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLFolderDisplayNode >::New());
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLROINode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLROIListNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLSliceCompositeNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLScriptedModuleNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLSegmentationDisplayNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLSegmentationNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLSegmentationStorageNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLSelectionNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLSliceDisplayNode >::New());
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLSliceNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLVolumeArchetypeStorageNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLScalarVolumeDisplayNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLLabelMapVolumeDisplayNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLLabelMapVolumeNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLColorNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLDiffusionWeightedVolumeNode >::New() );
#ifdef DMML_USE_vtkTeem
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLDiffusionTensorVolumeNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLDiffusionTensorVolumeDisplayNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLDiffusionTensorVolumeSliceDisplayNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLNRRDStorageNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLVectorVolumeNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLStreamingVolumeNode >::New() );
#endif
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLVectorVolumeDisplayNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLDiffusionWeightedVolumeDisplayNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLDiffusionTensorDisplayPropertiesNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLCameraNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLViewNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLLayoutNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLHierarchyNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLHierarchyStorageNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLDisplayableHierarchyNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLModelHierarchyNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLSnapshotClipNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLColorTableNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLColorTableStorageNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLProceduralColorNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLProceduralColorStorageNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLTransformDisplayNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLTransformStorageNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLTransformNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLGridTransformNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLBSplineTransformNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLCrosshairNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLInteractionNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLTableNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLTableStorageNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLTableViewNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLTextNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLTextStorageNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLPlotSeriesNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLPlotChartNode >::New() );
  this->RegisterNodeClass( vtkSmartPointer< vtkDMMLPlotViewNode >::New() );
  this->RegisterNodeClass(vtkSmartPointer<vtkDMMLSubjectHierarchyNode>::New()); // Increments next subject hierarchy item ID
  this->RegisterNodeClass(vtkSmartPointer<vtkDMMLSequenceNode>::New());
  this->RegisterNodeClass(vtkSmartPointer<vtkDMMLSequenceStorageNode>::New());
  this->RegisterNodeClass(vtkSmartPointer<vtkDMMLLinearTransformSequenceStorageNode>::New());
  this->RegisterNodeClass(vtkSmartPointer<vtkDMMLVolumeSequenceStorageNode>::New());

  this->RegisterAbstractNodeClass("vtkDMMLVolumeNode", "Volume");
}
...
//------------------------------------------------------------------------------
void vtkDMMLScene::SceneCallback( vtkObject *vtkNotUsed(caller),
                                  unsigned long vtkNotUsed(eid),
                                  void *clientData, void *vtkNotUsed(callData) )
{
  vtkDMMLScene *self = reinterpret_cast<vtkDMMLScene *>(clientData);
  if (self == nullptr)
    {
    return;
    }
  ...
  // are processed, then add a ProcessDMMLEvents method (instead of
  // doing everything in the static function).
  self->Clear(1);
}

//------------------------------------------------------------------------------
void vtkDMMLScene::Clear(int removeSingletons)
{
#ifdef DMMLSCENE_VERBOSE
  ...
  this->SetUndoOff();
  this->StartState(vtkDMMLScene::CloseState);
  ...
  // has been cleared
  this->EndState(vtkDMMLScene::CloseState);
#ifdef DMMLSCENE_VERBOSE
  timer->StopTimer();
  std::cerr << "vtkDMMLScene::Clear():" << timer->GetElapsedTime() << "\n";
  timer->Delete();
#endif
}

//------------------------------------------------------------------------------
void vtkDMMLScene::RemoveAllNodes(bool removeSingletons)
{
  ...
  for (this->Nodes->InitTraversal(it);
    (node = (vtkDMMLNode*)this->Nodes->GetNextItemAsObject(it));)
    {
  ...
  for(std::deque< std::string >::iterator nodeIt=removeNodeIds.begin(); nodeIt!=removeNodeIds.end(); ++nodeIt)
    {
    vtkDMMLNode* node=this->GetNodeByID(*nodeIt);
    if (node)
      {
...
//----------------------------------------------------------------------------
vtkDMMLNode* vtkDMMLScene::GetDefaultNodeByClass(const char* className)
{
  if (className==nullptr)
    {
    return nullptr;
    }
  std::map< std::string, vtkSmartPointer<vtkDMMLNode> >::iterator it = this->DefaultNodes.find(std::string(className));
...
//----------------------------------------------------------------------------
void vtkDMMLScene::AddDefaultNode(vtkDMMLNode* node)
{
  if (node==nullptr)
    {
    vtkErrorMacro("vtkDMMLScene::AddDefaultNode failed: invalid node");
    return;
    }
  const char* className = node->GetClassName();
  if (className==nullptr)
    {
    vtkErrorMacro("vtkDMMLScene::AddDefaultNode failed: invalid className");
    return;
    }
...
//----------------------------------------------------------------------------
void vtkDMMLScene::RemoveAllDefaultNodes()
{
  this->DefaultNodes.clear();
}

//------------------------------------------------------------------------------
void vtkDMMLScene::CopyDefaultNodesToScene(vtkDMMLScene *scene)
{
  if (!scene)
    {
    return;
    }
  for (std::map< std::string, vtkSmartPointer<vtkDMMLNode> >::iterator it = this->DefaultNodes.begin();
...
//----------------------------------------------------------------------------
vtkStandardNewMacro(vtkDMMLScene);

//------------------------------------------------------------------------------
vtkDMMLNode* vtkDMMLScene::CreateNodeByClass(const char* className)
{
  if (className == nullptr)
    {
  ...
  if (node == nullptr)
    ...
    if(ret)
      {
      node = static_cast<vtkDMMLNode *>(ret);
      // Clean memory
      if (!node)
        {
        ret->Delete();
  ...
  vtkDMMLNode* defaultNode = this->GetDefaultNodeByClass(className);
  if (defaultNode)
    {
...
//------------------------------------------------------------------------------
void vtkDMMLScene::RegisterNodeClass(vtkDMMLNode* node)
{
  this->RegisterNodeClass(node, node->GetNodeTagName());
}

//------------------------------------------------------------------------------
void vtkDMMLScene::RegisterNodeClass(vtkDMMLNode* node, const char* tagName)
{
  if (!node)
    {
  ...
  // XML tag. It allows plugins to DMML to override default behavior when
  ...
  this->InvokeEvent(vtkDMMLScene::NodeClassRegisteredEvent);
}

//------------------------------------------------------------------------------
void vtkDMMLScene::RegisterAbstractNodeClass(std::string className, std::string typeDisplayName)
{
...
//------------------------------------------------------------------------------
void vtkDMMLScene::CopyRegisteredNodesToScene(vtkDMMLScene *scene)
{
  if (scene)
    {
...
//------------------------------------------------------------------------------
void vtkDMMLScene::CopySingletonNodesToScene(vtkDMMLScene *scene)
{
  if (!scene)
    {
    return;
  ...
  for (n=0; n < this->Nodes->GetNumberOfItems(); n++)
    {
    node = (vtkDMMLNode*)this->Nodes->GetItemAsObject(n);
...
//------------------------------------------------------------------------------
const char* vtkDMMLScene::GetClassNameByTag(const char *tagName)
{
  if (tagName == nullptr)
    {
...
//------------------------------------------------------------------------------
const char* vtkDMMLScene::GetTagByClassName(const char *className)
{
  if ( !className )
    {
...
//------------------------------------------------------------------------------
std::string vtkDMMLScene::GetTypeDisplayNameByClassName(std::string className)
{
  for (unsigned int i=0; i<this->RegisteredNodeClasses.size(); i++)
    {
...
//------------------------------------------------------------------------------
vtkCollection* vtkDMMLScene::GetNodes()
{
  return this->Nodes;
}
...
//------------------------------------------------------------------------------
int vtkDMMLScene::GetStates()const
{
...
//------------------------------------------------------------------------------
void vtkDMMLScene::StartState(unsigned long state, int anticipatedMaxProgress)
{
  ...
  if (state != vtkDMMLScene::BatchProcessState &&
      !wasInState)
    {
...
//------------------------------------------------------------------------------
void vtkDMMLScene::EndState(unsigned long state)
{
  if (this->States.empty())
  {
    vtkErrorMacro("vtkDMMLScene::EndState failed: there was no previous state");
    return;
  }
  if (this->States.back() != state)
  {
    vtkWarningMacro("vtkDMMLScene::EndState found inconsistent state");
  }
  this->States.pop_back();

  bool isInState = ((this->GetStates() & state) == state);
  // vtkDMMLScene::BatchProcessState is handled after
  if (state != vtkDMMLScene::BatchProcessState &&
      !isInState)
    {
  ...
  if ((state & vtkDMMLScene::BatchProcessState) &&
    ...
    this->InvokeEvent( StateEvent | EndEvent |
                       vtkDMMLScene::BatchProcessState );
    }
}

//------------------------------------------------------------------------------
void vtkDMMLScene::ProgressState(unsigned long state, int progress)
{
  if (state & vtkDMMLScene::BatchProcessState)
    {
    this->InvokeEvent( StateEvent | ProgressEvent | vtkDMMLScene::BatchProcessState,
...
//------------------------------------------------------------------------------
int vtkDMMLScene::Connect(vtkDMMLMessageCollection* userMessagesInput/*=nullptr*/)
{
  if (this->IsClosing())
    {
    vtkWarningMacro("vtkDMMLScene::Connect(): scene is in closing state");
    }
  if (this->IsImporting())
    {
    vtkWarningMacro("vtkDMMLScene::Connect(): scene is in importing state");
    }
  ...
  timer->StartTimer();
#endif
  this->StartState(vtkDMMLScene::BatchProcessState);
  this->Clear(0);
  bool undoFlag = this->GetUndoFlag();
  int res = this->Import(userMessagesInput);

  this->EndState(vtkDMMLScene::BatchProcessState);
  this->SetUndoFlag(undoFlag);
#ifdef DMMLSCENE_VERBOSE
  timer->StopTimer();
  std::cerr << "vtkDMMLScene::Connect():" << timer->GetElapsedTime() << "\n";
  timer->Delete();
#endif
  return res;
}
...
//------------------------------------------------------------------------------
int vtkDMMLScene::Import(vtkDMMLMessageCollection* userMessagesInput/*=nullptr*/)
{
  ...
  this->SetUndoOff();
  this->StartState(vtkDMMLScene::ImportState);
  this->ReferencedIDChanges.clear();
  ...
  if (this->LoadIntoScene(loadedNodes, userMessages))
    ...
    for (loadedNodes->InitTraversal(it);
         (node = (vtkDMMLNode*)loadedNodes->GetNextItemAsObject(it)) ;)
      {
    ...
    this->InvokeEvent(vtkDMMLScene::NewSceneEvent, nullptr);
    ...
    for (addedNodes->InitTraversal(it);
         (node = (vtkDMMLNode*)addedNodes->GetNextItemAsObject(it)) ;)
      {
    ...
    vtkErrorToMessageCollectionMacro(userMessages, "vtkDMMLScene::Import", "Syntax error in scene file.");
    this->ReferencedIDChanges.clear();
    }
...
#endif
  this->EndState(vtkDMMLScene::ImportState);
#ifdef DMMLSCENE_VERBOSE
...
#ifdef DMMLSCENE_VERBOSE
  timer->StopTimer();
  std::cerr << "vtkDMMLScene::Import()::AddNodes:" << addNodesTimer->GetElapsedTime() << std::endl;
  std::cerr << "vtkDMMLScene::Import()::UpdateScene" << updateSceneTimer->GetElapsedTime() << std::endl;
  std::cerr << "vtkDMMLScene::Import()::SceneImported:" << importingTimer->GetElapsedTime() << std::endl;
  std::cerr << "vtkDMMLScene::Import():" << timer->GetElapsedTime() << std::endl;
  ...
  this->SetSubjectHierarchyNode(vtkDMMLSubjectHierarchyNode::ResolveSubjectHierarchy(this));
...
//------------------------------------------------------------------------------
int vtkDMMLScene::LoadIntoScene(vtkCollection* nodeCollection, vtkDMMLMessageCollection* userMessagesInput/*=nullptr*/)
{
  // We use userMessages for collecting error information, so make sure we have it, even if the caller does not need it.
  vtkSmartPointer<vtkDMMLMessageCollection> userMessages = userMessagesInput;
  if (!userMessages)
  ...
  if ((this->URL == "" && this->GetLoadFromXMLString()==0) ||
    ...
    {
    vtkErrorToMessageCollectionMacro(userMessages, "vtkDMMLScene::LoadIntoScene", "No URL specified");
    return 0;
    }
  // check to see if the dmml file lives on a remote disk
  if (this->GetCacheManager())
    {
    int remote = this->GetCacheManager()->IsRemoteReference(this->URL.c_str());
    if (remote)
      {
      vtkDebugMacro("LoadIntoScene: dmml file lives on a remote disk: " << this->URL.c_str());
      ...
      if (handler != nullptr)
        ...
        vtkDebugMacro("LoadIntoScene: downloaded the remote DMML file " << this->URL.c_str() << ", resetting URL to local file " << localURL);
        this->SetURL(localURL);
        }
      else
        {
        vtkErrorToMessageCollectionMacro(userMessages, "vtkDMMLScene::LoadIntoScene",
...
//------------------------------------------------------------------------------
int vtkDMMLScene::Commit(const char* url, vtkDMMLMessageCollection * userMessagesInput/*=nullptr*/)
{
  // We use userMessages for collecting error information, so make sure we have it, even if the caller does not need it.
  vtkSmartPointer<vtkDMMLMessageCollection> userMessages = userMessagesInput;
  if (!userMessages)
  ...
  if (url == nullptr)
    ...
    if (this->URL != "")
      ...
      {
      vtkErrorToMessageCollectionMacro(userMessages, "vtkDMMLScene::Commit", "Scene writing failed: URL is not set");
      return 0;
      }
    }
  ...
  if (this->GetSaveToXMLString())
    ...
    if (ofs.fail())
      {
      vtkErrorToMessageCollectionMacro(userMessages, "vtkDMMLScene::Commit", "Scene writing failed: Could not open file " << url);
      return 0;
      }
    }
  ...
  // of data. But, commented out for now because CLI modules are using DMML
  // to write data in another thread, causing GUI to crash.
  //this->InvokeEvent (vtkDMMLScene::SaveProgressFeedbackEvent );

  //file << "<?xml version=\"1.0\" standalone='no'?>\n";
  //file << "<!DOCTYPE DMML SYSTEM \"dmml20.dtd\">\n";

  // Add XML encoding specification. Cjyx uses the UTF-8 character set.
...
//------------------------------------------------------------------------------
inline bool IsNodeWithoutID(vtkDMMLNode* node)
{
  return node->GetID() == nullptr || node->GetID()[0] == '\0';
}

//------------------------------------------------------------------------------
inline bool IsNodeWithoutName(vtkDMMLNode* node)
{
...
//------------------------------------------------------------------------------
vtkDMMLNode* vtkDMMLScene::AddNodeNoNotify(vtkDMMLNode *n)
{
  if (!n)
    {
  ...
  if (n->GetSingletonTag() != nullptr)
    ...
    vtkDMMLNode *sn = this->GetSingletonNode(n);
    if (sn != nullptr)
      {
  ...
  // importing a scene (vtkDMMLScene::Import()), nodes to add already have an
  ...
  if (vtkDMMLSubjectHierarchyNode::SafeDownCast(n) != nullptr &&
...
//------------------------------------------------------------------------------
vtkDMMLNode* vtkDMMLScene::AddNode(vtkDMMLNode *n)
{
  if (!n)
    {
  ...
  vtkDMMLNode* node = this->AddNodeNoNotify(n);
  if (add)
    {
    ...
    {
    vtkWarningMacro("vtkDMMLScene::AddNode: Adding of a new node is not notified");
    }
...
//------------------------------------------------------------------------------
vtkDMMLNode* vtkDMMLScene::AddNewNodeByClass(
    std::string className, std::string nodeBaseName /* = "" */)
{
  ...
  vtkSmartPointer<vtkDMMLNode> nodeToAdd =
      vtkSmartPointer<vtkDMMLNode>::Take(this->CreateNodeByClass(className.c_str()));
...
//------------------------------------------------------------------------------
vtkDMMLNode* vtkDMMLScene::AddNewNodeByClassWithID(std::string className, std::string nodeBaseName, std::string nodeID)
{
  if (className.empty())
    {
...
//------------------------------------------------------------------------------
void vtkDMMLScene::NodeAdded(vtkDMMLNode *n)
{
  this->InvokeEvent(this->NodeAddedEvent, n);
}

//------------------------------------------------------------------------------
vtkDMMLNode* vtkDMMLScene::CopyNode(vtkDMMLNode *n)
{
   if (!n)
    {
  ...
  vtkDMMLNode* node = n->CreateNodeInstance();
  node->Copy(n);

  vtkDMMLNode* nnode = this->AddNode(node);
  node->Delete();
  return nnode;
}

//------------------------------------------------------------------------------
void vtkDMMLScene::RemoveNode(vtkDMMLNode *n)
{
  if (n == nullptr)
    {
  ...
  n->Register(this);
  this->InvokeEvent(vtkDMMLScene::NodeAboutToBeRemovedEvent, n);
  ...
  this->InvokeEvent(vtkDMMLScene::NodeRemovedEvent, n);
  ...
  if (!this->IsClosing())
    ...
    if (referencedNodeIdIt!=this->NodeReferences.end())
      ...
      for (NodeReferencesType::value_type::second_type::iterator referringNodesIt = referringNodes.begin();
        ...
        ++referringNodesIt)
        {
        vtkDMMLNode* node=this->GetNodeByID(*referringNodesIt);
        if (node)
          {
...
//------------------------------------------------------------------------------
void vtkDMMLScene::RemoveReferencedNodeID(const char *id, vtkDMMLNode *referencingNode)
{
...
//------------------------------------------------------------------------------
void vtkDMMLScene::RemoveNodeReferences(vtkDMMLNode *n)
{
  if (n == nullptr)
    {
...
//------------------------------------------------------------------------------
void vtkDMMLScene::RemoveUnusedNodeReferences()
{
  ...
  for (NodeReferencesType::iterator referenceIt = this->NodeReferences.begin();
    ...
    for (NodeReferencesType::value_type::second_type::iterator referringNodesIt = referenceIt->second.begin();
      ...
      {
      vtkDMMLNode *currentReferencingNodePtr=this->GetNodeByID(*referringNodesIt);
      if (currentReferencingNodePtr==nullptr)
        {
        // ### Cjyx 4.4: Simplify this logic when adding support for C++11 across all supported platform/compilers
  ...
  for (NodeReferencesType::iterator referenceIt = this->NodeReferences.begin();
    ...
    /*upon deletion the increment is done already, so don't increment here*/)
    {
    vtkDMMLNode *node = this->GetNodeByID(referenceIt->first);
...
//------------------------------------------------------------------------------
void vtkDMMLScene::RemoveReferencesToNode(vtkDMMLNode *n)
{
...
//------------------------------------------------------------------------------
int vtkDMMLScene::IsNodePresent(vtkDMMLNode *n)
{
  return this->Nodes->vtkCollection::IsItemPresent((vtkObject *)n);
}

//------------------------------------------------------------------------------
void vtkDMMLScene::InitTraversal()
{
  vtkWarningMacro("Usage of vtkDMMLScene::InitTraversal() is unsafe.");
  this->Nodes->InitTraversal();
}

//------------------------------------------------------------------------------
vtkDMMLNode* vtkDMMLScene::GetNextNode()
{
  vtkWarningMacro("Usage of vtkDMMLScene::GetNextNode() is unsafe.");
  return vtkDMMLNode::SafeDownCast(this->Nodes->GetNextItemAsObject());
}

//------------------------------------------------------------------------------
int vtkDMMLScene::GetNumberOfNodes ()
{
  return this->Nodes->GetNumberOfItems();
}

//------------------------------------------------------------------------------
int vtkDMMLScene::GetNumberOfNodesByClass(const char *className)
{
  if (className == nullptr)
    {
...
//------------------------------------------------------------------------------
int vtkDMMLScene::GetNodesByClass(const char *className, std::vector<vtkDMMLNode *> &nodes)
{
  nodes.clear();
  if (className == nullptr)
    {
...
//------------------------------------------------------------------------------
vtkCollection* vtkDMMLScene::GetNodesByClass(const char *className)
{
  if (className == nullptr)
    {
    vtkErrorMacro("GetNodesByClass: class name is null.");
...
//------------------------------------------------------------------------------
std::list< std::string > vtkDMMLScene::GetNodeClassesList()
{
...
//------------------------------------------------------------------------------
vtkDMMLNode *vtkDMMLScene::GetNextNodeByClass(const char *className)
{
  vtkWarningMacro("Usage of vtkDMMLScene::GetNextNodeByClass(const char *) is unsafe.");
  if (!className)
    {
  ...
  vtkDMMLNode *node = (vtkDMMLNode*)this->Nodes->GetNextItemAsObject();

  while (node != nullptr && !node->IsA(className))
    {
    node = (vtkDMMLNode*)this->Nodes->GetNextItemAsObject();
    }
...
//------------------------------------------------------------------------------
vtkDMMLNode* vtkDMMLScene::GetSingletonNode(const char* singletonTag, const char* className)
{
  if (singletonTag==nullptr || strlen(singletonTag)==0)
    {
    vtkErrorMacro("vtkDMMLScene::GetSingletonNode: received invalid singletonTag");
    return nullptr;
    }
  if (className==nullptr || strlen(className)==0)
    {
    vtkErrorMacro("vtkDMMLScene::GetSingletonNode: received invalid className");
    return nullptr;
    }
...
//------------------------------------------------------------------------------
vtkDMMLNode* vtkDMMLScene::GetSingletonNode(vtkDMMLNode* n)
{
  if (n == nullptr || n->GetSingletonTag() == nullptr)
    {
    vtkErrorMacro("vtkDMMLScene::GetSingletonNode failed: singleton node is expected");
    return nullptr;
    }
  vtkDMMLNode *sn = this->GetSingletonNode(n->GetSingletonTag(), n->GetClassName());
  if (sn != nullptr)
    {
  ...
  // The vtkDMMLNode was updated to serialize the singleton tag but legacy scene files from
...
//------------------------------------------------------------------------------
vtkDMMLNode* vtkDMMLScene::GetNthNode(int n)
{
  if(n < 0 || n >= this->Nodes->GetNumberOfItems())
    ...
    {
    return (vtkDMMLNode*)this->Nodes->GetItemAsObject(n);
    }
}

//------------------------------------------------------------------------------
vtkDMMLNode* vtkDMMLScene::GetNthNodeByClass(int n, const char *className)
{
...
//------------------------------------------------------------------------------
vtkDMMLNode* vtkDMMLScene::GetFirstNodeByClass(const char *className)
{
  return this->GetNthNodeByClass(0, className);
}

//------------------------------------------------------------------------------
vtkCollection* vtkDMMLScene::GetNodesByName(const char* name)
{
  vtkCollection* nodes = vtkCollection::New();
...
//-----------------------------------------------------------------------------
vtkDMMLNode* vtkDMMLScene::GetFirstNode(const char* byName,
                                        const char* byClass,
...
//------------------------------------------------------------------------------
vtkDMMLNode* vtkDMMLScene::GetFirstNodeByName(const char* name)
{
  vtkDMMLNode *node = nullptr;
  if (name == nullptr)
    {
...
//------------------------------------------------------------------------------
vtkDMMLNode* vtkDMMLScene::GetNodeByID(std::string id)
{
  return this->GetNodeByID(id.c_str());
}

//------------------------------------------------------------------------------
vtkDMMLNode* vtkDMMLScene::GetNodeByID(const char* id)
{
  if (id == nullptr)
    {
  ...
  vtkDMMLNode *node = nullptr;
  this->UpdateNodeIDs();
  std::map< std::string, vtkSmartPointer<vtkDMMLNode> >::iterator it = this->NodeIDs.find(std::string(id));
...
//------------------------------------------------------------------------------
vtkCollection* vtkDMMLScene::GetNodesByClassByName(const char* className, const char* name)
{
  vtkCollection* nodes = vtkCollection::New();
...
//------------------------------------------------------------------------------
vtkDMMLNode* vtkDMMLScene::InsertAfterNode(vtkDMMLNode *item, vtkDMMLNode *n)
{
  if (!n)
    {
...
//------------------------------------------------------------------------------
vtkDMMLNode* vtkDMMLScene::InsertBeforeNode(vtkDMMLNode *item, vtkDMMLNode *n)
{
  if (!n)
    {
...
//------------------------------------------------------------------------------
void vtkDMMLScene::PrintSelf(ostream& os, vtkIndent indent)
{
  ...
  for (unsigned int n = 0; n < this->RegisteredNodeClasses.size(); n++)
    ...
    if (this->RegisteredNodeClasses[n]->IsA("vtkDMMLStorageNode"))
      {
      vtkDMMLStorageNode *snode = vtkDMMLStorageNode::SafeDownCast(this->RegisteredNodeClasses[n]);
...
//------------------------------------------------------------------------------
void vtkDMMLScene::SetURL(const char *url)
{
  this->URL = std::string(url?url:"");
}

//------------------------------------------------------------------------------
const char * vtkDMMLScene::GetURL()
{
  return this->URL.c_str();
}

//------------------------------------------------------------------------------
void vtkDMMLScene::SetRootDirectory(const char *dir)
{
  this->RootDirectory = std::string(dir);
}

//------------------------------------------------------------------------------
const char * vtkDMMLScene::GetRootDirectory()
{
  return this->RootDirectory.c_str();
}

//------------------------------------------------------------------------------
int vtkDMMLScene::GetNumberOfRegisteredNodeClasses()
{
  return static_cast<int>(this->RegisteredNodeClasses.size());
}

//------------------------------------------------------------------------------
vtkDMMLNode *vtkDMMLScene::GetNthRegisteredNodeClass(int n)
{
...
//------------------------------------------------------------------------------
int vtkDMMLScene::GetNumberOfRegisteredAbstractNodeClasses()
{
  return static_cast<int>(this->RegisteredAbstractNodeClassTypeDisplayNames.size());
}

//------------------------------------------------------------------------------
std::string vtkDMMLScene::GetNthRegisteredAbstractNodeClassName(int n)
{
...
//------------------------------------------------------------------------------
std::string vtkDMMLScene::GetNthRegisteredAbstractNodeTypeDisplayName(int n)
{
  if (n >= 0 && n < this->GetNumberOfRegisteredAbstractNodeClasses())
    {
    auto classNameTypeDisplayNameIt = this->RegisteredAbstractNodeClassTypeDisplayNames.begin();
...
//------------------------------------------------------------------------------
bool vtkDMMLScene::IsNodeClassRegistered(const std::string& className)
{
  for (int index=0; index < this->GetNumberOfRegisteredNodeClasses(); ++index)
    {
    vtkDMMLNode* registeredNodeClass = this->GetNthRegisteredNodeClass(index);
...
//------------------------------------------------------------------------------
std::string vtkDMMLScene::GenerateUniqueID(vtkDMMLNode* node)
{
  if (!node)
    {
    vtkWarningMacro("vtkDMMLScene::GenerateUniqueID: invalid node");
...
//------------------------------------------------------------------------------
std::string vtkDMMLScene::GenerateUniqueID(const std::string& baseID)
{
...
//------------------------------------------------------------------------------
int vtkDMMLScene::GetUniqueIDIndex(const std::string& baseID)
{
  if (baseID.empty())
    {
    vtkWarningMacro("vtkDMMLScene::GetUniqueIDIndex: baseID is empty");
    }
  int lastIDIndex = 0;
...
//------------------------------------------------------------------------------
bool vtkDMMLScene::IsNodeIDReservedByUndo(const std::string id) const
{
...
//------------------------------------------------------------------------------
void vtkDMMLScene::GetNodeReferenceIDsFromUndoStack(std::set<std::string>& referenceIDs) const
{
  referenceIDs.clear();
  ...
  for (undoStackIt = this->UndoStack.begin(); undoStackIt != this->UndoStack.end(); ++undoStackIt)
    ...
    for (int i = 0; i < nodes->GetNumberOfItems(); ++i)
      {
      vtkDMMLNode* node = vtkDMMLNode::SafeDownCast(nodes->GetItemAsObject(i));
      if (!node)
        {
        continue;
        }
...
//------------------------------------------------------------------------------
std::string vtkDMMLScene::BuildID(const std::string& baseID, int idIndex)const
{
  std::stringstream ss;
  ss << baseID;
...
//------------------------------------------------------------------------------
std::string vtkDMMLScene::GenerateUniqueName(vtkDMMLNode* node)
{
  if (!node)
    {
    vtkErrorMacro("vtkDMMLScene::GenerateUniqueName: input node is invalid");
    return "";
    }
...
//------------------------------------------------------------------------------
std::string vtkDMMLScene::GenerateUniqueName(const std::string& baseName)
{
...
//------------------------------------------------------------------------------
const char* vtkDMMLScene::GetUniqueNameByString(const char* baseName)
{
...
//------------------------------------------------------------------------------
int vtkDMMLScene::GetUniqueNameIndex(const std::string& baseName)
{
  if (baseName.empty())
    {
    vtkWarningMacro("vtkDMMLScene::GetUniqueNameIndex: baseName is invalid");
    }
  int lastNameIndex = -1;
...
//------------------------------------------------------------------------------
std::string vtkDMMLScene::BuildName(const std::string& baseName, int nameIndex)const
{
...
//------------------------------------------------------------------------------
bool vtkDMMLScene::IsReservedID(const std::string& id)
{
  return !(this->ReservedIDs.find(id) == this->ReservedIDs.end());
}

//------------------------------------------------------------------------------
void vtkDMMLScene::AddReservedID(const char *id)
{
  if (id == nullptr)
    {
    return;
...
//------------------------------------------------------------------------------
void vtkDMMLScene::RemoveReservedIDs()
{
...
//
void vtkDMMLScene::SaveStateForUndo (vtkDMMLNode *node)
{
  if (!this->UndoFlag)
    {
    return;
...
//------------------------------------------------------------------------------
void vtkDMMLScene::SaveStateForUndo (std::vector<vtkDMMLNode *> nodes)
{
  if (!this->UndoFlag)
    {
    return;
...
//------------------------------------------------------------------------------
void vtkDMMLScene::SaveStateForUndo (vtkCollection* nodes)
{
  if (!this->UndoFlag)
    {
    return;
  ...
  for (int n=0; n<nnodes; n++)
    {
    vtkDMMLNode *node  = vtkDMMLNode::SafeDownCast(nodes->GetItemAsObject(n));
    if (node && node->GetUndoEnabled())
      {
      this->CopyNodeInUndoStack(node);
      }
...
//------------------------------------------------------------------------------
void vtkDMMLScene::SaveStateForUndo ()
{
  if (!this->UndoFlag)
    {
    return;
...
void vtkDMMLScene::PushIntoUndoStack()
{
  if (this->Nodes == nullptr)
    {
    return;
  ...
  for (int n=0; n<nnodes; n++)
    {
    vtkDMMLNode *node  = vtkDMMLNode::SafeDownCast(currentScene->GetItemAsObject(n));
    if (node && node->GetUndoEnabled())
      {
...
void vtkDMMLScene::PushIntoRedoStack()
{
  if (this->Nodes == nullptr)
    {
    return;
...
// can be edited
void vtkDMMLScene::CopyNodeInUndoStack(vtkDMMLNode *copyNode)
{
  if (!copyNode)
    {
  ...
  vtkDMMLNode *snode = copyNode->CreateNodeInstance();
  if (snode != nullptr)
    {
  ...
  for (int n=0; n<nnodes; n++)
    {
    vtkDMMLNode *node  = vtkDMMLNode::SafeDownCast(undoScene->GetItemAsObject(n));
    if (node == copyNode)
      {
...
void vtkDMMLScene::CopyNodeInRedoStack(vtkDMMLNode *copyNode)
{
  if (!copyNode)
    {
...
void vtkDMMLScene::Undo()
{
  ...
  this->StartState(vtkDMMLScene::UndoState);
  this->RemoveUnusedNodeReferences();
  ...
  std::vector<vtkDMMLNode*> currentNodes;
  ...
  std::vector<vtkDMMLNode*> undoNodes;
  ...
  std::vector<vtkDMMLNode*>::iterator iterNode;
  std::vector<std::string>::iterator curIterID;
  std::vector<vtkDMMLNode*>::iterator curIterNode;

  // copy back changes and add deleted nodes to the current scene
  std::vector<vtkDMMLNode*> addNodes;
  ...
  std::vector<vtkDMMLNode*> removeNodes;
  ...
  for (nn=0; nn<removeNodes.size(); nn++)
    {
    vtkDMMLNode* nodeToRemove = removeNodes[nn];
  ...
  this->EndState(vtkDMMLScene::UndoState);
...
void vtkDMMLScene::Redo()
{
  ...
  this->StartState(vtkDMMLScene::RedoState);
  ...
  vtkCollection* currentScene = this->Nodes;
  //std::hash_map<std::string, vtkDMMLNode*> currentMap;
  std::map<std::string, vtkWeakPointer<vtkDMMLNode> > currentMap;
  nnodes = currentScene->GetNumberOfItems();
  for (n=0; n<nnodes; n++)
    {
    vtkDMMLNode *node  = vtkDMMLNode::SafeDownCast(currentScene->GetItemAsObject(n));
  ...
  //std::hash_map<std::string, vtkDMMLNode*> undoMap;
  std::map<std::string, vtkWeakPointer<vtkDMMLNode> > undoMap;
  ...
  std::map<std::string, vtkWeakPointer<vtkDMMLNode> >::iterator iter;
  std::map<std::string, vtkWeakPointer<vtkDMMLNode> >::iterator curIter;

  // copy back changes and add deleted nodes to the current scene
  std::vector<vtkWeakPointer<vtkDMMLNode> > addNodes;
  ...
  // remove new nodes created before Undo
  std::vector<vtkWeakPointer<vtkDMMLNode> > removeNodes;
  ...
  this->EndState(vtkDMMLScene::RedoState);
}

//------------------------------------------------------------------------------
void vtkDMMLScene::ClearUndoStack()
{
...
//------------------------------------------------------------------------------
void vtkDMMLScene::ClearRedoStack()
{
  std::list< vtkCollection* >::iterator iter;
...
//------------------------------------------------------------------------------
void vtkDMMLScene::AddReferencedNodeID(const char *id, vtkDMMLNode *referencingNode)
{
  if (id==nullptr)
    {
...
//------------------------------------------------------------------------------
bool vtkDMMLScene::IsNodeReferencingNodeID(vtkDMMLNode* referencingNode, const char* id)
{
  if (id == nullptr || referencingNode == nullptr)
    {
    vtkErrorMacro("RemoveReferencedNodeID: either id is null or the reference node is null.");
...
//------------------------------------------------------------------------------
int vtkDMMLScene::IsFilePathRelative(const char * filepath)
{
  if (filepath == nullptr)
    {
...
//------------------------------------------------------------------------------
const char* vtkDMMLScene::GetChangedID(const char* id)
{
...
//------------------------------------------------------------------------------
void vtkDMMLScene::UpdateNodeReferences(vtkCollection* checkNodes/*=nullptr*/)
{
...
//------------------------------------------------------------------------------
void vtkDMMLScene::RemoveInvalidNodeReferences(vtkCollection* checkNodes, const std::set<std::string> &validNodeIDs)
{
  ...
  for (checkNodes->InitTraversal(it);
    (node = vtkDMMLNode::SafeDownCast(checkNodes->GetNextItemAsObject(it)));)
    {
...
//------------------------------------------------------------------------------
void vtkDMMLScene::AddReferencedNodes(vtkDMMLNode *node, vtkCollection *refNodes, bool recursive/*=true*/)
{
  ...
  std::deque<vtkDMMLNode*> newFoundReferencedNodes;
  ...
  for (NodeReferencesType::iterator referenceIt = this->NodeReferences.begin();
    ...
    if (referringNodesIt!=referenceIt->second.end())
      ...
      vtkDMMLNode *referencedNode = this->GetNodeByID(referenceIt->first);
  ...
  if (recursive)
    ...
    for (std::deque<vtkDMMLNode*>::iterator newReferencedNodeIt=newFoundReferencedNodes.begin();
...
//------------------------------------------------------------------------------
vtkCollection* vtkDMMLScene::GetReferencedNodes(vtkDMMLNode *node, bool recursive/*=true*/)
{
  vtkCollection* nodes = vtkCollection::New();
  if (node != nullptr)
    {
...
//-----------------------------------------------------------------------------
void vtkDMMLScene::GetReferencingNodes(vtkDMMLNode* referencedNode, std::vector<vtkDMMLNode *> &referencingNodes)
{
...
//------------------------------------------------------------------------------
void vtkDMMLScene::CopyNodeReferences(vtkDMMLScene *scene)
{
  if (!scene)
    {
    return;
...
//------------------------------------------------------------------------------
void vtkDMMLScene::CopyNodeChangedIDs(vtkDMMLScene *scene)
{
  if (!scene)
    {
    return;
...
//------------------------------------------------------------------------------
void vtkDMMLScene::UpdateNodeChangedIDs()
{
...
//------------------------------------------------------------------------------
void vtkDMMLScene::UpdateNodeIDs()
{
  if (this->Nodes->GetNumberOfItems() == 0)
    {
    this->ClearNodeIDs();
...
//-----------------------------------------------------------------------------
void vtkDMMLScene::AddNodeID(vtkDMMLNode *node)
{
...
//-----------------------------------------------------------------------------
void vtkDMMLScene::RemoveNodeID(char *nodeID)
{
...
//-----------------------------------------------------------------------------
void vtkDMMLScene::ClearNodeIDs()
{
  if (this->Nodes)
    {
    this->NodeIDs.clear();
...
//------------------------------------------------------------------------------
void vtkDMMLScene::AddURIHandler(vtkURIHandler *handler)
{
...
//------------------------------------------------------------------------------
vtkURIHandler * vtkDMMLScene::FindURIHandlerByName(const char *name)
{
  vtkURIHandler *u;
  if ( name == nullptr )
    {
...
//------------------------------------------------------------------------------
vtkURIHandler * vtkDMMLScene::FindURIHandler(const char *URI)
{
  if (URI == nullptr)
    {
...
//-----------------------------------------------------------------------------
void vtkDMMLScene
::GetReferencedSubScene(vtkDMMLNode *rnode, vtkDMMLScene* newScene)
{
  //
  // clear scene
  //
  ...
  //
  vtkDMMLNode *currentObject = nullptr;
  vtkCollectionSimpleIterator it;
  for (nodes->InitTraversal(it);
    (currentObject = (vtkDMMLNode*)nodes->GetNextItemAsObject(it));)
    {
    vtkDMMLNode* n = vtkDMMLNode::SafeDownCast(currentObject);
    if (n == nullptr)
      {
      continue;
      }
    ...
    vtkDMMLNode* node = n->CreateNodeInstance();
    vtkDMMLNode* originalNode = this->GetNodeByID(n->GetID());
...
//-----------------------------------------------------------------------------
void vtkDMMLScene::SetSceneXMLString(const std::string &xmlString)
{
  this->SceneXMLString = xmlString;
}

//-----------------------------------------------------------------------------
const std::string& vtkDMMLScene::GetSceneXMLString()
{
  return this->SceneXMLString;
}

//----------------------------------------------------------------------------
vtkDMMLSubjectHierarchyNode* vtkDMMLScene::GetSubjectHierarchyNode()
{
...
//-----------------------------------------------------------------------------
void vtkDMMLScene::SetSubjectHierarchyNode(vtkDMMLSubjectHierarchyNode* node)
{
  this->SubjectHierarchyNode = node;
}

//-----------------------------------------------------------------------------
bool vtkDMMLScene::GetModifiedSinceRead(vtkCollection* modifiedNodes/*=nullptr*/)
{
  if (modifiedNodes)
    {
  ...
  bool hasAtLeast1DisplayableNode =
    (this->GetFirstNode(nullptr, "vtkDMMLDisplayableNode", &hideFromEditors) != nullptr);
  ...
  for (this->Nodes->InitTraversal(it);
    (node = (vtkDMMLNode*)this->Nodes->GetNextItemAsObject(it));)
    {
    if (node->IsA("vtkDMMLAbstractViewNode"))
      {
...
::GetStorableNodesModifiedSinceRead(vtkCollection* modifiedStorableNodes)
{
  ...
  storableNodes.TakeReference(
    this->GetNodesByClass("vtkDMMLStorableNode"));
  vtkCollectionSimpleIterator it;
  vtkDMMLStorableNode* storableNode;
  for (storableNodes->InitTraversal(it);
       (storableNode= vtkDMMLStorableNode::SafeDownCast(
...
//-----------------------------------------------------------------------------
void vtkDMMLScene::SetStorableNodesModifiedSinceRead()
{
  vtkSmartPointer<vtkCollection> storableNodes;
  storableNodes.TakeReference(this->GetNodesByClass("vtkDMMLStorableNode"));
  vtkDMMLScene::SetStorableNodesModifiedSinceRead(storableNodes);
}
...
//-----------------------------------------------------------------------------
int vtkDMMLScene::GetNumberOfNodeReferences()
{
...
//-----------------------------------------------------------------------------
vtkDMMLNode* vtkDMMLScene::GetNthReferencingNode(int n)
{
  for (NodeReferencesType::iterator referenceIt = this->NodeReferences.begin();
    referenceIt != this->NodeReferences.end();
    ++referenceIt)
...
//-----------------------------------------------------------------------------
const char* vtkDMMLScene::GetNthReferencedID(int n)
{
  for (NodeReferencesType::iterator referenceIt = this->NodeReferences.begin();
    referenceIt != this->NodeReferences.end();
    ++referenceIt)
...
//-----------------------------------------------------------------------------
void vtkDMMLScene::SetMaximumNumberOfSavedUndoStates(int stackSize)
{
...
//-----------------------------------------------------------------------------
void vtkDMMLScene::TrimUndoStack()
{
...
//----------------------------------------------------------------------------
bool vtkDMMLScene::WriteToMRB(const char* filename, vtkImageData* thumbnail/*=nullptr*/, vtkDMMLMessageCollection* userMessages/*=nullptr*/)
{
  //
  ...
  if (vtksys::SystemTools::FileExists(bundleDir, false))
    ...
    if (!vtksys::SystemTools::RemoveADirectory(bundleDir))
      {
      vtkErrorToMessageCollectionMacro(userMessages, "vtkDMMLScene::WriteToMRB",
  ...
  //
  bool retval = this->SaveSceneToCjyxDataBundleDirectory(bundleDir.c_str(), thumbnail, userMessages);
  if (!retval)
    {
    vtkErrorToMessageCollectionMacro(userMessages, "vtkDMMLScene::WriteToMRB",
  ...
  if (!vtksys::SystemTools::RemoveADirectory(tempDir))
    {
    vtkWarningToMessageCollectionMacro(userMessages, "vtkDMMLScene::WriteToMRB",
...
//-----------------------------------------------------------------------------
bool vtkDMMLScene::ReadFromMRB(const char* fullName, bool clear/*=false*/, vtkDMMLMessageCollection* userMessagesInput/*=nullptr*/)
{
  // We use userMessages for collecting error information, so make sure we have it, even if the caller does not need it.
  vtkSmartPointer<vtkDMMLMessageCollection> userMessages = userMessagesInput;
  if (!userMessages)
  ...
  if (this->GetDataIOManager()
    ...
    {
    vtkErrorToMessageCollectionMacro(userMessages, "vtkDMMLScene::ReadFromMRB",
  ...
  std::string dmmlFile = vtkDMMLScene::UnpackCjyxDataBundle(fullName, unpackDir.c_str());
  this->SetURL(dmmlFile.c_str());
  int success = false;
  if (clear)
    {
  ...
  if (!vtksys::SystemTools::RemoveADirectory(unpackDir))
    {
    vtkErrorToMessageCollectionMacro(userMessages, "vtkDMMLScene::ReadFromMRB",
      "vtkDMMLScene::ReadFromMRB failed: cannot remove directory '" << unpackDir << "'");
    return false;
    }
  ...
  std::string resetURL = mrbDir + "/" + mrbBaseName + ".dmml";
  ...
  this->GetNodesByClass("vtkDMMLStorageNode", storageNodes);
  for (std::vector<vtkDMMLNode *>::iterator storageNodeIt = storageNodes.begin(); storageNodeIt != storageNodes.end(); ++storageNodeIt)
    {
    vtkDMMLStorageNode* storageNode = vtkDMMLStorageNode::SafeDownCast(*storageNodeIt);
    if (!storageNode)
      {
      continue;
      }
...
//----------------------------------------------------------------------------
std::string vtkDMMLScene::UnpackCjyxDataBundle(const char* sdbFilePath, const char* temporaryDirectory, vtkDMMLMessageCollection* userMessages/*=nullptr*/)
{
  ...
  if (!glob.FindFiles(globPattern + "/*.dmml"))
    {
  ...
  if (files.size() <= 0)
    {
    vtkGenericWarningMacro("could not find dmml file in archive");
    if (userMessages)
      {
      userMessages->AddMessage(vtkCommand::ErrorEvent, "Could not find dmml file in archive.");
      }
    return "";
    }
...
//----------------------------------------------------------------------------
bool vtkDMMLScene::SaveSceneToCjyxDataBundleDirectory(const char* sdbDir,
  vtkImageData* screenShot/*=nullptr*/, vtkDMMLMessageCollection* userMessagesInput/*=nullptr*/)
{
  // Overview:
  ...
  if (!sdbDir)
    {
    vtkErrorToMessageCollectionMacro(userMessages, "vtkDMMLScene::SaveSceneToCjyxDataBundleDirectory",
  ...
  // the new url of the dmml scene
  std::string urlStr = vtksys::SystemTools::GetFilenameWithoutExtension(rootDir.c_str()) + std::string(".dmml");
  ...
  std::map<vtkDMMLStorageNode*, std::vector<std::string> > originalStorageNodeFileNames;
  ...
  for (int i = 0; i < numNodes; ++i)
    {
    vtkDMMLNode* dmmlNode = this->GetNthNode(i);
    if (!dmmlNode)
      {
      vtkWarningToMessageCollectionMacro(userMessages, "vtkDMMLScene::SaveSceneToCjyxDataBundleDirectory",
        "Save scene to data bundle directory error: Unable to get " << i << "th node from scene with " << numNodes << " nodes");
      continue;
      }
    if (dmmlNode->IsA("vtkDMMLStorableNode"))
      {
      // get all storable nodes in the main scene
      // and store them in the map by ID to avoid duplicates for the scene views
      vtkDMMLStorableNode* storableNode = vtkDMMLStorableNode::SafeDownCast(dmmlNode);
      if (!this->SaveStorableNodeToCjyxDataBundleDirectory(storableNode, dataDir, originalStorageNodeFileNames, userMessages))
        {
        success = false;
        }
  ...
  for (int i = 0; i < numNodes; ++i)
    {
    vtkDMMLSceneViewNode* sceneViewNode = vtkDMMLSceneViewNode::SafeDownCast(this->GetNthNode(i));
    if (!sceneViewNode)
      {
      continue;
      }
    ...
    sceneViewNode->GetNodesByClass("vtkDMMLStorableNode", snodes);
    std::vector<vtkDMMLNode *>::iterator sit;
    for (sit = snodes.begin(); sit != snodes.end(); sit++)
      {
      vtkDMMLStorableNode* storableNode = vtkDMMLStorableNode::SafeDownCast(*sit);
      std::map<std::string, vtkDMMLNode *>::iterator storableNodeIt = storableNodes.find(std::string(storableNode->GetID()));
      if (storableNodeIt == storableNodes.end())
        ...
        vtkDMMLStorageNode* storageNodeInMainScene = vtkDMMLStorableNode::SafeDownCast(storableNodeIt->second)->GetStorageNode();
  ...
  for (int i = 0; i < numNodes; ++i)
    ...
    if (dmmlNode->IsA("vtkDMMLSceneViewNode"))
      {
...
//----------------------------------------------------------------------------
void vtkDMMLScene::SaveSceneScreenshot(vtkImageData* screenshot)
{
  if (this->GetURL() == nullptr)
    {
    vtkErrorMacro("vtkDMMLScene::SaveSceneScreenshot failed: invalid scene or URL");
    return;
    }
  std::string screenshotFilePath = this->GetURL();

  // Write screenshot with the same name and folder as the dmml file but with .png extension

  // Strip file extension (.dmml)
...
//----------------------------------------------------------------------------
std::string vtkDMMLScene::CreateUniqueFileName(const std::string& filename, const std::string& knownExtension)
{
...
//----------------------------------------------------------------------------
bool vtkDMMLScene::SaveStorableNodeToCjyxDataBundleDirectory(vtkDMMLStorableNode* storableNode, std::string &dataDir,
  std::map<vtkDMMLStorageNode*, std::vector<std::string> > &originalStorageNodeFileNames, vtkDMMLMessageCollection* userMessages)
{
...
//----------------------------------------------------------------------------
std::string vtkDMMLScene::PercentEncode(std::string s)
{
...
//-----------------------------------------------------------------------------
bool vtkDMMLScene::ParseVersion(const char* versionString, std::string& application, int& major, int& minor, int& patch, int& revision)
{
  if (!versionString)
    {
    return false;
  ...
  // Old-style: "Cjyx4.4.0"
  vtksys::RegularExpression oldStyle("^Cjyx([0-9]+)\\.([0-9]+)\\.([0-9]+)");
  // New-style: "Cjyx 4.4.0 123456"
