...
#ifndef __vtkDMMLVolumeNode_h
#define __vtkDMMLVolumeNode_h
...
class VTK_DMML_EXPORT vtkDMMLVolumeNode : public vtkDMMLDisplayableNode
{
public:
  vtkTypeMacro(vtkDMMLVolumeNode,vtkDMMLDisplayableNode);
  ...
  vtkDMMLCopyContentMacro(vtkDMMLVolumeNode);

  ///
  /// Copy the node's attributes to this object
  void CopyOrientation(vtkDMMLVolumeNode *node);
  ...
  /// be applied to it.
  /// \sa GetSliceBounds(), GetIJKToRASMatrix(), vtkDMMLSliceLogic::GetVolumeSliceBounds()
  /// \sa GetNodeBounds()
  ...
  virtual vtkDMMLVolumeDisplayNode* GetVolumeDisplayNode();
  ...
  /// made to store all information in the DMML node (vtkDMMLVolumeNode::Origin,
  /// vtkDMMLVolumeNode::Spacing, and vtkDMMLVolumeNode::IJKToRASDirections).
...
protected:
  vtkDMMLVolumeNode();
  ~vtkDMMLVolumeNode() override;
  vtkDMMLVolumeNode(const vtkDMMLVolumeNode&);
  void operator=(const vtkDMMLVolumeNode&);

  /// Set the image data pipeline to all the display nodes.
  void SetImageDataToDisplayNodes();
  void SetImageDataToDisplayNode(vtkDMMLVolumeDisplayNode* displayNode);

  /// Called when a display node is added/removed/modified. Propagate the polydata
  /// to the new display node.
  virtual void UpdateDisplayNodeImageData(vtkDMMLDisplayNode *dnode);
