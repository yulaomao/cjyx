/*=auto=========================================================================
  ...
  Program:   3D Cjyx
  Module:    $RCSfile: vtkDMMLColorTableNode.h,v $
  Date:      $Date: 2006/03/19 17:12:28 $
  Version:   $Revision: 1.0 $

=========================================================================auto=*/

#ifndef __vtkDMMLColorTableNode_h
#define __vtkDMMLColorTableNode_h

#include "vtkDMMLColorNode.h"

/// \brief DMML node to represent discrete color information.
///
/// Color nodes describe color look up tables. The tables may be pre-generated by
/// Cjyx (the label map colors, a random one) or created by
/// a user. More than one model or label volume or editor can access the prebuilt
/// nodes.
class VTK_DMML_EXPORT vtkDMMLColorTableNode : public vtkDMMLColorNode
{
public:
  static vtkDMMLColorTableNode *New();
  vtkTypeMacro(vtkDMMLColorTableNode,vtkDMMLColorNode);
  ...
  /// Labels - the Cjyx2 FullRainbow editor labels
...
protected:
  vtkDMMLColorTableNode();
  ~vtkDMMLColorTableNode() override;
  vtkDMMLColorTableNode(const vtkDMMLColorTableNode&);
  void operator=(const vtkDMMLColorTableNode&);
