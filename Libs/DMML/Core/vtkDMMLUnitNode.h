...
#ifndef __vtkDMMLUnitNode_h
#define __vtkDMMLUnitNode_h
...
class VTK_DMML_EXPORT vtkDMMLUnitNode : public vtkDMMLNode
{
public:
  static vtkDMMLUnitNode *New();
  vtkTypeMacro(vtkDMMLUnitNode,vtkDMMLNode);
...
protected:
  vtkDMMLUnitNode();
  ~vtkDMMLUnitNode() override;
  vtkDMMLUnitNode(const vtkDMMLUnitNode&);
  void operator=(const vtkDMMLUnitNode&);
