/*=auto=========================================================================
  ...
  Program:   3D Cjyx
  Module:    $RCSfile: vtkDMMLTransformNode.h,v $
  Date:      $Date: 2006/03/19 17:12:29 $
  Version:   $Revision: 1.13 $

=========================================================================auto=*/

#ifndef __vtkDMMLTransformNode_h
#define __vtkDMMLTransformNode_h
...
/// \brief DMML node for representing a transformation
/// between this node space and a parent node space.
///
/// General Transformation between this node space and a parent node space.
/// A vtkDMMLTransformableNode::TransformModifiedEvent is called if the transforms
/// are changed. ModifiedEvent is called if either transforms or other properties
/// of the object are changed.
class VTK_DMML_EXPORT vtkDMMLTransformNode : public vtkDMMLDisplayableNode
{
public:
  static vtkDMMLTransformNode *New();
  vtkTypeMacro(vtkDMMLTransformNode,vtkDMMLDisplayableNode);
  ...
  vtkDMMLCopyContentMacro(vtkDMMLTransformNode);
  ...
  int  IsTransformToNodeLinear(vtkDMMLTransformNode* node);
  ...
  /// \sa GetTransformBetweenNodes
  void GetTransformToNode(vtkDMMLTransformNode* node,
                          vtkGeneralTransform* transformToNode);

  ///
  /// Get concatenated transforms from the specified node.
  /// \sa GetTransformBetweenNodes
  void GetTransformFromNode(vtkDMMLTransformNode* node,
  ...
  static void GetTransformBetweenNodes(vtkDMMLTransformNode* sourceNode,
  ...
  /// Returns 0 if the transform is not linear (cannot be described by a matrix).
  /// \sa GetMatrixTransformBetweenNodes
  virtual int GetMatrixTransformToNode(vtkDMMLTransformNode* node,
  ...
  /// Returns 0 if the transform is not linear (cannot be described by a matrix).
  /// \sa GetMatrixTransformBetweenNodes
  virtual int GetMatrixTransformFromNode(vtkDMMLTransformNode* node,
  ...
  /// Source and target nodes are allowed to be nullptr, which means that transform is the world transform.
  /// Returns 0 if the transform is not linear (cannot be described by a matrix).
  static int GetMatrixTransformBetweenNodes(vtkDMMLTransformNode* sourceNode,
    vtkDMMLTransformNode* targetNode, vtkMatrix4x4* transformSourceToTarget);
  ...
  int IsTransformNodeMyParent(vtkDMMLTransformNode* node);

  ///
  /// Returns 1 if the node is one of the this node's descendents
  int IsTransformNodeMyChild(vtkDMMLTransformNode* node);
  ...
  vtkDMMLTransformNode* GetFirstCommonParent(vtkDMMLTransformNode* targetNode);
  ...
  /// Reimplemented from vtkDMMLTransformableNode
  ...
  virtual void TransformModified()
    {
    this->InvokeCustomModifiedEvent(vtkDMMLTransformableNode::TransformModifiedEvent);
    }
  ...
  /// vtkDMMLTransformableNode::TransformModifiedEvent is fired.
...
protected:
  ...
  ~vtkDMMLTransformNode() override;
  vtkDMMLTransformNode(const vtkDMMLTransformNode&);
  void operator=(const vtkDMMLTransformNode&);
