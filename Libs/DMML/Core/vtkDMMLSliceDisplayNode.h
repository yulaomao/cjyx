...
#ifndef __vtkDMMLSliceDisplayNode_h
#define __vtkDMMLSliceDisplayNode_h

// DMML includes
#include "vtkDMMLModelDisplayNode.h"

/// \brief DMML node to store display properties of slice nodes.
///
/// This node controls appearance of slice intersections in slice views
/// and slices in 3D views.
class VTK_DMML_EXPORT vtkDMMLSliceDisplayNode : public vtkDMMLModelDisplayNode
{
public:
  static vtkDMMLSliceDisplayNode *New();
  vtkTypeMacro(vtkDMMLSliceDisplayNode,vtkDMMLModelDisplayNode);
  ...
  vtkDMMLCopyContentMacro(vtkDMMLSliceDisplayNode);
  ...
  /// \sa ComponentType
  int GetActiveComponentType(std::string context = vtkDMMLSliceDisplayNode::GetDefaultContextName());

  /// Index of active component (that the mouse or other interaction context is hovered over).
  /// This property is computed on-the-fly and saved to file.
  /// \param context Name of the interaction context. By default it is empty string, meaning mouse
  int GetActiveComponentIndex(std::string context= vtkDMMLSliceDisplayNode::GetDefaultContextName());
  ...
  void SetActiveComponent(int componentType, int componentIndex,
                          std::string context= vtkDMMLSliceDisplayNode::GetDefaultContextName());
...
protected:
  vtkDMMLSliceDisplayNode();
  ~vtkDMMLSliceDisplayNode() override;
  vtkDMMLSliceDisplayNode(const vtkDMMLSliceDisplayNode&);
  void operator=(const vtkDMMLSliceDisplayNode&);
