/*=auto=========================================================================
  ...
  Program:   3D Cjyx
  Module:    $RCSfile: vtkDMMLGlyphableVolumeSliceDisplayNode.h,v $
  Date:      $Date: 2006/03/19 17:12:28 $
  Version:   $Revision: 1.6 $

  =========================================================================auto=*/

#ifndef __vtkDMMLGlyphableVolumeSliceDisplayNode_h
#define __vtkDMMLGlyphableVolumeSliceDisplayNode_h
...
///
/// vtkDMMLGlyphableVolumeSliceDisplayNode nodes store display properties of trajectories
/// from tractography in diffusion MRI data, including color type (by bundle, by fiber,
/// or by scalar invariants), display on/off for tensor glyphs and display of
/// trajectory as a line or tube.
class VTK_DMML_EXPORT vtkDMMLGlyphableVolumeSliceDisplayNode : public vtkDMMLModelDisplayNode
{
 public:
  static vtkDMMLGlyphableVolumeSliceDisplayNode *New (  );
  vtkTypeMacro ( vtkDMMLGlyphableVolumeSliceDisplayNode,vtkDMMLModelDisplayNode );
 ...
 protected:
  ...
  ~vtkDMMLGlyphableVolumeSliceDisplayNode ( ) override;
  vtkDMMLGlyphableVolumeSliceDisplayNode ( const vtkDMMLGlyphableVolumeSliceDisplayNode& );
  void operator= ( const vtkDMMLGlyphableVolumeSliceDisplayNode& );
