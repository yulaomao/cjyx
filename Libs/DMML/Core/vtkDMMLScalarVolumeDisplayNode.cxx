...
//----------------------------------------------------------------------------
vtkDMMLNodeNewMacro(vtkDMMLScalarVolumeDisplayNode);

//----------------------------------------------------------------------------
vtkDMMLScalarVolumeDisplayNode::vtkDMMLScalarVolumeDisplayNode()
{
  // Strings
  this->Interpolate = 1;
  ...
  vtkEventBroker::GetInstance()->AddObservation(
    this, vtkCommand::ModifiedEvent, this, this->DMMLCallbackCommand  , 10000.);
}
...
//----------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::SetDefaultColorMap()
{
  this->SetAndObserveColorNodeID("vtkDMMLColorTableNodeGrey");
}

//----------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::SetInputImageDataConnection(vtkAlgorithmOutput *imageDataConnection)
{
  ...
  if (oldInputImageDataAlgorithm != nullptr)
    ...
    vtkEventBroker::GetInstance()->RemoveObservations(
      oldInputImageDataAlgorithm, vtkCommand::ModifiedEvent, this, this->DMMLCallbackCommand );
    }
  ...
  if (inputImageDataAlgorithm != nullptr)
    {
    vtkEventBroker::GetInstance()->AddObservation(
      inputImageDataAlgorithm, vtkCommand::ModifiedEvent, this, this->DMMLCallbackCommand );
    }

}

//----------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode
::SetInputToImageDataPipeline(vtkAlgorithmOutput *imageDataConnection)
{
  this->Threshold->SetInputConnection(imageDataConnection);

  if (this->GetScalarRangeFlag() == vtkDMMLDisplayNode::UseDirectMapping)
    {
...
//----------------------------------------------------------------------------
vtkAlgorithmOutput* vtkDMMLScalarVolumeDisplayNode::GetBackgroundImageStencilDataConnection()
{
  // Input ports:
...
//----------------------------------------------------------------------------
vtkAlgorithmOutput* vtkDMMLScalarVolumeDisplayNode::GetInputImageDataConnection()
{
...
//----------------------------------------------------------------------------
vtkAlgorithmOutput* vtkDMMLScalarVolumeDisplayNode::GetOutputImageDataConnection()
{
  return this->AppendComponents->GetOutputPort();
}

//----------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::WriteXML(ostream& of, int nIndent)
{
...
//----------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::ReadXMLAttributes(const char** atts)
{
...
void vtkDMMLScalarVolumeDisplayNode::Copy(vtkDMMLNode *anode)
{
  int disabledModify = this->StartModify();

  Superclass::Copy(anode);
  vtkDMMLScalarVolumeDisplayNode *node = (vtkDMMLScalarVolumeDisplayNode *) anode;
...
//----------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::PrintSelf(ostream& os, vtkIndent indent)
{
...
//---------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::ProcessDMMLEvents ( vtkObject *caller,
                                           unsigned long event,
                                           void *callData )
{
...
//---------------------------------------------------------------------------
double vtkDMMLScalarVolumeDisplayNode::GetWindow()
{
  return this->MapToWindowLevelColors->GetWindow();
}

//---------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::SetWindow(double window)
{
...
//---------------------------------------------------------------------------
double vtkDMMLScalarVolumeDisplayNode::GetLevel()
{
  return this->MapToWindowLevelColors->GetLevel();
}

//---------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::SetLevel(double level)
{
...
//---------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::SetWindowLevel(double window, double level)
{
  if (this->MapToWindowLevelColors->GetWindow() == window &&
...
//---------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::SetWindowLevelMinMax(double min, double max)
{
...
//---------------------------------------------------------------------------
double vtkDMMLScalarVolumeDisplayNode::GetWindowLevelMin()
{
...
//---------------------------------------------------------------------------
double vtkDMMLScalarVolumeDisplayNode::GetWindowLevelMax()
{
  const double window = this->GetWindow();
  const double level = this->GetLevel();
  return level + 0.5 * window;
...
//---------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::SetApplyThreshold(int apply)
{
...
//---------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::SetLowerThreshold(double threshold)
{
  this->SetThreshold(threshold, this->GetUpperThreshold());
}

//---------------------------------------------------------------------------
double vtkDMMLScalarVolumeDisplayNode::GetLowerThreshold()
{
  return this->Threshold->GetLowerThreshold();
}

//---------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::SetUpperThreshold(double threshold)
{
  this->SetThreshold(this->GetLowerThreshold(), threshold);
}

//---------------------------------------------------------------------------
double vtkDMMLScalarVolumeDisplayNode::GetUpperThreshold()
{
  return this->Threshold->GetUpperThreshold();
}

//---------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::SetThreshold(double lowerThreshold, double upperThreshold)
{
...
//---------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::SetColorNodeInternal(vtkDMMLColorNode* newColorNode)
{
...
//---------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::UpdateLookupTable(vtkDMMLColorNode* newColorNode)
{
  ...
  if (newColorNode)
    ...
    if (lookupTable == nullptr)
      {
      if (vtkDMMLProceduralColorNode::SafeDownCast(newColorNode) != nullptr)
        {
        vtkDebugMacro("UpdateImageDataPipeline: getting color transfer function");
        lookupTable = vtkDMMLProceduralColorNode::SafeDownCast(newColorNode)->GetColorTransferFunction();
        }
      }
    }

  if (lookupTable && this->GetScalarRangeFlag() != vtkDMMLDisplayNode::UseDirectMapping
...
//---------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::AddWindowLevelPresetFromString(const char *preset)
{
...
//---------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::AddWindowLevelPreset(double window, double level)
{
  vtkDMMLScalarVolumeDisplayNode::WindowLevelPreset preset;
...
//---------------------------------------------------------------------------
int vtkDMMLScalarVolumeDisplayNode::GetNumberOfWindowLevelPresets()
{
  return static_cast<int>(this->WindowLevelPresets.size());
}

//---------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::SetWindowLevelFromPreset(int p)
{
...
//---------------------------------------------------------------------------
double vtkDMMLScalarVolumeDisplayNode::GetWindowPreset(int p)
{
  if (p < 0 || p >= this->GetNumberOfWindowLevelPresets())
    {
...
//---------------------------------------------------------------------------
double vtkDMMLScalarVolumeDisplayNode::GetLevelPreset(int p)
{
  if (p < 0 || p >= this->GetNumberOfWindowLevelPresets())
    {
...
//---------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::ResetWindowLevelPresets()
{
  this->WindowLevelPresets.clear();
}

//---------------------------------------------------------------------------
vtkImageData* vtkDMMLScalarVolumeDisplayNode::GetScalarImageData()
{
...
//---------------------------------------------------------------------------
vtkAlgorithmOutput* vtkDMMLScalarVolumeDisplayNode::GetScalarImageDataConnection()
{
  return this->GetInputImageDataConnection();
}

//---------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::GetDisplayScalarRange(double range[2])
{
  range[0] = 0;
  range[1] = 255.;
  ...
  if (!imageData || !this->GetInputImageData())
    ...
    // loaded (vtkDMMLScene::LoadIntoScene)or stored
    // (vtkDMMLSceneViewNode::StoreScene).
...
//---------------------------------------------------------------------------
void vtkDMMLScalarVolumeDisplayNode::CalculateAutoLevels()
{
