...
//----------------------------------------------------------------------------
vtkDMMLNodeNewMacro(vtkDMMLROINode);

//----------------------------------------------------------------------------
void vtkDMMLROINode::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void vtkDMMLROINode::WriteXML(ostream& of, int nIndent)
{
...
//----------------------------------------------------------------------------
void vtkDMMLROINode::ReadXMLAttributes( const char** atts)
{
...
void vtkDMMLROINode::ReadXMLString(const char *keyValuePairs)
{
...
void vtkDMMLROINode::Copy(vtkDMMLNode *anode)
{
  int disabledModify = this->StartModify();
  ...
  vtkDMMLROINode *node = (vtkDMMLROINode *) anode;
...
//-----------------------------------------------------------------------------
void vtkDMMLROINode::UpdateScene(vtkDMMLScene *scene)
{
...
//-----------------------------------------------------------------------------
void vtkDMMLROINode::UpdateReferences()
{
...
//-----------------------------------------------------------------------------
void vtkDMMLROINode::ProcessDMMLEvents ( vtkObject *caller,
                                        unsigned long event,
                                        void *callData )
{
...
//-----------------------------------------------------------------------------
void vtkDMMLROINode::SetXYZ(double X, double Y, double Z)
{
  this->XYZ[0] = X;
  this->XYZ[1] = Y;
  this->XYZ[2] = Z;
...
//-----------------------------------------------------------------------------
void vtkDMMLROINode::SetXYZ(double* xyz)
{
...
//-----------------------------------------------------------------------------
void vtkDMMLROINode::SetRadiusXYZ(double RadiusX, double RadiusY, double RadiusZ)
{
...
//-----------------------------------------------------------------------------
void vtkDMMLROINode::SetRadiusXYZ(double* radiusXYZ)
{
...
//-----------------------------------------------------------------------------
void vtkDMMLROINode::SetIJK(double I, double J, double K)
{
  this->IJK[0] = I;
  this->IJK[1] = J;
  this->IJK[2] = K;
...
//-----------------------------------------------------------------------------
void vtkDMMLROINode::SetIJK(double* ijk)
{
...
//-----------------------------------------------------------------------------
void vtkDMMLROINode::SetRadiusIJK(double RadiusI, double RadiusJ, double RadiusK)
{
...
//-----------------------------------------------------------------------------
void vtkDMMLROINode::SetRadiusIJK(double* radiusIJK)
{
...
//---------------------------------------------------------------------------
bool vtkDMMLROINode::CanApplyNonLinearTransforms()const
{
  return true;
}

//---------------------------------------------------------------------------
void vtkDMMLROINode::ApplyTransform(vtkAbstractTransform* transform)
{
...
void vtkDMMLROINode::GetTransformedPlanes(vtkPlanes *planes)
{
  double bounds[6];
  int i;
