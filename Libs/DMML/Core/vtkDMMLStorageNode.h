/*=auto=========================================================================
  ...
  Program:   3D Cjyx
  Module:    $RCSfile: vtkDMMLStorageNode.h,v $
  Date:      $Date: 2006/03/19 17:12:29 $
  Version:   $Revision: 1.3 $

=========================================================================auto=*/

#ifndef __vtkDMMLStorageNode_h
#define __vtkDMMLStorageNode_h
...
class VTK_DMML_EXPORT vtkDMMLStorageNode : public vtkDMMLNode
{
public:
  vtkTypeMacro(vtkDMMLStorageNode,vtkDMMLNode);
  ...
  /// \sa vtkDMMLStorableNode
  virtual vtkDMMLStorableNode* GetStorableNode();
  ...
  virtual int ReadData(vtkDMMLNode *refNode, bool temporaryFile = false);
  ...
  virtual int WriteData(vtkDMMLNode *refNode);
  ...
  ///
  /// Get the file's absolute path from the file name and the dmml scene root
  ...
  virtual bool CanReadInReferenceNode(vtkDMMLNode* refNode) = 0;
  ...
  virtual bool CanWriteFromReferenceNode(vtkDMMLNode* refNode);
  ...
  const vtkDMMLMessageCollection *GetUserMessages() const { return this->UserMessages; }
  vtkDMMLMessageCollection *GetUserMessages() { return this->UserMessages; }

protected:
  vtkDMMLStorageNode();
  ~vtkDMMLStorageNode() override;
  vtkDMMLStorageNode(const vtkDMMLStorageNode&);
  void operator=(const vtkDMMLStorageNode&);
  ...
  vtkWeakPointer<vtkDMMLStorableNode> LastFoundStorableNode;
