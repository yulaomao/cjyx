...
#ifndef __vtkDMMLDiffusionTensorDisplayPropertiesNode_h
#define __vtkDMMLDiffusionTensorDisplayPropertiesNode_h
...
/// \brief DMML node for display of a diffusion tensor.
///
...
/// This class is used by classes (vtkDMMLFiberBundleDisplayNode,
/// vtkDMMLDiffusionTensorVolumeDisplayNode) that handle higher-level display
/// concepts for many diffusion tensors, such as choosing between scalars/glyphs/etc.
/// for specific display needs.
/// This class inherits from the vtkDMMLColorNode->vtkDMMLColorTableNode superclasses,
/// used for vtkDMMLModelNodes and vtkDMMLVolumeNodes, in order to
/// provide specific lookup tables for the scalar invariant display.
class VTK_DMML_EXPORT vtkDMMLDiffusionTensorDisplayPropertiesNode : public vtkDMMLColorTableNode
{
 public:
  static vtkDMMLDiffusionTensorDisplayPropertiesNode *New();
  vtkTypeMacro(vtkDMMLDiffusionTensorDisplayPropertiesNode,vtkDMMLColorTableNode);
  ...
  ///
  /// Read node attributes from a DMML file in XML format.
 ...
 protected:
  ...
  ~vtkDMMLDiffusionTensorDisplayPropertiesNode() override;
  vtkDMMLDiffusionTensorDisplayPropertiesNode(const vtkDMMLDiffusionTensorDisplayPropertiesNode&);
  void operator=(const vtkDMMLDiffusionTensorDisplayPropertiesNode&);

  void UpdateGlyphSource ( );

  /// ---- Parameters that should be written to DMML --- //
  ...
  /// ---- End of parameters that should be written to DMML --- //
  ...
  /// TO DO: read/write DMML for all parameters
};
