...
bool vtkITKTransformConverter::SetITKLinearTransformFromVTK(vtkObject* loggerObject, itk::Object::Pointer& transformItk_LPS, vtkMatrix4x4* transformVtk_RAS)
{
  ...
  // Convert from RAS (Cjyx) to LPS (ITK)
  //
    ...
    typename itk::TransformBaseTemplate<typename BSplineTransformType::ScalarType>::Pointer warpTransformItk)
{
  ...
  if (bsplineVtk==nullptr)
    {
    vtkErrorWithObjectMacro(loggerObject, "vtkDMMLTransformStorageNode::SetVTKBSplineFromITKv4 failed: bsplineVtk is invalid");
    return false;
    }
  ...
  // convert the direction matrix from LPS (itk) to RAS (cjyx)
  ...
  // convert the origin from LPS (itk) to RAS (cjyx)
  ...
  if( actualNumberOfParameters != expectedNumberOfParameters )
    {
    vtkErrorWithObjectMacro(loggerObject,"Mismatch in number of BSpline parameters in the transform file and the DMML node");
    return false;
    }
  ...
  typename itk::TransformBaseTemplate<T>::Pointer warpTransformItk, typename itk::TransformBaseTemplate<T>::Pointer bulkTransformItk)
{
  if (bsplineVtk==nullptr)
    {
    vtkErrorWithObjectMacro(loggerObject, "vtkDMMLTransformStorageNode::SetVTKBSplineFromITK failed: bsplineVtk is invalid");
    return false;
    }
  ...
  typename itk::Transform< typename BSplineTransformType::ScalarType,VTKDimension,VTKDimension>::Pointer& warpTransformItk, vtkOrientedBSplineTransform* bsplineVtk)
{
  ...
  if (bsplineVtk==nullptr)
    {
    vtkErrorWithObjectMacro(loggerObject, "vtkDMMLTransformStorageNode::SetITKBSplineFromVTK failed: bsplineVtk is invalid");
    return false;
    }
  ...
  vtkOrientedBSplineTransform* bsplineVtk, bool alwaysAddBulkTransform)
{
  ...
  if (!itkTransformSetSuccessfully)
    {
    vtkErrorWithObjectMacro(loggerObject, "vtkDMMLTransformStorageNode::SetITKBSplineFromVTK failed: cannot determine BSpline parameters");
    return false;
    }
  ...
  vtkOrientedBSplineTransform* bsplineVtk)
{
  ...
  if (!itkTransformSetSuccessfully)
    {
    vtkErrorWithObjectMacro(loggerObject, "vtkDMMLTransformStorageNode::SetITKv4BSplineFromVTKGeneric failed: cannot determine BSpline parameters");
    return false;
    }
  return true;
}
  ...
  vtkAbstractTransform* transformVtk, itk::Object::Pointer& secondaryTransformItk, int preferITKv3CompatibleTransforms, bool initialize /*= true*/)
{
  ...
  vtkDMMLTransformNode::FlattenGeneralTransform(transformList.GetPointer(), transformVtk);
