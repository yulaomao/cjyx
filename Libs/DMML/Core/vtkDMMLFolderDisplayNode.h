...
#ifndef __vtkDMMLFolderDisplayNode_h
#define __vtkDMMLFolderDisplayNode_h
...
/// \brief DMML node to represent a display property for child nodes of a
///        subject hierarchy folder.
///
/// vtkDMMLFolderDisplayNode nodes stores display property of a generic
...
///
class VTK_DMML_EXPORT vtkDMMLFolderDisplayNode : public vtkDMMLDisplayNode
{
public:
  static vtkDMMLFolderDisplayNode *New();
  vtkTypeMacro(vtkDMMLFolderDisplayNode,vtkDMMLDisplayNode);
  ...
  vtkDMMLCopyContentMacro(vtkDMMLFolderDisplayNode);

  /// Make sure display node and transform node are present and valid
  void SetScene(vtkDMMLScene* scene) override;

  /// Process events from the DMML scene
  ...
  static vtkDMMLDisplayNode* GetOverridingHierarchyDisplayNode(vtkDMMLDisplayableNode* node);
  ...
  static bool GetHierarchyVisibility(vtkDMMLDisplayableNode* node);
  ...
  static double GetHierarchyOpacity(vtkDMMLDisplayableNode* node);

protected:
  vtkDMMLFolderDisplayNode();
  ~vtkDMMLFolderDisplayNode() override;
  vtkDMMLFolderDisplayNode(const vtkDMMLFolderDisplayNode&);
  void operator=(const vtkDMMLFolderDisplayNode&);
