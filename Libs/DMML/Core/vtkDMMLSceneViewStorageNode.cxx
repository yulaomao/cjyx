/*=auto=========================================================================
  ...
  Program:   3D Cjyx
  Module:    $RCSfile: vtkDMMLSceneViewStorageNode.cxx,v $
...
//----------------------------------------------------------------------------
vtkDMMLNodeNewMacro(vtkDMMLSceneViewStorageNode);

//----------------------------------------------------------------------------
vtkDMMLSceneViewStorageNode::vtkDMMLSceneViewStorageNode()
{
  this->DefaultWriteFileExtension = "png";
}

//----------------------------------------------------------------------------
vtkDMMLSceneViewStorageNode::~vtkDMMLSceneViewStorageNode() = default;

//----------------------------------------------------------------------------
void vtkDMMLSceneViewStorageNode::PrintSelf(ostream& os, vtkIndent indent)
{
  return this->Superclass::PrintSelf(os, indent);
}

//----------------------------------------------------------------------------
bool vtkDMMLSceneViewStorageNode::CanReadInReferenceNode(vtkDMMLNode *refNode)
{
  return refNode->IsA("vtkDMMLSceneViewNode");
}

//----------------------------------------------------------------------------
int vtkDMMLSceneViewStorageNode::ReadDataInternal(vtkDMMLNode *refNode)
{
  ...
  vtkDMMLSceneViewNode *sceneViewNode = dynamic_cast <vtkDMMLSceneViewNode *> (refNode);
...
//----------------------------------------------------------------------------
int vtkDMMLSceneViewStorageNode::WriteDataInternal(vtkDMMLNode *refNode)
{
  vtkDMMLSceneViewNode *sceneViewNode = vtkDMMLSceneViewNode::SafeDownCast(refNode);
  ...
  if (fullName.empty())
    {
    vtkErrorMacro("vtkDMMLSceneViewNode: File name not specified");
    return 0;
    }
...
//----------------------------------------------------------------------------
void vtkDMMLSceneViewStorageNode::InitializeSupportedReadFileTypes()
{
...
//----------------------------------------------------------------------------
void vtkDMMLSceneViewStorageNode::InitializeSupportedWriteFileTypes()
{
