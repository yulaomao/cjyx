...
//------------------------------------------------------------------------------
vtkDMMLNodeNewMacro(vtkDMMLDiffusionWeightedVolumeNode);

//----------------------------------------------------------------------------
vtkDMMLDiffusionWeightedVolumeNode::vtkDMMLDiffusionWeightedVolumeNode() :
...
//----------------------------------------------------------------------------
void vtkDMMLDiffusionWeightedVolumeNode::WriteXML(ostream& of, int nIndent)
{
...
//----------------------------------------------------------------------------
void vtkDMMLDiffusionWeightedVolumeNode::ReadXMLAttributes(const char** atts)
{
...
//----------------------------------------------------------------------------
void vtkDMMLDiffusionWeightedVolumeNode::SetMeasurementFrameMatrix(const double mf[3][3])
{
  for (int i=0; i<3; i++)
    {
    for (int j=0; j<3; j++)
...
//----------------------------------------------------------------------------
void vtkDMMLDiffusionWeightedVolumeNode::GetMeasurementFrameMatrix(double mf[3][3])
{
  for (int i=0; i<3; i++)
    {
    for (int j=0; j<3; j++)
...
//----------------------------------------------------------------------------
void vtkDMMLDiffusionWeightedVolumeNode::SetMeasurementFrameMatrix(
...
//----------------------------------------------------------------------------
void vtkDMMLDiffusionWeightedVolumeNode::SetMeasurementFrameMatrix(vtkMatrix4x4 *mf)
{
  if (!mf)
    {
    return;
...
//----------------------------------------------------------------------------
void vtkDMMLDiffusionWeightedVolumeNode::GetMeasurementFrameMatrix(vtkMatrix4x4 *mf)
{
  if (!mf)
    {
    return;
...
//----------------------------------------------------------------------------
void vtkDMMLDiffusionWeightedVolumeNode::SetNumberOfGradients(int val)
{
...
//----------------------------------------------------------------------------
void vtkDMMLDiffusionWeightedVolumeNode::SetNumberOfGradientsInternal(int val)
{
...
//----------------------------------------------------------------------------
int vtkDMMLDiffusionWeightedVolumeNode::GetNumberOfGradients()
{
...
//----------------------------------------------------------------------------
void vtkDMMLDiffusionWeightedVolumeNode::SetDiffusionGradient(int num, const double grad[3])
{
  if ((num < 0) ||
  ...
  if (!valid_grad_length(tmp_grad))
    {
    vtkErrorMacro(<< "vtkDMMLDiffusionWeightedVolumeNode only accepts gradient vectors with length 0.0 or 1.0!"
...
//----------------------------------------------------------------------------
void vtkDMMLDiffusionWeightedVolumeNode::SetDiffusionGradients(vtkDoubleArray *grad)
{
...
//----------------------------------------------------------------------------
void vtkDMMLDiffusionWeightedVolumeNode::GetDiffusionGradient(int num,double grad[3])
{
...
//----------------------------------------------------------------------------
double *vtkDMMLDiffusionWeightedVolumeNode::GetDiffusionGradient(int num)
{
  if (num < 0 || num >= this->DiffusionGradients->GetNumberOfTuples())
    {
    vtkErrorMacro(<< "Gradient number is out of range.");
...
//----------------------------------------------------------------------------
void vtkDMMLDiffusionWeightedVolumeNode::SetBValues(vtkDoubleArray *bValues)
{
...
//----------------------------------------------------------------------------
void vtkDMMLDiffusionWeightedVolumeNode::SetBValue(int num, const double b)
{
...
//----------------------------------------------------------------------------
double vtkDMMLDiffusionWeightedVolumeNode::GetBValue(int num)
{
  if (num < 0 || num >= this->BValues->GetNumberOfTuples())
    {
    vtkErrorMacro(<< "B value number is out of range.");
...
void vtkDMMLDiffusionWeightedVolumeNode::Copy(vtkDMMLNode *anode)
{
  int disabledModify = this->StartModify();

  Superclass::Copy(anode);
  vtkDMMLDiffusionWeightedVolumeNode *node = (vtkDMMLDiffusionWeightedVolumeNode *) anode;
...
//----------------------------------------------------------------------------
void vtkDMMLDiffusionWeightedVolumeNode::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
vtkDMMLDiffusionWeightedVolumeDisplayNode* vtkDMMLDiffusionWeightedVolumeNode::GetDiffusionWeightedVolumeDisplayNode()
{
  return vtkDMMLDiffusionWeightedVolumeDisplayNode::SafeDownCast(this->GetDisplayNode());
}

//----------------------------------------------------------------------------
vtkDMMLStorageNode* vtkDMMLDiffusionWeightedVolumeNode::CreateDefaultStorageNode()
{
...
//----------------------------------------------------------------------------
void vtkDMMLDiffusionWeightedVolumeNode::CreateDefaultDisplayNodes()
{
  if (vtkDMMLDiffusionWeightedVolumeDisplayNode::SafeDownCast(this->GetDisplayNode())!=nullptr)
    {
  ...
  if (this->GetScene()==nullptr)
    {
    vtkErrorMacro("vtkDMMLDiffusionWeightedVolumeNode::CreateDefaultDisplayNodes failed: scene is invalid");
    return;
    }
  vtkDMMLDiffusionWeightedVolumeDisplayNode* dispNode = vtkDMMLDiffusionWeightedVolumeDisplayNode::SafeDownCast(
    this->GetScene()->AddNewNodeByClass("vtkDMMLDiffusionWeightedVolumeDisplayNode") );
