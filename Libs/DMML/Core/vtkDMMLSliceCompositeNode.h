/*=auto=========================================================================
  ...
  Program:   3D Cjyx
  Module:    $RCSfile: vtkDMMLSliceCompositeNode.h,v $
  Date:      $Date: 2006/03/19 17:12:29 $
  Version:   $Revision: 1.3 $

=========================================================================auto=*/

#ifndef __vtkDMMLSliceCompositeNode_h
#define __vtkDMMLSliceCompositeNode_h
...
/// vtkDMMLVolumes into a single display image.
class VTK_DMML_EXPORT vtkDMMLSliceCompositeNode : public vtkDMMLNode
{
public:
  static vtkDMMLSliceCompositeNode *New();
  vtkTypeMacro(vtkDMMLSliceCompositeNode,vtkDMMLNode);
  ...
  vtkDMMLCopyContentMacro(vtkDMMLSliceCompositeNode);
  ...
  /// \sa vtkDMMLSliceNode::SetLayoutName
...
protected:
  ...
  ~vtkDMMLSliceCompositeNode() override;
  vtkDMMLSliceCompositeNode(const vtkDMMLSliceCompositeNode&);
  void operator=(const vtkDMMLSliceCompositeNode&);
  ...
  std::string GetCompositeNodeIDFromSliceModelNode(vtkDMMLModelNode* sliceModelNode);

  // Cached value of last found displayable node (it is expensive to determine it)
  vtkWeakPointer<vtkDMMLSliceDisplayNode> LastFoundSliceDisplayNode;
