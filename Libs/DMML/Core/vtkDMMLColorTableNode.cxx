...
Program:   3D Cjyx
Module:    $RCSfile: vtkDMMLColorTableNode.cxx,v $
...
//------------------------------------------------------------------------------
vtkDMMLNodeNewMacro(vtkDMMLColorTableNode);

//----------------------------------------------------------------------------
vtkDMMLColorTableNode::vtkDMMLColorTableNode()
{
  this->SetName("");
...
//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::WriteXML(ostream& of, int nIndent)
{
...
//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::ReadXMLAttributes(const char** atts)
{
  ...
  while (*atts != nullptr)
  {
      ...
      for (int i = 0; i < this->LookupTable->GetNumberOfTableValues(); i++)
        {
        vtkDebugMacro("Reading color " << i << " of " << this->LookupTable->GetNumberOfTableValues() << endl);
        ss << attValue;
        // index name r g b a
        int index;
        std::string name;
        ...
        ss >> b;
        ss >> a;
        // might have a version of a dmml file that has tick marks around
        // the name
        ...
        vtkDebugMacro("Adding color at index " << index << ", r = " << r << ", g = " << g << ", b = " << b << ", a = " << a << " and then setting name to " << name.c_str() << endl);
...
void vtkDMMLColorTableNode::Copy(vtkDMMLNode *anode)
{
  ...
  /// See also vtkDMMLMarkupsNode::Copy.
  ...
  vtkDMMLColorTableNode *node = (vtkDMMLColorTableNode *) anode;
...
//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToFullRainbow()
{
    this->SetType(this->FullRainbow);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToGrey()
{
    this->SetType(this->Grey);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToIron()
{
    this->SetType(this->Iron);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToRainbow()
{
    this->SetType(this->Rainbow);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToOcean()
{
    this->SetType(this->Ocean);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToDesert()
{
    this->SetType(this->Desert);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToInvGrey()
{
    this->SetType(this->InvGrey);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToReverseRainbow()
{
    this->SetType(this->ReverseRainbow);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToFMRI()
{
    this->SetType(this->FMRI);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToFMRIPA()
{
    this->SetType(this->FMRIPA);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToLabels()
{
    this->SetType(this->Labels);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToRandom()
{
  this->SetType(this->Random);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToRed()
{
  this->SetType(this->Red);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToGreen()
{
    this->SetType(this->Green);
}
//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToBlue()
{
    this->SetType(this->Blue);
}
//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToCyan()
{
    this->SetType(this->Cyan);
}
//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToMagenta()
{
    this->SetType(this->Magenta);
}
//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToYellow()
{
    this->SetType(this->Yellow);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToWarm1()
{
    this->SetType(this->Warm1);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToWarm2()
{
    this->SetType(this->Warm2);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToWarm3()
{
    this->SetType(this->Warm3);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToCool1()
{
    this->SetType(this->Cool1);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToCool2()
{
    this->SetType(this->Cool2);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToCool3()
{
    this->SetType(this->Cool3);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToWarmShade1()
{
    this->SetType(this->WarmShade1);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToWarmShade2()
{
    this->SetType(this->WarmShade2);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToWarmShade3()
{
    this->SetType(this->WarmShade3);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToCoolShade1()
{
    this->SetType(this->CoolShade1);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToCoolShade2()
{
    this->SetType(this->CoolShade2);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToCoolShade3()
{
    this->SetType(this->CoolShade3);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToWarmTint1()
{
    this->SetType(this->WarmTint1);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToWarmTint2()
{
    this->SetType(this->WarmTint2);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToWarmTint3()
{
    this->SetType(this->WarmTint3);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToCoolTint1()
{
    this->SetType(this->CoolTint1);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToCoolTint2()
{
    this->SetType(this->CoolTint2);
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetTypeToCoolTint3()
{
    this->SetType(this->CoolTint3);
}

//----------------------------------------------------------------------------
const char* vtkDMMLColorTableNode::GetTypeAsString()
{
...
//---------------------------------------------------------------------------
void vtkDMMLColorTableNode::ProcessDMMLEvents ( vtkObject *caller,
                                           unsigned long event,
                                           void *callData )
{
...
//---------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetType(int type)
{
  if (this->GetLookupTable() != nullptr &&
    ...
    if (this->GetLookupTable() == nullptr)
      {
      vtkDebugMacro("vtkDMMLColorTableNode::SetType Creating a new lookup table (was null) of type " << this->GetTypeAsString() << "\n");
    ...
    // delay setting names from colors until asked for one
    if (this->Type == this->FullRainbow)
      {
      // from vtkDMMLSliceLayerLogic.cxx
      ...
      this->GetLookupTable()->Build();
      this->SetNamesFromColors();
      this->SetDescription("A scale from black to blue through purple, 256 colors, ramp of cool colors with variation in value that is complementary to WarmShade2 ");
      }
      ...
      this->GetLookupTable()->Build();
      this->SetNamesFromColors();
      this->SetDescription("A scale from green to yellow, 256 colors, ramp of warm colors that's complementary to Cool2");
      }
      ...
      this->GetLookupTable()->Build();
      this->SetNamesFromColors();
      this->SetDescription("A scale from cyan to green, 256 colors, ramp of warm colors that's complementary to Cool3");
      }
      ...
      this->GetLookupTable()->Build();
      this->SetNamesFromColors();
      this->SetDescription("A scale from blue to cyan, 256 colors, ramp of cool colors that's complementary to Warm1");
      }
      ...
      this->GetLookupTable()->Build();
      this->SetNamesFromColors();
      this->SetDescription("A scale from magenta to blue, 256 colors, ramp of cool colors that's complementary to Warm2");
      }
      ...
      this->GetLookupTable()->Build();
      this->SetNamesFromColors();
      this->SetDescription("A scale from red to magenta, ramp of cool colors that's complementary to Warm3");
      }
      ...
      */
      ...
      this->SetNamesFromColors();
      this->SetDescription("A random selection of 256 rgb colors, useful to distinguish between a small number of labeled regions (especially outside of the brain)");
      }
      ...
      this->SetDescription("A user defined color table, use the editor to specify it");
      }
      ...
      {
      vtkErrorMacro("vtkDMMLColorTableNode: SetType ERROR, unknown type " << type << endl);
      return;
      }
    ...
    this->InvokeEvent(vtkDMMLColorTableNode::TypeModifiedEvent);
}

//---------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetNumberOfColors(int n)
{
  if (this->GetLookupTable() == nullptr)
    {
  ...
  if (this->GetType() != this->User &&
    ...
    {
    vtkErrorMacro("vtkDMMLColorTableNode::SetNumberOfColors: Cannot set number of colors"
...
//---------------------------------------------------------------------------
int vtkDMMLColorTableNode::GetNumberOfColors()
{
  if (this->GetLookupTable() != nullptr)
    {
...
//---------------------------------------------------------------------------
void vtkDMMLColorTableNode::AddColor(const char *name, double r, double g, double b, double a)
{
 if (this->GetType() != this->User &&
     this->GetType() != this->File)
    {
      vtkErrorMacro("vtkDMMLColorTableNode::AddColor: ERROR: can't add a color if not a user defined color table, reset the type first to User or File\n");
      return;
    }
 this->LastAddedColor++;
...
//---------------------------------------------------------------------------
int vtkDMMLColorTableNode::SetColor(int entry, const char *name, double r, double g, double b, double a)
{
  if (this->GetType() != this->User &&
      this->GetType() != this->File)
    {
      vtkErrorMacro( "vtkDMMLColorTableNode::SetColor: ERROR: can't set a color if not a user defined color table, reset the type first to User or File\n");
      return 0;
    }
  if (entry < 0 ||
      entry >= this->GetLookupTable()->GetNumberOfTableValues())
    {
    vtkErrorMacro( "vtkDMMLColorTableNode::SetColor: requested entry " << entry << " is out of table range: 0 - " << this->GetLookupTable()->GetNumberOfTableValues() << ", call SetNumberOfColors" << endl);
      return 0;
    }
...
//---------------------------------------------------------------------------
int vtkDMMLColorTableNode::SetColor(int entry, double r, double g, double b, double a)
{
  if (this->GetType() != this->User &&
      this->GetType() != this->File)
    {
...
//---------------------------------------------------------------------------
int vtkDMMLColorTableNode::SetColors(int firstEntry, int lastEntry, const char *name, double r, double g, double b, double a)
{
  if (this->GetType() != this->User &&
      this->GetType() != this->File)
    {
    vtkErrorMacro("vtkDMMLColorTableNode::SetColors: Cannot set a color if not a user defined color table, reset the type first to User or File");
    return 0;
    }
  ...
  if (firstEntry < 0 || firstEntry >= numberOfValues)
    {
    vtkErrorMacro("vtkDMMLColorTableNode::SetColors: requested first entry "
      << firstEntry << " is out of table range: 0 - " << numberOfValues << ", call SetNumberOfColors");
    return 0;
    }
  if (lastEntry < 0 || lastEntry >= numberOfValues)
    {
    vtkErrorMacro("vtkDMMLColorTableNode::SetColors: requested last entry "
...
//---------------------------------------------------------------------------
int vtkDMMLColorTableNode::SetColor(int entry, double r, double g, double b)
{
  if (entry < 0 ||
      entry >= this->GetLookupTable()->GetNumberOfTableValues())
    {
...
//---------------------------------------------------------------------------
int vtkDMMLColorTableNode::SetOpacity(int entry, double opacity)
{
  if (entry < 0 ||
      entry >= this->GetLookupTable()->GetNumberOfTableValues())
    {
...
//---------------------------------------------------------------------------
bool vtkDMMLColorTableNode::GetColor(int entry, double color[4])
{
...
//---------------------------------------------------------------------------
void vtkDMMLColorTableNode::ClearNames()
{
  this->Names.clear();
...
//---------------------------------------------------------------------------
void vtkDMMLColorTableNode::Reset(vtkDMMLNode* defaultNode)
{
  int disabledModify = this->StartModify();

  // only call reset if this is a user node
  if (this->GetType() == vtkDMMLColorTableNode::User)
    {
...
//---------------------------------------------------------------------------
vtkDMMLStorageNode* vtkDMMLColorTableNode::CreateDefaultStorageNode()
{
  ...
  return vtkDMMLStorageNode::SafeDownCast(scene->CreateNodeByClass("vtkDMMLColorTableStorageNode"));
}

//----------------------------------------------------------------------------
vtkLookupTable* vtkDMMLColorTableNode::GetLookupTable()
{
  return this->LookupTable;
}

//----------------------------------------------------------------------------
void vtkDMMLColorTableNode::SetAndObserveLookupTable(vtkLookupTable *lut)
{
  if (lut == this->LookupTable)
    {
    return;
    }
  vtkSetAndObserveDMMLObjectMacro(this->LookupTable, lut);
  this->Modified();
}
