...
#ifndef __vtkDMMLTableNode_h
#define __vtkDMMLTableNode_h
...
/// \brief DMML node to represent a table object
///
...
class VTK_DMML_EXPORT vtkDMMLTableNode : public vtkDMMLStorableNode
{
public:
  /// Data types supported by the table. Used in qDMMLTableModel for visualization.

public:
  static vtkDMMLTableNode *New();
  vtkTypeMacro(vtkDMMLTableNode,vtkDMMLStorableNode);
  ...
  vtkDMMLCopyContentMacro(vtkDMMLTableNode);
 ...
 protected:
  vtkDMMLTableNode();
  ~vtkDMMLTableNode() override;
  vtkDMMLTableNode(const vtkDMMLTableNode&);
  void operator=(const vtkDMMLTableNode&);
