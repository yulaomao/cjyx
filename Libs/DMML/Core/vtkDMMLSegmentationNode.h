...
#ifndef __vtkDMMLSegmentationNode_h
#define __vtkDMMLSegmentationNode_h
...
/// \brief DMML node containing segmentations
...
///
class VTK_DMML_EXPORT vtkDMMLSegmentationNode : public vtkDMMLDisplayableNode
{
public:
  // Define constants
  static const char* GetSegmentIDAttributeName() { return "segmentID"; };

  static vtkDMMLSegmentationNode *New();
  vtkTypeMacro(vtkDMMLSegmentationNode, vtkDMMLDisplayableNode);
  ...
  vtkDMMLCopyContentMacro(vtkDMMLSegmentationNode);
  ...
  virtual void OnSubjectHierarchyUIDAdded(vtkDMMLSubjectHierarchyNode* shNode, vtkIdType itemWithNewUID);
  ...
  ///   using vtkDMMLSubjectHierarchyNode::GetSubjectHierarchyNode)
  virtual vtkIdType GetSegmentSubjectHierarchyItem(std::string segmentID, vtkDMMLSubjectHierarchyNode* shNode);
...
//ETX
  ...
  virtual void SetReferenceImageGeometryParameterFromVolumeNode(vtkDMMLScalarVolumeNode* volumeNode);
  ...
  /// The vtkDMMLColorTableNode that is used to convert to and from labelmap representations.
  ...
  vtkDMMLColorTableNode* GetLabelmapConversionColorTableNode();
...
protected:
  ...
  static const char* GetLabelmapConversionColorTableNodeReferenceDMMLAttributeName() { return "labelmapConversionColorTableNodeRef"; };
...
protected:
  vtkDMMLSegmentationNode();
  ~vtkDMMLSegmentationNode() override;
  vtkDMMLSegmentationNode(const vtkDMMLSegmentationNode&);
  void operator=(const vtkDMMLSegmentationNode&);
...
#endif // __vtkDMMLSegmentationNode_h
