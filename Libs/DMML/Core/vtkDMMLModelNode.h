/*=auto=========================================================================
  ...
  Program:   3D Cjyx
  Module:    $RCSfile: vtkDMMLModelNode.h,v $
  Date:      $Date: 2006/03/19 17:12:28 $
  Version:   $Revision: 1.6 $

=========================================================================auto=*/

#ifndef __vtkDMMLModelNode_h
#define __vtkDMMLModelNode_h
...
/// When a model display node (vtkDMMLModelDisplayNode) is observed by the
...
class VTK_DMML_EXPORT vtkDMMLModelNode : public vtkDMMLDisplayableNode
{
public:
  static vtkDMMLModelNode *New();
  vtkTypeMacro(vtkDMMLModelNode,vtkDMMLDisplayableNode);
  ...
  vtkDMMLCopyContentMacro(vtkDMMLModelNode);
  ...
  /// Get associated model display DMML node
...
protected:
  vtkDMMLModelNode();
  ~vtkDMMLModelNode() override;
  vtkDMMLModelNode(const vtkDMMLModelNode&);
  void operator=(const vtkDMMLModelNode&);
  ...
  virtual void UpdateDisplayNodeMesh(vtkDMMLDisplayNode *dnode);
  ...
  virtual void SetMeshToDisplayNode(vtkDMMLModelDisplayNode* modelDisplayNode);
