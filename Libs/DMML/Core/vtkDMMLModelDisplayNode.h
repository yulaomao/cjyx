/*=auto=========================================================================
  ...
  Program:   3D Cjyx
  Module:    $RCSfile: vtkDMMLModelDisplayNode.h,v $
  Date:      $Date: 2006/03/19 17:12:28 $
  Version:   $Revision: 1.6 $

=========================================================================auto=*/

#ifndef __vtkDMMLModelDisplayNode_h
#define __vtkDMMLModelDisplayNode_h
...
/// \brief DMML node to represent a display property of 3D surface model.
///
/// vtkDMMLModelDisplayNode nodes stores display property of a 3D surface model
/// including reference to ColorNode, texture, opacity, etc.
class VTK_DMML_EXPORT vtkDMMLModelDisplayNode : public vtkDMMLDisplayNode
{
public:
  static vtkDMMLModelDisplayNode *New();
  vtkTypeMacro(vtkDMMLModelDisplayNode,vtkDMMLDisplayNode);
  ...
  vtkDMMLCopyContentMacro(vtkDMMLModelDisplayNode);
  ...
  virtual vtkDMMLColorNode* GetDistanceEncodedProjectionColorNode();
...
protected:
  ...
  ~vtkDMMLModelDisplayNode() override;
  vtkDMMLModelDisplayNode(const vtkDMMLModelDisplayNode&);
  void operator=(const vtkDMMLModelDisplayNode&);
