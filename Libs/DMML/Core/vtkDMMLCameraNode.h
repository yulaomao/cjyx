/*=auto=========================================================================
  ...
  Program:   3D Cjyx
  Module:    $RCSfile: vtkDMMLCameraNode.h,v $
  Date:      $Date: 2006/03/19 17:12:28 $
  Version:   $Revision: 1.6 $

=========================================================================auto=*/

#ifndef __vtkDMMLCameraNode_h
#define __vtkDMMLCameraNode_h
...
/// \brief DMML node to represent camera node
///
/// Camera node uses vtkCamera to store the state of the camera
class VTK_DMML_EXPORT vtkDMMLCameraNode : public vtkDMMLTransformableNode
{
public:
  static vtkDMMLCameraNode *New();
  vtkTypeMacro(vtkDMMLCameraNode,vtkDMMLTransformableNode);
  ...
  vtkDMMLCopyContentMacro(vtkDMMLCameraNode);
  ...
  /// \sa vtkDMMLViewNode::SetLayoutName
...
protected:
  vtkDMMLCameraNode();
  ~vtkDMMLCameraNode() override;
  vtkDMMLCameraNode(const vtkDMMLCameraNode&);
  void operator=(const vtkDMMLCameraNode&);
...
//---------------------------------------------------------------------------
void vtkDMMLCameraNode::SetPosition(double x, double y, double z)
{
  double pos[3] = {x, y, z};
...
//---------------------------------------------------------------------------
void vtkDMMLCameraNode::SetFocalPoint(double x, double y, double z)
{
  double pos[3] = {x, y, z};
...
//---------------------------------------------------------------------------
void vtkDMMLCameraNode::SetViewUp(double vx, double vy, double vz)
{
