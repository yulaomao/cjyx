...
documentation of vtkDMMLColorLogic::AddDefaultColorNodes()
"""

nodes = cjyx.dmmlScene.GetNodesByClass("vtkDMMLColorNode")
...
for index in range(nodes.GetNumberOfItems()):
    ...
    table.append({
        'family': n.GetClassName().replace('vtkDMML', '').replace('Node', ''),
