...
#ifndef __vtkDMMLSegmentationDisplayNode_h
#define __vtkDMMLSegmentationDisplayNode_h
...
/// \brief DMML node for representing segmentation display attributes.
///
/// vtkDMMLSegmentationDisplayNode nodes describe how volume is displayed.
class VTK_DMML_EXPORT vtkDMMLSegmentationDisplayNode : public vtkDMMLDisplayNode
{
public:
  // Define constants
...
public:
  static vtkDMMLSegmentationDisplayNode *New();
  vtkTypeMacro(vtkDMMLSegmentationDisplayNode,vtkDMMLDisplayNode);
  ...
  vtkDMMLCopyContentMacro(vtkDMMLSegmentationDisplayNode);
...
public:
  ...
  /// If not specified then "vtkDMMLColorTableNodeFileGenericAnatomyColors.txt" is used.
...
protected:
  vtkDMMLSegmentationDisplayNode();
  ~vtkDMMLSegmentationDisplayNode() override;
  vtkDMMLSegmentationDisplayNode(const vtkDMMLSegmentationDisplayNode&);
  void operator=(const vtkDMMLSegmentationDisplayNode&);

  friend class vtkDMMLSegmentationNode; // Access to UpdateSegmentList();
