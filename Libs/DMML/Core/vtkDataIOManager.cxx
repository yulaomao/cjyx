...
//----------------------------------------------------------------------------
vtkDataTransfer *vtkDataIOManager::AddNewDataTransfer ( vtkDMMLNode *node )
{
  if (node == nullptr)
    {
...
//----------------------------------------------------------------------------
void vtkDataIOManager::AddNewDataTransfer ( vtkDataTransfer *transfer, vtkDMMLNode *node )
{
...
//----------------------------------------------------------------------------
void vtkDataIOManager::QueueRead ( vtkDMMLNode *node )
{
  if (node == nullptr)
    {
  ...
  if (dnode == nullptr)
    {
    vtkErrorMacro("QueueRead: unable to cast input dmml node to a storable node");
    return;
    }
  ...
  for (int i = 0; i < dnode->GetNumberOfStorageNodes(); i++)
    {
    if (dnode->GetNthStorageNode(i)->GetReadState() == vtkDMMLStorageNode::Pending)
      {
...
//----------------------------------------------------------------------------
void vtkDataIOManager::QueueWrite ( vtkDMMLNode *node )
{
  if (node == nullptr)
    {
  ...
  if (dnode == nullptr)
    {
    vtkErrorMacro("QueueWrite: unable to cast input dmml node to a storable node");
    return;
    }
  if (dnode->GetStorageNode() == nullptr)
    {
  ...
  for (int i = 0; i < dnode->GetNumberOfStorageNodes(); i++)
    {
    if (dnode->GetNthStorageNode(i)->GetWriteState() == vtkDMMLStorageNode::Pending)
      {
