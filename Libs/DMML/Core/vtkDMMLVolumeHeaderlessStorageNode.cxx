...
Program:   3D Cjyx
Module:    $RCSfile: vtkDMMLVolumeHeaderlessStorageNode.cxx,v $
...
#endif
#include "vtkDMMLVolumeHeaderlessStorageNode.h"
...
//----------------------------------------------------------------------------
vtkDMMLNodeNewMacro(vtkDMMLVolumeHeaderlessStorageNode);

//----------------------------------------------------------------------------
vtkDMMLVolumeHeaderlessStorageNode::vtkDMMLVolumeHeaderlessStorageNode()
{
...
//----------------------------------------------------------------------------
const char* vtkDMMLVolumeHeaderlessStorageNode::GetFileScalarTypeAsString()
{
...
//----------------------------------------------------------------------------
void vtkDMMLVolumeHeaderlessStorageNode::SetFileScalarTypeAsString(const char* type)
{
  if (!strcmp(type, "Bit"))
    {
...
void vtkDMMLVolumeHeaderlessStorageNode::WriteXML(ostream& of, int nIndent)
{
...
//----------------------------------------------------------------------------
void vtkDMMLVolumeHeaderlessStorageNode::ReadXMLAttributes(const char** atts)
{
  int disabledModify = this->StartModify();

  vtkDMMLStorageNode::ReadXMLAttributes(atts);
...
void vtkDMMLVolumeHeaderlessStorageNode::Copy(vtkDMMLNode *anode)
{
  int disabledModify = this->StartModify();

  Superclass::Copy(anode);
  vtkDMMLVolumeHeaderlessStorageNode *node = (vtkDMMLVolumeHeaderlessStorageNode *) anode;
...
//----------------------------------------------------------------------------
void vtkDMMLVolumeHeaderlessStorageNode::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
bool vtkDMMLVolumeHeaderlessStorageNode::CanReadInReferenceNode(vtkDMMLNode *refNode)
{
...
//----------------------------------------------------------------------------
int vtkDMMLVolumeHeaderlessStorageNode::ReadDataInternal(vtkDMMLNode *refNode)
{
  ...
  for (unsigned int i=0; i<names.size(); i++)
    ...
    try
      ...
      reader->RemoveObservers( vtkCommand::ProgressEvent,  this->DMMLCallbackCommand);
      return 0;
      }
...
//----------------------------------------------------------------------------
bool vtkDMMLVolumeHeaderlessStorageNode::CanWriteFromReferenceNode(vtkDMMLNode *refNode)
{
  return refNode->IsA("vtkDMMLScalarVolumeNode");
}

//----------------------------------------------------------------------------
int vtkDMMLVolumeHeaderlessStorageNode::WriteDataInternal(vtkDMMLNode *refNode)
{
  ...
  if (fullName.empty())
    {
    vtkErrorMacro("vtkDMMLVolumeNode: File name not specified");
    return 0;
    }
...
//----------------------------------------------------------------------------
void vtkDMMLVolumeHeaderlessStorageNode::InitializeSupportedWriteFileTypes()
{
