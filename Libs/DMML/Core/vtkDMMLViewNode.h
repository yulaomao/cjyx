/*=auto=========================================================================
  ...
  Program:   3D Cjyx
  Module:    $RCSfile: vtkDMMLViewNode.h,v $
  Date:      $Date: 2006/03/19 17:12:28 $
  Version:   $Revision: 1.6 $

=========================================================================auto=*/

#ifndef __vtkDMMLViewNode_h
#define __vtkDMMLViewNode_h

// VTK includes
#include "vtkDMMLAbstractViewNode.h"

/// \brief DMML node to represent a 3D view.
///
/// View node contains view parameters.
class VTK_DMML_EXPORT vtkDMMLViewNode
  : public vtkDMMLAbstractViewNode
{
public:
  static vtkDMMLViewNode *New();
  vtkTypeMacro(vtkDMMLViewNode,vtkDMMLAbstractViewNode);
  ...
  vtkDMMLCopyContentMacro(vtkDMMLViewNode);
...
protected:
  vtkDMMLViewNode();
  ~vtkDMMLViewNode() override;
  vtkDMMLViewNode(const vtkDMMLViewNode&);
  void operator=(const vtkDMMLViewNode&);
