...
#ifndef __vtkDMMLPlotSeriesNode_h
#define __vtkDMMLPlotSeriesNode_h
...
/// \brief DMML node to represent a vtkPlot object
///
...
class VTK_DMML_EXPORT vtkDMMLPlotSeriesNode : public vtkDMMLNode
{
public:
  static vtkDMMLPlotSeriesNode *New();
  vtkTypeMacro(vtkDMMLPlotSeriesNode,vtkDMMLNode);
  ...
  //----------------------------------------------------------------
  /// Standard methods for DMML nodes
  //----------------------------------------------------------------
  ...
  ///
  /// Get associated Table DMML node.
  virtual vtkDMMLTableNode* GetTableNode();
  ...
  /// If colorTableNodeID is not specified then vtkDMMLColorTableNodeRandom is used.
  ...
  //----------------------------------------------------------------
protected:
  vtkDMMLPlotSeriesNode();
  ~vtkDMMLPlotSeriesNode() override;
  vtkDMMLPlotSeriesNode(const vtkDMMLPlotSeriesNode&);
  void operator=(const vtkDMMLPlotSeriesNode&);
  ...
  void OnNodeReferenceAdded(vtkDMMLNodeReference *reference) override
  {
    ...
    if (std::string(reference->GetReferenceRole()) == this->TableNodeReferenceRole)
      {
      this->InvokeCustomModifiedEvent(vtkDMMLPlotSeriesNode::TableModifiedEvent, reference->GetReferencedNode());
      }
  }
  ...
  vtkDMMLCopyContentMacro(vtkDMMLPlotSeriesNode);
