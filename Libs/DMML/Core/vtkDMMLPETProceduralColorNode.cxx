...
//----------------------------------------------------------------------------
vtkDMMLNodeNewMacro(vtkDMMLPETProceduralColorNode);


//----------------------------------------------------------------------------
vtkDMMLPETProceduralColorNode::vtkDMMLPETProceduralColorNode()
{
...
//----------------------------------------------------------------------------
void vtkDMMLPETProceduralColorNode::WriteXML(ostream& of, int nIndent)
{
...
//----------------------------------------------------------------------------
void vtkDMMLPETProceduralColorNode::ReadXMLAttributes(const char** atts)
{
...
void vtkDMMLPETProceduralColorNode::Copy(vtkDMMLNode *anode)
{
  Superclass::Copy(anode);
  //vtkDMMLPETProceduralColorNode *node = (vtkDMMLPETProceduralColorNode *) anode;
}

//----------------------------------------------------------------------------
void vtkDMMLPETProceduralColorNode::PrintSelf(ostream& os, vtkIndent indent)
{
...
void vtkDMMLPETProceduralColorNode::UpdateScene(vtkDMMLScene *scene)
{
  Superclass::UpdateScene(scene);
}

//---------------------------------------------------------------------------
void vtkDMMLPETProceduralColorNode::ProcessDMMLEvents ( vtkObject *caller,
                                           unsigned long event,
                                           void *callData )
{
...
//---------------------------------------------------------------------------
void vtkDMMLPETProceduralColorNode::SetTypeToHeat()
{
  this->SetType(this->PETheat);
}

//---------------------------------------------------------------------------
void vtkDMMLPETProceduralColorNode::SetTypeToRainbow()
{
  this->SetType(this->PETrainbow);
}

//---------------------------------------------------------------------------
void vtkDMMLPETProceduralColorNode::SetTypeToRainbow2()
{
  this->SetType(this->PETrainbow);
}

//---------------------------------------------------------------------------
void vtkDMMLPETProceduralColorNode::SetTypeToDICOM()
{
  this->SetType(this->PETDICOM);
}

//---------------------------------------------------------------------------
void vtkDMMLPETProceduralColorNode::SetTypeToHotMetalBlue()
{
  this->SetType(this->PEThotMetalBlue);
}

//---------------------------------------------------------------------------
void vtkDMMLPETProceduralColorNode::SetTypeToMIP()
{
  this->SetType(this->PETMIP);
}

//---------------------------------------------------------------------------
const char *vtkDMMLPETProceduralColorNode::GetTypeAsString()
{
...
//---------------------------------------------------------------------------
void vtkDMMLPETProceduralColorNode::SetType(int type)
{
