...
Program:   3D Cjyx
Module:    $RCSfile: vtkDMMLLinearTransformNode.cxx,v $
...
//----------------------------------------------------------------------------
vtkDMMLNodeNewMacro(vtkDMMLLinearTransformNode);

//----------------------------------------------------------------------------
vtkDMMLLinearTransformNode::vtkDMMLLinearTransformNode()
{
...
//----------------------------------------------------------------------------
vtkDMMLLinearTransformNode::~vtkDMMLLinearTransformNode() = default;

//----------------------------------------------------------------------------
void vtkDMMLLinearTransformNode::WriteXML(ostream& of, int nIndent)
{
...
//----------------------------------------------------------------------------
void vtkDMMLLinearTransformNode::ReadXMLAttributes(const char** atts)
{
  ...
  while (*atts != nullptr)
    ...
    if (!strcmp(attName, "readWriteAsTransformToParent"))
      ...
      // anymore) vtkDMMLLinearTransformNode and readWriteAsTransformToParent attribute management
...
//----------------------------------------------------------------------------
void vtkDMMLLinearTransformNode::PrintSelf(ostream& os, vtkIndent indent)
{
