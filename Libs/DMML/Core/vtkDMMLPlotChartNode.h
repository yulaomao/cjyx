...
#ifndef __vtkDMMLPlotChartNode_h
#define __vtkDMMLPlotChartNode_h
...
/// \brief DMML node for referencing a collection of data to plot.
class VTK_DMML_EXPORT vtkDMMLPlotChartNode : public vtkDMMLNode
{
 public:
  //----------------------------------------------------------------
  ...
  static vtkDMMLPlotChartNode *New();
  vtkTypeMacro(vtkDMMLPlotChartNode,vtkDMMLNode);
  ...
  vtkDMMLCopyContentMacro(vtkDMMLPlotChartNode);
  ...
  vtkDMMLPlotSeriesNode* GetPlotSeriesNode();
  ...
  /// yet into the scene.
  vtkDMMLPlotSeriesNode* GetNthPlotSeriesNode(int n);
 ...
 protected:
  ...
  //----------------------------------------------------------------
  vtkDMMLPlotChartNode();
  ~vtkDMMLPlotChartNode() override;
  vtkDMMLPlotChartNode(const vtkDMMLPlotChartNode&);
  void operator=(const vtkDMMLPlotChartNode&);
