/*=auto=========================================================================
  ...
  Program:   3D Cjyx
  Module:    $RCSfile: vtkDMMLScalarVolumeDisplayNode.h,v $
  Date:      $Date: 2006/03/19 17:12:29 $
  Version:   $Revision: 1.3 $

=========================================================================auto=*/

#ifndef __vtkDMMLScalarVolumeDisplayNode_h
#define __vtkDMMLScalarVolumeDisplayNode_h
...
///
/// vtkDMMLScalarVolumeDisplayNode nodes describe how volume is displayed.
class VTK_DMML_EXPORT vtkDMMLScalarVolumeDisplayNode : public vtkDMMLVolumeDisplayNode
{
  public:
  static vtkDMMLScalarVolumeDisplayNode *New();
  vtkTypeMacro(vtkDMMLScalarVolumeDisplayNode,vtkDMMLVolumeDisplayNode);
...
protected:
  vtkDMMLScalarVolumeDisplayNode();
  ~vtkDMMLScalarVolumeDisplayNode() override;
  vtkDMMLScalarVolumeDisplayNode(const vtkDMMLScalarVolumeDisplayNode&);
  void operator=(const vtkDMMLScalarVolumeDisplayNode&);

  void SetColorNodeInternal(vtkDMMLColorNode* newColorNode) override;
  void UpdateLookupTable(vtkDMMLColorNode* newColorNode);
