/*=auto=========================================================================
  ...
  Program:   3D Cjyx
  Module:    $RCSfile: vtkDMMLCrosshairNode.h,v $
  Date:      $Date: 2006/03/19 17:12:29 $
  Version:   $Revision: 1.3 $

=========================================================================auto=*/

#ifndef __vtkDMMLCrosshairNode_h
#define __vtkDMMLCrosshairNode_h

#include "vtkDMMLNode.h"
#include "vtkDMMLSliceNode.h"

/// \brief DMML node for storing a crosshair through RAS space
///
/// This node stores the information about a crosshair (position,
/// style, attributes)
class VTK_DMML_EXPORT vtkDMMLCrosshairNode : public vtkDMMLNode
{
  public:
  static vtkDMMLCrosshairNode *New();
  vtkTypeMacro(vtkDMMLCrosshairNode,vtkDMMLNode);
  ...
  vtkDMMLCopyContentMacro(vtkDMMLCrosshairNode);
  ...
  void SetCursorPositionXYZ(double xyz[3], vtkDMMLSliceNode *sliceNode);
  ...
  /// This is typically called by other classes to get the current cursor position after receiving
  /// CursorPositionModifiedEvent event.
  vtkDMMLSliceNode* GetCursorPositionXYZ(double xyz[3]);
...
protected:
  vtkDMMLCrosshairNode();
  ~vtkDMMLCrosshairNode() override;
  vtkDMMLCrosshairNode(const vtkDMMLCrosshairNode&);
  void operator=(const vtkDMMLCrosshairNode&);
  ...
  /// CursorSliceNode points to the slice where the cursor is. It is not stored as a DMML node reference
  ...
  vtkWeakPointer<vtkDMMLSliceNode> CursorSliceNode;
