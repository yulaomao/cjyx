...
int vtkDMMLTableNodeTest1(int , char * [] )
{
  vtkNew<vtkDMMLScene> scene;

  vtkNew<vtkDMMLTableNode> node1;
  scene->AddNode(node1.GetPointer());
  EXERCISE_ALL_BASIC_DMML_METHODS(node1.GetPointer());

  vtkNew<vtkDMMLTableNode> node2;
  ...
  vtkSmartPointer< vtkDMMLTableStorageNode > storageNode = vtkSmartPointer< vtkDMMLTableStorageNode >::Take(vtkDMMLTableStorageNode::SafeDownCast(node2->CreateDefaultStorageNode()));
  ...
  vtkSmartPointer< vtkDMMLTableNode > node2copy = vtkSmartPointer< vtkDMMLTableNode >::New();
  ...
  std::cout << "vtkDMMLTableNodeTest1 completed successfully" << std::endl;
  return EXIT_SUCCESS;
}
