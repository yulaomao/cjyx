...
int vtkDMMLScriptedModuleNodeTest1(int , char * [] )
{
  vtkNew<vtkDMMLScriptedModuleNode> node1;
...
int TestScriptedModuleParameterSaveLoadSpecialCharacters()
{
  ...
  vtkNew<vtkDMMLScriptedModuleNode> node;
  ...
  vtkDMMLNode* nodeReloaded = sceneReloaded->GetFirstNodeByClass("vtkDMMLScriptedModuleNode");
