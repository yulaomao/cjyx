                   ...
                   void *clientData, void *vtkNotUsed(callData) )
{
  ...
  if (caller != nullptr)
    {
    vtkDMMLModelNode *callNode = vtkDMMLModelNode::SafeDownCast(caller);
    if (callNode != nullptr)
      {
...
int vtkObserverManagerTest1(int , char * [] )
{
  ...
  if (vtkDMMLModelNode::SafeDownCast(owner) != modelNode.GetPointer())
    {
  ...
  vtkSmartPointer<vtkDMMLModelNode> observed = vtkSmartPointer<vtkDMMLModelNode>::New();
  ...
  vtkSmartPointer<vtkDMMLModelNode> observed2 = vtkSmartPointer<vtkDMMLModelNode>::New();
  ...
  vtkSmartPointer<vtkDMMLModelNode> observed3 = vtkSmartPointer<vtkDMMLModelNode>::New();
  ...
  vtkDMMLModelNode *observed4 = vtkDMMLModelNode::New();
