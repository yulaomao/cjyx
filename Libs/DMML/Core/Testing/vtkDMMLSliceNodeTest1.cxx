...
//----------------------------------------------------------------------------
void AddSliceOrientationPresets(vtkDMMLSliceNode *sliceNode);
...
//----------------------------------------------------------------------------
int vtkDMMLSliceNodeTest1(int , char * [] )
{
  vtkNew<vtkDMMLSliceNode> node1;
...
{
  {
    ...
    vtkDMMLSliceNode::GetAxialSliceToRASMatrix(preset.GetPointer());
  ...
  {
    vtkNew<vtkMatrix3x3> preset;
    vtkDMMLSliceNode::GetSagittalSliceToRASMatrix(preset.GetPointer());
  ...
  {
    vtkNew<vtkMatrix3x3> preset;
    vtkDMMLSliceNode::GetCoronalSliceToRASMatrix(preset.GetPointer());
...
//----------------------------------------------------------------------------
int CheckOrientationPresetNames(vtkDMMLSliceNode* sliceNode,
...
int GetSliceOrientationPresetNameTest()
{
  ...
  vtkDMMLSliceNode::GetAxialSliceToRASMatrix(originalPreset.GetPointer());
...
int InitializeDefaultMatrixTest()
{
  ...
  vtkDMMLSliceNode::GetAxialSliceToRASMatrix(axial.GetPointer());
  CHECK_NOT_NULL(axial.GetPointer());

  vtkNew<vtkMatrix3x3> coronal;
  vtkDMMLSliceNode::GetCoronalSliceToRASMatrix(coronal.GetPointer());
  CHECK_NOT_NULL(coronal.GetPointer());

  vtkNew<vtkMatrix3x3> sagittal;
  vtkDMMLSliceNode::GetSagittalSliceToRASMatrix(sagittal.GetPointer());
