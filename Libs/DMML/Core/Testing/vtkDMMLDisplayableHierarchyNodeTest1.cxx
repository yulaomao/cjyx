...
//----------------------------------------------------------------------------
class vtkDMMLDisplayableHierarchyNodeTestHelper1;
...
//----------------------------------------------------------------------------
int vtkDMMLDisplayableHierarchyNodeTest1(int vtkNotUsed(argc),
...
//----------------------------------------------------------------------------
class vtkDMMLDisplayableHierarchyNodeTestHelper1 : public vtkDMMLDisplayableNode
{
public:
  // Provide a concrete New.
  static vtkDMMLDisplayableHierarchyNodeTestHelper1 *New();

  vtkTypeMacro(vtkDMMLDisplayableHierarchyNodeTestHelper1, vtkDMMLDisplayableNode);

  vtkDMMLNode* CreateNodeInstance() override
    {
    return vtkDMMLDisplayableHierarchyNodeTestHelper1::New();
    }
...
vtkStandardNewMacro(vtkDMMLDisplayableHierarchyNodeTestHelper1);
...
int TestBasics()
{
  vtkNew<vtkDMMLDisplayableHierarchyNode> node1;
  ...
  vtkDMMLDisplayableNode* pnode = node1->GetDisplayableNode();
  std::cout << "GetDisplayableNode returned "
            << (pnode == nullptr ? "null" : "not null")
            << std::endl;

  vtkDMMLDisplayNode* dnode1 = node1->GetDisplayNode();
  ...
  vtkDMMLDisplayableHierarchyNode* pnode1 =
...
int TestHierarchyNodeCount()
{
  ...
  vtkNew<vtkDMMLScalarVolumeDisplayNode> dnode2;
  ...
  vtkNew<vtkDMMLDisplayableHierarchyNodeTestHelper1> displayableNode;
  ...
  vtkNew<vtkDMMLDisplayableHierarchyNode> node2;
  ...
  vtkDMMLDisplayableHierarchyNode* hnode3 =
...
int TestHierarchyEvents()
{
  ...
  CHECK_INT(callback->GetNumberOfEvents(vtkDMMLDisplayableHierarchyNode::DisplayModifiedEvent), 0);
  ...
  CHECK_BOOL(callback->GetErrorString().empty(), true);
  CHECK_INT(callback->GetNumberOfModified(), 0);
  CHECK_INT(callback->GetNumberOfEvents(vtkDMMLDisplayableHierarchyNode::DisplayModifiedEvent), 1);
  callback->ResetNumberOfEvents();
