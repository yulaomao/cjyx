...
//---------------------------------------------------------------------------
int vtkDMMLModelNodeTest1(int , char * [] )
{
...
int TestGetSetMesh()
{
  ...
  CHECK_INT(node1->GetMeshType(), vtkDMMLModelNode::PolyDataMeshType)
  ...
  CHECK_INT(node1->GetMeshType(), vtkDMMLModelNode::UnstructuredGridMeshType)
  CHECK_NOT_NULL(node1->GetMesh());
  CHECK_NOT_NULL(node1->GetMeshConnection());
  CHECK_NULL(node1->GetPolyData());
  CHECK_NULL(node1->GetPolyDataConnection());
  ...
  CHECK_INT(node2->GetMeshType(), vtkDMMLModelNode::PolyDataMeshType)
