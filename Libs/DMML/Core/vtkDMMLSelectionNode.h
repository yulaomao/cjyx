/*=auto=========================================================================
  ...
  Program:   3D Cjyx
  Module:    $RCSfile: vtkDMMLSelectionNode.h,v $
  Date:      $Date: 2006/03/19 17:12:29 $
  Version:   $Revision: 1.3 $

=========================================================================auto=*/

#ifndef __vtkDMMLSelectionNode_h
#define __vtkDMMLSelectionNode_h
...
/// \brief  DMML node for storing information about the active nodes in the scene.
///
...
class VTK_DMML_EXPORT vtkDMMLSelectionNode : public vtkDMMLNode
{
  public:
  static vtkDMMLSelectionNode *New();
  vtkTypeMacro(vtkDMMLSelectionNode,vtkDMMLNode);
  ...
  /// the ID of a DMMLVolumeNode (typically background)
  ...
  /// the ID of a DMMLVolumeNode (typically foreground)
  ...
  void GetUnitNodes(std::vector<vtkDMMLUnitNode*>& units);
  ...
  /// not found
  /// \sa vtkDMMLSelectionNode::PlaceNodeClassNameInList
  /// \sa vtkDMMLSelectionNode::GetPlaceNodeResourceByIndex
...
protected:
  vtkDMMLSelectionNode();
  ~vtkDMMLSelectionNode() override;
  vtkDMMLSelectionNode(const vtkDMMLSelectionNode&);
  void operator=(const vtkDMMLSelectionNode&);
