/*=auto=========================================================================
  ...
  Program:   3D Cjyx
  Module:    $RCSfile: vtkDMMLDisplayableNode.h,v $
  Date:      $Date: 2006/03/19 17:12:28 $
  Version:   $Revision: 1.6 $

=========================================================================auto=*/

#ifndef __vtkDMMLDisplayableNode_h
#define __vtkDMMLDisplayableNode_h
...
/// \brief DMML node to represent an item that can be rendered in a view.
///
...
/// \sa vtkDMMLDisplayNode

class vtkDMMLDisplayNode;

class VTK_DMML_EXPORT vtkDMMLDisplayableNode : public vtkDMMLTransformableNode
{
public:
  vtkTypeMacro(vtkDMMLDisplayableNode,vtkDMMLTransformableNode);
  ...
  virtual void WriteCLI(std::vector<std::string>& vtkNotUsed(commandLine),
                        ...
                        int vtkNotUsed(coordinateSystemFlag) = vtkDMMLStorageNode::CoordinateSystemRAS,
  ...
  ///
  /// Get associated display DMML node. Can be 0 in temporary states; e.g. if
  ...
  vtkDMMLDisplayNode* GetNthDisplayNode(int n);
  ...
  /// const std::vector<vtkDMMLDisplayNode*>& GetDisplayNodes();
  ...
  /// It ignores display nodes that have ShowMode other than vtkDMMLDisplayNode::ShowDefault.
...
protected:
  vtkDMMLDisplayableNode();
  ~vtkDMMLDisplayableNode() override;
  vtkDMMLDisplayableNode(const vtkDMMLDisplayableNode&);
  void operator=(const vtkDMMLDisplayableNode&);

  static const char* DisplayNodeReferenceRole;
  static const char* DisplayNodeReferenceDMMLAttributeName;

  virtual const char* GetDisplayNodeReferenceDMMLAttributeName();
