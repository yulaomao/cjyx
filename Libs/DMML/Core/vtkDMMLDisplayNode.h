/*=auto=========================================================================
  ...
  Program:   3D Cjyx
  Module:    $RCSfile: vtkDMMLDisplayNode.h,v $
  Date:      $Date: 2006/03/19 17:12:29 $
  Version:   $Revision: 1.3 $

=========================================================================auto=*/

#ifndef __vtkDMMLDisplayNode_h
#define __vtkDMMLDisplayNode_h
...
/// displayable nodes.
///
/// vtkDMMLDisplayNode fires a ModifiedEvent event when the texture image data
/// or the color node is modified.
/// \sa vtkDMMLDisplayableNode, TextureImageDataConnection, ColorNode
class VTK_DMML_EXPORT vtkDMMLDisplayNode : public vtkDMMLNode
{
public:
  vtkTypeMacro(vtkDMMLDisplayNode,vtkDMMLNode);
  ...
  /// \sa vtkDMMLDisplayableNode
  virtual vtkDMMLDisplayableNode* GetDisplayableNode();
  ...
  /// \sa vtkDMMLScene::Commit()
  void WriteXML(ostream& of, int indent) override;

  /// Copy node content (excludes basic data, such as name and node references).
  /// \sa vtkDMMLNode::CopyContent
  vtkDMMLCopyContentMacro(vtkDMMLDisplayNode);
  ...
  /// ShowDefault is recommended for most display nodes, for example vtkDMMLModelDisplayNode for a vtkDMMLModelNode.
  /// If set to ShowIgnore then show request is ignored - visibility has to be set manually. ShowIgnore is useful
  /// for auxiliary display nodes, such as vtkDMMLColorLegendDisplayNode or vtkDMMLVolumeRenderingDisplayNode,
  ...
  bool IsShowModeDefault() { return this->GetShowMode() == vtkDMMLDisplayNode::ShowDefault; }
  //@}
  ...
  /// Get associated color DMML node. Search the node into the scene if the node
  /// hasn't been cached yet. This can be a slow call.
  /// \sa ColorNodeID, SetAndObserveColorNodeID, GetColorNodeID()
  virtual vtkDMMLColorNode* GetColorNode();
...
protected:
  vtkDMMLDisplayNode();
  ~vtkDMMLDisplayNode() override;
  vtkDMMLDisplayNode(const vtkDMMLDisplayNode&);
  void operator=(const vtkDMMLDisplayNode&);

  /// Internal function to set the color node. Called by
  /// \a SetColorNodeID().
  /// \sa SetColorNodeID(),
  /// ColorNode, ColorNodeID
  virtual void SetColorNodeInternal(vtkDMMLColorNode* newColorNode);
  ...
  /// observed and when modified, vtkDMMLDisplayNode fires a ModifiedEvent too.
  ...
  /// String ID of the color DMML node. The color node LUT or Color transfer
  ...
  /// observed and when modified, vtkDMMLDisplayNode fires a ModifiedEvent too.
  /// \sa GetColorNode(), ProcessDMMLEvents()
  /// ColorNodeID
  ...
  vtkWeakPointer<vtkDMMLDisplayableNode> LastFoundDisplayableNode;
private:
  void SetColorNodeID(const char* id);
};

//----------------------------------------------------------------------------
int vtkDMMLDisplayNode::GetNumberOfViewNodeIDs()const
{
  return static_cast<int>(this->ViewNodeIDs.size());
}

//----------------------------------------------------------------------------
std::vector< std::string > vtkDMMLDisplayNode::GetViewNodeIDs()const
{
