...
#ifndef __vtkDMMLTableStorageNode_h
#define __vtkDMMLTableStorageNode_h
...
///
/// vtkDMMLTableStorageNode allows reading/writing of table node from
...
///
class VTK_DMML_EXPORT vtkDMMLTableStorageNode : public vtkDMMLStorageNode
{
public:
  static vtkDMMLTableStorageNode *New();
  vtkTypeMacro(vtkDMMLTableStorageNode,vtkDMMLStorageNode);
...
protected:
  vtkDMMLTableStorageNode();
  ~vtkDMMLTableStorageNode() override;
  vtkDMMLTableStorageNode(const vtkDMMLTableStorageNode&);
  void operator=(const vtkDMMLTableStorageNode&);
  ...
  std::vector<ColumnInfo> GetColumnInfo(vtkDMMLTableNode* tableNode, vtkTable* rawTable);
  ...
  bool ReadSchema(std::string filename, vtkDMMLTableNode* tableNode);
  bool ReadTable(std::string filename, vtkDMMLTableNode* tableNode);

  bool WriteTable(std::string filename, vtkDMMLTableNode* tableNode);
  bool WriteSchema(std::string filename, vtkDMMLTableNode* tableNode);
