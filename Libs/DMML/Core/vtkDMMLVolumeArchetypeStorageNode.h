/*=auto=========================================================================
  ...
  Program:   3D Cjyx
  Module:    $RCSfile: vtkDMMLVolumeArchetypeStorageNode.h,v $
  Date:      $Date: 2006/03/19 17:12:29 $
  Version:   $Revision: 1.8 $

=========================================================================auto=*/

#ifndef __vtkDMMLVolumeArchetypeStorageNode_h
#define __vtkDMMLVolumeArchetypeStorageNode_h
...
///
/// vtkDMMLVolumeArchetypeStorageNode nodes describe the archetybe based volume storage
/// node that allows to read/write volume data from/to file using generic ITK mechanism.
class VTK_DMML_EXPORT vtkDMMLVolumeArchetypeStorageNode : public vtkDMMLStorageNode
{
public:
  static vtkDMMLVolumeArchetypeStorageNode *New();
  vtkTypeMacro(vtkDMMLVolumeArchetypeStorageNode,vtkDMMLStorageNode);
  ...
  std::string UpdateFileList(vtkDMMLNode *refNode, bool move=false);
  ...
  static void SetMetaDataDictionaryFromReader(vtkDMMLVolumeNode*, vtkITKArchetypeImageSeriesReader*);

protected:
  vtkDMMLVolumeArchetypeStorageNode();
  ~vtkDMMLVolumeArchetypeStorageNode() override;
  vtkDMMLVolumeArchetypeStorageNode(const vtkDMMLVolumeArchetypeStorageNode&);
  void operator=(const vtkDMMLVolumeArchetypeStorageNode&);
