...
#ifndef __vtkDMMLTransformDisplayNode_h
#define __vtkDMMLTransformDisplayNode_h
...
/// \brief DMML node to represent display properties for transforms visualization in the slice and 3D viewers.
///
/// vtkDMMLTransformDisplayNode nodes store display properties of transforms.
class VTK_DMML_EXPORT vtkDMMLTransformDisplayNode : public vtkDMMLDisplayNode
{
 public:
  static vtkDMMLTransformDisplayNode *New (  );
  vtkTypeMacro ( vtkDMMLTransformDisplayNode,vtkDMMLDisplayNode );
  ...
  vtkDMMLCopyContentMacro(vtkDMMLTransformDisplayNode);
  ...
  /// displayed.
  vtkDMMLNode* GetRegionNode();
  void SetAndObserveRegionNode(vtkDMMLNode* node);
  ...
  vtkDMMLNode* GetGlyphPointsNode();
  void SetAndObserveGlyphPointsNode(vtkDMMLNode* node);
...
protected:
 ...
 protected:
  ...
  ~vtkDMMLTransformDisplayNode ( ) override;
  vtkDMMLTransformDisplayNode ( const vtkDMMLTransformDisplayNode& );
  void operator= ( const vtkDMMLTransformDisplayNode& );
