...
//----------------------------------------------------------------------------
vtkDMMLNodeNewMacro(vtkDMMLLayoutNode);

//----------------------------------------------------------------------------
vtkDMMLLayoutNode::vtkDMMLLayoutNode()
{
  this->SetSingletonTag("vtkDMMLLayoutNode");
  this->GUIPanelVisibility = 1;
  this->BottomPanelVisibility = 1;
  this->GUIPanelLR = 0;
  this->ViewArrangement = vtkDMMLLayoutNode::CjyxLayoutNone;
  ...
  this->AddLayoutDescription(vtkDMMLLayoutNode::CjyxLayoutNone, "");
}
...
//----------------------------------------------------------------------------
void vtkDMMLLayoutNode::WriteXML(ostream& of, int nIndent)
{
...
//----------------------------------------------------------------------------
void vtkDMMLLayoutNode::ReadXMLAttributes(const char** atts)
{
  ...
  while (*atts != nullptr)
    ...
    if (!strcmp(attName, "currentViewArrangement"))
      ...
      if (this->ViewArrangement < vtkDMMLLayoutNode::CjyxLayoutInitialView)
        {
        this->ViewArrangement = vtkDMMLLayoutNode::CjyxLayoutInitialView;
        }
      }
...
//----------------------------------------------------------------------------
void vtkDMMLLayoutNode::Reset(vtkDMMLNode* defaultNode)
{
...
//----------------------------------------------------------------------------
void vtkDMMLLayoutNode::SetViewArrangement(int arrNew)
{
...
//----------------------------------------------------------------------------
bool vtkDMMLLayoutNode::AddLayoutDescription(int layout, const char* layoutDescription)
{
...
//----------------------------------------------------------------------------
bool vtkDMMLLayoutNode::SetLayoutDescription(int layout, const char* layoutDescription)
{
  if (!this->IsLayoutDescription(layout))
    {
...
//----------------------------------------------------------------------------
bool vtkDMMLLayoutNode::IsLayoutDescription(int layout)
{
...
//----------------------------------------------------------------------------
std::string vtkDMMLLayoutNode::GetLayoutDescription(int layout)
{
  std::map<int, std::string>::const_iterator it = this->Layouts.find(layout);
...
//----------------------------------------------------------------------------
void vtkDMMLLayoutNode::UpdateCurrentLayoutDescription()
{
  if (this->GetViewArrangement() == vtkDMMLLayoutNode::CjyxLayoutCustomView)
    {
    return;
    }
  ...
  if (!this->IsLayoutDescription(viewArrangement))
    ...
    viewArrangement = vtkDMMLLayoutNode::CjyxLayoutDefaultView;
    }
...
//----------------------------------------------------------------------------
void vtkDMMLLayoutNode::SetAndParseCurrentLayoutDescription(const char* description)
{
...
//----------------------------------------------------------------------------
vtkXMLDataElement* vtkDMMLLayoutNode::ParseLayout(const char* description)
{
  ...
  if (root==nullptr)
    {
    vtkErrorWithObjectMacro(parser, "vtkDMMLLayoutNode::ParseLayout: failed to parse layout description");
    return nullptr;
    }
...
void vtkDMMLLayoutNode::Copy(vtkDMMLNode *anode)
{
  int disabledModify = this->StartModify();

//  vtkObject::Copy(anode);
  vtkDMMLLayoutNode *node = (vtkDMMLLayoutNode *) anode;
...
//----------------------------------------------------------------------------
void vtkDMMLLayoutNode::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
vtkDMMLAbstractViewNode* vtkDMMLLayoutNode::GetMaximizedViewNode()
{
  return vtkDMMLAbstractViewNode::SafeDownCast(this->GetNodeReference("MaximizedView"));
}

//----------------------------------------------------------------------------
void vtkDMMLLayoutNode::SetMaximizedViewNode(vtkDMMLAbstractViewNode* maximizedViewNode)
{
