...
//------------------------------------------------------------------------------
vtkColor3d vtkDMMLColors::sliceRed()
{
  // 243, 74, 51 -> #F34A33
...
//------------------------------------------------------------------------------
vtkColor3d vtkDMMLColors::sliceGreen()
{
  // 110, 176, 75 -> #6EB04B
...
//------------------------------------------------------------------------------
vtkColor3d vtkDMMLColors::sliceYellow()
{
  // 237, 213, 76 -> #EDD54C
...
//------------------------------------------------------------------------------
vtkColor3d vtkDMMLColors::sliceOrange()
{
  // 225, 112, 18 -> #E17012
...
//------------------------------------------------------------------------------
vtkColor3d vtkDMMLColors::threeDViewBlue()
{
  // 116, 131, 233 -> #7483E9
...
//------------------------------------------------------------------------------
vtkColor3d vtkDMMLColors::sliceGray()
{
  // #8C8C8C
...
//------------------------------------------------------------------------------
bool vtkDMMLColors::toRGBColor(const vtkColor3d& from, double to[3])
{
  to[0] = from.GetRed();
  to[1] = from.GetGreen();
  to[2] = from.GetBlue();
