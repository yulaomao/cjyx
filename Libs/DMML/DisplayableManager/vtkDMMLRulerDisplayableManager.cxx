...
#include "vtkDMMLRulerDisplayableManager.h"
...
public:
  ...
  vtkWeakPointer<vtkDMMLRulerDisplayableManager> DisplayableManager;
};

//---------------------------------------------------------------------------
vtkStandardNewMacro(vtkDMMLRulerDisplayableManager );

//---------------------------------------------------------------------------
class vtkDMMLRulerDisplayableManager::vtkInternal
{
public:
  vtkInternal(vtkDMMLRulerDisplayableManager * external);
  ~vtkInternal();
  ...
  vtkDMMLRulerDisplayableManager* External;
};
...
//---------------------------------------------------------------------------
vtkDMMLRulerDisplayableManager::vtkInternal::vtkInternal(vtkDMMLRulerDisplayableManager * external)
{
...
//---------------------------------------------------------------------------
vtkDMMLRulerDisplayableManager::vtkInternal::~vtkInternal()
{
  RemoveRendererUpdateObserver();
}

//---------------------------------------------------------------------------
void vtkDMMLRulerDisplayableManager::vtkInternal::ShowActors(bool show)
{
...
//---------------------------------------------------------------------------
void vtkDMMLRulerDisplayableManager::vtkInternal::AddRendererUpdateObserver(vtkRenderer* renderer)
{
  RemoveRendererUpdateObserver();
  if (renderer)
    {
...
//---------------------------------------------------------------------------
void vtkDMMLRulerDisplayableManager::vtkInternal::RemoveRendererUpdateObserver()
{
...
//---------------------------------------------------------------------------
void vtkDMMLRulerDisplayableManager::vtkInternal::SetupMarkerRenderer()
{
  vtkRenderer* renderer = this->External->GetRenderer();
  if (renderer==nullptr)
    {
    vtkErrorWithObjectMacro(this->External, "vtkDMMLRulerDisplayableManager::vtkInternal::SetupMarkerRenderer() failed: renderer is invalid");
    return;
    }
...
//---------------------------------------------------------------------------
void vtkDMMLRulerDisplayableManager::vtkInternal::SetupRuler()
{
...
//---------------------------------------------------------------------------
void vtkDMMLRulerDisplayableManager::vtkInternal::UpdateRuler()
{
  ...
  if (!viewNode || !viewNode->GetRulerEnabled())
    {
    vtkErrorWithObjectMacro(this->External, "vtkDMMLRulerDisplayableManager::UpdateMarkerOrientation() failed: view node is invalid");
  ...
  if (this->External->RulerScalePresets.empty())
    {
    vtkErrorWithObjectMacro(this->External, "vtkDMMLRulerDisplayableManager::UpdateMarkerOrientation() failed: no ruler scale presets are defined");
    this->ShowActors(false);
    return;
    }

  int type = viewNode->GetRulerType();
  if (type==vtkDMMLAbstractViewNode::RulerTypeNone)
    {
  ...
  if (sliceNode)
    ...
    {
    vtkErrorWithObjectMacro(this->External, "vtkDMMLRulerDisplayableManager::UpdateMarkerOrientation() failed: displayable node is invalid");
    this->ShowActors(false);
    return;
    }
  ...
  switch (type)
  {
  case vtkDMMLAbstractViewNode::RulerTypeThin:
    ...
    break;
  case vtkDMMLAbstractViewNode::RulerTypeThick:
  ...
  switch (color)
  {
  case vtkDMMLAbstractViewNode::RulerColorWhite:
    lineProperty->SetColor(1,1,1);
    textProperty->SetColor(1,1,1);
    break;
  case vtkDMMLAbstractViewNode::RulerColorBlack:
    lineProperty->SetColor(0,0,0);
    textProperty->SetColor(0,0,0);
    break;
  case vtkDMMLAbstractViewNode::RulerColorYellow:
...
//---------------------------------------------------------------------------
// vtkDMMLRulerDisplayableManager methods

//---------------------------------------------------------------------------
vtkDMMLRulerDisplayableManager::vtkDMMLRulerDisplayableManager()
{
...
//---------------------------------------------------------------------------
void vtkDMMLRulerDisplayableManager::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
}

//---------------------------------------------------------------------------
void vtkDMMLRulerDisplayableManager::Create()
{
...
//---------------------------------------------------------------------------
void vtkDMMLRulerDisplayableManager::UpdateFromViewNode()
{
...
//---------------------------------------------------------------------------
void vtkDMMLRulerDisplayableManager::OnDMMLDisplayableNodeModifiedEvent(vtkObject* vtkNotUsed(caller))
{
...
//---------------------------------------------------------------------------
void vtkDMMLRulerDisplayableManager::UpdateFromRenderer()
{
...
//---------------------------------------------------------------------------
void vtkDMMLRulerDisplayableManager::AddRulerScalePreset(double length, int numberOfMajorDivisions, int numberOfMinorDivisions,
...
//---------------------------------------------------------------------------
void vtkDMMLRulerDisplayableManager::RemoveAllRulerScalePresets()
{
