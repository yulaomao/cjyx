...
#ifndef __vtkDMMLInteractionEventData_h
#define __vtkDMMLInteractionEventData_h
...
class VTK_DMML_DISPLAYABLEMANAGER_EXPORT vtkDMMLInteractionEventData : public vtkEventDataDevice3D
{
public:
  vtkTypeMacro(vtkDMMLInteractionEventData, vtkEventDataDevice3D);
  static vtkDMMLInteractionEventData *New();

  /// Extends vtkCommand events
  enum DMMLInteractionEvents
    {
  ...
  void SetViewNode(vtkDMMLAbstractViewNode* viewNode);
  vtkDMMLAbstractViewNode* GetViewNode() const;
...
protected:
  ...
  vtkDMMLInteractionEventData();
  ~vtkDMMLInteractionEventData() override  = default;

private:
  vtkDMMLInteractionEventData(const vtkDMMLInteractionEventData& c) = delete;
  void operator=(const vtkDMMLInteractionEventData&) = delete;
};
