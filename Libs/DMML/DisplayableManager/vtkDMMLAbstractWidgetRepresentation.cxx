...
//----------------------------------------------------------------------
vtkDMMLAbstractWidgetRepresentation::vtkDMMLAbstractWidgetRepresentation()
{
  // Default glyph scale used to be 3.0 (in Cjyx-4.10 and earlier).
...
//----------------------------------------------------------------------
vtkDMMLAbstractWidgetRepresentation::~vtkDMMLAbstractWidgetRepresentation() = default;

//----------------------------------------------------------------------
void vtkDMMLAbstractWidgetRepresentation
...
//-----------------------------------------------------------------------------
void vtkDMMLAbstractWidgetRepresentation::SetRenderer(vtkRenderer *ren)
{
...
//-----------------------------------------------------------------------------
vtkRenderer* vtkDMMLAbstractWidgetRepresentation::GetRenderer()
{
  return this->Renderer;
}

//-----------------------------------------------------------------------------
void vtkDMMLAbstractWidgetRepresentation::SetViewNode(vtkDMMLAbstractViewNode* viewNode)
{
...
//-----------------------------------------------------------------------------
vtkDMMLAbstractViewNode* vtkDMMLAbstractWidgetRepresentation::GetViewNode()
{
  return this->ViewNode;
}

//-----------------------------------------------------------------------------
void vtkDMMLAbstractWidgetRepresentation::PrintSelf(ostream& os,
                                                      vtkIndent indent)
{
...
//-----------------------------------------------------------------------------
void vtkDMMLAbstractWidgetRepresentation::AddActorsBounds(vtkBoundingBox& boundingBox,
...
//----------------------------------------------------------------------
void vtkDMMLAbstractWidgetRepresentation::UpdateFromDMML(
    vtkDMMLNode* vtkNotUsed(caller), unsigned long vtkNotUsed(event), void *vtkNotUsed(callData))
{
}

//-----------------------------------------------------------------------------
void vtkDMMLAbstractWidgetRepresentation::UpdateRelativeCoincidentTopologyOffsets(vtkMapper* mapper)
{
  if (this->AlwaysOnTop)
    {
