...
vtkStandardNewMacro(vtkDMMLSliceIntersectionInteractionRepresentationHelper);

//----------------------------------------------------------------------
vtkDMMLSliceIntersectionInteractionRepresentationHelper::vtkDMMLSliceIntersectionInteractionRepresentationHelper()
{
}
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentationHelper::PrintSelf(ostream & os, vtkIndent indent)
{
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentationHelper::GetSliceViewBoundariesXY(vtkDMMLSliceNode* sliceNode, double* sliceViewBounds)
{
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentationHelper::GetIntersectionWithSliceViewBoundaries(double* pointA, double* pointB,
...
//---------------------------------------------------------------------------
int vtkDMMLSliceIntersectionInteractionRepresentationHelper::IntersectWithFinitePlane(double n[3], double o[3],
...
//----------------------------------------------------------------------
int vtkDMMLSliceIntersectionInteractionRepresentationHelper::GetLineTipsFromIntersectingSliceNode(vtkDMMLSliceNode* intersectingSliceNode,
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentationHelper::ComputeHandleToWorldTransformMatrix(double handlePosition[2], double handleOrientation[2],
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentationHelper::RotationMatrixFromVectors(double vector1[2], double vector2[2], vtkMatrix4x4* rotationMatrixHom)
{
  // 3D vectors
