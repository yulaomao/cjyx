...
vtkStandardNewMacro(vtkDMMLSliceIntersectionInteractionRepresentation);
vtkCxxSetObjectMacro(vtkDMMLSliceIntersectionInteractionRepresentation, DMMLApplicationLogic, vtkDMMLApplicationLogic);
...
class SliceIntersectionInteractionDisplayPipeline
{
  public:
    ...
    //----------------------------------------------------------------------
    void SetAndObserveSliceLogic(vtkDMMLSliceLogic* sliceLogic, vtkCallbackCommand* callback)
    {
      if (sliceLogic != this->SliceLogic || callback != this->Callback)
        ...
        if (sliceLogic)
          ...
          sliceLogic->AddObserver(vtkDMMLSliceLogic::CompositeModifiedEvent, callback);
          }
    ...
    void SetHandlesVisibility(bool visibility)
      {
      bool rotationHandle1Visible = visibility && (this->HandlesVisibilityMode != vtkDMMLSliceDisplayNode::NeverVisible)
        && this->RotationHandlesVisible && this->RotationHandle1Displayable;
      bool rotationHandle2Visible = visibility && (this->HandlesVisibilityMode != vtkDMMLSliceDisplayNode::NeverVisible)
        && this->RotationHandlesVisible && this->RotationHandle2Displayable;
      bool sliceOffsetHandle1Visible = visibility && (this->HandlesVisibilityMode != vtkDMMLSliceDisplayNode::NeverVisible)
        && this->TranslationHandlesVisible && this->SliceOffsetHandle1Displayable;
      bool sliceOffsetHandle2Visible = visibility && (this->HandlesVisibilityMode != vtkDMMLSliceDisplayNode::NeverVisible)
        && this->TranslationHandlesVisible && this->SliceOffsetHandle2Displayable;
      bool translationHandleVisible = visibility && (this->HandlesVisibilityMode != vtkDMMLSliceDisplayNode::NeverVisible)
        && this->TranslationHandlesVisible && this->SliceIntersectionMode == vtkDMMLSliceDisplayNode::FullLines;
    ...
    int  HandlesVisibilityMode = vtkDMMLSliceDisplayNode::NeverVisible;
    int  SliceIntersectionMode = vtkDMMLSliceDisplayNode::SkipLineCrossings;
    // Indicates that this representation has changed and thus re-rendering is needed
    bool NeedToRender = true;
  };

class vtkDMMLSliceIntersectionInteractionRepresentation::vtkInternal
{
  public:
    vtkInternal(vtkDMMLSliceIntersectionInteractionRepresentation* external);
    ~vtkInternal();

    vtkDMMLSliceIntersectionInteractionRepresentation* External;

    vtkSmartPointer<vtkDMMLSliceNode> SliceNode;
    vtkSmartPointer<vtkDMMLSliceDisplayNode> SliceDisplayNode;
...
//---------------------------------------------------------------------------
vtkDMMLSliceIntersectionInteractionRepresentation::vtkInternal
::vtkInternal(vtkDMMLSliceIntersectionInteractionRepresentation* external)
{
...
//---------------------------------------------------------------------------
vtkDMMLSliceIntersectionInteractionRepresentation::vtkInternal::~vtkInternal() = default;

//----------------------------------------------------------------------
vtkDMMLSliceIntersectionInteractionRepresentation::vtkDMMLSliceIntersectionInteractionRepresentation()
{
  this->DMMLApplicationLogic = nullptr;

  this->Internal = new vtkInternal(this);
  this->Internal->SliceNodeModifiedCommand->SetClientData(this);
  this->Internal->SliceNodeModifiedCommand->SetCallback(vtkDMMLSliceIntersectionInteractionRepresentation::SliceNodeModifiedCallback);
  ...
  // Helper
  vtkNew<vtkDMMLSliceIntersectionInteractionRepresentationHelper> helper;
  this->Helper = helper;
}
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentation::GetActors2D(vtkPropCollection * pc)
{
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentation::ReleaseGraphicsResources(vtkWindow * win)
{
  for (std::deque<SliceIntersectionInteractionDisplayPipeline*>::iterator
    sliceIntersectionIt = this->Internal->SliceIntersectionInteractionDisplayPipelines.begin();
    sliceIntersectionIt != this->Internal->SliceIntersectionInteractionDisplayPipelines.end(); ++sliceIntersectionIt)
...
//----------------------------------------------------------------------
int vtkDMMLSliceIntersectionInteractionRepresentation::RenderOverlay(vtkViewport * viewport)
{
  int count = 0;
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentation::PrintSelf(ostream & os, vtkIndent indent)
{
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentation::SliceNodeModifiedCallback(
  vtkObject * caller, unsigned long vtkNotUsed(eid), void* clientData, void* vtkNotUsed(callData))
{
  vtkDMMLSliceIntersectionInteractionRepresentation* self = vtkDMMLSliceIntersectionInteractionRepresentation::SafeDownCast((vtkObject*)clientData);
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentation::SliceNodeModified(vtkDMMLSliceNode * sliceNode)
{
  if (!sliceNode)
    {
    return;
  ...
  if (sliceNode == this->Internal->SliceNode)
    ...
    vtkDMMLSliceDisplayNode* displayNode = this->GetSliceDisplayNode();
    if (displayNode)
      {
      int componentType = displayNode->GetActiveComponentType();
      handlesVisible = componentType != vtkDMMLSliceDisplayNode::ComponentNone
        && componentType != vtkDMMLSliceDisplayNode::ComponentSliceIntersection; // hide handles during interaction:
      }
...
//----------------------------------------------------------------------
SliceIntersectionInteractionDisplayPipeline* vtkDMMLSliceIntersectionInteractionRepresentation::GetDisplayPipelineFromSliceLogic(vtkDMMLSliceLogic * sliceLogic)
{
  for (std::deque<SliceIntersectionInteractionDisplayPipeline*>::iterator
    sliceIntersectionIt = this->Internal->SliceIntersectionInteractionDisplayPipelines.begin();
    sliceIntersectionIt != this->Internal->SliceIntersectionInteractionDisplayPipelines.end(); ++sliceIntersectionIt)
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentation::UpdateSliceIntersectionDisplay(SliceIntersectionInteractionDisplayPipeline * pipeline)
{
  if (!pipeline || !this->Internal->SliceNode || pipeline->SliceLogic == nullptr)
    {
    return;
    }
  vtkDMMLSliceNode* intersectingSliceNode = pipeline->SliceLogic->GetSliceNode();
  ...
  vtkDMMLSliceDisplayNode* displayNode = this->GetSliceDisplayNode(intersectingSliceNode);
  if (displayNode)
    {
  ...
  vtkDMMLSliceNode* currentSliceNode = this->GetSliceNode();
  ...
  if (this->SliceIntersectionPointFound == false)
    ...
    if (pipeline->SliceIntersectionMode == vtkDMMLSliceDisplayNode::FullLines)
      {
    ...
    else if (pipeline->SliceIntersectionMode == vtkDMMLSliceDisplayNode::SkipLineCrossings)
      {
      ...
      {
      vtkWarningMacro("vtkDMMLSliceIntersectionInteractionRepresentation::UpdateSliceIntersectionDisplay failed: unknown visualization mode.");
      if (pipeline->NeedToRender)
        {
        this->NeedToRenderOn();
        }
...
//----------------------------------------------------------------------
vtkDMMLSliceDisplayNode* vtkDMMLSliceIntersectionInteractionRepresentation::GetSliceDisplayNode()
{
  if (this->Internal->SliceDisplayNode)
    {
    return this->Internal->SliceDisplayNode;
    }
  vtkDMMLSliceDisplayNode* sliceDisplayNode = this->GetSliceDisplayNode(this->Internal->SliceNode);
  this->SetSliceDisplayNode(sliceDisplayNode);
  return sliceDisplayNode;
}

//----------------------------------------------------------------------
vtkDMMLSliceDisplayNode* vtkDMMLSliceIntersectionInteractionRepresentation::GetSliceDisplayNode(vtkDMMLSliceNode* sliceNode)
{
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentation::SetSliceNode(vtkDMMLSliceNode * sliceNode)
{
  if (sliceNode == this->Internal->SliceNode)
    {
    // no change
  ...
  vtkDMMLSliceDisplayNode* sliceDisplayNode = this->GetSliceDisplayNode(sliceNode);
  this->SetSliceDisplayNode(sliceDisplayNode);
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentation::SetSliceDisplayNode(vtkDMMLSliceDisplayNode* sliceDisplayNode)
{
...
//----------------------------------------------------------------------
vtkDMMLSliceNode* vtkDMMLSliceIntersectionInteractionRepresentation::GetSliceNode()
{
  return this->Internal->SliceNode;
}

//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentation::AddIntersectingSliceLogic(vtkDMMLSliceLogic * sliceLogic)
{
  if (!sliceLogic)
    {
    return;
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentation::RemoveIntersectingSliceNode(vtkDMMLSliceNode * sliceNode)
{
  if (!sliceNode)
    {
    return;
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentation::UpdateIntersectingSliceNodes()
{
  this->RemoveAllIntersectingSliceNodes();
  if (!this->GetSliceNode() || !this->DMMLApplicationLogic)
    {
    return;
    }
  vtkCollection* sliceLogics = this->DMMLApplicationLogic->GetSliceLogics();
  if (!sliceLogics)
    {
    return;
    }
  ...
  for (sliceLogics->InitTraversal(it);
    (sliceLogic = vtkDMMLSliceLogic::SafeDownCast(sliceLogics->GetNextItemAsObject(it)));)
    {
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentation::RemoveAllIntersectingSliceNodes()
{
  for (std::deque<SliceIntersectionInteractionDisplayPipeline*>::iterator
    sliceIntersectionIt = this->Internal->SliceIntersectionInteractionDisplayPipelines.begin();
    sliceIntersectionIt != this->Internal->SliceIntersectionInteractionDisplayPipelines.end(); ++sliceIntersectionIt)
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentation::ComputeSliceIntersectionPoint()
{
  this->SliceIntersectionPoint[0] = 0.0;
  this->SliceIntersectionPoint[1] = 0.0;
  this->SliceIntersectionPoint[2] = 0.0;
...
//----------------------------------------------------------------------
double* vtkDMMLSliceIntersectionInteractionRepresentation::GetSliceIntersectionPoint()
{
  return this->SliceIntersectionPoint;
}

//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentation::TransformIntersectingSlices(vtkMatrix4x4 * rotatedSliceToSliceTransformMatrix)
{
  ...
  for (std::deque<SliceIntersectionInteractionDisplayPipeline*>::iterator
    ...
    vtkDMMLSliceNode* sliceNode = (*sliceIntersectionIt)->SliceLogic->GetSliceNode();
...
//----------------------------------------------------------------------
double vtkDMMLSliceIntersectionInteractionRepresentation::GetMaximumHandlePickingDistance2()
{
...
//-----------------------------------------------------------------------------
std::string vtkDMMLSliceIntersectionInteractionRepresentation::CanInteract(vtkDMMLInteractionEventData* interactionEventData,
  int& foundComponentType, int& foundComponentIndex, double& closestDistance2, double& handleOpacity)
{
  foundComponentType = vtkDMMLSliceDisplayNode::ComponentNone;
    ...
    if (sliceNode)
      ...
      for (HandleInfo handleInfo : handleInfoList)
        ...
        if (!intersectingSlicesTranslationEnabled
          && (handleInfo.ComponentType == vtkDMMLSliceDisplayNode::ComponentTranslateIntersectingSlicesHandle
            || handleInfo.ComponentType == vtkDMMLSliceDisplayNode::ComponentTranslateSingleIntersectingSliceHandle))
          {
          // translation is disabled and this is a translation handle
          continue;
          }
        if (!intersectingSlicesRotationEnabled
          && handleInfo.ComponentType == vtkDMMLSliceDisplayNode::ComponentRotateIntersectingSlicesHandle)
          {
        ...
        if (dist2 < extendedPickingDistanceFromControlPoint2)
          ...
          if (dist2 < maxPickingDistanceFromControlPoint2)
            ...
            if (dist2 < closestDistance2
              || (handleInfo.ComponentType == vtkDMMLSliceDisplayNode::ComponentTranslateIntersectingSlicesHandle
                && foundComponentType == vtkDMMLSliceDisplayNode::ComponentTranslateSingleIntersectingSliceHandle))
              {
              closestDistance2 = dist2;

              if (foundComponentType == vtkDMMLSliceDisplayNode::ComponentTranslateIntersectingSlicesHandle
                && handleInfo.ComponentType == vtkDMMLSliceDisplayNode::ComponentTranslateSingleIntersectingSliceHandle)
                {
...
//----------------------------------------------------------------------
vtkDMMLSliceIntersectionInteractionRepresentation::HandleInfoList
vtkDMMLSliceIntersectionInteractionRepresentation::GetHandleInfoList(SliceIntersectionInteractionDisplayPipeline* pipeline)
{
  vtkDMMLSliceNode* currentSliceNode = this->GetSliceNode(); // Get slice node
  vtkDMMLSliceNode* intersectingSliceNode = pipeline->SliceLogic->GetSliceNode(); // Get intersecting slice node
  ...
  for (int i = 0; i < pipeline->RotationHandlePoints->GetNumberOfPoints(); ++i)
    ...
    HandleInfo info(i, vtkDMMLSliceDisplayNode::ComponentRotateIntersectingSlicesHandle,
  ...
  for (int i = 0; i < pipeline->TranslationHandlePoints->GetNumberOfPoints(); ++i)
    ...
    handlePositionWorld[1] = handlePositionWorld_h[1];
    handlePositionWorld[2] = handlePositionWorld_h[2];
    HandleInfo info(i, vtkDMMLSliceDisplayNode::ComponentTranslateIntersectingSlicesHandle,
      intersectingSliceNodeID, handlePositionWorld, handlePositionLocal);
    handleInfoList.push_back(info);
    }
  ...
  for (int i = 0; i < pipeline->SliceOffsetHandlePoints->GetNumberOfPoints(); ++i)
    ...
    handlePositionWorld[1] = handlePositionWorld_h[1];
    handlePositionWorld[2] = handlePositionWorld_h[2];
    HandleInfo info(i, vtkDMMLSliceDisplayNode::ComponentTranslateSingleIntersectingSliceHandle,
      intersectingSliceNodeID, handlePositionWorld, handlePositionLocal);
    handleInfoList.push_back(info);
    }
...
//----------------------------------------------------------------------
double vtkDMMLSliceIntersectionInteractionRepresentation::GetViewScaleFactorAtPosition(double positionWorld[3])
{
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentation::SetPipelinesHandlesVisibility(bool visible)
{
  ...
  for (std::deque<SliceIntersectionInteractionDisplayPipeline*>::iterator
    ...
    sliceIntersectionIt != this->Internal->SliceIntersectionInteractionDisplayPipelines.end(); ++sliceIntersectionIt)
    {
    if ((*sliceIntersectionIt)->HandlesVisibilityMode == vtkDMMLSliceDisplayNode::AlwaysVisible)
      {
      visible = true;
      }
    else if ((*sliceIntersectionIt)->HandlesVisibilityMode == vtkDMMLSliceDisplayNode::NeverVisible)
      {
      visible = false;
      }
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentation::SetPipelinesHandlesOpacity(double opacity)
{
  // Update handles visibility in all display pipelines
  for (std::deque<SliceIntersectionInteractionDisplayPipeline*>::iterator
    sliceIntersectionIt = this->Internal->SliceIntersectionInteractionDisplayPipelines.begin();
...
//----------------------------------------------------------------------
bool vtkDMMLSliceIntersectionInteractionRepresentation::IsMouseCursorInSliceView(double cursorPosition[2])
{
  // Get current slice view bounds
  vtkDMMLSliceNode* currentSliceNode = this->GetSliceNode();
  double sliceViewBounds[4] = {};
...
//-----------------------------------------------------------------------------
bool vtkDMMLSliceIntersectionInteractionRepresentation::IsDisplayable()
{
  vtkDMMLSliceDisplayNode* sliceDisplayNode = this->GetSliceDisplayNode();
  if (!sliceDisplayNode
    || !this->ViewNode
  ...
  if (vtkDMMLSliceNode::SafeDownCast(this->ViewNode))
    {
  ...
  if (vtkDMMLViewNode::SafeDownCast(this->ViewNode))
    {
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionInteractionRepresentation::UpdateFromDMML(vtkDMMLNode* caller, unsigned long event, void *callData /*=nullptr*/)
{
  Superclass::UpdateFromDMML(caller, event, callData);

  this->NeedToRenderOn();

  vtkDMMLSliceIntersectionInteractionRepresentation* self = vtkDMMLSliceIntersectionInteractionRepresentation::SafeDownCast((vtkObject*)callData);
  ...
  vtkDMMLSliceLogic* sliceLogic = vtkDMMLSliceLogic::SafeDownCast(caller);
  if (sliceLogic)
    {
...
//----------------------------------------------------------------------
int vtkDMMLSliceIntersectionInteractionRepresentation::GetTranslateArrowCursor(const std::string& intersectingSliceNodeID)
{
  for (std::deque<SliceIntersectionInteractionDisplayPipeline*>::iterator
    sliceIntersectionIt = this->Internal->SliceIntersectionInteractionDisplayPipelines.begin();
    sliceIntersectionIt != this->Internal->SliceIntersectionInteractionDisplayPipelines.end(); ++sliceIntersectionIt)
    {
    vtkDMMLSliceLogic* sliceLogic = (*sliceIntersectionIt)->SliceLogic;
    if (!sliceLogic)
      {
      continue;
      }
...
//----------------------------------------------------------------------
double vtkDMMLSliceIntersectionInteractionRepresentation::GetLineThicknessFromMode(int lineThicknessMode)
{
  switch (lineThicknessMode)
  {
  case vtkDMMLSliceDisplayNode::FineLines: return 1.0;
  case vtkDMMLSliceDisplayNode::MediumLines: return 2.0;
  case vtkDMMLSliceDisplayNode::ThickLines: return 3.0;
  default:
    return 1.0;
  }
}
