...
#include "vtkDMMLOrientationMarkerDisplayableManager.h"
...
public:
  ...
  vtkWeakPointer<vtkDMMLOrientationMarkerDisplayableManager> DisplayableManager;
};

//---------------------------------------------------------------------------
vtkStandardNewMacro(vtkDMMLOrientationMarkerDisplayableManager );

//---------------------------------------------------------------------------
class vtkDMMLOrientationMarkerDisplayableManager::vtkInternal
{
public:
  vtkInternal(vtkDMMLOrientationMarkerDisplayableManager * external);
  ~vtkInternal();
  ...
  vtkDMMLOrientationMarkerDisplayableManager* External;
};
...
//---------------------------------------------------------------------------
vtkDMMLOrientationMarkerDisplayableManager::vtkInternal::vtkInternal(vtkDMMLOrientationMarkerDisplayableManager * external)
{
...
//---------------------------------------------------------------------------
vtkDMMLOrientationMarkerDisplayableManager::vtkInternal::~vtkInternal()
{
  RemoveRendererUpdateObserver();
}

//---------------------------------------------------------------------------
void vtkDMMLOrientationMarkerDisplayableManager::vtkInternal::AddRendererUpdateObserver(vtkRenderer* renderer)
{
  RemoveRendererUpdateObserver();
  if (renderer)
    {
...
//---------------------------------------------------------------------------
void vtkDMMLOrientationMarkerDisplayableManager::vtkInternal::RemoveRendererUpdateObserver()
{
...
//---------------------------------------------------------------------------
void vtkDMMLOrientationMarkerDisplayableManager::vtkInternal::SetupMarkerRenderer()
{
  vtkRenderer* renderer = this->External->GetRenderer();
  if (renderer==nullptr)
    {
    vtkErrorWithObjectMacro(this->External, "vtkDMMLOrientationMarkerDisplayableManager::vtkInternal::SetupMarkerRenderer() failed: renderer is invalid");
    return;
    }
  ...
  vtkDMMLViewNode* threeDViewNode = vtkDMMLViewNode::SafeDownCast(this->External->GetDMMLDisplayableNode());
  if (threeDViewNode)
    {
...
//---------------------------------------------------------------------------
vtkProp3D* vtkDMMLOrientationMarkerDisplayableManager::vtkInternal::GetCubeActor()
{
  if (!this->CubeActor)
    {
...
//----------------------------------------------------------------------------
std::string vtkDMMLOrientationMarkerDisplayableManager::vtkInternal::GetOrientationMarkerModelPath(const char* modelFileName)
{
  std::vector<std::string> filesVector;
  filesVector.emplace_back(""); // The first two components do not add a slash.
  filesVector.push_back(vtkDMMLLogic::GetApplicationShareDirectory());
...
//---------------------------------------------------------------------------
vtkProp3D* vtkDMMLOrientationMarkerDisplayableManager::vtkInternal::GetHumanActor()
{
  if (!this->HumanActor)
    {
...
//---------------------------------------------------------------------------
vtkProp3D* vtkDMMLOrientationMarkerDisplayableManager::vtkInternal::GetAxesActor()
{
  if (!this->AxesActor)
    {
...
//---------------------------------------------------------------------------
void vtkDMMLOrientationMarkerDisplayableManager::vtkInternal::UpdateMarkerType()
{
  vtkDMMLAbstractViewNode* viewNode = vtkDMMLAbstractViewNode::SafeDownCast(this->External->GetDMMLDisplayableNode());
  ...
  switch (viewNode->GetOrientationMarkerType())
    {
    case vtkDMMLAbstractViewNode::OrientationMarkerTypeCube:
      actorToDisplay = this->GetCubeActor();
      break;
    case vtkDMMLAbstractViewNode::OrientationMarkerTypeHuman:
      actorToDisplay = this->GetHumanActor();
      break;
    case vtkDMMLAbstractViewNode::OrientationMarkerTypeAxes:
      actorToDisplay = this->GetAxesActor();
      break;
    case vtkDMMLAbstractViewNode::OrientationMarkerTypeNone:
    default:
      break;
    }
  ...
  if (viewNode->GetOrientationMarkerType() == vtkDMMLAbstractViewNode::OrientationMarkerTypeHuman)
    {
    vtkDMMLModelNode* humanModelNode = viewNode->GetOrientationMarkerHumanModelNode();
    if (humanModelNode && humanModelNode->GetPolyData())
      ...
      if (polyData->GetPointData() && polyData->GetPointData()->HasArray("Color"))
        ...
        vtkDMMLModelDisplayNode* displayNode = vtkDMMLModelDisplayNode::SafeDownCast(humanModelNode->GetDisplayNode());
        if (displayNode)
          {
...
//---------------------------------------------------------------------------
void vtkDMMLOrientationMarkerDisplayableManager::vtkInternal::UpdateMarkerOrientation()
{
  ...
  if (renderer==nullptr)
    {
    vtkErrorWithObjectMacro(this->External, "vtkDMMLOrientationMarkerDisplayableManager::vtkInternal::UpdateMarkerOrientation() failed: renderer is invalid");
    return;
    }
  vtkDMMLAbstractViewNode* viewNode = vtkDMMLAbstractViewNode::SafeDownCast(this->External->GetDMMLDisplayableNode());
  if (!viewNode || !viewNode->GetOrientationMarkerEnabled())
    {
    vtkErrorWithObjectMacro(this->External, "vtkDMMLOrientationMarkerDisplayableManager::UpdateMarkerOrientation() failed: displayable node is invalid");
    return;
    }
  if (viewNode->GetOrientationMarkerType() == vtkDMMLAbstractViewNode::OrientationMarkerTypeNone)
    {
...
//---------------------------------------------------------------------------
void vtkDMMLOrientationMarkerDisplayableManager::vtkInternal::UpdateMarkerSize()
{
  if (this->MarkerRenderer==nullptr)
    {
    vtkErrorWithObjectMacro(this->External, "vtkDMMLOrientationMarkerDisplayableManager::vtkInternal::UpdateMarkerSize() failed: MarkerRenderer is invalid");
    return;
    }
  vtkDMMLAbstractViewNode* viewNode = vtkDMMLAbstractViewNode::SafeDownCast(this->External->GetDMMLDisplayableNode());
  if (!viewNode || !viewNode->GetOrientationMarkerEnabled())
  ...
  switch (viewNode->GetOrientationMarkerSize())
    {
    case vtkDMMLAbstractViewNode::OrientationMarkerSizeSmall: sizePercent=15; break;
    case vtkDMMLAbstractViewNode::OrientationMarkerSizeLarge: sizePercent=40; break;
    case vtkDMMLAbstractViewNode::OrientationMarkerSizeMedium:
    default:
      // keep default
      break;
    }
  ...
  if (rendererSizeInPixels[0]>0 && rendererSizeInPixels[1]>0)
    ...
    if (viewNode->GetOrientationMarkerType()==vtkDMMLAbstractViewNode::OrientationMarkerTypeAxes && this->AxesActor)
      {
...
//---------------------------------------------------------------------------
void vtkDMMLOrientationMarkerDisplayableManager::vtkInternal::UpdateMarkerLabels()
{
  if (this->MarkerRenderer==nullptr)
    {
    vtkErrorWithObjectMacro(this->External, "vtkDMMLOrientationMarkerDisplayableManager::vtkInternal::UpdateMarkerLabels() failed: MarkerRenderer is invalid");
    return;
    }
  vtkDMMLAbstractViewNode* viewNode = vtkDMMLAbstractViewNode::SafeDownCast(this->External->GetDMMLDisplayableNode());
  if (!viewNode || !viewNode->GetOrientationMarkerEnabled())
...
//---------------------------------------------------------------------------
// vtkDMMLOrientationMarkerDisplayableManager methods

//---------------------------------------------------------------------------
vtkDMMLOrientationMarkerDisplayableManager::vtkDMMLOrientationMarkerDisplayableManager()
{
...
//---------------------------------------------------------------------------
void vtkDMMLOrientationMarkerDisplayableManager::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
}

//---------------------------------------------------------------------------
void vtkDMMLOrientationMarkerDisplayableManager::Create()
{
...
//---------------------------------------------------------------------------
void vtkDMMLOrientationMarkerDisplayableManager::UpdateFromViewNode()
{
...
//---------------------------------------------------------------------------
void vtkDMMLOrientationMarkerDisplayableManager::OnDMMLDisplayableNodeModifiedEvent(vtkObject* vtkNotUsed(caller))
{
...
//---------------------------------------------------------------------------
void vtkDMMLOrientationMarkerDisplayableManager::UpdateFromRenderer()
{
