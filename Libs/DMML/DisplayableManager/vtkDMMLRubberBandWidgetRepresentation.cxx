...
vtkStandardNewMacro(vtkDMMLRubberBandWidgetRepresentation);

class vtkDMMLRubberBandWidgetRepresentation::vtkInternal
{
public:
  vtkInternal(vtkDMMLRubberBandWidgetRepresentation * external);
  ~vtkInternal();
  ...
  vtkDMMLRubberBandWidgetRepresentation* External;
...
//---------------------------------------------------------------------------
vtkDMMLRubberBandWidgetRepresentation::vtkInternal
::vtkInternal(vtkDMMLRubberBandWidgetRepresentation * external)
{
...
//---------------------------------------------------------------------------
vtkDMMLRubberBandWidgetRepresentation::vtkInternal::~vtkInternal() = default;

//----------------------------------------------------------------------
vtkDMMLRubberBandWidgetRepresentation::vtkDMMLRubberBandWidgetRepresentation()
{
...
//----------------------------------------------------------------------
void vtkDMMLRubberBandWidgetRepresentation::GetActors2D(vtkPropCollection *pc)
{
...
//----------------------------------------------------------------------
void vtkDMMLRubberBandWidgetRepresentation::ReleaseGraphicsResources(vtkWindow *win)
{
...
//----------------------------------------------------------------------
int vtkDMMLRubberBandWidgetRepresentation::RenderOverlay(vtkViewport *viewport)
{
...
//----------------------------------------------------------------------
void vtkDMMLRubberBandWidgetRepresentation::PrintSelf(ostream& os, vtkIndent indent)
{
