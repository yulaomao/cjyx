...
*
 * @sa
 * vtkDMMLAbstractWidgetRepresentation vtkDMMLAbstractWidget
*/

#ifndef vtkDMMLAbstractRepresentation_h
#define vtkDMMLAbstractRepresentation_h
...
class VTK_DMML_DISPLAYABLEMANAGER_EXPORT vtkDMMLAbstractWidgetRepresentation : public vtkProp
{
public:
  /// Standard methods for instances of this class.
  vtkTypeMacro(vtkDMMLAbstractWidgetRepresentation, vtkProp);
  ...
  */
  virtual void SetViewNode(vtkDMMLAbstractViewNode* viewNode);
  virtual vtkDMMLAbstractViewNode* GetViewNode();
  //@}

  /**
  * UpdateFromDMML() - update the widget from its state stored in DMML.
 ...
 protected:
  vtkDMMLAbstractWidgetRepresentation();
  ~vtkDMMLAbstractWidgetRepresentation() override;
...
private:
  vtkDMMLAbstractWidgetRepresentation(const vtkDMMLAbstractWidgetRepresentation&) = delete;
  void operator=(const vtkDMMLAbstractWidgetRepresentation&) = delete;
};
