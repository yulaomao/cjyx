/*=========================================================================
  ...
  Module:    vtkDMMLSliceIntersectionRepresentation2D.cxx
...
vtkStandardNewMacro(vtkDMMLSliceIntersectionRepresentation2D);
vtkCxxSetObjectMacro(vtkDMMLSliceIntersectionRepresentation2D, DMMLApplicationLogic, vtkDMMLApplicationLogic);
...
class vtkDMMLSliceIntersectionRepresentation2D::vtkInternal
{
public:
  vtkInternal(vtkDMMLSliceIntersectionRepresentation2D * external);
  ~vtkInternal();
  ...
  vtkDMMLSliceIntersectionRepresentation2D* External;
...
//---------------------------------------------------------------------------
vtkDMMLSliceIntersectionRepresentation2D::vtkInternal
::vtkInternal(vtkDMMLSliceIntersectionRepresentation2D * external)
{
...
//---------------------------------------------------------------------------
vtkDMMLSliceIntersectionRepresentation2D::vtkInternal::~vtkInternal() = default;


//---------------------------------------------------------------------------
int vtkDMMLSliceIntersectionRepresentation2D::vtkInternal::IntersectWithFinitePlane(double n[3], double o[3],
...
//----------------------------------------------------------------------
vtkDMMLSliceIntersectionRepresentation2D::vtkDMMLSliceIntersectionRepresentation2D()
{
  this->DMMLApplicationLogic = nullptr;

  this->Internal = new vtkInternal(this);
  this->Internal->SliceNodeModifiedCommand->SetClientData(this);
  this->Internal->SliceNodeModifiedCommand->SetCallback(vtkDMMLSliceIntersectionRepresentation2D::SliceNodeModifiedCallback);
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionRepresentation2D::GetActors2D(vtkPropCollection *pc)
{
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionRepresentation2D::ReleaseGraphicsResources(vtkWindow *win)
{
  for (std::deque<SliceIntersectionDisplayPipeline*>::iterator sliceIntersectionIt = this->Internal->SliceIntersectionDisplayPipelines.begin();
    sliceIntersectionIt != this->Internal->SliceIntersectionDisplayPipelines.end(); ++sliceIntersectionIt)
    {
...
//----------------------------------------------------------------------
int vtkDMMLSliceIntersectionRepresentation2D::RenderOverlay(vtkViewport *viewport)
{
  int count = 0;
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionRepresentation2D::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionRepresentation2D::SliceNodeModifiedCallback(
  vtkObject* caller, unsigned long vtkNotUsed(eid), void* clientData, void* vtkNotUsed(callData))
{
  vtkDMMLSliceIntersectionRepresentation2D* self = vtkDMMLSliceIntersectionRepresentation2D::SafeDownCast((vtkObject*)clientData);
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionRepresentation2D::SliceNodeModified(vtkDMMLSliceNode* sliceNode)
{
  if (!sliceNode)
    {
    return;
...
//----------------------------------------------------------------------
SliceIntersectionDisplayPipeline* vtkDMMLSliceIntersectionRepresentation2D::GetDisplayPipelineFromSliceLogic(vtkDMMLSliceLogic* sliceLogic)
{
  for (std::deque<SliceIntersectionDisplayPipeline*>::iterator sliceIntersectionIt = this->Internal->SliceIntersectionDisplayPipelines.begin();
    sliceIntersectionIt != this->Internal->SliceIntersectionDisplayPipelines.end(); ++sliceIntersectionIt)
    {
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionRepresentation2D::UpdateSliceIntersectionDisplay(SliceIntersectionDisplayPipeline *pipeline)
{
  ...
  vtkDMMLSliceDisplayNode* displayNode = nullptr;
  vtkDMMLSliceLogic *sliceLogic = nullptr;
  vtkDMMLApplicationLogic *dmmlAppLogic = this->GetDMMLApplicationLogic();
  if (dmmlAppLogic)
    {
    sliceLogic = dmmlAppLogic->GetSliceLogic(intersectingSliceNode);
    }
  if (sliceLogic)
    {
  ...
  int intersectionFound = vtkDMMLSliceIntersectionRepresentation2D::vtkInternal::IntersectWithFinitePlane(slicePlaneNormal, slicePlaneOrigin,
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionRepresentation2D::SetSliceNode(vtkDMMLSliceNode* sliceNode)
{
  if (sliceNode == this->Internal->SliceNode)
    {
    // no change
...
//----------------------------------------------------------------------
vtkDMMLSliceNode* vtkDMMLSliceIntersectionRepresentation2D::GetSliceNode()
{
  return this->Internal->SliceNode;
}

//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionRepresentation2D::AddIntersectingSliceLogic(vtkDMMLSliceLogic* sliceLogic)
{
  if (!sliceLogic)
    {
    return;
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionRepresentation2D::RemoveIntersectingSliceNode(vtkDMMLSliceNode* sliceNode)
{
  if (!sliceNode)
    {
    return;
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionRepresentation2D::UpdateIntersectingSliceNodes()
{
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionRepresentation2D::RemoveAllIntersectingSliceNodes()
{
  for (std::deque<SliceIntersectionDisplayPipeline*>::iterator sliceIntersectionIt = this->Internal->SliceIntersectionDisplayPipelines.begin();
    sliceIntersectionIt != this->Internal->SliceIntersectionDisplayPipelines.end(); ++sliceIntersectionIt)
    {
...
//----------------------------------------------------------------------
double* vtkDMMLSliceIntersectionRepresentation2D::GetSliceIntersectionPoint()
{
...
//----------------------------------------------------------------------
void vtkDMMLSliceIntersectionRepresentation2D::TransformIntersectingSlices(vtkMatrix4x4* rotatedSliceToSliceTransformMatrix)
  {
