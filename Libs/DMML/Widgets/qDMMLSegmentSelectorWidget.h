...
#ifndef __qDMMLSegmentSelectorWidget_h
#define __qDMMLSegmentSelectorWidget_h

// qDMMLWidgets includes
...
class vtkDMMLNode;
class qDMMLSegmentSelectorWidgetPrivate;
...
/// \ingroup CjyxRt_QtModules_Segmentations_Widgets
class QDMML_WIDGETS_EXPORT qDMMLSegmentSelectorWidget : public qDMMLWidget
{
  Q_OBJECT
  QVTK_OBJECT
...
public:
  ...
  /// Constructor
  explicit qDMMLSegmentSelectorWidget(QWidget* parent = nullptr);
  /// Destructor
  ~qDMMLSegmentSelectorWidget() override;

  /// Get currently selected segmentation DMML node
  Q_INVOKABLE vtkDMMLNode* currentNode();
...
public slots:
  ...
  Q_INVOKABLE void setCurrentNode(vtkDMMLNode* node);
...
protected slots:
  ...
  Q_INVOKABLE void onCurrentNodeChanged(vtkDMMLNode* node);
...
signals:
  void currentNodeChanged(vtkDMMLNode*);
...
protected:
  QScopedPointer<qDMMLSegmentSelectorWidgetPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qDMMLSegmentSelectorWidget);
  Q_DISABLE_COPY(qDMMLSegmentSelectorWidget);
};
