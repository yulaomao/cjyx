...
#include "ui_qDMMLSegmentSelectorWidget.h"
...
//-----------------------------------------------------------------------------
class qDMMLSegmentSelectorWidgetPrivate: public Ui_qDMMLSegmentSelectorWidget
{
  Q_DECLARE_PUBLIC(qDMMLSegmentSelectorWidget);

protected:
  qDMMLSegmentSelectorWidget* const q_ptr;
public:
  qDMMLSegmentSelectorWidgetPrivate(qDMMLSegmentSelectorWidget& object);
  void init();
...
//-----------------------------------------------------------------------------
qDMMLSegmentSelectorWidgetPrivate::qDMMLSegmentSelectorWidgetPrivate(qDMMLSegmentSelectorWidget& object)
  : q_ptr(&object)
...
//-----------------------------------------------------------------------------
void qDMMLSegmentSelectorWidgetPrivate::init()
{
  Q_Q(qDMMLSegmentSelectorWidget);
  this->setupUi(q);

  // Make connections
  QObject::connect( this->DMMLNodeComboBox_Segmentation, SIGNAL(currentNodeChanged(vtkDMMLNode*)),
    q, SLOT(onCurrentNodeChanged(vtkDMMLNode*)) );
  QObject::connect( this->DMMLNodeComboBox_Segmentation, SIGNAL(currentNodeChanged(vtkDMMLNode*)),
    q, SIGNAL(currentNodeChanged(vtkDMMLNode*)) );
  QObject::connect( this->DMMLNodeComboBox_Segmentation, SIGNAL(currentNodeChanged(bool)),
    q, SIGNAL(currentNodeChanged(bool)) );
  QObject::connect( this->DMMLNodeComboBox_Segmentation, SIGNAL(nodeAboutToBeEdited(vtkDMMLNode*)),
                q, SIGNAL(nodeAboutToBeEdited(vtkDMMLNode*)));
...
//--------------------------------------------------------------------------
void qDMMLSegmentSelectorWidgetPrivate::setMessage(QString message)
{
...
//-----------------------------------------------------------------------------
// qDMMLSegmentSelectorWidget methods

//-----------------------------------------------------------------------------
qDMMLSegmentSelectorWidget::qDMMLSegmentSelectorWidget(QWidget* _parent)
  : qDMMLWidget(_parent)
  , d_ptr(new qDMMLSegmentSelectorWidgetPrivate(*this))
{
  Q_D(qDMMLSegmentSelectorWidget);
  d->init();
  this->populateSegmentCombobox();
}

//-----------------------------------------------------------------------------
qDMMLSegmentSelectorWidget::~qDMMLSegmentSelectorWidget() = default;

//-----------------------------------------------------------------------------
void qDMMLSegmentSelectorWidget::onCurrentNodeChanged(vtkDMMLNode* node)
{
  Q_D(qDMMLSegmentSelectorWidget);
...
//------------------------------------------------------------------------------
void qDMMLSegmentSelectorWidget::setCurrentNode(vtkDMMLNode* node)
{
  Q_D(qDMMLSegmentSelectorWidget);
...
//-----------------------------------------------------------------------------
vtkDMMLNode* qDMMLSegmentSelectorWidget::currentNode()
{
  Q_D(qDMMLSegmentSelectorWidget);
  return d->DMMLNodeComboBox_Segmentation->currentNode();
}

//------------------------------------------------------------------------------
void qDMMLSegmentSelectorWidget::setCurrentNodeID(const QString& nodeID)
{
  Q_D(qDMMLSegmentSelectorWidget);
  d->DMMLNodeComboBox_Segmentation->setCurrentNodeID(nodeID);
}

//------------------------------------------------------------------------------
QString qDMMLSegmentSelectorWidget::currentNodeID()
{
  Q_D(qDMMLSegmentSelectorWidget);
  return d->DMMLNodeComboBox_Segmentation->currentNodeID();
}

//-----------------------------------------------------------------------------
void qDMMLSegmentSelectorWidget::populateSegmentCombobox()
{
  Q_D(qDMMLSegmentSelectorWidget);
...
//-----------------------------------------------------------------------------
void qDMMLSegmentSelectorWidget::onCurrentSegmentChanged(int index)
{
  Q_D(qDMMLSegmentSelectorWidget);
...
//-----------------------------------------------------------------------------
void qDMMLSegmentSelectorWidget::onSegmentMultiSelectionChanged()
{
  Q_D(qDMMLSegmentSelectorWidget);
...
//-----------------------------------------------------------------------------
QString qDMMLSegmentSelectorWidget::currentSegmentID()
{
  Q_D(qDMMLSegmentSelectorWidget);
...
//-----------------------------------------------------------------------------
QStringList qDMMLSegmentSelectorWidget::selectedSegmentIDs()
{
  Q_D(qDMMLSegmentSelectorWidget);
...
//-----------------------------------------------------------------------------
QStringList qDMMLSegmentSelectorWidget::segmentIDs()
{
  Q_D(qDMMLSegmentSelectorWidget);
...
//-----------------------------------------------------------------------------
void qDMMLSegmentSelectorWidget::setCurrentSegmentID(QString segmentID)
{
  Q_D(qDMMLSegmentSelectorWidget);
...
//-----------------------------------------------------------------------------
void qDMMLSegmentSelectorWidget::setSelectedSegmentIDs(QStringList segmentIDList)
{
  Q_D(qDMMLSegmentSelectorWidget);
...
//--------------------------------------------------------------------------
void qDMMLSegmentSelectorWidget::setNoneEnabled(bool enable)
{
  Q_D(qDMMLSegmentSelectorWidget);
  d->DMMLNodeComboBox_Segmentation->setNoneEnabled(enable);
...
//--------------------------------------------------------------------------
bool qDMMLSegmentSelectorWidget::noneEnabled()const
{
  Q_D(const qDMMLSegmentSelectorWidget);
  return d->DMMLNodeComboBox_Segmentation->noneEnabled();
}

//--------------------------------------------------------------------------
void qDMMLSegmentSelectorWidget::setEditEnabled(bool enable)
{
  Q_D(qDMMLSegmentSelectorWidget);
  d->DMMLNodeComboBox_Segmentation->setEditEnabled(enable);
}

//--------------------------------------------------------------------------
bool qDMMLSegmentSelectorWidget::editEnabled()const
{
  Q_D(const qDMMLSegmentSelectorWidget);
  return d->DMMLNodeComboBox_Segmentation->editEnabled();
}

//--------------------------------------------------------------------------
void qDMMLSegmentSelectorWidget::setSegmentationNodeSelectorVisible(bool visible)
{
  Q_D(qDMMLSegmentSelectorWidget);
  d->DMMLNodeComboBox_Segmentation->setVisible(visible);
}

//--------------------------------------------------------------------------
bool qDMMLSegmentSelectorWidget::segmentationNodeSelectorVisible()const
{
  Q_D(const qDMMLSegmentSelectorWidget);
  return d->DMMLNodeComboBox_Segmentation->isVisible();
}

//--------------------------------------------------------------------------
bool qDMMLSegmentSelectorWidget::multiSelection()const
{
  Q_D(const qDMMLSegmentSelectorWidget);
...
//--------------------------------------------------------------------------
void qDMMLSegmentSelectorWidget::setMultiSelection(bool multi)
{
  Q_D(qDMMLSegmentSelectorWidget);
...
//--------------------------------------------------------------------------
bool qDMMLSegmentSelectorWidget::horizontalLayout()const
{
  Q_D(const qDMMLSegmentSelectorWidget);
...
//--------------------------------------------------------------------------
void qDMMLSegmentSelectorWidget::setHorizontalLayout(bool horizontal)
{
  Q_D(qDMMLSegmentSelectorWidget);
  ...
  if (horizontal)
    ...
    d->DMMLNodeComboBox_Segmentation->setSizePolicy(QSizePolicy::Preferred, QSizePolicy::Preferred);
    ...
    d->DMMLNodeComboBox_Segmentation->setSizePolicy(QSizePolicy::Preferred, QSizePolicy::Fixed);
...
//--------------------------------------------------------------------------
bool qDMMLSegmentSelectorWidget::selectNodeUponCreation()const
{
  Q_D(const qDMMLSegmentSelectorWidget);
  return d->DMMLNodeComboBox_Segmentation->selectNodeUponCreation();
}

//--------------------------------------------------------------------------
void qDMMLSegmentSelectorWidget::setSelectNodeUponCreation(bool value)
{
  Q_D(qDMMLSegmentSelectorWidget);
  d->DMMLNodeComboBox_Segmentation->setSelectNodeUponCreation(value);
}
