...
// ----------------------------------------------------------------------------
qDMMLCheckableNodeComboBoxEventPlayer::qDMMLCheckableNodeComboBoxEventPlayer(QObject *parent)
  : pqWidgetEventPlayer(parent)
{
}

// ----------------------------------------------------------------------------
bool qDMMLCheckableNodeComboBoxEventPlayer::playEvent(QObject *Object,
                                    ...
                                    bool &Error)
{
  ...
  qDMMLCheckableNodeComboBox* parent = nullptr;
  for(QObject* test = Object; parent == nullptr && test != nullptr; test = test->parent())
    {
    parent = qobject_cast<qDMMLCheckableNodeComboBox*>(test);
    }
  ...
  if(parent)
    ...
    if(Command == "check_indexes")
      ...
      foreach (QString Arg, Args)
        ...
        vtkDMMLNode* node = parent->nodeFromIndex(value);
