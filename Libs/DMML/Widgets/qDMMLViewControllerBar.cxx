...
//--------------------------------------------------------------------------
// qDMMLViewControllerBarPrivate methods

//---------------------------------------------------------------------------
qDMMLViewControllerBarPrivate::qDMMLViewControllerBarPrivate(
  qDMMLViewControllerBar& object)
  : QObject(nullptr)
  , q_ptr(&object)
{
  ...
  this->LayoutBehavior = qDMMLViewControllerBar::Popup;
}
...
//---------------------------------------------------------------------------
void qDMMLViewControllerBarPrivate::init()
{
  Q_Q(qDMMLViewControllerBar);
  // Widget contains
...
//---------------------------------------------------------------------------
void qDMMLViewControllerBarPrivate::setupPopupUi()
{
...
//---------------------------------------------------------------------------
bool qDMMLViewControllerBarPrivate::eventFilter(QObject* object, QEvent* event)
{
  if (object == this->PinButton && event->type() == QEvent::Enter)
    {
    if (this->LayoutBehavior == qDMMLViewControllerBar::Popup)
      {
...
//---------------------------------------------------------------------------
void qDMMLViewControllerBarPrivate::setColor(QColor barColor)
{
  //Q_Q(qDMMLViewControllerBar);
...
//---------------------------------------------------------------------------
QColor qDMMLViewControllerBarPrivate::color()const
{
  return this->BarColor;
}

// --------------------------------------------------------------------------
// qDMMLViewControllerBar methods

// --------------------------------------------------------------------------
qDMMLViewControllerBar::qDMMLViewControllerBar(QWidget* parentWidget)
  : Superclass(parentWidget)
  , d_ptr(new qDMMLViewControllerBarPrivate(*this))
{
  Q_D(qDMMLViewControllerBar);
  d->init();
}

// --------------------------------------------------------------------------
qDMMLViewControllerBar::qDMMLViewControllerBar(qDMMLViewControllerBarPrivate* pimpl, QWidget* parentWidget)
  : Superclass(parentWidget)
  , d_ptr(pimpl)
{
...
// --------------------------------------------------------------------------
qDMMLViewControllerBar::~qDMMLViewControllerBar() = default;


// --------------------------------------------------------------------------
void qDMMLViewControllerBar::setLayoutBehavior(LayoutBehavior behavior)
{
  Q_D(qDMMLViewControllerBar);
  ...
  if (d->PopupWidget)
    {
    if (behavior == qDMMLViewControllerBar::Popup)
      {
...
// --------------------------------------------------------------------------
QLayout* qDMMLViewControllerBar::barLayout()
{
  Q_D(qDMMLViewControllerBar);
...
// --------------------------------------------------------------------------
QWidget* qDMMLViewControllerBar::barWidget()
{
  Q_D(qDMMLViewControllerBar);
...
// --------------------------------------------------------------------------
QToolButton* qDMMLViewControllerBar::pinButton()
{
  Q_D(qDMMLViewControllerBar);
  return d->PinButton;
}
...
// --------------------------------------------------------------------------
QLabel* qDMMLViewControllerBar::viewLabel()
{
  Q_D(qDMMLViewControllerBar);
  return d->ViewLabel;
}
...
// --------------------------------------------------------------------------
void qDMMLViewControllerBar::maximizeView()
{
  Q_D(qDMMLViewControllerBar);
  ...
  if (this->dmmlViewNode()->GetParentLayoutNode())
    {
    layoutNode = vtkDMMLLayoutNode::SafeDownCast(this->dmmlViewNode()->GetParentLayoutNode());
    if (!layoutNode)
      {
  ...
  if (!layoutNode)
    {
    layoutNode = vtkDMMLLayoutNode::SafeDownCast(this->dmmlScene()->GetFirstNodeByClass("vtkDMMLLayoutNode"));
    }
  if (!layoutNode)
    {
  ...
  if (layoutNode->GetMaximizedViewNode() == this->dmmlViewNode())
    {
    layoutNode->SetMaximizedViewNode(nullptr);
    }
  else
    {
    layoutNode->SetMaximizedViewNode(this->dmmlViewNode());
    }
}

//---------------------------------------------------------------------------
void qDMMLViewControllerBar::setDMMLViewNode(vtkDMMLAbstractViewNode* viewNode)
{
  Q_D(qDMMLViewControllerBar);
  this->qvtkReconnect(d->ViewNode, viewNode, vtkCommand::ModifiedEvent, this, SLOT(updateWidgetFromDMMLView()));
  d->ViewNode = viewNode;
  this->updateWidgetFromDMMLView();
}

//---------------------------------------------------------------------------
vtkDMMLAbstractViewNode* qDMMLViewControllerBar::dmmlViewNode() const
{
  Q_D(const qDMMLViewControllerBar);
  return d->ViewNode;
}

//---------------------------------------------------------------------------
void qDMMLViewControllerBar::updateWidgetFromDMMLView()
{
  Q_D(qDMMLViewControllerBar);
