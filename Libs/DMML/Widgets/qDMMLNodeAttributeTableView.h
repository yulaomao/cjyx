...
#ifndef __qDMMLNodeAttributeTableView_h
#define __qDMMLNodeAttributeTableView_h
...
class vtkDMMLNode;
class qDMMLNodeAttributeTableViewPrivate;
class QTableWidgetItem;
class QItemSelectionModel;

class QDMML_WIDGETS_EXPORT qDMMLNodeAttributeTableView : public QWidget
{
  Q_OBJECT
  QVTK_OBJECT
...
public:
  /// Constructor
  explicit qDMMLNodeAttributeTableView(QWidget* parent = nullptr);
  /// Destructor
  ~qDMMLNodeAttributeTableView() override;

  /// Set the inspected DMML node
  void setInspectedNode(vtkDMMLNode* node);
...
protected:
  QScopedPointer<qDMMLNodeAttributeTableViewPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qDMMLNodeAttributeTableView);
  Q_DISABLE_COPY(qDMMLNodeAttributeTableView);
};
