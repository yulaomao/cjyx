...
//-----------------------------------------------------------------------------
qDMMLWidget::qDMMLWidget(QWidget * _parent, Qt::WindowFlags f):Superclass(_parent, f)
  , d_ptr(new qDMMLWidgetPrivate)
{
}

//-----------------------------------------------------------------------------
qDMMLWidget::~qDMMLWidget() = default;

//-----------------------------------------------------------------------------
void qDMMLWidget::setDMMLScene(vtkDMMLScene* newScene)
{
  Q_D(qDMMLWidget);
...
//-----------------------------------------------------------------------------
vtkDMMLScene* qDMMLWidget::dmmlScene() const
{
  Q_D(const qDMMLWidget);
  return d->DMMLScene;
}

//-----------------------------------------------------------------------------
void qDMMLWidget::preInitializeApplication()
{
#ifdef _WIN32
  ...
  QString openGLProfileStr = qgetenv(DMML_APPLICATION_OPENGL_PROFILE_ENV);
...
//-----------------------------------------------------------------------------
void qDMMLWidget::postInitializeApplication()
{
...
//-----------------------------------------------------------------------------
QPixmap qDMMLWidget::pixmapFromIcon(const QIcon& icon)
{
