...
#ifndef __qDMMLSliceInformationWidget_h
#define __qDMMLSliceInformationWidget_h
...
class qDMMLSliceInformationWidgetPrivate;
class vtkDMMLNode;
class vtkDMMLSliceNode;

class vtkDMMLSliceLogic;

class QDMML_WIDGETS_EXPORT qDMMLSliceInformationWidget : public qDMMLWidget
{
  Q_OBJECT
public:
  /// Superclass typedef
  ...
  /// Constructors
  explicit qDMMLSliceInformationWidget(QWidget* parent = nullptr);
  ~qDMMLSliceInformationWidget() override;

  /// Get \a sliceNode
  /// \sa setDMMLSliceCompositeNode();
  vtkDMMLSliceNode* dmmlSliceNode()const;

public slots:

  /// Set a new SliceNode.
  void setDMMLSliceNode(vtkDMMLNode* newNode);
  ...
  /// \sa vtkDMMLSliceNode::AutomaticSliceSpacingMode vtkDMMLSliceNode::PrescribedSliceSpacingMode
...
protected:
  QScopedPointer<qDMMLSliceInformationWidgetPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qDMMLSliceInformationWidget);
  Q_DISABLE_COPY(qDMMLSliceInformationWidget);
};
