...
// --------------------------------------------------------------------------
qDMMLNodeComboBoxDelegate::qDMMLNodeComboBoxDelegate(QObject* parent,
                                                     QComboBox* comboBox)
...
// --------------------------------------------------------------------------
bool qDMMLNodeComboBoxDelegate::isSeparator(const QModelIndex &index)
{
...
// --------------------------------------------------------------------------
void qDMMLNodeComboBoxDelegate::setSeparator(QAbstractItemModel *model,
...
// --------------------------------------------------------------------------
void qDMMLNodeComboBoxDelegate::paint(QPainter *painter,
...
// --------------------------------------------------------------------------
QSize qDMMLNodeComboBoxDelegate::sizeHint(const QStyleOptionViewItem &option,
                       const QModelIndex &index) const
{
  if (this->isSeparator(index))
    {
...
// --------------------------------------------------------------------------
void qDMMLNodeComboBoxDelegate::drawDisplay(QPainter *painter,
                                            const QStyleOptionViewItem &option,
                                            const QRect &rect,
...
// --------------------------------------------------------------------------
void qDMMLNodeComboBoxDelegate::drawFocus(QPainter *painter,
                                          const QStyleOptionViewItem &option,
