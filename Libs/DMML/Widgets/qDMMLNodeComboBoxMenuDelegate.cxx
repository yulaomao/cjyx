...
// --------------------------------------------------------------------------
qDMMLNodeComboBoxMenuDelegate::qDMMLNodeComboBoxMenuDelegate(QObject* parent,
                                                             QComboBox* comboBox)
...
// --------------------------------------------------------------------------
void qDMMLNodeComboBoxMenuDelegate::paint(QPainter *painter,
...
// --------------------------------------------------------------------------
QSize qDMMLNodeComboBoxMenuDelegate::sizeHint(const QStyleOptionViewItem &option,
                                              const QModelIndex &index) const
{
...
QStyleOptionMenuItem qDMMLNodeComboBoxMenuDelegate::getStyleOption(
    const QStyleOptionViewItem &option, const QModelIndex &index) const
{
    ...
    if (qDMMLNodeComboBoxDelegate::isSeparator(index))
      {
