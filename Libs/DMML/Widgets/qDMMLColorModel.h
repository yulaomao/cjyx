...
#ifndef __qDMMLColorModel_h
#define __qDMMLColorModel_h
...
class qDMMLColorModelPrivate;

//------------------------------------------------------------------------------
class QDMML_WIDGETS_EXPORT qDMMLColorModel : public QStandardItemModel
{
  Q_OBJECT
  QVTK_OBJECT
...
public:
  ...
  qDMMLColorModel(QObject *parent=nullptr);
  ~qDMMLColorModel() override;
  ...
  void setDMMLColorNode(vtkDMMLColorNode* node);
...
protected slots:
  void onDMMLColorNodeModified(vtkObject* node);
  void onItemChanged(QStandardItem * item);

protected:

  qDMMLColorModel(qDMMLColorModelPrivate* pimpl, QObject *parent=nullptr);
...
protected:
  QScopedPointer<qDMMLColorModelPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qDMMLColorModel);
  Q_DISABLE_COPY(qDMMLColorModel);
};

// -----------------------------------------------------------------------------
int qDMMLColorModel::colorFromIndex(const QModelIndex &nodeIndex)const
{
  return this->colorFromItem(this->itemFromIndex(nodeIndex));
}

// -----------------------------------------------------------------------------
QColor qDMMLColorModel::qcolorFromIndex(const QModelIndex &nodeIndex)const
{
  return this->qcolorFromItem(this->itemFromIndex(nodeIndex));
}

// -----------------------------------------------------------------------------
QColor qDMMLColorModel::qcolorFromItem(QStandardItem* nodeItem)const
{
