...
void checkFinalWidgetState(void* data)
  {
  qDMMLColorTableComboBox* widget = reinterpret_cast<qDMMLColorTableComboBox*>(data);
...
//-----------------------------------------------------------------------------
int qDMMLColorTableComboBoxEventTranslatorPlayerTest1(int argc, char * argv [] )
{
  ...
  // Test case 1
  qDMMLColorTableComboBox* widget = new qDMMLColorTableComboBox();
  ...
  etpWidget.addTestCase(widget,
                        xmlDirectory + "qDMMLColorTableComboBoxEventTranslatorPlayerTest1.xml",
