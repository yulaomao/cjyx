...
// ----------------------------------------------------------------------------
int testSingleSelection(qDMMLSegmentSelectorWidget* segmentSelectorWidget)
{
  vtkNew<vtkDMMLScene> scene;

  segmentSelectorWidget->setNoneEnabled(true);
  segmentSelectorWidget->setMultiSelection(false);
  segmentSelectorWidget->setDMMLScene(scene.GetPointer());

  vtkNew<vtkDMMLSegmentationNode> segmentationNode;
  scene->AddNode(segmentationNode);

  QSignalSpy nodeChangedSpy(segmentSelectorWidget, SIGNAL(currentNodeChanged(vtkDMMLNode*)));
...
// ----------------------------------------------------------------------------
int testMultiSelection(qDMMLSegmentSelectorWidget* segmentSelectorWidget)
{
  vtkNew<vtkDMMLScene> scene;
...
int qDMMLSegmentSelectorWidgetTest1( int argc, char * argv [] )
{
  qDMMLWidget::preInitializeApplication();
  QApplication app(argc, argv);
  qDMMLWidget::postInitializeApplication();

  qRegisterMetaType<vtkDMMLNode*>("vtkDMMLNode*");
  ...
  qDMMLSegmentSelectorWidget singleSegmentSelectorWidget;
  ...
  qDMMLSegmentSelectorWidget multiSegmentSelectorWidget;
