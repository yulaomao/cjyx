...
// ----------------------------------------------------------------------------
class qDMMLNodeAttributeTableViewTester: public QObject
{
  Q_OBJECT
  qDMMLNodeAttributeTableView* NodeAttributeTableView;
...
Q_DECLARE_METATYPE(qDMMLNodeAttributeTableViewTester::AttributeType)
Q_DECLARE_METATYPE(QList<qDMMLNodeAttributeTableViewTester::AttributeType>)
Q_DECLARE_METATYPE(qDMMLNodeAttributeTableViewTester::AttributeEmptyType)
Q_DECLARE_METATYPE(QList<qDMMLNodeAttributeTableViewTester::AttributeEmptyType>)

// ----------------------------------------------------------------------------
void qDMMLNodeAttributeTableViewTester::init()
{
  this->NodeAttributeTableView = new qDMMLNodeAttributeTableView;
}

// ----------------------------------------------------------------------------
void qDMMLNodeAttributeTableViewTester::cleanup()
{
...
// ----------------------------------------------------------------------------
void qDMMLNodeAttributeTableViewTester::testDefaults()
{
...
// ----------------------------------------------------------------------------
void qDMMLNodeAttributeTableViewTester::testPopulate()
{
...
// ----------------------------------------------------------------------------
void qDMMLNodeAttributeTableViewTester::testPopulate_data()
{
...
// ----------------------------------------------------------------------------
void qDMMLNodeAttributeTableViewTester::testSetAttribute()
{
  // We may get empty name, in that case error is logged
  TESTING_OUTPUT_IGNORE_WARNINGS_ERRORS_BEGIN();
...
// ----------------------------------------------------------------------------
void qDMMLNodeAttributeTableViewTester::testSetAttribute_data()
{
  // We may get empty name, in that case error is logged
  TESTING_OUTPUT_IGNORE_WARNINGS_ERRORS_BEGIN();
  ...
  for (int setOnNode = 0; setOnNode < 2; ++setOnNode)
    ...
    //   vtkDMMLNode::SetAttribute() makes a difference between 0 and ""
...
// ----------------------------------------------------------------------------
void qDMMLNodeAttributeTableViewTester::testSelect()
{
  // We may get empty name, in that case error is logged
  TESTING_OUTPUT_IGNORE_WARNINGS_ERRORS_BEGIN();
...
// ----------------------------------------------------------------------------
void qDMMLNodeAttributeTableViewTester::testSelect_data()
{
...
// ----------------------------------------------------------------------------
void qDMMLNodeAttributeTableViewTester::testAdd()
{
  // We may get empty name, in that case error is logged
  TESTING_OUTPUT_IGNORE_WARNINGS_ERRORS_BEGIN();
...
// ----------------------------------------------------------------------------
void qDMMLNodeAttributeTableViewTester::testAdd_data()
{
  QTest::addColumn<QList<AttributeType> >("attributes");
  QTest::addColumn<QList<AttributeType> >("expectedAttributes");
...
// ----------------------------------------------------------------------------
void qDMMLNodeAttributeTableViewTester::testRename()
{
  // We may get empty name, in that case error is logged
  TESTING_OUTPUT_IGNORE_WARNINGS_ERRORS_BEGIN();
...
// ----------------------------------------------------------------------------
void qDMMLNodeAttributeTableViewTester::testRename_data()
{
...
// ----------------------------------------------------------------------------
void qDMMLNodeAttributeTableViewTester::testRemove()
{
  // We may get empty name, in that case error is logged
  TESTING_OUTPUT_IGNORE_WARNINGS_ERRORS_BEGIN();
...
// ----------------------------------------------------------------------------
void qDMMLNodeAttributeTableViewTester::testRemove_data()
{
...
// ----------------------------------------------------------------------------
void qDMMLNodeAttributeTableViewTester::testSelectAndAdd()
{
  // We may get empty name, in that case error is logged
  TESTING_OUTPUT_IGNORE_WARNINGS_ERRORS_BEGIN();
...
// ----------------------------------------------------------------------------
void qDMMLNodeAttributeTableViewTester::testSelectAndAdd_data()
{
  QTest::addColumn<QList<AttributeType> >("attributes");
  QTest::addColumn<QList<int> >("rangeToSelect"); // top, left, bottom, right
  QTest::addColumn<QList<AttributeType> >("expectedAttributes");
...
// ----------------------------------------------------------------------------
CTK_TEST_MAIN(qDMMLNodeAttributeTableViewTest)
#include "moc_qDMMLNodeAttributeTableViewTest.cxx"
