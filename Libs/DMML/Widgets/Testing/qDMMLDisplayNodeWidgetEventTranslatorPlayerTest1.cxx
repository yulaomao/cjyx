...
void checkFinalWidgetState(void* data)
  {
  qDMMLDisplayNodeWidget* widget = reinterpret_cast<qDMMLDisplayNodeWidget*>(data);
...
//-----------------------------------------------------------------------------
int qDMMLDisplayNodeWidgetEventTranslatorPlayerTest1(int argc, char * argv [] )
{
  ...
  // Test case 1
  qDMMLDisplayNodeWidget* widget = new qDMMLDisplayNodeWidget();

  vtkSmartPointer< vtkDMMLModelDisplayNode > displayNode =
    vtkSmartPointer< vtkDMMLModelDisplayNode >::New();

  widget->setDMMLDisplayNode(displayNode);

  etpWidget.addTestCase(widget,
                        xmlDirectory + "qDMMLDisplayNodeWidgetEventTranslatorPlayerTest1.xml",
