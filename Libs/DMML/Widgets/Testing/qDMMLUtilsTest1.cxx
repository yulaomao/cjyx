...
int qDMMLUtilsTest1( int argc, char * argv [] )
{
  ...
  double color2[3];
  qDMMLUtils::colorToQColor(nullptr, qcolor1);
  qDMMLUtils::qColorToColor(qcolor1, nullptr);
  qDMMLUtils::colorToQColor(color1, qcolor2);
  ...
  qDMMLUtils::qColorToColor(qcolor1, color2);
