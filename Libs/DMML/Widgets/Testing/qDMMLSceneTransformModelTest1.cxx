...
int qDMMLSceneTransformModelTest1(int argc, char * argv [])
{
  qDMMLWidget::preInitializeApplication();
  QApplication app(argc, argv);
  qDMMLWidget::postInitializeApplication();

  qDMMLSceneTransformModel model;
  ...
  try
    ...
    vtkDMMLNode* node1 = sceneFactory.generateNode("vtkDMMLLinearTransformNode");
    vtkDMMLNode* node2 = sceneFactory.generateNode("vtkDMMLLinearTransformNode");
  ...
  */
  ...
  qDMMLTreeView* treeWidget = new qDMMLTreeView;
  treeWidget->setWindowTitle("qDMMLTreeView");
  treeWidget->setDMMLScene(sceneFactory.dmmlScene());
  ...
  QTreeView view2;
  view2.setWindowTitle("qDMMLSortFilterProxyModel");
