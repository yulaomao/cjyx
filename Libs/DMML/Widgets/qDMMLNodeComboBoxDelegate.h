...
#ifndef __qDMMLNodeComboBoxDelegate_h
#define __qDMMLNodeComboBoxDelegate_h
...
class QDMML_WIDGETS_EXPORT qDMMLNodeComboBoxDelegate : public QItemDelegate
{
  Q_OBJECT
public :
  typedef QItemDelegate Superclass;
  qDMMLNodeComboBoxDelegate(QObject* parent, QComboBox* comboBox);
...
private:
  QComboBox* mCombo;
  Q_DISABLE_COPY(qDMMLNodeComboBoxDelegate);
};

#endif // __qDMMLNodeComboBoxDelegate_h
