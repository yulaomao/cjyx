...
#ifndef __qDMMLSliceControllerWidget_h
#define __qDMMLSliceControllerWidget_h
...
class QButtonGroup;
class QToolButton;
class qDMMLSliceControllerWidgetPrivate;
...
/// qDMMLSliceControllerWidget offers controls to a slice view (vtkDMMLSliceNode
///  and vtkDMMLSliceCompositeNode). It internally creates a slice logic that
/// can be changed.
///
/// To be valid, it needs at least a DMML scene and a DMML slice node:
/// \code
/// qDMMLSliceControllerWidget controllerWidget;
/// controllerWidget.setSliceViewName("Red");
/// controllerWidget.setSliceViewLabel("R");
/// controllerWidget.setSliceViewColor(Qt::red);
/// controllerWidget.setDMMLScene(scene);
/// controllerWidget.setDMMLSliceNode(sliceNode);
/// \endcode
class QDMML_WIDGETS_EXPORT qDMMLSliceControllerWidget
...
public:
  ...
  /// Constructors
  explicit qDMMLSliceControllerWidget(QWidget* parent = nullptr);
  ~qDMMLSliceControllerWidget() override;
  ...
  /// This is equivalent to call vtkDMMLSliceNode::SetLayoutLabel()
  /// If no SliceNode is set, this is a no-op.
  /// \sa setDMMLSliceNode(), vtkDMMLSliceNode::SetLayoutLabel()
  void setSliceViewLabel(const QString& newSliceViewLabel);

  /// Get the abbreviated slice view name.
  /// \sa setSliceViewLabel(), vtkDMMLSliceNode::GetLayoutLabel()
  ...
  Q_INVOKABLE void setSliceLogic(vtkDMMLSliceLogic * newSliceLogic);
  ...
  Q_INVOKABLE qDMMLSliderWidget* sliceOffsetSlider();
...
protected:
  ...
  qDMMLSliceControllerWidget(qDMMLSliceControllerWidgetPrivate* obj,
                             QWidget* parent);

private:
  Q_DECLARE_PRIVATE(qDMMLSliceControllerWidget);
  Q_DISABLE_COPY(qDMMLSliceControllerWidget);
};
