...
#ifndef __qDMMLCoordinatesWidget_h
#define __qDMMLCoordinatesWidget_h
...
///
/// \sa qDMMLSliderWidget, qDMMLSpinBox
class QDMML_WIDGETS_EXPORT qDMMLCoordinatesWidget : public ctkCoordinatesWidget
{
  Q_OBJECT
  QVTK_OBJECT
...
public:
  ...
  explicit qDMMLCoordinatesWidget(QWidget* parent = nullptr);
  ~qDMMLCoordinatesWidget() override;
...
protected:
  QScopedPointer<qDMMLCoordinatesWidgetPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qDMMLCoordinatesWidget);
  Q_DISABLE_COPY(qDMMLCoordinatesWidget);
};

Q_DECLARE_OPERATORS_FOR_FLAGS(qDMMLCoordinatesWidget::UnitAwareProperties)
