...
#ifndef __vtkDMMLCommandLineModuleNode_h
#define __vtkDMMLCommandLineModuleNode_h

/// DMML includes
#include <vtkDMMLNode.h>

#include "vtkDMMLCLIExport.h"

class ModuleDescription;

/// \brief DMML node for representing the parameters allowing to run a command
...
class VTK_DMML_CLI_EXPORT vtkDMMLCommandLineModuleNode : public vtkDMMLNode
{
public:
  static vtkDMMLCommandLineModuleNode *New();
  vtkTypeMacro(vtkDMMLCommandLineModuleNode, vtkDMMLNode);
  ...
  vtkDMMLCopyContentMacro(vtkDMMLCommandLineModuleNode);
  ...
  bool SetParameterAsNode(const char* name, vtkDMMLNode* value);
...
protected:
  void AbortProcess();
  void ProcessDMMLEvents(vtkObject *caller, unsigned long event,
                                 void *callData) override;

private:
  vtkDMMLCommandLineModuleNode();
  ~vtkDMMLCommandLineModuleNode() override;
  vtkDMMLCommandLineModuleNode(const vtkDMMLCommandLineModuleNode&) = delete;
  void operator=(const vtkDMMLCommandLineModuleNode&) = delete;
