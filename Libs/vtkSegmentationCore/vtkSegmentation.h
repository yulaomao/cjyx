...
///     * Additional representations can be defined (CjyxRT adds two: Planar contour, Ribbon model)
...
public:
  ...
  /// Write this object's information to a DMML file in XML format.
...
protected:
  ...
  friend class vtkDMMLSegmentationNode;
  friend class vtkCjyxSegmentationsModuleLogic;
  friend class vtkSegmentationModifier;
  friend class qDMMLSegmentEditorWidgetPrivate;
