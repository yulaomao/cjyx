...
vtkSegment::vtkSegment()
{
  ...
  // Set default terminology Tissue/Tissue from the default Cjyx terminology dictionary
  this->SetTag( vtkSegment::GetTerminologyEntryTagName(),
    "Segmentation category and type - 3D Cjyx General Anatomy list~SCT^85756007^Tissue~SCT^85756007^Tissue~^^~Anatomic codes - DICOM master list~^^~^^");
}
