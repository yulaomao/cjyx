...
class SegmentStatisticsSubjectHierarchyPlugin(AbstractScriptedSubjectHierarchyPlugin):
    """ Scripted subject hierarchy plugin for the Segment Statistics module.
        ...
        qCjyxSubjectHierarchyAbstractPlugin is satisfactory) can simply be
    ...
    def canAddNodeToSubjectHierarchy(self, node, parentItemID):
        ...
        # if node is not None and node.IsA("vtkDMMLMyNode"):
        #   return 1.0
        return 0.0
    ...
    def canOwnSubjectHierarchyItem(self, itemID):
        ...
        # if associatedNode is not None and associatedNode.IsA("vtkDMMLMyNode")
        #   return 1.0
        return 0.0
    ...
    def onCalculateStatistics(self):
        ...
        statisticsWidget = cjyx.modules.segmentstatistics.widgetRepresentation().self()
        statisticsWidget.segmentationSelector.setCurrentNode(segmentationNode)

        # Get master volume from segmentation
        masterVolume = segmentationNode.GetNodeReference(cjyx.vtkDMMLSegmentationNode.GetReferenceImageGeometryReferenceRole())
