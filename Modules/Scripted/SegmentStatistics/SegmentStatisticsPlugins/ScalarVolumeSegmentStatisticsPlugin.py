...
class ScalarVolumeSegmentStatisticsPlugin(SegmentStatisticsPluginBase):
    ...
    def computeStatistics(self, segmentID):
        ...
        grayscaleNode = cjyx.dmmlScene.GetNodeByID(self.getParameterNode().GetParameter("ScalarVolume"))
    ...
    def getStencilForVolume(self, segmentationNode, segmentID, grayscaleNode):
        ...
        cjyx.vtkDMMLTransformNode.GetTransformBetweenNodes(segmentationNode.GetParentTransformNode(),
    ...
    def getMeasurementInfo(self, key):
        ...
        scalarVolumeNode = cjyx.dmmlScene.GetNodeByID(self.getParameterNode().GetParameter("ScalarVolume"))
