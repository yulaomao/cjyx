...
class DICOMRecentActivityWidget(qt.QWidget):
    """Display the recent activity of the cjyx DICOM database
       Example:
         cjyx.util.selectModule('DICOM')
         import DICOMLib
         w = DICOMLib.DICOMRecentActivityWidget(None, cjyx.dicomDatabase, cjyx.modules.DICOMInstance.browserWidget)
         w.update()
         w.show()
    """

    def __init__(self, parent, dicomDatabase=None, browserWidget=None):
        """If browserWidget is specified (e.g., set to cjyx.modules.DICOMInstance.browserWidget)
        ...
        if dicomDatabase:
            ...
            self.dicomDatabase = cjyx.dicomDatabase
    ...
    def update(self):
        ...
        if len(self.recentSeries) > 0:
            ...
            cjyx.util.showStatusMessage(statusMessage, 10000)
