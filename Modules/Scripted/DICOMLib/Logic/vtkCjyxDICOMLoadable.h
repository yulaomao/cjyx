...
#ifndef __vtkCjyxDICOMLoadable_h
#define __vtkCjyxDICOMLoadable_h
...
class VTK_CJYX_DICOMLIB_MODULE_LOGIC_EXPORT vtkCjyxDICOMLoadable : public vtkObject
{
public:
  static vtkCjyxDICOMLoadable *New();
  vtkTypeMacro(vtkCjyxDICOMLoadable, vtkObject);
...
protected:
  vtkCjyxDICOMLoadable();
  ~vtkCjyxDICOMLoadable() override;
  vtkCjyxDICOMLoadable(const vtkCjyxDICOMLoadable&);
  void operator=(const vtkCjyxDICOMLoadable&);
