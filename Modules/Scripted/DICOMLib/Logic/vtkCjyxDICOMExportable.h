...
#ifndef __vtkCjyxDICOMExportable_h
#define __vtkCjyxDICOMExportable_h
...
#include "vtkCjyxDICOMLibModuleLogicExport.h"

/// VTK implementation of \sa qCjyxDICOMExportable
class VTK_CJYX_DICOMLIB_MODULE_LOGIC_EXPORT vtkCjyxDICOMExportable : public vtkObject
{
public:
  static vtkCjyxDICOMExportable *New();
  vtkTypeMacro(vtkCjyxDICOMExportable, vtkObject);
...
protected:
  vtkCjyxDICOMExportable();
  ~vtkCjyxDICOMExportable() override;
  vtkCjyxDICOMExportable(const vtkCjyxDICOMExportable&);
  void operator=(const vtkCjyxDICOMExportable&);
