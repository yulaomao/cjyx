...
//------------------------------------------------------------------------------
vtkStandardNewMacro(vtkCjyxDICOMExportable);

//----------------------------------------------------------------------------
vtkCjyxDICOMExportable::vtkCjyxDICOMExportable()
{
  this->Name = nullptr;
  this->SetName("Unknown exporter");
  this->Tooltip = nullptr;
  this->SetTooltip("Creates a DICOM file from the selected data");
  this->SubjectHierarchyItemID = vtkDMMLSubjectHierarchyNode::INVALID_ITEM_ID;
...
//----------------------------------------------------------------------------
vtkCjyxDICOMExportable::~vtkCjyxDICOMExportable() = default;

//----------------------------------------------------------------------------
void vtkCjyxDICOMExportable::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
const char* vtkCjyxDICOMExportable::GetTag(std::string tagName)
{
  return this->Tags[tagName].c_str();
}

//----------------------------------------------------------------------------
void vtkCjyxDICOMExportable::SetTag(std::string tagName, std::string tagValue)
{
