...
//-----------------------------------------------------------------------------
class qCjyxDICOMLoadablePrivate
{
public:
  qCjyxDICOMLoadablePrivate();
  virtual ~qCjyxDICOMLoadablePrivate();
...
//-----------------------------------------------------------------------------
// qCjyxDICOMLoadablePrivate methods

//-----------------------------------------------------------------------------
qCjyxDICOMLoadablePrivate::qCjyxDICOMLoadablePrivate()
{
...
//-----------------------------------------------------------------------------
qCjyxDICOMLoadablePrivate::~qCjyxDICOMLoadablePrivate() = default;


//-----------------------------------------------------------------------------
// qCjyxDICOMLoadable methods

//-----------------------------------------------------------------------------
qCjyxDICOMLoadable::qCjyxDICOMLoadable(QObject* parentObject)
  : Superclass(parentObject)
  , d_ptr(new qCjyxDICOMLoadablePrivate)
{
}

//-----------------------------------------------------------------------------
qCjyxDICOMLoadable::~qCjyxDICOMLoadable() = default;

//-----------------------------------------------------------------------------
CTK_SET_CPP(qCjyxDICOMLoadable, const QString&, setName, Name)
CTK_GET_CPP(qCjyxDICOMLoadable, QString, name, Name)

//-----------------------------------------------------------------------------
CTK_SET_CPP(qCjyxDICOMLoadable, const QString&, setTooltip, Tooltip)
CTK_GET_CPP(qCjyxDICOMLoadable, QString, tooltip, Tooltip)

//-----------------------------------------------------------------------------
CTK_SET_CPP(qCjyxDICOMLoadable, const QString&, setWarning, Warning)
CTK_GET_CPP(qCjyxDICOMLoadable, QString, warning, Warning)

//-----------------------------------------------------------------------------
CTK_SET_CPP(qCjyxDICOMLoadable, const QStringList&, setFiles, Files)
CTK_GET_CPP(qCjyxDICOMLoadable, QStringList, files, Files)

//-----------------------------------------------------------------------------
CTK_SET_CPP(qCjyxDICOMLoadable, const bool, setSelected, Selected)
CTK_GET_CPP(qCjyxDICOMLoadable, bool, selected, Selected)

//-----------------------------------------------------------------------------
CTK_SET_CPP(qCjyxDICOMLoadable, const double, setConfidence, Confidence)
CTK_GET_CPP(qCjyxDICOMLoadable, double, confidence, Confidence)

//-----------------------------------------------------------------------------
CTK_SET_CPP(qCjyxDICOMLoadable, const QStringList&, setReferencedInstanceUIDs, ReferencedInstanceUIDs)
CTK_GET_CPP(qCjyxDICOMLoadable, QStringList, referencedInstanceUIDs, ReferencedInstanceUIDs)

//-----------------------------------------------------------------------------
void qCjyxDICOMLoadable::copyToVtkLoadable(vtkCjyxDICOMLoadable* vtkLoadable)
{
  Q_D(qCjyxDICOMLoadable);
...
//-----------------------------------------------------------------------------
void qCjyxDICOMLoadable::copyFromVtkLoadable(vtkCjyxDICOMLoadable* vtkLoadable)
{
  Q_D(qCjyxDICOMLoadable);
