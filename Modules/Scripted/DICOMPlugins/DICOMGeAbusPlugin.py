...
class DICOMGeAbusPluginClass(DICOMPlugin):
    ...
    def examineFiles(self, files):
        ...
        for filePath in files:
            ...
            try:
                ...
                manufacturerModelName = cjyx.dicomDatabase.fileValue(filePath, self.tags['manufacturerModelName'])
    ...
    def load(self, loadable):
        ...
        volumeNode = cjyx.dmmlScene.AddNewNodeByClass("vtkDMMLScalarVolumeNode", cjyx.dmmlScene.GenerateUniqueName(loadable.name))
...
class DICOMGeAbusPlugin:
    ...
    """
        ...
        try:
            ...
            cjyx.modules.dicomPlugins = {}
        cjyx.modules.dicomPlugins['DICOMGeAbusPlugin'] = DICOMGeAbusPluginClass
