...
class DICOMEnhancedUSVolumePluginClass(DICOMPlugin):
    ...
    def load(self, loadable):
        ...
        if loadable.grayscale:
            volumeNode = cjyx.dmmlScene.AddNewNodeByClass("vtkDMMLScalarVolumeNode", loadable.name)
        else:
            volumeNode = cjyx.dmmlScene.AddNewNodeByClass("vtkDMMLVectorVolumeNode", loadable.name)
...
class DICOMEnhancedUSVolumePlugin:
    ...
    """
        ...
        try:
            ...
            cjyx.modules.dicomPlugins = {}
        cjyx.modules.dicomPlugins['DICOMEnhancedUSVolumePlugin'] = DICOMEnhancedUSVolumePluginClass
