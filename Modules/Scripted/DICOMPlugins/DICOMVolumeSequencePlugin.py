...
class DICOMVolumeSequencePluginClass(DICOMPlugin):
    ...
    def getSequenceBrowserNodeForMasterOutputNode(self, masterOutputNode):
        browserNodes = cjyx.dmmlScene.GetNodesByClass('vtkDMMLSequenceBrowserNode')
    ...
    def examineForExport(self, subjectHierarchyItemID):
        ...
        createDicomSeriesParameterNode = cjyx.modules.createdicomseries.cliModuleLogic().CreateNode()
        ...
        if not dicomUIDSettingSupported:
            # This version of Cjyx does not allow setting DICOM UIDs for export
            return []
...
class DICOMVolumeSequencePlugin:
    ...
    """
        ...
        try:
            ...
            cjyx.modules.dicomPlugins = {}
        cjyx.modules.dicomPlugins['DICOMVolumeSequencePlugin'] = DICOMVolumeSequencePluginClass
