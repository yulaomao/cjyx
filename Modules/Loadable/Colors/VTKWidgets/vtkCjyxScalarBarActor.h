...
///  vtkCjyxScalarBarActor - cjyx vtk class for adding color names in scalar bar
///
/// This class enhances the vtkScalarBarActor class by adding color names
/// in the label display.

#ifndef __vtkCjyxScalarBarActor_h
#define __vtkCjyxScalarBarActor_h
...
// DMMLLogic includes
#include "vtkCjyxColorsModuleVTKWidgetsExport.h"

/// \ingroup CjyxRt_QtModules_Isodose
class VTK_CJYX_COLORS_VTKWIDGETS_EXPORT vtkCjyxScalarBarActor
  : public vtkScalarBarActor
{
public:
  // The usual VTK class functions
  static vtkCjyxScalarBarActor *New();
  vtkTypeMacro(vtkCjyxScalarBarActor,vtkScalarBarActor);
...
protected:
  vtkCjyxScalarBarActor();
  ~vtkCjyxScalarBarActor() override;
...
private:
  vtkCjyxScalarBarActor(const vtkCjyxScalarBarActor&) = delete;
  void operator=(const vtkCjyxScalarBarActor&) = delete;
};
