...
///  vtkCjyxColorLogic - cjyx logic class for color manipulation
///
/// This class manages the logic associated with reading, saving,
/// and changing propertied of the colors

#ifndef __vtkCjyxColorLogic_h
#define __vtkCjyxColorLogic_h

// DMMLLogic includes
#include <vtkDMMLColorLogic.h>
#include "vtkCjyxColorsModuleLogicExport.h"

class vtkDMMLColorLegendDisplayNode;
class vtkDMMLDisplayableNode;
class vtkDMMLDisplayNode;

class VTK_CJYX_COLORS_MODULE_LOGIC_EXPORT vtkCjyxColorLogic
  : public vtkDMMLColorLogic
{
public:

  /// The Usual vtk class functions
  static vtkCjyxColorLogic *New();
  vtkTypeMacro(vtkCjyxColorLogic,vtkDMMLColorLogic);
  ...
  static vtkDMMLColorLegendDisplayNode* AddDefaultColorLegendDisplayNode(vtkDMMLDisplayableNode* displayableNode);
  ...
  /// @return the newly created (or already existing) color legend display node. Nullptr in case of an error.
  static vtkDMMLColorLegendDisplayNode* AddDefaultColorLegendDisplayNode(vtkDMMLDisplayNode* displayNode);
  ...
  static vtkDMMLColorLegendDisplayNode* GetNthColorLegendDisplayNode(vtkDMMLDisplayableNode* displayableNode, int n);

  /// Return number of color legend display nodes.
  /// \sa GetNthColorLegendDisplayNode
  static int GetNumberOfColorLegendDisplayNodes(vtkDMMLDisplayableNode* displayableNode);
  ...
  static vtkDMMLColorLegendDisplayNode* GetColorLegendDisplayNode(vtkDMMLDisplayableNode* displayableNode);
  ...
  static vtkDMMLColorLegendDisplayNode* GetColorLegendDisplayNode(vtkDMMLDisplayNode* displayNode);

protected:
  vtkCjyxColorLogic();
  ~vtkCjyxColorLogic() override;
  vtkCjyxColorLogic(const vtkCjyxColorLogic&);
  void operator=(const vtkCjyxColorLogic&);

  static vtkDMMLDisplayNode* GetFirstNonColorLegendDisplayNode(vtkDMMLDisplayableNode* displayableNode);
