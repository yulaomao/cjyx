...
// ----------------------------------------------------------------------------
class qCjyxPresetComboBoxTester: public QObject
{
  Q_OBJECT
...
// ----------------------------------------------------------------------------
void qCjyxPresetComboBoxTester::testSetScene()
{
  qCjyxPresetComboBox presetComboBox;
  QCOMPARE(presetComboBox.nodeCount() , 0);

  vtkNew<vtkDMMLScene> scene;
  presetComboBox.setDMMLScene(scene.GetPointer());
  QCOMPARE(presetComboBox.nodeCount() , 0);
...
// ----------------------------------------------------------------------------
void qCjyxPresetComboBoxTester::testAddPresetNode()
{
  qCjyxPresetComboBox presetComboBox;
  ...
  vtkNew<vtkDMMLVolumePropertyNode> presetNode;
...
// ----------------------------------------------------------------------------
void qCjyxPresetComboBoxTester::testPreview()
{
  vtkNew<vtkColorTransferFunction> colorFunction;
...
// ----------------------------------------------------------------------------
CTK_TEST_MAIN(qCjyxPresetComboBoxTest)
#include "moc_qCjyxPresetComboBoxTest.cxx"
