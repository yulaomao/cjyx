...
//---------------------------------------------------------------------------
void BuildShaderProperty( vtkDMMLShaderPropertyNode * psNode );
int TestReadWriteData(vtkDMMLScene* scene, const char *extension, vtkDMMLShaderPropertyNode* sp );

int vtkDMMLShaderPropertyStorageNodeTest1(int argc, char * argv[])
{
  if (argc != 2)
    {
  ...
  // Test basic methods
  vtkNew<vtkDMMLShaderPropertyStorageNode> node1;
...
//---------------------------------------------------------------------------
void BuildShaderProperty( vtkDMMLShaderPropertyNode * spNode )
{
...
//---------------------------------------------------------------------------
int CompareShaderProperty( vtkDMMLShaderPropertyNode * n1, vtkDMMLShaderPropertyNode * n2 )
{
...
//---------------------------------------------------------------------------
int TestReadWriteData(vtkDMMLScene* scene, const char *extension, vtkDMMLShaderPropertyNode* spNode )
{
  std::string fileName = std::string(scene->GetRootDirectory()) +
    std::string("/vtkDMMLShaderPropertyStorageNodeTest1") +
    std::string(extension);

  vtksys::SystemTools::RemoveFile(fileName);

  // Add storage node
  vtkNew<vtkDMMLShaderPropertyStorageNode> storageNode;
  ...
  // Test reading
  vtkNew<vtkDMMLShaderPropertyNode> spNodeRead;
