/// vtkDMMLVolumePropertyNode - DMML node to represent volume rendering
/// information.
/// This node is especially used to store visualization parameter sets for
/// volume rendering

#ifndef __vtkDMMLVolumePropertyNode_h
#define __vtkDMMLVolumePropertyNode_h
...
/// \brief vtkDMMLVolumePropertyNode contains the transfer functions (scalar
/// opacity, color and gradient opacity) for the volume rendering.
class VTK_CJYX_VOLUMERENDERING_MODULE_DMML_EXPORT vtkDMMLVolumePropertyNode
...
public:
  ...
  /// Create a new vtkDMMLVolumePropertyNode
  static vtkDMMLVolumePropertyNode *New();
  vtkTypeMacro(vtkDMMLVolumePropertyNode,vtkDMMLStorableNode);
...
protected:
  ...
  ~vtkDMMLVolumePropertyNode() override;
...
private:
  ...
  vtkDMMLVolumePropertyNode(const vtkDMMLVolumePropertyNode&) = delete;
  void operator=(const vtkDMMLVolumePropertyNode&) = delete;

};

//---------------------------------------------------------------------------
void vtkDMMLVolumePropertyNode
::GetPiecewiseFunctionFromString(const char *str,
                                 vtkPiecewiseFunction* result)
{
  vtkDMMLVolumePropertyNode::GetPiecewiseFunctionFromString(
...
::GetColorTransferFunctionFromString(const char *str,
                                     vtkColorTransferFunction* result)
{
  vtkDMMLVolumePropertyNode::GetColorTransferFunctionFromString(
    std::string (str), result);
}
