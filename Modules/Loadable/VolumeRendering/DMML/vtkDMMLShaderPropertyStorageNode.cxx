...
//----------------------------------------------------------------------------
vtkDMMLNodeNewMacro(vtkDMMLShaderPropertyStorageNode);

//----------------------------------------------------------------------------
vtkDMMLShaderPropertyStorageNode::vtkDMMLShaderPropertyStorageNode()
{
  this->DefaultWriteFileExtension = "sp";
}

//----------------------------------------------------------------------------
vtkDMMLShaderPropertyStorageNode::~vtkDMMLShaderPropertyStorageNode() = default;

//----------------------------------------------------------------------------
void vtkDMMLShaderPropertyStorageNode::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os,indent);
}

//----------------------------------------------------------------------------
bool vtkDMMLShaderPropertyStorageNode::CanReadInReferenceNode(vtkDMMLNode *refNode)
{
  return refNode->IsA("vtkDMMLShaderPropertyNode");
}
...
//----------------------------------------------------------------------------
int vtkDMMLShaderPropertyStorageNode::ReadDataInternal(vtkDMMLNode *refNode)
{
  vtkDMMLShaderPropertyNode *spNode =
    vtkDMMLShaderPropertyNode::SafeDownCast(refNode);
...
//----------------------------------------------------------------------------
int vtkDMMLShaderPropertyStorageNode::WriteDataInternal(vtkDMMLNode *refNode)
{
  vtkDMMLShaderPropertyNode *spNode = vtkDMMLShaderPropertyNode::SafeDownCast(refNode);

  std::string fullName =  this->GetFullNameFromFileName();
  if (fullName.empty())
    {
    vtkErrorMacro("vtkDMMLShaderPropertyStorageNode: File name not specified");
    return 0;
    }
...
//----------------------------------------------------------------------------
void vtkDMMLShaderPropertyStorageNode::InitializeSupportedReadFileTypes()
{
  this->SupportedReadFileTypes->InsertNextValue("Shader Property (.sp)");
}

//----------------------------------------------------------------------------
void vtkDMMLShaderPropertyStorageNode::InitializeSupportedWriteFileTypes()
{
