...
class AnnotationsSubjectHierarchyPlugin(AbstractScriptedSubjectHierarchyPlugin):
    ...
    def canAddNodeToSubjectHierarchy(self, node, parentItemID):
        if node is not None:
            if node.IsA("vtkDMMLAnnotationROINode") or node.IsA("vtkDMMLAnnotationRulerNode"):
                return 1.0
        return 0.0
    ...
    def canOwnSubjectHierarchyItem(self, itemID):
        ...
        if associatedNode is not None:
            if associatedNode.IsA("vtkDMMLAnnotationROINode") or associatedNode.IsA("vtkDMMLAnnotationRulerNode"):
                return 1.0
        return 0.0
    ...
    def icon(self, itemID):
        ...
        if associatedNode is not None:
            # ROI
            if associatedNode.IsA("vtkDMMLAnnotationROINode"):
            ...
            # Ruler
            if associatedNode.IsA("vtkDMMLAnnotationRulerNode"):
