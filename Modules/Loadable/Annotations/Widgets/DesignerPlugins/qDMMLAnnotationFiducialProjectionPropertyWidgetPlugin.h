...
#ifndef __qDMMLAnnotationFiducialProjectionPropertyWidgetPlugin_h
#define __qDMMLAnnotationFiducialProjectionPropertyWidgetPlugin_h
...
public:
  qDMMLAnnotationFiducialProjectionPropertyWidgetPlugin(QObject *_parent = nullptr);
