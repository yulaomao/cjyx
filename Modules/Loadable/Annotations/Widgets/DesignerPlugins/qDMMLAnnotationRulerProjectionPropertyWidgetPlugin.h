...
#ifndef __qDMMLAnnotationRulerProjectionPropertyWidgetPlugin_h
#define __qDMMLAnnotationRulerProjectionPropertyWidgetPlugin_h
...
public:
  qDMMLAnnotationRulerProjectionPropertyWidgetPlugin(QObject *_parent = nullptr);
