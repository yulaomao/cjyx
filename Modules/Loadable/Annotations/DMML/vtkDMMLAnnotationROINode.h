#ifndef __vtkDMMLAnnotationROINode_h
#define __vtkDMMLAnnotationROINode_h
...
class  VTK_CJYX_ANNOTATIONS_MODULE_DMML_EXPORT vtkDMMLAnnotationROINode
  : public vtkDMMLAnnotationLinesNode
{
public:
  static vtkDMMLAnnotationROINode *New();
  vtkTypeMacro(vtkDMMLAnnotationROINode,vtkDMMLAnnotationLinesNode);
  /// Description:
  ...
  vtkDMMLCopyContentMacro(vtkDMMLAnnotationROINode);
...
protected:
  vtkDMMLAnnotationROINode();
  ~vtkDMMLAnnotationROINode() override;
  vtkDMMLAnnotationROINode(const vtkDMMLAnnotationROINode&);
  void operator=(const vtkDMMLAnnotationROINode&);
