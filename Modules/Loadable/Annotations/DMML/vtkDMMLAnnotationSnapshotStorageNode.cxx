/*=auto=========================================================================
  ...
  Program:   3D Cjyx
  Module:    $RCSfile: vtkDMMLAnnotationSnapshotStorageNode.cxx,v $
...
//----------------------------------------------------------------------------
vtkDMMLNodeNewMacro(vtkDMMLAnnotationSnapshotStorageNode);

//----------------------------------------------------------------------------
vtkDMMLAnnotationSnapshotStorageNode::vtkDMMLAnnotationSnapshotStorageNode()
{
  this->DefaultWriteFileExtension = "png";
}

//----------------------------------------------------------------------------
vtkDMMLAnnotationSnapshotStorageNode::~vtkDMMLAnnotationSnapshotStorageNode() = default;

//----------------------------------------------------------------------------
void vtkDMMLAnnotationSnapshotStorageNode::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os,indent);
}

//----------------------------------------------------------------------------
bool vtkDMMLAnnotationSnapshotStorageNode::CanReadInReferenceNode(vtkDMMLNode *refNode)
{
  return refNode->IsA("vtkDMMLAnnotationSnapshotNode");
}

//----------------------------------------------------------------------------
int vtkDMMLAnnotationSnapshotStorageNode::ReadDataInternal(vtkDMMLNode *refNode)
{
  vtkDMMLAnnotationSnapshotNode *sceneViewNode =
    vtkDMMLAnnotationSnapshotNode::SafeDownCast(refNode);
...
//----------------------------------------------------------------------------
int vtkDMMLAnnotationSnapshotStorageNode::WriteDataInternal(vtkDMMLNode *refNode)
{
  vtkDMMLAnnotationSnapshotNode *sceneViewNode = vtkDMMLAnnotationSnapshotNode::SafeDownCast(refNode);
  ...
  if (fullName.empty())
  {
    vtkErrorMacro("vtkDMMLAnnotationSnapshotNode: File name not specified");
    return 0;
  }
...
//----------------------------------------------------------------------------
void vtkDMMLAnnotationSnapshotStorageNode::InitializeSupportedReadFileTypes()
{
...
//----------------------------------------------------------------------------
void vtkDMMLAnnotationSnapshotStorageNode::InitializeSupportedWriteFileTypes()
{
