// .NAME vtkDMMLAnnotationTextDisplayNode - DMML node to represent display properties for tractography.
// .SECTION Description
// vtkDMMLAnnotationTextDisplayNode nodes store display properties of trajectories
// from tractography in diffusion MRI data, including color type (by bundle, by fiber,
// or by scalar invariants), display on/off for tensor glyphs and display of
// trajectory as a line or tube.
//

#ifndef __vtkDMMLAnnotationTextDisplayNode_h
#define __vtkDMMLAnnotationTextDisplayNode_h
...
class  VTK_CJYX_ANNOTATIONS_MODULE_DMML_EXPORT vtkDMMLAnnotationTextDisplayNode : public vtkDMMLAnnotationDisplayNode
{
 public:
  static vtkDMMLAnnotationTextDisplayNode *New (  );
  vtkTypeMacro ( vtkDMMLAnnotationTextDisplayNode,vtkDMMLAnnotationDisplayNode );
...
protected:
  ...
  ~vtkDMMLAnnotationTextDisplayNode() override  = default;
  vtkDMMLAnnotationTextDisplayNode( const vtkDMMLAnnotationTextDisplayNode& );
  void operator= ( const vtkDMMLAnnotationTextDisplayNode& );
