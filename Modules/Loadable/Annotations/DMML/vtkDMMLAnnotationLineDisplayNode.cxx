...
//----------------------------------------------------------------------------
vtkDMMLNodeNewMacro(vtkDMMLAnnotationLineDisplayNode);

//----------------------------------------------------------------------------
vtkDMMLAnnotationLineDisplayNode::vtkDMMLAnnotationLineDisplayNode()
{
...
//----------------------------------------------------------------------------
void vtkDMMLAnnotationLineDisplayNode::WriteXML(ostream& of, int nIndent)
{
...
//----------------------------------------------------------------------------
void vtkDMMLAnnotationLineDisplayNode::ReadXMLAttributes(const char** atts)
{
...
void vtkDMMLAnnotationLineDisplayNode::Copy(vtkDMMLNode *anode)
{
  int disabledModify = this->StartModify();

  Superclass::Copy(anode);
  vtkDMMLAnnotationLineDisplayNode *node = (vtkDMMLAnnotationLineDisplayNode *) anode;
...
//----------------------------------------------------------------------------
void vtkDMMLAnnotationLineDisplayNode::PrintSelf(ostream& os, vtkIndent indent)
{
...
//---------------------------------------------------------------------------
void vtkDMMLAnnotationLineDisplayNode::ProcessDMMLEvents ( vtkObject *caller,
                                           unsigned long event,
                                           void *callData )
{
...
//-----------------------------------------------------------
void vtkDMMLAnnotationLineDisplayNode::UpdateScene(vtkDMMLScene *scene)
{
   Superclass::UpdateScene(scene);
}

//---------------------------------------------------------------------------
void vtkDMMLAnnotationLineDisplayNode::SetLineThickness(double thickness)
{
    ...
    //  {
      ...
      // KP this->InvokeEvent(vtkDMMLAnnotationLineDisplayNode::DisplayModifiedEvent);
    //  }
  this->Modified();
}
...
void vtkDMMLAnnotationLineDisplayNode::CreateBackup()
{
  vtkDMMLAnnotationLineDisplayNode * backupNode = vtkDMMLAnnotationLineDisplayNode::New();
...
void vtkDMMLAnnotationLineDisplayNode::RestoreBackup()
{
  if (this->m_Backup)
    {
