...
//------------------------------------------------------------------------------
vtkDMMLNodeNewMacro(vtkDMMLAnnotationROINode);

//----------------------------------------------------------------------------
vtkDMMLAnnotationROINode::vtkDMMLAnnotationROINode()
{
  ...
  // default placement of the widget as in Cjyx3
  this->SetXYZ(0,0,0);
  this->SetRadiusXYZ(10,10,10);
}
//----------------------------------------------------------------------------
void vtkDMMLAnnotationROINode::Initialize(vtkDMMLScene* dmmlScene)
{
...
//
//    this->InvokeEvent(vtkDMMLAnnotationROINode::ROINodeAddedEvent);
//}
...
//----------------------------------------------------------------------------
void vtkDMMLAnnotationROINode::WriteXML(ostream& of, int nIndent)
{
...
//----------------------------------------------------------------------------
void vtkDMMLAnnotationROINode::ReadXMLAttributes(const char** atts)
{
...
//----------------------------------------------------------------------------
void vtkDMMLAnnotationROINode::CopyContent(vtkDMMLNode* anode, bool deepCopy/*=true*/)
{
  DMMLNodeModifyBlocker blocker(this);
  Superclass::CopyContent(anode, deepCopy);

  //  vtkObject::Copy(anode);
  vtkDMMLAnnotationROINode *node = vtkDMMLAnnotationROINode::SafeDownCast(anode);
  if (!node)
    {
    return;
    }
...
//-----------------------------------------------------------
void vtkDMMLAnnotationROINode::UpdateScene(vtkDMMLScene *scene)
{
...
//---------------------------------------------------------------------------
void vtkDMMLAnnotationROINode::ProcessDMMLEvents ( vtkObject *caller,
                                           unsigned long event,
                                           void *callData )
{
...
//----------------------------------------------------------------------------
void vtkDMMLAnnotationROINode::PrintAnnotationInfo(ostream& os, vtkIndent indent, int titleFlag)
{
  //cout << "vtkDMMLAnnotationROINode::PrintAnnotationInfo" << endl;
  if (titleFlag)
    {

      os <<indent << "vtkDMMLAnnotationROINode: Annotation Summary";
      if (this->GetName())
    {
      os << " of " << this->GetName();
    }
...
//---------------------------------------------------------------------------
int vtkDMMLAnnotationROINode::AddControlPoint(double newControl[3],int selectedFlag, int visibleFlag)
{
...
//---------------------------------------------------------------------------
double vtkDMMLAnnotationROINode::GetROIAnnotationScale()
{
...
//---------------------------------------------------------------------------
void vtkDMMLAnnotationROINode::SetROIAnnotationScale(double init)
{
  vtkDMMLAnnotationTextDisplayNode *node = this->GetAnnotationTextDisplayNode();
...
//---------------------------------------------------------------------------
void vtkDMMLAnnotationROINode::SetROIAnnotationVisibility(int flag)
{
...
//---------------------------------------------------------------------------
int vtkDMMLAnnotationROINode::GetROIAnnotationVisibility()
{
  return this->GetAnnotationAttribute(0, vtkDMMLAnnotationNode::TEXT_VISIBLE);
}

//---------------------------------------------------------------------------
bool vtkDMMLAnnotationROINode::GetXYZ(double point[3])
{
...
//---------------------------------------------------------------------------
bool vtkDMMLAnnotationROINode::GetRadiusXYZ(double point[3])
{
  point[0] = point[1] = point[2] = 0.0;
  if (this->GetPoints())
    {
...
//---------------------------------------------------------------------------
int vtkDMMLAnnotationROINode::SetControlPoint(int id, double newControl[3])
{
  if (id < 0 || id > 1) {
    return 0;
  }
...
//---------------------------------------------------------------------------
double* vtkDMMLAnnotationROINode::GetPointColor()
{
...
//---------------------------------------------------------------------------
void vtkDMMLAnnotationROINode::SetPointColor(double initColor[3])
{
  vtkDMMLAnnotationPointDisplayNode *node = this->GetAnnotationPointDisplayNode();
  if (!node)
    {
...
//---------------------------------------------------------------------------
double* vtkDMMLAnnotationROINode::GetROIAnnotationTextColor()
{
  vtkDMMLAnnotationTextDisplayNode *node = this->GetAnnotationTextDisplayNode();
  if (!node)
    {
...
//---------------------------------------------------------------------------
void vtkDMMLAnnotationROINode::SetROIAnnotationTextColor(double initColor[3])
{
  vtkDMMLAnnotationTextDisplayNode *node = this->GetAnnotationTextDisplayNode();
  if (!node)
    {
...
//---------------------------------------------------------------------------
double* vtkDMMLAnnotationROINode::GetLineColor()
{
...
//---------------------------------------------------------------------------
void vtkDMMLAnnotationROINode::SetLineColor(double initColor[3])
{
  vtkDMMLAnnotationLineDisplayNode *node = this->GetAnnotationLineDisplayNode();
  if (!node)
    {
...
//----------------------------------------------------------------------------
void vtkDMMLAnnotationROINode::ApplyTransformMatrix(vtkMatrix4x4* transformMatrix)
{
...
//---------------------------------------------------------------------------
void vtkDMMLAnnotationROINode::ApplyTransform(vtkAbstractTransform* transform)
{
  ...
  vtkErrorMacro("vtkDMMLAnnotationROINode::ApplyTransform is only supported for linear transforms");
}

//---------------------------------------------------------------------------
void vtkDMMLAnnotationROINode::GetTransformedPlanes(vtkPlanes *planes)
{
  double bounds[6];
  int i;
...
//---------------------------------------------------------------------------
void vtkDMMLAnnotationROINode::GetBounds(double bounds[6])
{
...
//---------------------------------------------------------------------------
void vtkDMMLAnnotationROINode::GetRASBounds(double bounds[6])
{
