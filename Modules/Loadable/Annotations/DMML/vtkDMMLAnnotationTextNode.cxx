...
//----------------------------------------------------------------------------
vtkDMMLNodeNewMacro(vtkDMMLAnnotationTextNode);

//-----------------------------------------------------------------------------
vtkDMMLAnnotationTextNode::vtkDMMLAnnotationTextNode()
{
  this->SetCaptionCoordinates(0.05, 0.05);
}

//-----------------------------------------------------------------------------
int vtkDMMLAnnotationTextNode::SetCaptionCoordinates(double newCoord[2])
{
  return this->SetCaptionCoordinates(newCoord[0], newCoord[1]);
}

//-----------------------------------------------------------------------------
int vtkDMMLAnnotationTextNode::SetCaptionCoordinates(double x, double y)
{
  if (x < 0.0 || x > 1.0)
    {
