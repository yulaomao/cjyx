#ifndef __vtkDMMLAnnotationRulerNode_h
#define __vtkDMMLAnnotationRulerNode_h
...
class  VTK_CJYX_ANNOTATIONS_MODULE_DMML_EXPORT vtkDMMLAnnotationRulerNode : public vtkDMMLAnnotationLinesNode
{
public:
  static vtkDMMLAnnotationRulerNode *New();
  vtkTypeMacro(vtkDMMLAnnotationRulerNode,vtkDMMLAnnotationLinesNode);
  // Description:
...
//  void Initialize(vtkDMMLScene* dmmlScene);
...
protected:
  vtkDMMLAnnotationRulerNode();
  ~vtkDMMLAnnotationRulerNode() override;
  vtkDMMLAnnotationRulerNode(const vtkDMMLAnnotationRulerNode&);
  void operator=(const vtkDMMLAnnotationRulerNode&);
