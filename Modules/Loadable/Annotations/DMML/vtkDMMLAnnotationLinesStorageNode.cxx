...
//----------------------------------------------------------------------------
vtkDMMLNodeNewMacro(vtkDMMLAnnotationLinesStorageNode);

//----------------------------------------------------------------------------
vtkDMMLAnnotationLinesStorageNode::vtkDMMLAnnotationLinesStorageNode() = default;

//----------------------------------------------------------------------------
vtkDMMLAnnotationLinesStorageNode::~vtkDMMLAnnotationLinesStorageNode() = default;

//----------------------------------------------------------------------------
void vtkDMMLAnnotationLinesStorageNode::WriteXML(ostream& of, int nIndent)
{
  Superclass::WriteXML(of, nIndent);
}

//----------------------------------------------------------------------------
void vtkDMMLAnnotationLinesStorageNode::ReadXMLAttributes(const char** atts)
{
...
void vtkDMMLAnnotationLinesStorageNode::Copy(vtkDMMLNode *anode)
{
  Superclass::Copy(anode);
}

//----------------------------------------------------------------------------
void vtkDMMLAnnotationLinesStorageNode::PrintSelf(ostream& os, vtkIndent indent)
{
  vtkDMMLStorageNode::PrintSelf(os,indent);
}

//----------------------------------------------------------------------------
int vtkDMMLAnnotationLinesStorageNode::ReadAnnotationLineDisplayProperties(vtkDMMLAnnotationLineDisplayNode *refNode, std::string lineString, std::string preposition)
{
  if (refNode == nullptr)
    {
...
//----------------------------------------------------------------------------
int vtkDMMLAnnotationLinesStorageNode::ReadAnnotationLinesData(vtkDMMLAnnotationLinesNode *refNode, char line[1024],
...
//----------------------------------------------------------------------------
int vtkDMMLAnnotationLinesStorageNode::ReadAnnotationLinesProperties(vtkDMMLAnnotationLinesNode *vtkNotUsed(refNode), char line[1024], int &typeColumn,
...
int vtkDMMLAnnotationLinesStorageNode::ReadAnnotation(vtkDMMLAnnotationLinesNode *refNode)
{
 ...
 vtkDMMLAnnotationLineDisplayNode *aLineDisplayNode = refNode->GetAnnotationLineDisplayNode();
...
//----------------------------------------------------------------------------
bool vtkDMMLAnnotationLinesStorageNode::CanReadInReferenceNode(vtkDMMLNode* refNode)
{
  return refNode->IsA("vtkDMMLAnnotationLinesNode");
}

//----------------------------------------------------------------------------
int vtkDMMLAnnotationLinesStorageNode::ReadDataInternal(vtkDMMLNode *refNode)
{
  // cast the input node
  vtkDMMLAnnotationLinesNode *aNode =
    vtkDMMLAnnotationLinesNode::SafeDownCast(refNode);
  ...
  aNode->InvokeEvent(vtkDMMLScene::NodeAddedEvent, aNode);//vtkDMMLAnnotationNode::DisplayModifiedEvent);

  return 1;
}

//----------------------------------------------------------------------------
int vtkDMMLAnnotationLinesStorageNode::WriteAnnotationLineDisplayProperties(fstream& of, vtkDMMLAnnotationLineDisplayNode *refNode, std::string preposition)
{
  if (!refNode)
   {
   return 0;
...
//----------------------------------------------------------------------------
int vtkDMMLAnnotationLinesStorageNode::WriteAnnotationLinesProperties(fstream& of, vtkDMMLAnnotationLinesNode *refNode)
{
   // put down a header
  if (refNode == nullptr)
    {
  ...
  vtkDMMLAnnotationLineDisplayNode *annDisNode = refNode->GetAnnotationLineDisplayNode();
...
//----------------------------------------------------------------------------
int vtkDMMLAnnotationLinesStorageNode::WriteAnnotationLinesData(fstream& of, vtkDMMLAnnotationLinesNode *refNode)
{
  if (!refNode)
    {
    return 0;
  ...
  for (int i = 0; i < refNode->GetNumberOfLines(); i++)
    {
      ...
      int sel = refNode->GetAnnotationAttribute(i, vtkDMMLAnnotationLinesNode::LINE_SELECTED);
      int vis = refNode->GetAnnotationAttribute(i, vtkDMMLAnnotationLinesNode::LINE_VISIBLE);
...
//----------------------------------------------------------------------------
int vtkDMMLAnnotationLinesStorageNode::WriteAnnotationDataInternal(vtkDMMLNode *refNode, fstream& of)
{
  ...
  // cast the input nod
  vtkDMMLAnnotationLinesNode *aNode = vtkDMMLAnnotationLinesNode::SafeDownCast(refNode);
