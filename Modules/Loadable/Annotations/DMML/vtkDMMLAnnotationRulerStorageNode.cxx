...
//----------------------------------------------------------------------------
vtkDMMLNodeNewMacro(vtkDMMLAnnotationRulerStorageNode);

//----------------------------------------------------------------------------
vtkDMMLAnnotationRulerStorageNode::vtkDMMLAnnotationRulerStorageNode() = default;

//----------------------------------------------------------------------------
vtkDMMLAnnotationRulerStorageNode::~vtkDMMLAnnotationRulerStorageNode() = default;

//----------------------------------------------------------------------------
void vtkDMMLAnnotationRulerStorageNode::WriteXML(ostream& of, int nIndent)
{
  Superclass::WriteXML(of, nIndent);
}

//----------------------------------------------------------------------------
void vtkDMMLAnnotationRulerStorageNode::ReadXMLAttributes(const char** atts)
{
...
void vtkDMMLAnnotationRulerStorageNode::Copy(vtkDMMLNode *anode)
{
  Superclass::Copy(anode);
}

//----------------------------------------------------------------------------
void vtkDMMLAnnotationRulerStorageNode::PrintSelf(ostream& os, vtkIndent indent)
{
  vtkDMMLStorageNode::PrintSelf(os,indent);
}

//----------------------------------------------------------------------------
int vtkDMMLAnnotationRulerStorageNode::ReadAnnotationRulerData(vtkDMMLAnnotationRulerNode *refNode, char line[1024],
...
//----------------------------------------------------------------------------
int vtkDMMLAnnotationRulerStorageNode::ReadAnnotationRulerProperties(vtkDMMLAnnotationRulerNode *refNode, char line[1024], int &typeColumn,
                                     int& line1IDColumn, int& selColumn, int& visColumn, int& numColumns)
{
  // cout << "vtkDMMLAnnotationRulerStorageNode::ReadAnnotationRulerProperties " << line << endl;
 if (line[0] != '#' || line[1] != ' ')
    {
      return 0;
    }
...
int vtkDMMLAnnotationRulerStorageNode::ReadAnnotation(vtkDMMLAnnotationRulerNode *refNode)
{
...
//----------------------------------------------------------------------------
bool vtkDMMLAnnotationRulerStorageNode::CanReadInReferenceNode(vtkDMMLNode* refNode)
{
  return refNode->IsA("vtkDMMLAnnotationRulerNode");
}

//----------------------------------------------------------------------------
int vtkDMMLAnnotationRulerStorageNode::ReadDataInternal(vtkDMMLNode *refNode)
{
  // cast the input node
  vtkDMMLAnnotationRulerNode *aNode =
    vtkDMMLAnnotationRulerNode::SafeDownCast(refNode);
...
//----------------------------------------------------------------------------
int vtkDMMLAnnotationRulerStorageNode::ReadOneRuler(fstream & fstr, vtkDMMLAnnotationRulerNode *refNode)
{
...
//----------------------------------------------------------------------------
int vtkDMMLAnnotationRulerStorageNode::WriteAnnotationRulerProperties(fstream& of, vtkDMMLAnnotationRulerNode *refNode)
{
   // put down a header
  if (refNode == nullptr)
    {
...
//----------------------------------------------------------------------------
int vtkDMMLAnnotationRulerStorageNode::WriteAnnotationRulerData(fstream& of, vtkDMMLAnnotationRulerNode *refNode)
{
  if (!refNode)
    {
...
//----------------------------------------------------------------------------
int vtkDMMLAnnotationRulerStorageNode::WriteAnnotationDataInternal(vtkDMMLNode *refNode, fstream& of)
{
  ...
  if ( !( refNode->IsA("vtkDMMLAnnotationRulerNode") ) )
    {
    vtkErrorMacro("WriteAnnotationDataInternal: Reference node is not a proper vtkDMMLAnnotationRulerNode");
    return 0;
    }


  // cast the input nod
  vtkDMMLAnnotationRulerNode *aNode = dynamic_cast <vtkDMMLAnnotationRulerNode *> (refNode);
