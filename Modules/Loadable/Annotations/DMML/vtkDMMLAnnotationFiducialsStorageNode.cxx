...
//----------------------------------------------------------------------------
vtkDMMLNodeNewMacro(vtkDMMLAnnotationFiducialsStorageNode);


//----------------------------------------------------------------------------
int vtkDMMLAnnotationFiducialsStorageNode::ReadAnnotationFiducialsData(vtkDMMLAnnotationFiducialNode *refNode, char line[1024], int labelColumn, int xColumn, int yColumn, int zColumn,  int selColumn,  int visColumn, int numColumns)
{
  if (!refNode)
    {
      return -1;
  ...
  //newNode->InvokeEvent(vtkDMMLScene::NodeAddedEvent, newCPDisplayNode);//vtkDMMLAnnotationNode::DisplayModifiedEvent);

  return 1;
}

//----------------------------------------------------------------------------
int vtkDMMLAnnotationFiducialsStorageNode::ReadAnnotationFiducialsProperties(vtkDMMLAnnotationFiducialNode *refNode, char line[1024], int &labelColumn,
...
int vtkDMMLAnnotationFiducialsStorageNode::ReadAnnotation(vtkDMMLAnnotationFiducialNode *refNode)
{
...
//----------------------------------------------------------------------------
bool vtkDMMLAnnotationFiducialsStorageNode::CanReadInReferenceNode(vtkDMMLNode *refNode)
{
  return refNode->IsA("vtkDMMLAnnotationFiducialNode");
}

//----------------------------------------------------------------------------
int vtkDMMLAnnotationFiducialsStorageNode::ReadDataInternal(vtkDMMLNode *refNode)
{
  vtkDMMLAnnotationFiducialNode *fiducialNode =
    vtkDMMLAnnotationFiducialNode::SafeDownCast(refNode);
...
//----------------------------------------------------------------------------
int vtkDMMLAnnotationFiducialsStorageNode::ReadOneFiducial(fstream & fstr, vtkDMMLAnnotationFiducialNode *refNode)
{
  if (refNode == nullptr)
    {
...
//   if (fullName.empty())
//     {
//     vtkErrorMacro("vtkDMMLAnnotationFiducialsStorageNode: File name not specified");
//     return 0;
//     }
//
//   // cast the input node
//   vtkDMMLAnnotationFiducialsNode *annotationNode = nullptr;
//   if ( refNode->IsA("vtkDMMLAnnotationFiducialsNode") )
//     {
//     annotationNode = dynamic_cast <vtkDMMLAnnotationFiducialsNode *> (refNode);
//     }
//
...
//
//   // cast the input node
//   vtkDMMLAnnotationTextDisplayNode *annotationDisplayNode = annotationNode->GetAnnotationTextDisplayNode();
...
//     annotationNode->InvokeEvent(vtkDMMLScene::NodeAddedEvent, annotationNode);//vtkDMMLAnnotationFiducialsNode::DisplayModifiedEvent);
//     fstr.close();
//     }
//   else
//     {
...
//----------------------------------------------------------------------------
void vtkDMMLAnnotationFiducialsStorageNode::InitializeSupportedWriteFileTypes()
{
