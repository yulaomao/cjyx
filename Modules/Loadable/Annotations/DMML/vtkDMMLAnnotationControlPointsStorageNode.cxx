...
//----------------------------------------------------------------------------
vtkDMMLNodeNewMacro(vtkDMMLAnnotationControlPointsStorageNode);

//----------------------------------------------------------------------------
vtkDMMLAnnotationControlPointsStorageNode::vtkDMMLAnnotationControlPointsStorageNode() = default;

//----------------------------------------------------------------------------
vtkDMMLAnnotationControlPointsStorageNode::~vtkDMMLAnnotationControlPointsStorageNode() = default;

//----------------------------------------------------------------------------
void vtkDMMLAnnotationControlPointsStorageNode::PrintSelf(ostream& os, vtkIndent indent)
{
  vtkDMMLStorageNode::PrintSelf(os,indent);
}

//----------------------------------------------------------------------------
int vtkDMMLAnnotationControlPointsStorageNode::ReadAnnotationPointDisplayProperties(vtkDMMLAnnotationPointDisplayNode *refNode, std::string lineString, std::string preposition)
{
  if (refNode == nullptr)
    {
...
//----------------------------------------------------------------------------
int vtkDMMLAnnotationControlPointsStorageNode::ReadAnnotationControlPointsData(vtkDMMLAnnotationControlPointsNode *refNode, char line[1024],
...
//----------------------------------------------------------------------------
int vtkDMMLAnnotationControlPointsStorageNode::ReadAnnotationControlPointsProperties(vtkDMMLAnnotationControlPointsNode *refNode,
...
int vtkDMMLAnnotationControlPointsStorageNode::ReadAnnotation(vtkDMMLAnnotationControlPointsNode *refNode)
{
  ...
  if (!vtkDMMLAnnotationStorageNode::ReadAnnotation(refNode))
    {
      return 0;
    }
 ...
 vtkDMMLAnnotationPointDisplayNode *aPointDisplayNode = refNode->GetAnnotationPointDisplayNode();
...
//----------------------------------------------------------------------------
bool vtkDMMLAnnotationControlPointsStorageNode::CanReadInReferenceNode(vtkDMMLNode *refNode)
{
  return refNode->IsA("vtkDMMLAnnotationControlPointsNode");
}

//----------------------------------------------------------------------------
int vtkDMMLAnnotationControlPointsStorageNode::ReadDataInternal(vtkDMMLNode *refNode)
{
  // cast the input node
  vtkDMMLAnnotationControlPointsNode *aCPNode =
    vtkDMMLAnnotationControlPointsNode::SafeDownCast(refNode);
  ...
  aCPNode->InvokeEvent(vtkDMMLScene::NodeAddedEvent, aCPNode);//vtkDMMLAnnotationNode::DisplayModifiedEvent);

  return 1;
}

//----------------------------------------------------------------------------
int vtkDMMLAnnotationControlPointsStorageNode::WriteAnnotationPointDisplayProperties(fstream& of, vtkDMMLAnnotationPointDisplayNode *refNode, std::string preposition)
{
  if (!refNode)
   {
...
//----------------------------------------------------------------------------
int vtkDMMLAnnotationControlPointsStorageNode::WriteAnnotationControlPointsProperties(fstream& of, vtkDMMLAnnotationControlPointsNode *refNode)
{
   // put down a header
  if (refNode == nullptr)
    {
  ...
  vtkDMMLAnnotationPointDisplayNode *annPointDisNode = refNode->GetAnnotationPointDisplayNode();
...
//----------------------------------------------------------------------------
int vtkDMMLAnnotationControlPointsStorageNode::WriteAnnotationControlPointsData(fstream& of, vtkDMMLAnnotationControlPointsNode *refNode)
{
  if (!refNode)
    {
  ...
  for (int i = 0; i < refNode->GetNumberOfControlPoints(); i++)
    ...
    int sel = refNode->GetAnnotationAttribute(i, vtkDMMLAnnotationControlPointsNode::CP_SELECTED);
    int vis = refNode->GetAnnotationAttribute(i, vtkDMMLAnnotationControlPointsNode::CP_VISIBLE);
...
//----------------------------------------------------------------------------
int vtkDMMLAnnotationControlPointsStorageNode::WriteAnnotationDataInternal(vtkDMMLNode *refNode,  fstream &of)
{
  ...
  // cast the input node
  vtkDMMLAnnotationControlPointsNode *annCPNode = dynamic_cast <vtkDMMLAnnotationControlPointsNode *> (refNode);
