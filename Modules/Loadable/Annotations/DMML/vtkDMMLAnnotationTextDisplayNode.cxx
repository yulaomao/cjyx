...
//------------------------------------------------------------------------------
vtkDMMLAnnotationTextDisplayNode*
vtkDMMLAnnotationTextDisplayNode::New()
{
  ...
  if (ret)
    {
      return (vtkDMMLAnnotationTextDisplayNode*) ret;
    }
  // If the factory was unable to create the object, then create it here.
  vtkDMMLAnnotationTextDisplayNode* result = new vtkDMMLAnnotationTextDisplayNode;
...
//-----------------------------------------------------------------------------
vtkDMMLNode*
vtkDMMLAnnotationTextDisplayNode::CreateNodeInstance()
{
  vtkObject* ret = vtkObjectFactory::CreateInstance(
      "vtkDMMLAnnotationTextDisplayNode");
  if (ret)
...
//----------------------------------------------------------------------------
vtkDMMLAnnotationTextDisplayNode::vtkDMMLAnnotationTextDisplayNode()
{
  this->TextScale = 4.5;
...
//----------------------------------------------------------------------------
void
vtkDMMLAnnotationTextDisplayNode::WriteXML(ostream& of, int nIndent)
{
...
//----------------------------------------------------------------------------
void
vtkDMMLAnnotationTextDisplayNode::ReadXMLAttributes(const char** atts)
{
...
void
vtkDMMLAnnotationTextDisplayNode::Copy(vtkDMMLNode *anode)
{
  int disabledModify = this->StartModify();

  Superclass::Copy(anode);
  vtkDMMLAnnotationTextDisplayNode *node =
      (vtkDMMLAnnotationTextDisplayNode *) anode;
...
//----------------------------------------------------------------------------
void
vtkDMMLAnnotationTextDisplayNode::PrintSelf(ostream& os, vtkIndent indent)
{
...
//---------------------------------------------------------------------------
void
vtkDMMLAnnotationTextDisplayNode::ProcessDMMLEvents(vtkObject *caller,
...
//-----------------------------------------------------------
void
vtkDMMLAnnotationTextDisplayNode::UpdateScene(vtkDMMLScene *scene)
{
...
//---------------------------------------------------------------------------
void
vtkDMMLAnnotationTextDisplayNode::SetTextScale(double scale)
{
...
void vtkDMMLAnnotationTextDisplayNode::CreateBackup()
{

  vtkDMMLAnnotationTextDisplayNode * backupNode = vtkDMMLAnnotationTextDisplayNode::New();
...
void vtkDMMLAnnotationTextDisplayNode::RestoreBackup()
{
...
std::string vtkDMMLAnnotationTextDisplayNode::GetLineWrappedText(std::string inputText)
{
