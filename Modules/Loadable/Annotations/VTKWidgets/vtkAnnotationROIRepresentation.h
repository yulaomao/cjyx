...
=========================================================================*/
///  vtkAnnotationROIRepresentation - a class defining the representation for the vtkCjyxBoxWidget2
///
/// This class is a concrete representation for the vtkCjyxBoxWidget2. It
...
//
/// .SECTION Caveats
/// This class, and vtkCjyxBoxWidget2, are second generation VTK
/// widgets. An earlier version of this functionality was defined in the
/// class vtkCjyxBoxWidget.

/// .SECTION See Also
/// vtkCjyxBoxWidget2 vtkCjyxBoxWidget
...
#include "vtkCjyxAnnotationsModuleVTKWidgetsExport.h"
...
class VTK_CJYX_ANNOTATIONS_MODULE_VTKWIDGETS_EXPORT
...
public:
  ...
  ///
  /// The interaction state may be set from a widget (e.g., vtkCjyxBoxWidget2) or
