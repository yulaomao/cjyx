...
/* this test has been adopted from vtkDMMLAnnotationAngleTest1 by
...
//----------------------------------------------------------------------------
int TestGetTransformedPlanes(vtkDMMLScene* scene, vtkDMMLAnnotationROINode* node);

//----------------------------------------------------------------------------
int vtkDMMLAnnotationROINodeTest1(int , char * [] )
{
  // ======================
  // Basic Setup
  // ======================

  vtkNew<vtkDMMLAnnotationROINode> node2;
  vtkNew<vtkDMMLScene> dmmlScene;

  vtkNew<vtkDMMLAnnotationROINode> node1;
  ...
  CHECK_EXIT_SUCCESS(TestGetTransformedPlanes(dmmlScene.GetPointer(), node2.GetPointer()));
