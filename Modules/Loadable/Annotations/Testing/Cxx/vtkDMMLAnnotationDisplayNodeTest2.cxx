...
int vtkDMMLAnnotationDisplayNodeTest2(int , char * [] )
{
  // define test colors
  ...
  vtkSmartPointer< vtkDMMLAnnotationDisplayNode > displayNode1 = vtkSmartPointer< vtkDMMLAnnotationDisplayNode >::New();
  scene->AddNode(displayNode1);

  vtkSmartPointer< vtkDMMLAnnotationDisplayNode > displayNode2 = vtkSmartPointer< vtkDMMLAnnotationDisplayNode >::New();
  scene->AddNode(displayNode2);

  vtkSmartPointer< vtkDMMLAnnotationDisplayNode > displayNode3 = vtkSmartPointer< vtkDMMLAnnotationDisplayNode >::New();
  scene->AddNode(displayNode3);

  vtkSmartPointer< vtkDMMLAnnotationNode > annotationNode = vtkSmartPointer<vtkDMMLAnnotationNode>::New();
  ...
  for(int i=0; i< annotationNode->GetNumberOfDisplayNodes(); i++)
    ...
    vtkDMMLDisplayNode *displayNode = annotationNode->GetNthDisplayNode(i);
