...
if selectionNode:
    print(selectionNode)
    annotClassName = "vtkDMMLAnnotationRulerNode"
    ...
    annotClassName = "vtkDMMLAnnotationFiducialNode"
    ...
    selectionNode.AddNewPlaceNodeClassNameToList("vtkDMMLAnnotationRulerNode", ":/Icons/AnnotationDistanceWithArrow.png")
    endIndex = selectionNode.PlaceNodeClassNameInList(annotClassName)
    if endIndex == -1:
