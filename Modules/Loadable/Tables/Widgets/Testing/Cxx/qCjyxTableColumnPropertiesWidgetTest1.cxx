...
int qCjyxTableColumnPropertiesWidgetTest1( int argc, char * argv [] )
{
  ...
  qCjyxTableColumnPropertiesWidget* columnPropertiesWidget = new qCjyxTableColumnPropertiesWidget();
  columnPropertiesWidget->setParent(&parentWidget);
  columnPropertiesWidget->setSelectionFromDMMLTableView(tableView);
