...
#ifndef __qCjyxSubjectHierarchyTablesPlugin_h
#define __qCjyxSubjectHierarchyTablesPlugin_h

// SubjectHierarchy includes
#include "qCjyxSubjectHierarchyAbstractPlugin.h"

#include "qCjyxTablesSubjectHierarchyPluginsExport.h"

class qCjyxSubjectHierarchyTablesPluginPrivate;
class vtkDMMLNode;
class vtkDMMLSubjectHierarchyNode;
class vtkDMMLTableViewNode;

/// \ingroup Cjyx_QtModules_SubjectHierarchy_Plugins
class Q_CJYX_TABLES_SUBJECT_HIERARCHY_PLUGINS_EXPORT qCjyxSubjectHierarchyTablesPlugin : public qCjyxSubjectHierarchyAbstractPlugin
{
public:
  Q_OBJECT
...
public:
  ...
  qCjyxSubjectHierarchyTablesPlugin(QObject* parent = nullptr);
  ~qCjyxSubjectHierarchyTablesPlugin() override;
...
protected:
  ...
  vtkDMMLTableViewNode* getTableViewNode()const;

protected:
  QScopedPointer<qCjyxSubjectHierarchyTablesPluginPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qCjyxSubjectHierarchyTablesPlugin);
  Q_DISABLE_COPY(qCjyxSubjectHierarchyTablesPlugin);
};
