...
#ifndef __qCjyxSegmentEditorScriptedLabelEffect_h
#define __qCjyxSegmentEditorScriptedLabelEffect_h
...
///
class Q_CJYX_SEGMENTATIONS_EFFECTS_EXPORT qCjyxSegmentEditorScriptedLabelEffect
...
public:
  ...
  qCjyxSegmentEditorScriptedLabelEffect(QObject* parent = nullptr);
  ~qCjyxSegmentEditorScriptedLabelEffect() override;
...
protected:
  QScopedPointer<qCjyxSegmentEditorScriptedLabelEffectPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qCjyxSegmentEditorScriptedLabelEffect);
  Q_DISABLE_COPY(qCjyxSegmentEditorScriptedLabelEffect);
};
