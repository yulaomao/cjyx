...
#include "qCjyxSegmentEditorAbstractLabelEffect_p.h"
...
//-----------------------------------------------------------------------------
// qCjyxSegmentEditorAbstractLabelEffectPrivate methods

//-----------------------------------------------------------------------------
qCjyxSegmentEditorAbstractLabelEffectPrivate::qCjyxSegmentEditorAbstractLabelEffectPrivate(qCjyxSegmentEditorAbstractLabelEffect& object)
  : q_ptr(&object)
{
}

//-----------------------------------------------------------------------------
qCjyxSegmentEditorAbstractLabelEffectPrivate::~qCjyxSegmentEditorAbstractLabelEffectPrivate() = default;

//-----------------------------------------------------------------------------


//-----------------------------------------------------------------------------
// qCjyxSegmentEditorAbstractLabelEffect methods

//----------------------------------------------------------------------------
qCjyxSegmentEditorAbstractLabelEffect::qCjyxSegmentEditorAbstractLabelEffect(QObject* parent)
 : Superclass(parent)
 , d_ptr( new qCjyxSegmentEditorAbstractLabelEffectPrivate(*this) )
{
}

//----------------------------------------------------------------------------
qCjyxSegmentEditorAbstractLabelEffect::~qCjyxSegmentEditorAbstractLabelEffect() = default;

//-----------------------------------------------------------------------------
void qCjyxSegmentEditorAbstractLabelEffect::referenceGeometryChanged()
{
}

//-----------------------------------------------------------------------------
void qCjyxSegmentEditorAbstractLabelEffect::masterVolumeNodeChanged()
{
}

//-----------------------------------------------------------------------------
void qCjyxSegmentEditorAbstractLabelEffect::setupOptionsFrame()
{
}

//-----------------------------------------------------------------------------
void qCjyxSegmentEditorAbstractLabelEffect::setDMMLDefaults()
{
}

//-----------------------------------------------------------------------------
void qCjyxSegmentEditorAbstractLabelEffect::updateGUIFromDMML()
{
  if (!this->active())
    {
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorAbstractLabelEffect::updateDMMLFromGUI()
{
}

//-----------------------------------------------------------------------------
void qCjyxSegmentEditorAbstractLabelEffect::appendPolyMask(vtkOrientedImageData* input, vtkPolyData* polyData, qDMMLSliceWidget* sliceWidget, vtkDMMLSegmentationNode* segmentationNode/*=nullptr*/)
{
  ...
  qCjyxSegmentEditorAbstractLabelEffect::createMaskImageFromPolyData(polyData, polyMaskImage, sliceWidget);
  ...
  qCjyxSegmentEditorAbstractLabelEffect::appendImage(input, polyMaskImage);
}

//-----------------------------------------------------------------------------
void qCjyxSegmentEditorAbstractLabelEffect::appendImage(vtkOrientedImageData* inputImage, vtkOrientedImageData* appendedImage)
{
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorAbstractLabelEffect::createMaskImageFromPolyData(vtkPolyData* polyData, vtkOrientedImageData* outputMask, qDMMLSliceWidget* sliceWidget)
{
  ...
  //
  // Note: uses the cjyx2-based vtkImageFillROI filter
  ...
  qCjyxSegmentEditorAbstractEffect::xyzToRas(originXYZ, originRAS, sliceWidget);
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorAbstractLabelEffect::imageToWorldMatrix(vtkDMMLVolumeNode* node, vtkMatrix4x4* ijkToRas)
{
  if (!node || !ijkToRas)
    {
    return;
...
//-----------------------------------------------------------------------------
void qCjyxSegmentEditorAbstractLabelEffect::imageToWorldMatrix(vtkOrientedImageData* image, vtkDMMLSegmentationNode* node, vtkMatrix4x4* ijkToRas)
{
