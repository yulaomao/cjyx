...
class SegmentEditorMarginEffect(AbstractScriptedSegmentEditorEffect):
    ...
    def setupOptionsFrame(self):
        ...
        self.marginSizeMMSpinBox = cjyx.qDMMLSpinBox()
        self.marginSizeMMSpinBox.setDMMLScene(cjyx.dmmlScene)
        ...
        self.marginSizeMMSpinBox.connect("valueChanged(double)", self.updateDMMLFromGUI)
