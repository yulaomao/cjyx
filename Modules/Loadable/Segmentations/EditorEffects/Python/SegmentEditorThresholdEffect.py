...
class SegmentEditorThresholdEffect(AbstractScriptedSegmentEditorEffect):
    """ ThresholdEffect is an Effect implementing the global threshold
        ...
        qCjyxSegmentEditorAbstractEffect is satisfactory) can simply be omitted.
    """
...
<li><b>Apply:</b> set the previewed segmentation in the selected segment. Previous contents of the segment is overwritten.</li>
    ...
    def setupOptionsFrame(self):
        ...
        self.boxROIButton.clicked.connect(self.updateDMMLFromGUI)
        ...
        self.circleROIButton.clicked.connect(self.updateDMMLFromGUI)
        ...
        self.drawROIButton.clicked.connect(self.updateDMMLFromGUI)
        ...
        self.lineROIButton.clicked.connect(self.updateDMMLFromGUI)
        ...
        self.histogramLowerThresholdMinimumButton.clicked.connect(self.updateDMMLFromGUI)
        ...
        self.histogramLowerThresholdLowerButton.clicked.connect(self.updateDMMLFromGUI)
        ...
        self.histogramLowerThresholdAverageButton.clicked.connect(self.updateDMMLFromGUI)
        ...
        self.histogramUpperThresholdAverageButton.clicked.connect(self.updateDMMLFromGUI)
        ...
        self.histogramUpperThresholdUpperButton.clicked.connect(self.updateDMMLFromGUI)
        ...
        self.histogramUpperThresholdMaximumButton.clicked.connect(self.updateDMMLFromGUI)
    ...
    def updateDMMLFromGUI(self):
        with cjyx.util.NodeModify(self.scriptedEffect.parameterSetNode()):
    ...
    def onThresholdValuesChanged(self, min, max):
        self.scriptedEffect.updateDMMLFromGUI()
    ...
    def setupPreviewDisplay(self):
        ...
        for sliceViewName in layoutManager.sliceViewNames():
            ...
            if not self.scriptedEffect.segmentationDisplayableInView(sliceWidget.dmmlSliceNode()):
                continue
