...
class SegmentEditorHollowEffect(AbstractScriptedSegmentEditorEffect):
    ...
    def setupOptionsFrame(self):
        ...
        self.shellThicknessMMSpinBox = cjyx.qDMMLSpinBox()
        self.shellThicknessMMSpinBox.setDMMLScene(cjyx.dmmlScene)
        ...
        self.shellThicknessMMSpinBox.connect("valueChanged(double)", self.updateDMMLFromGUI)
