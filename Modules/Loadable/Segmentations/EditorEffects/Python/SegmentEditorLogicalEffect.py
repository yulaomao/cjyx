...
<p></html>"""
    ...
    def setupOptionsFrame(self):
        ...
        self.modifierSegmentSelector = cjyx.qDMMLSegmentsTableView()
        ...
        self.modifierSegmentSelector.setDMMLScene(cjyx.dmmlScene)
        ...
        self.modifierSegmentSelector.connect("selectionChanged(QItemSelection, QItemSelection)", self.updateDMMLFromGUI)
        self.bypassMaskingCheckBox.connect("stateChanged(int)", self.updateDMMLFromGUI)
    ...
    def getInvertedBinaryLabelmap(self, modifierLabelmap):
        ...
        invertedModifierLabelmap = cjyx.vtkOrientedImageData()
    ...
    def onApply(self):
        ...
        if operation in self.operationsRequireModifierSegment:
            ...
            modifierSegmentLabelmap = cjyx.vtkOrientedImageData()
            ...
            if not commonGeometryString:
                ...
                return
            commonGeometryImage = cjyx.vtkOrientedImageData()
            ...
            if not vtkSegmentationCore.vtkOrientedImageDataResample.DoGeometriesMatch(commonGeometryImage, modifierSegmentLabelmap):
                modifierSegmentLabelmap_CommonGeometry = cjyx.vtkOrientedImageData()
            ...
            if operation == LOGICAL_COPY:
                self.scriptedEffect.modifySelectedSegmentByLabelmap(
                    modifierSegmentLabelmap, cjyx.qCjyxSegmentEditorAbstractEffect.ModificationModeSet, bypassMasking)
            elif operation == LOGICAL_UNION:
                self.scriptedEffect.modifySelectedSegmentByLabelmap(
                    modifierSegmentLabelmap, cjyx.qCjyxSegmentEditorAbstractEffect.ModificationModeAdd, bypassMasking)
            elif operation == LOGICAL_SUBTRACT:
                self.scriptedEffect.modifySelectedSegmentByLabelmap(
                    modifierSegmentLabelmap, cjyx.qCjyxSegmentEditorAbstractEffect.ModificationModeRemove, bypassMasking)
            elif operation == LOGICAL_INTERSECT:
                selectedSegmentLabelmap = self.scriptedEffect.selectedSegmentLabelmap()
                intersectionLabelmap = cjyx.vtkOrientedImageData()
                ...
                self.scriptedEffect.modifySelectedSegmentByLabelmap(
                    intersectionLabelmap, cjyx.qCjyxSegmentEditorAbstractEffect.ModificationModeSet, commonExtent, bypassMasking)

        elif operation == LOGICAL_INVERT:
            selectedSegmentLabelmap = self.scriptedEffect.selectedSegmentLabelmap()
            invertedSelectedSegmentLabelmap = self.getInvertedBinaryLabelmap(selectedSegmentLabelmap)
            self.scriptedEffect.modifySelectedSegmentByLabelmap(
                invertedSelectedSegmentLabelmap, cjyx.qCjyxSegmentEditorAbstractEffect.ModificationModeSet, bypassMasking)
            ...
            self.scriptedEffect.modifySelectedSegmentByLabelmap(
                selectedSegmentLabelmap, cjyx.qCjyxSegmentEditorAbstractEffect.ModificationModeSet, bypassMasking)
