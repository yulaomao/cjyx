...
class AbstractScriptedSegmentEditorAutoCompleteEffect(AbstractScriptedSegmentEditorEffect):
    ...
    def setupOptionsFrame(self):
        ...
        self.previewOpacitySlider.connect("valueChanged(double)", self.updateDMMLFromGUI)
        self.previewShow3DButton.connect("toggled(bool)", self.updateDMMLFromGUI)
        self.autoUpdateCheckBox.connect("stateChanged(int)", self.updateDMMLFromGUI)
    ...
    def onPreview(self):
        ...
        cjyx.util.showStatusMessage(f"Running {self.scriptedEffect.name} auto-complete...", 2000)
        try:
    ...
    def reset(self):
        ...
        if previewNode:
            ...
            cjyx.dmmlScene.RemoveNode(previewNode)
    ...
    def onApply(self):
        ...
        for index in range(segmentIDs.GetNumberOfValues()):
            ...
            previewSegmentLabelmap = cjyx.vtkOrientedImageData()
    ...
    def effectiveExtentChanged(self):
        ...
        effectiveGeometryImage = cjyx.vtkOrientedImageData()
    ...
    def preview(self):
        ...
        if self.effectiveExtentChanged():
            ...
            if not self.mergedLabelmapGeometryImage:
                self.mergedLabelmapGeometryImage = cjyx.vtkOrientedImageData()
            ...
            previewNode = cjyx.dmmlScene.AddNewNodeByClass("vtkDMMLSegmentationNode")
            ...
            previewNode.GetSegmentation().SetConversionParameter(
                cjyx.vtkBinaryLabelmapToClosedSurfaceConversionRule.GetSmoothingFactorParameterName(),
                "-0.5")
            ...
            if self.clippedMasterImageDataRequired:
                self.clippedMasterImageData = cjyx.vtkOrientedImageData()
            ...
            if self.clippedMaskImageDataRequired:
                self.clippedMaskImageData = cjyx.vtkOrientedImageData()
        ...
        outputLabelmap = cjyx.vtkOrientedImageData()
