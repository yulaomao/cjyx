...
#ifndef __qCjyxSegmentEditorAbstractEffect_p_h
#define __qCjyxSegmentEditorAbstractEffect_p_h
...
//-----------------------------------------------------------------------------
class qCjyxSegmentEditorAbstractEffectPrivate: public QObject
{
  Q_OBJECT
  Q_DECLARE_PUBLIC(qCjyxSegmentEditorAbstractEffect);
protected:
  qCjyxSegmentEditorAbstractEffect* const q_ptr;
public:
  qCjyxSegmentEditorAbstractEffectPrivate(qCjyxSegmentEditorAbstractEffect& object);
  ~qCjyxSegmentEditorAbstractEffectPrivate() override;
signals:
