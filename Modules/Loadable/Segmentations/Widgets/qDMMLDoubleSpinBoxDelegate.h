...
#ifndef __qDMMLDoubleSpinBoxDelegate_h
#define __qDMMLDoubleSpinBoxDelegate_h
...
class Q_CJYX_MODULE_SEGMENTATIONS_WIDGETS_EXPORT qDMMLDoubleSpinBoxDelegate : public QStyledItemDelegate
{
  Q_OBJECT

public:
  qDMMLDoubleSpinBoxDelegate(QObject *parent = nullptr);
