...
#ifndef __qDMMLSortFilterSegmentsProxyModel_h
#define __qDMMLSortFilterSegmentsProxyModel_h
...
class Q_CJYX_MODULE_SEGMENTATIONS_WIDGETS_EXPORT qDMMLSortFilterSegmentsProxyModel : public QSortFilterProxyModel
{
  Q_OBJECT
  QVTK_OBJECT
...
public:
  ...
  qDMMLSortFilterSegmentsProxyModel(QObject *parent=nullptr);
  ~qDMMLSortFilterSegmentsProxyModel() override;
  ...
  /// The list of available status is in vtkCjyxSegmentationsModuleLogic::SegmentStatus
  /// \sa setShowStatus
...
protected:
  QScopedPointer<qDMMLSortFilterSegmentsProxyModelPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qDMMLSortFilterSegmentsProxyModel);
  Q_DISABLE_COPY(qDMMLSortFilterSegmentsProxyModel);
};
