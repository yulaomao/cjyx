...
#ifndef __qDMMLSegmentationGeometryDialog_h
#define __qDMMLSegmentationGeometryDialog_h
...
class qDMMLSegmentationGeometryDialogPrivate;

/// \brief Qt dialog for changing segmentation labelmap geometry
/// \ingroup Cjyx_QtModules_Segmentations_Widgets
class Q_CJYX_MODULE_SEGMENTATIONS_WIDGETS_EXPORT qDMMLSegmentationGeometryDialog : public QObject
{
public:
  Q_OBJECT
...
public:
  ...
  qDMMLSegmentationGeometryDialog(vtkDMMLSegmentationNode* segmentationNode, QObject* parent=nullptr);
  ~qDMMLSegmentationGeometryDialog() override;
...
protected:
  QScopedPointer<qDMMLSegmentationGeometryDialogPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qDMMLSegmentationGeometryDialog);
  Q_DISABLE_COPY(qDMMLSegmentationGeometryDialog);
};
