...
#include "ui_qDMMLSegmentationRepresentationsListView.h"
...
// --------------------------------------------------------------------------
class qDMMLSegmentationRepresentationsListViewPrivate: public Ui_qDMMLSegmentationRepresentationsListView
{
  Q_DECLARE_PUBLIC(qDMMLSegmentationRepresentationsListView);
protected:
  qDMMLSegmentationRepresentationsListView* const q_ptr;
public:
  qDMMLSegmentationRepresentationsListViewPrivate(qDMMLSegmentationRepresentationsListView& object);
  void init();
...
// --------------------------------------------------------------------------
qDMMLSegmentationRepresentationsListViewPrivate::qDMMLSegmentationRepresentationsListViewPrivate(qDMMLSegmentationRepresentationsListView& object)
  : q_ptr(&object)
{
...
// --------------------------------------------------------------------------
void qDMMLSegmentationRepresentationsListViewPrivate::init()
{
  Q_Q(qDMMLSegmentationRepresentationsListView);
  this->setupUi(q);
...
//-----------------------------------------------------------------------------
int qDMMLSegmentationRepresentationsListViewPrivate::columnIndex(QString label)
{
  return this->ColumnLabels.indexOf(label);
}

// --------------------------------------------------------------------------
void qDMMLSegmentationRepresentationsListViewPrivate::setMessage(const QString& message)
{
...
// --------------------------------------------------------------------------
// qDMMLSegmentationRepresentationsListView methods

// --------------------------------------------------------------------------
qDMMLSegmentationRepresentationsListView::qDMMLSegmentationRepresentationsListView(QWidget* _parent)
  : QWidget(_parent)
  , d_ptr(new qDMMLSegmentationRepresentationsListViewPrivate(*this))
{
  Q_D(qDMMLSegmentationRepresentationsListView);
  d->init();
  this->populateRepresentationsList();
}

// --------------------------------------------------------------------------
qDMMLSegmentationRepresentationsListView::~qDMMLSegmentationRepresentationsListView() = default;

//-----------------------------------------------------------------------------
void qDMMLSegmentationRepresentationsListView::setSegmentationNode(vtkDMMLNode* node)
{
  Q_D(qDMMLSegmentationRepresentationsListView);
...
//-----------------------------------------------------------------------------
vtkDMMLNode* qDMMLSegmentationRepresentationsListView::segmentationNode()
{
  Q_D(qDMMLSegmentationRepresentationsListView);
...
//-----------------------------------------------------------------------------
void qDMMLSegmentationRepresentationsListView::populateRepresentationsList()
{
  Q_D(qDMMLSegmentationRepresentationsListView);
...
//-----------------------------------------------------------------------------
void qDMMLSegmentationRepresentationsListView::createRepresentationDefault()
{
  Q_D(qDMMLSegmentationRepresentationsListView);
...
//-----------------------------------------------------------------------------
void qDMMLSegmentationRepresentationsListView::createRepresentationAdvanced()
{
  Q_D(qDMMLSegmentationRepresentationsListView);
  ...
  qDMMLSegmentationConversionParametersWidget* parametersWidget = new qDMMLSegmentationConversionParametersWidget(parametersDialog);
...
//-----------------------------------------------------------------------------
void qDMMLSegmentationRepresentationsListView::removeRepresentation()
{
  Q_D(qDMMLSegmentationRepresentationsListView);
...
//-----------------------------------------------------------------------------
void qDMMLSegmentationRepresentationsListView::makeMaster()
{
  Q_D(qDMMLSegmentationRepresentationsListView);
