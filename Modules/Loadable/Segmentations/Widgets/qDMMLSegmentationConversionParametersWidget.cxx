...
#include "ui_qDMMLSegmentationConversionParametersWidget.h"
...
// --------------------------------------------------------------------------
class qDMMLSegmentationConversionParametersWidgetPrivate: public Ui_qDMMLSegmentationConversionParametersWidget
{
  Q_DECLARE_PUBLIC(qDMMLSegmentationConversionParametersWidget);
protected:
  qDMMLSegmentationConversionParametersWidget* const q_ptr;
public:
  qDMMLSegmentationConversionParametersWidgetPrivate(qDMMLSegmentationConversionParametersWidget& object);
  void init();
...
// --------------------------------------------------------------------------
qDMMLSegmentationConversionParametersWidgetPrivate::qDMMLSegmentationConversionParametersWidgetPrivate(qDMMLSegmentationConversionParametersWidget& object)
  : q_ptr(&object)
{
...
// --------------------------------------------------------------------------
void qDMMLSegmentationConversionParametersWidgetPrivate::init()
{
  Q_Q(qDMMLSegmentationConversionParametersWidget);
  this->setupUi(q);
...
//-----------------------------------------------------------------------------
int qDMMLSegmentationConversionParametersWidgetPrivate::pathsColumnIndex(QString label)
{
  return this->PathsColumnLabels.indexOf(label);
}

//-----------------------------------------------------------------------------
int qDMMLSegmentationConversionParametersWidgetPrivate::parametersColumnIndex(QString label)
{
  return this->ParametersColumnLabels.indexOf(label);
}

// --------------------------------------------------------------------------
// qDMMLSegmentationConversionParametersWidget methods

// --------------------------------------------------------------------------
qDMMLSegmentationConversionParametersWidget::qDMMLSegmentationConversionParametersWidget(QWidget* _parent)
  : QWidget(_parent)
  , d_ptr(new qDMMLSegmentationConversionParametersWidgetPrivate(*this))
{
  Q_D(qDMMLSegmentationConversionParametersWidget);
  d->init();
...
// --------------------------------------------------------------------------
qDMMLSegmentationConversionParametersWidget::~qDMMLSegmentationConversionParametersWidget() = default;

//-----------------------------------------------------------------------------
void qDMMLSegmentationConversionParametersWidget::setSegmentationNode(vtkDMMLNode* node)
{
  Q_D(qDMMLSegmentationConversionParametersWidget);
...
//-----------------------------------------------------------------------------
vtkDMMLNode* qDMMLSegmentationConversionParametersWidget::segmentationNode()
{
  Q_D(qDMMLSegmentationConversionParametersWidget);
...
//-----------------------------------------------------------------------------
void qDMMLSegmentationConversionParametersWidget::setTargetRepresentationName(QString representationName)
{
  Q_D(qDMMLSegmentationConversionParametersWidget);
...
//-----------------------------------------------------------------------------
QString qDMMLSegmentationConversionParametersWidget::targetRepresentationName()
{
  Q_D(qDMMLSegmentationConversionParametersWidget);
...
//-----------------------------------------------------------------------------
void qDMMLSegmentationConversionParametersWidget::populatePathsTable()
{
  Q_D(qDMMLSegmentationConversionParametersWidget);
...
//-----------------------------------------------------------------------------
void qDMMLSegmentationConversionParametersWidget::populateParametersTable()
{
  Q_D(qDMMLSegmentationConversionParametersWidget);
...
//-----------------------------------------------------------------------------
void qDMMLSegmentationConversionParametersWidget::applyConversion()
{
  Q_D(qDMMLSegmentationConversionParametersWidget);
...
//-----------------------------------------------------------------------------
void qDMMLSegmentationConversionParametersWidget::onParameterChanged(QTableWidgetItem* changedItem)
{
  Q_D(qDMMLSegmentationConversionParametersWidget);
...
//-----------------------------------------------------------------------------
void qDMMLSegmentationConversionParametersWidget::onSpecifyGeometryButtonClicked()
{
  Q_D(qDMMLSegmentationConversionParametersWidget);
  ...
  qDMMLSegmentationGeometryDialog geometryDialog(d->SegmentationNode, this);
...
//-----------------------------------------------------------------------------
vtkSegmentationConverter::ConversionPathType qDMMLSegmentationConversionParametersWidget::selectedPath()
{
  Q_D(qDMMLSegmentationConversionParametersWidget);
...
//-----------------------------------------------------------------------------
vtkSegmentationConverterRule::ConversionParameterListType qDMMLSegmentationConversionParametersWidget::conversionParameters()
{
  Q_D(qDMMLSegmentationConversionParametersWidget);
