...
#ifndef __qCjyxSubjectHierarchySegmentsPlugin_h
#define __qCjyxSubjectHierarchySegmentsPlugin_h
...
class qCjyxSubjectHierarchySegmentsPluginPrivate;
class vtkDMMLNode;
class vtkDMMLSubjectHierarchyNode;

/// \ingroup CjyxRt_QtModules_Segmentations
class Q_CJYX_SEGMENTATIONS_PLUGINS_EXPORT qCjyxSubjectHierarchySegmentsPlugin : public qCjyxSubjectHierarchyAbstractPlugin
{
public:
  Q_OBJECT
...
public:
  ...
  qCjyxSubjectHierarchySegmentsPlugin(QObject* parent = nullptr);
  ~qCjyxSubjectHierarchySegmentsPlugin() override;
...
protected:
  QScopedPointer<qCjyxSubjectHierarchySegmentsPluginPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qCjyxSubjectHierarchySegmentsPlugin);
  Q_DISABLE_COPY(qCjyxSubjectHierarchySegmentsPlugin);
};
