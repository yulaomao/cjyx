...
#ifndef __qCjyxSubjectHierarchySegmentationsPlugin_h
#define __qCjyxSubjectHierarchySegmentationsPlugin_h

// Subject Hierarchy includes
#include "qCjyxSubjectHierarchyAbstractPlugin.h"

#include "qCjyxSegmentationsSubjectHierarchyPluginsExport.h"

class qCjyxSubjectHierarchySegmentationsPluginPrivate;
class vtkDMMLSegmentationNode;

/// \ingroup CjyxRt_QtModules_Segmentations
class Q_CJYX_SEGMENTATIONS_PLUGINS_EXPORT qCjyxSubjectHierarchySegmentationsPlugin : public qCjyxSubjectHierarchyAbstractPlugin
{
public:
  Q_OBJECT
...
public:
  ...
  qCjyxSubjectHierarchySegmentationsPlugin(QObject* parent = nullptr);
  ~qCjyxSubjectHierarchySegmentationsPlugin() override;
...
public:
  ...
  double canAddNodeToSubjectHierarchy(vtkDMMLNode* node, vtkIdType parentItemID=vtkDMMLSubjectHierarchyNode::INVALID_ITEM_ID )const override;

  /// Creates subject hierarchy item using default method and updates all segments
  bool addNodeToSubjectHierarchy(vtkDMMLNode* node, vtkIdType parentItemID) override;
...
protected:
  QScopedPointer<qCjyxSubjectHierarchySegmentationsPluginPrivate> d_ptr;

  void updateAllSegmentsFromDMML(vtkDMMLSegmentationNode* segmentationNode);
...
private:
  Q_DECLARE_PRIVATE(qCjyxSubjectHierarchySegmentationsPlugin);
  Q_DISABLE_COPY(qCjyxSubjectHierarchySegmentationsPlugin);
};
