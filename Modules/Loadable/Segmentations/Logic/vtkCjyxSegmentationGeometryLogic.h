...
// .NAME vtkCjyxSegmentationGeometryLogic
// .SECTION Description
// This class manages the logic associated with converting and handling
// segmentation node objects.

#ifndef __vtkCjyxSegmentationGeometryLogic_h
#define __vtkCjyxSegmentationGeometryLogic_h
...
class VTK_CJYX_SEGMENTATIONS_LOGIC_EXPORT vtkCjyxSegmentationGeometryLogic : public vtkObject
{
public:
  static vtkCjyxSegmentationGeometryLogic* New();
  vtkTypeMacro(vtkCjyxSegmentationGeometryLogic, vtkObject);
  ...
  //@{
  /// Input segmentation DMML node to modify the labelmap geometry of
  vtkGetObjectMacro(InputSegmentationNode, vtkDMMLSegmentationNode);
  vtkSetObjectMacro(InputSegmentationNode, vtkDMMLSegmentationNode);
  //@}

  /// DMML node specifying the source geometry
  vtkGetObjectMacro(SourceGeometryNode, vtkDMMLDisplayableNode);
  virtual void SetSourceGeometryNode(vtkDMMLDisplayableNode* node);
...
protected:
  vtkCjyxSegmentationGeometryLogic();
  ~vtkCjyxSegmentationGeometryLogic() override;
...
protected:
  ...
  vtkDMMLSegmentationNode* InputSegmentationNode{ nullptr };
  vtkDMMLDisplayableNode* SourceGeometryNode{ nullptr };
...
private:
  vtkCjyxSegmentationGeometryLogic(const vtkCjyxSegmentationGeometryLogic&) = delete;
  void operator=(const vtkCjyxSegmentationGeometryLogic&) = delete;
};
