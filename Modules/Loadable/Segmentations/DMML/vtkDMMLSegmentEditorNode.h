...
#ifndef __vtkDMMLSegmentEditorNode_h
#define __vtkDMMLSegmentEditorNode_h
...
#include "vtkCjyxSegmentationsModuleDMMLExport.h"
...
///
class VTK_CJYX_SEGMENTATIONS_MODULE_DMML_EXPORT vtkDMMLSegmentEditorNode : public vtkDMMLNode
{
public:
  enum
    {
...
public:
  static vtkDMMLSegmentEditorNode *New();
  vtkTypeMacro(vtkDMMLSegmentEditorNode, vtkDMMLNode);
...
public:
  ...
  vtkDMMLScalarVolumeNode* GetMasterVolumeNode();
  void SetAndObserveMasterVolumeNode(vtkDMMLScalarVolumeNode* node);
  //@}

  //@{
  /// Get/set segmentation node
  vtkDMMLSegmentationNode* GetSegmentationNode();
  void SetAndObserveSegmentationNode(vtkDMMLSegmentationNode* node);
  //@}
  ...
  /// Uses vtkDMMLSegmentationNode::EditAllowed_... constants.
  /// \sa vtkDMMLSegmentationNode::EditAllowedEverywhere, vtkDMMLSegmentationNode::EditAllowedInsideAllSegments,
  /// vtkDMMLSegmentationNode::EditAllowedInsideVisibleSegments, vtkDMMLSegmentationNode::EditAllowedOutsideAllSegments,
  /// vtkDMMLSegmentationNode::EditAllowedOutsideVisibleSegments, vtkDMMLSegmentationNode::EditAllowedInsideSingleSegment
  ...
  /// \sa vtkDMMLSegmentationNode::EditAllowedInsideSingleSegment, SetMaskMode
...
protected:
  vtkDMMLSegmentEditorNode();
  ~vtkDMMLSegmentEditorNode() override;
  vtkDMMLSegmentEditorNode(const vtkDMMLSegmentEditorNode&);
  void operator=(const vtkDMMLSegmentEditorNode&);
  ...
  int MaskMode{vtkDMMLSegmentationNode::EditAllowedEverywhere};
...
#endif // __vtkDMMLSegmentEditorNode_h
