...
#ifndef __qCjyxSubjectHierarchySceneViewsPlugin_h
#define __qCjyxSubjectHierarchySceneViewsPlugin_h

// SubjectHierarchy Plugins includes
#include "qCjyxSubjectHierarchyAbstractPlugin.h"

#include "qCjyxSceneViewsSubjectHierarchyPluginsExport.h"

class qCjyxSubjectHierarchySceneViewsPluginPrivate;
class vtkDMMLNode;
class vtkDMMLSubjectHierarchyNode;

/// \ingroup Cjyx_QtModules_SubjectHierarchy_Widgets
class Q_CJYX_SCENEVIEWS_SUBJECT_HIERARCHY_PLUGINS_EXPORT qCjyxSubjectHierarchySceneViewsPlugin : public qCjyxSubjectHierarchyAbstractPlugin
{
public:
  Q_OBJECT
...
public:
  ...
  qCjyxSubjectHierarchySceneViewsPlugin(QObject* parent = nullptr);
  ~qCjyxSubjectHierarchySceneViewsPlugin() override;
...
protected:
  QScopedPointer<qCjyxSubjectHierarchySceneViewsPluginPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qCjyxSubjectHierarchySceneViewsPlugin);
  Q_DISABLE_COPY(qCjyxSubjectHierarchySceneViewsPlugin);
};
