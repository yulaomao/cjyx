/*=auto=========================================================================
  ...
  Program:   3D Cjyx
  Module:    $RCSfile: vtkCjyxCropVolumeLogic.cxx,v $
...
//----------------------------------------------------------------------------
class vtkCjyxCropVolumeLogic::vtkInternal
{
public:
  vtkInternal();
  static void GetROIXYZ(vtkDMMLDisplayableNode* roi, double* xyz)
    {
    vtkDMMLAnnotationROINode* annotationROI = vtkDMMLAnnotationROINode::SafeDownCast(roi);
    vtkDMMLMarkupsROINode* markupsROI = vtkDMMLMarkupsROINode::SafeDownCast(roi);
    if (annotationROI)
      {
      ...
      {
      vtkGenericWarningMacro("vtkCjyxCropVolumeLogic::vtkInternal::GetROIXYZ failed: invalid ROI");
      }
    }

  static void SetROIXYZ(vtkDMMLDisplayableNode* roi, double* xyz)
    {
    vtkDMMLAnnotationROINode* annotationROI = vtkDMMLAnnotationROINode::SafeDownCast(roi);
    vtkDMMLMarkupsROINode* markupsROI = vtkDMMLMarkupsROINode::SafeDownCast(roi);
    if (annotationROI)
      ...
      {
      vtkGenericWarningMacro("vtkCjyxCropVolumeLogic::vtkInternal::SetXYZ failed: invalid ROI");
      }
    }

  static void GetROIRadius(vtkDMMLDisplayableNode* roi, double* radius)
    {
    vtkDMMLAnnotationROINode* annotationROI = vtkDMMLAnnotationROINode::SafeDownCast(roi);
    vtkDMMLMarkupsROINode* markupsROI = vtkDMMLMarkupsROINode::SafeDownCast(roi);
    if (annotationROI)
      ...
      {
      vtkGenericWarningMacro("vtkCjyxCropVolumeLogic::vtkInternal::GetROIRadius failed: invalid ROI");
      }
    }

  static void SetROIRadius(vtkDMMLDisplayableNode* roi, double* radius)
    {
    vtkDMMLAnnotationROINode* annotationROI = vtkDMMLAnnotationROINode::SafeDownCast(roi);
    vtkDMMLMarkupsROINode* markupsROI = vtkDMMLMarkupsROINode::SafeDownCast(roi);
    if (annotationROI)
      ...
      {
      vtkGenericWarningMacro("vtkCjyxCropVolumeLogic::vtkInternal::SetROIRadius failed: invalid ROI");
      }
    }


  static void GetMatrixTransformFromObjectToNode(vtkDMMLDisplayableNode* roi, vtkDMMLTransformableNode* toNode, vtkMatrix4x4* objectToNode)
    {
    vtkDMMLTransformNode::GetMatrixTransformBetweenNodes(roi->GetParentTransformNode(), toNode->GetParentTransformNode(), objectToNode);
    vtkDMMLMarkupsROINode* markupsROI = vtkDMMLMarkupsROINode::SafeDownCast(roi);
    if (markupsROI)
      {
  ...
  static void GetObjectToVolumeIJK(vtkDMMLDisplayableNode* roi, vtkDMMLVolumeNode* volumeNode, vtkMatrix4x4* objectToVolumeIJK)
    {
...
//----------------------------------------------------------------------------
vtkCjyxCropVolumeLogic::vtkInternal::vtkInternal()=default;

//----------------------------------------------------------------------------
vtkStandardNewMacro(vtkCjyxCropVolumeLogic);

//----------------------------------------------------------------------------
vtkCjyxCropVolumeLogic::vtkCjyxCropVolumeLogic()
{
...
//----------------------------------------------------------------------------
void vtkCjyxCropVolumeLogic::PrintSelf(ostream& os, vtkIndent indent)
{
  this->vtkObject::PrintSelf(os, indent);
  os << indent << "vtkCjyxCropVolumeLogic:             " << this->GetClassName() << "\n";
}

//----------------------------------------------------------------------------
void vtkCjyxCropVolumeLogic::RegisterNodes()
{
  if (!this->GetDMMLScene())
    {
    return;
    }
  this->GetDMMLScene()->RegisterNodeClass(vtkSmartPointer<vtkDMMLCropVolumeParametersNode>::New());
}

//----------------------------------------------------------------------------
int vtkCjyxCropVolumeLogic::Apply(vtkDMMLCropVolumeParametersNode* pnode)
{
  ...
  vtkDMMLVolumeNode* inputVolume = vtkDMMLVolumeNode::SafeDownCast(scene->GetNodeByID(pnode->GetInputVolumeNodeID()));
  vtkDMMLDisplayableNode* inputROI = vtkDMMLDisplayableNode::SafeDownCast(scene->GetNodeByID(pnode->GetROINodeID()));
  vtkDMMLAnnotationROINode* inputAnnotationROI = vtkDMMLAnnotationROINode::SafeDownCast(inputROI);
  vtkDMMLMarkupsROINode* inputMarkupsROI = vtkDMMLMarkupsROINode::SafeDownCast(inputROI);
  if (!inputVolume || (!inputAnnotationROI && !inputMarkupsROI))
    {
    vtkErrorMacro("CropVolume: Invalid input volume or ROI");
    return -1;
    }
  if (vtkDMMLDiffusionTensorVolumeNode::SafeDownCast(inputVolume))
    {
  ...
  vtkDMMLVolumeNode *outputVolume =
    vtkDMMLVolumeNode::SafeDownCast(scene->GetNodeByID(pnode->GetOutputVolumeNodeID()));
  if (outputVolume)
    {
    ...
    vtkCjyxVolumesLogic* volumesLogic =
      vtkCjyxVolumesLogic::SafeDownCast(this->GetModuleLogic("Volumes"));
    ...
    outputVolume = volumesLogic->CloneVolume(this->GetDMMLScene(), inputVolume, outSS.str().c_str());
    if (!outputVolume)
      {
      vtkErrorMacro("CropVolume: failed to create output volume");
      return -2;
      }
    vtkDMMLTransformNode *outputTransform = outputVolume->GetParentTransformNode();
...
//----------------------------------------------------------------------------
bool vtkCjyxCropVolumeLogic::GetVoxelBasedCropOutputExtent(vtkDMMLDisplayableNode* roi, vtkDMMLVolumeNode* inputVolume,
  int outputExtent[6], bool limitToInputExtent/*=true*/)
{
  ...
  vtkDMMLTransformNode* roiTransform = roi->GetParentTransformNode();
  ...
  if (inputVolume->GetParentTransformNode() && !inputVolume->GetParentTransformNode()->IsTransformToWorldLinear())
    {
    vtkGenericWarningMacro("vtkCjyxCropVolumeLogic::CropVoxelBased: voxel-based cropping of non-linearly transformed input volume is not supported");
    return -1;
    }

  vtkNew<vtkMatrix4x4> objectToVolumeIJKTransformMatrix;
  vtkCjyxCropVolumeLogic::vtkInternal::GetObjectToVolumeIJK(roi, inputVolume, objectToVolumeIJKTransformMatrix);

  double roiXYZ[3] = { 0.0, 0.0, 0.0 };
  double roiRadius[3] = { 0.0, 0.0, 0.0 };
  vtkCjyxCropVolumeLogic::vtkInternal::GetROIXYZ(roi, roiXYZ);
  vtkCjyxCropVolumeLogic::vtkInternal::GetROIRadius(roi, roiRadius);
...
//----------------------------------------------------------------------------
int vtkCjyxCropVolumeLogic::CropVoxelBased(vtkDMMLDisplayableNode* roi,
  vtkDMMLVolumeNode* inputVolume, vtkDMMLVolumeNode* outputVolume, bool limitToInputExtent/*=true*/, double fillValue/*=0.0*/)
{
  ...
  if (!inputVolume->GetImageData())
    {
    vtkGenericWarningMacro("vtkCjyxCropVolumeLogic::CropVoxelBased: input image is empty");
    outputVolume->SetAndObserveImageData(nullptr);
    return 0;
    }

  int outputExtent[6] = { 0, -1, 0, -1, 0, -1 };
  if (!vtkCjyxCropVolumeLogic::GetVoxelBasedCropOutputExtent(roi, inputVolume, outputExtent, limitToInputExtent))
    {
    vtkGenericWarningMacro("vtkCjyxCropVolumeLogic::CropVoxelBased: failed to get output geometry");
    return -1;
    }
...
//----------------------------------------------------------------------------
bool vtkCjyxCropVolumeLogic::GetInterpolatedCropOutputGeometry(vtkDMMLDisplayableNode* roi, vtkDMMLVolumeNode* inputVolume,
  bool isotropicResampling, double spacingScale, int outputExtent[6], double outputSpacing[3])
{
  ...
  if (isotropicResampling)
    ...
    vtkDMMLTransformNode::GetTransformBetweenNodes(inputVolume->GetParentTransformNode(),
      roi->GetParentTransformNode(), volumeToObjectTransform.GetPointer());
    if (vtkDMMLTransformNode::IsGeneralTransformLinear(volumeToObjectTransform.GetPointer(), volumeToObjectTransformLinear.GetPointer()))
      {
...
//----------------------------------------------------------------------------
int vtkCjyxCropVolumeLogic::CropInterpolated(vtkDMMLDisplayableNode* roi, vtkDMMLVolumeNode* inputVolume, vtkDMMLVolumeNode* outputVolume,
  bool isotropicResampling, double spacingScale, int interpolationMode, double fillValue)
{
  ...
  vtkCjyxCLIModuleLogic* resampleLogic =
    vtkCjyxCLIModuleLogic::SafeDownCast(this->GetModuleLogic("ResampleScalarVectorDWIVolume"));
  if (!resampleLogic)
    {
  ...
  if (roiTransform && !roiTransform->IsTransformToWorldLinear())
    ...
    vtkErrorMacro("vtkCjyxCropVolumeLogic::CropInterpolated: ROI is under a non-linear transform");
    return -5;
    }
  if (outputTransform && !outputTransform->IsTransformToWorldLinear())
    {
    // The resample module can only create a rectangular output.
    vtkErrorMacro("vtkCjyxCropVolumeLogic::CropInterpolated: output volume is under a non-linear transform");
    return -6;
    }

  vtkNew<vtkMatrix4x4> roiMatrix;
  vtkCjyxCropVolumeLogic::vtkInternal::GetMatrixTransformFromObjectToNode(roi, outputVolume, roiMatrix);
  ...
  vtkDMMLCommandLineModuleNode* cmdNode = resampleLogic->CreateNodeInScene();
  if (cmdNode == nullptr)
    {
  ...
  vtkNew<vtkDMMLMarkupsFiducialNode> originMarkupNode;
  ...
  this->GetDMMLScene()->AddNode(originMarkupNode.GetPointer());
  ...
  vtkDMMLTransformNode* inputToRASTransformNodeToRemove = nullptr;
  if (inputVolume->GetParentTransformNode() != nullptr)
    ...
    vtkNew<vtkDMMLTransformNode> inputToRASTransformNode;
    inputToRASTransformNode->SetAndObserveTransformToParent(inputToRASTransform.GetPointer());
    this->GetDMMLScene()->AddNode(inputToRASTransformNode.GetPointer());
  ...
  switch (interpolationMode)
    {
    case vtkDMMLCropVolumeParametersNode::InterpolationNearestNeighbor:
      interp = "nn";
      break;
    case vtkDMMLCropVolumeParametersNode::InterpolationLinear:
      interp = "linear";
      break;
    case vtkDMMLCropVolumeParametersNode::InterpolationWindowedSinc:
      interp = "ws";
      break;
    case vtkDMMLCropVolumeParametersNode::InterpolationBSpline:
      interp = "bs";
      break;
    }
  ...
  this->GetDMMLScene()->RemoveNode(cmdNode);
  this->GetDMMLScene()->RemoveNode(originMarkupNode.GetPointer());
  if (inputToRASTransformNodeToRemove != nullptr)
    {
    this->GetDMMLScene()->RemoveNode(inputToRASTransformNodeToRemove);
    }
...
//-----------------------------------------------------------------------------
bool vtkCjyxCropVolumeLogic::FitROIToInputVolume(vtkDMMLCropVolumeParametersNode* parametersNode)
{
  if (!parametersNode)
    {
    return false;
    }
  vtkDMMLDisplayableNode* roiNode = parametersNode->GetROINode();
  vtkDMMLVolumeNode* volumeNode = parametersNode->GetInputVolumeNode();
  if (!roiNode || !volumeNode)
    {
    return false;
    }

  vtkDMMLTransformNode* roiTransform = roiNode->GetParentTransformNode();
  if (roiTransform && !roiTransform->IsTransformToWorldLinear())
    {
    roiTransform = nullptr;
  ...
  vtkDMMLTransformNode::GetMatrixTransformBetweenNodes(nullptr, roiTransform, worldToObject.GetPointer());

  vtkDMMLMarkupsROINode* markupsROI = vtkDMMLMarkupsROINode::SafeDownCast(roiNode);
  if (markupsROI)
    {
  ...
  vtkCjyxCropVolumeLogic::vtkInternal::SetROIXYZ(roiNode, roiCenter);
  vtkCjyxCropVolumeLogic::vtkInternal::SetROIRadius(roiNode, roiRadius);

  return true;
}

//----------------------------------------------------------------------------
void vtkCjyxCropVolumeLogic::SnapROIToVoxelGrid(vtkDMMLCropVolumeParametersNode* parametersNode)
{
  ...
  vtkDMMLMarkupsROINode* markupsROI = vtkDMMLMarkupsROINode::SafeDownCast(parametersNode->GetROINode());
  ...
  if (!markupsROI && parametersNode->GetROINode()->GetParentTransformNode() != nullptr)
    ...
    if (IsROIAlignedWithInputVolume(parametersNode))
      ...
      vtkCjyxCropVolumeLogic::vtkInternal::SetROIXYZ(parametersNode->GetROINode(), xyz);
      vtkCjyxCropVolumeLogic::vtkInternal::SetROIRadius(parametersNode->GetROINode(), radius);
      return;
      }
    }
  ...
  if (markupsROI)
    ...
    vtkDMMLTransformNode::GetMatrixTransformBetweenNodes(parametersNode->GetInputVolumeNode()->GetParentTransformNode(),
    ...
    DMMLNodeModifyBlocker blocker(markupsROI);
    markupsROI->GetObjectToNodeMatrix()->DeepCopy(volumeIJKToObjectLocal);
    markupsROI->UpdateControlPointsFromROI();
    markupsROI->Modified();

    vtkDMMLTransformNode::GetMatrixTransformBetweenNodes(nullptr, markupsROI->GetParentTransformNode(), worldToObjectTransformMatrix);
    vtkNew<vtkMatrix4x4> localToObjectMatrix;
    vtkMatrix4x4::Invert(markupsROI->GetObjectToNodeMatrix(), localToObjectMatrix);
    ...
    if (!parametersNode->GetROIAlignmentTransformNode())
      {
      vtkNew<vtkDMMLTransformNode> roiTransformNode;
  ...
  vtkCjyxCropVolumeLogic::vtkInternal::SetROIXYZ(parametersNode->GetROINode(), roiCenter);
  ...
  vtkCjyxCropVolumeLogic::vtkInternal::SetROIRadius(parametersNode->GetROINode(), radius_ROI);
}

//----------------------------------------------------------------------------
bool vtkCjyxCropVolumeLogic::IsROIAlignedWithInputVolume(vtkDMMLCropVolumeParametersNode* parametersNode)
{
  if (!parametersNode || !parametersNode->GetInputVolumeNode() || !parametersNode->GetROINode())
    {
    // no misalignment (not enough nodes to be misaligned)
  ...
  vtkNew<vtkMatrix4x4> objectToVolumeIJKTransformMatrix;
  vtkCjyxCropVolumeLogic::vtkInternal::GetObjectToVolumeIJK(parametersNode->GetROINode(), parametersNode->GetInputVolumeNode(),
