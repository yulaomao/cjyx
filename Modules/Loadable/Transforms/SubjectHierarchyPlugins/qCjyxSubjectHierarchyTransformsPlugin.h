...
#ifndef __qCjyxSubjectHierarchyTransformsPlugin_h
#define __qCjyxSubjectHierarchyTransformsPlugin_h

// SubjectHierarchy includes
#include "qCjyxSubjectHierarchyAbstractPlugin.h"

#include "qCjyxTransformsSubjectHierarchyPluginsExport.h"

class qCjyxSubjectHierarchyTransformsPluginPrivate;

/// \ingroup Cjyx_QtModules_SubjectHierarchy_Plugins
class Q_CJYX_TRANSFORMS_SUBJECT_HIERARCHY_PLUGINS_EXPORT qCjyxSubjectHierarchyTransformsPlugin : public qCjyxSubjectHierarchyAbstractPlugin
{
public:
  Q_OBJECT
...
public:
  ...
  qCjyxSubjectHierarchyTransformsPlugin(QObject* parent = nullptr);
  ~qCjyxSubjectHierarchyTransformsPlugin() override;
...
protected:
  QScopedPointer<qCjyxSubjectHierarchyTransformsPluginPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qCjyxSubjectHierarchyTransformsPlugin);
  Q_DISABLE_COPY(qCjyxSubjectHierarchyTransformsPlugin);
};
