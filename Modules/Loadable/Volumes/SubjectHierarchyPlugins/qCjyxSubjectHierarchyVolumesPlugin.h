...
#ifndef __qCjyxSubjectHierarchyVolumesPlugin_h
#define __qCjyxSubjectHierarchyVolumesPlugin_h
...
class qCjyxSubjectHierarchyVolumesPluginPrivate;
class vtkDMMLScalarVolumeNode;

/// \ingroup Cjyx_QtModules_SubjectHierarchy_Plugins
class Q_CJYX_VOLUMES_SUBJECT_HIERARCHY_PLUGINS_EXPORT qCjyxSubjectHierarchyVolumesPlugin : public qCjyxSubjectHierarchyAbstractPlugin
{
public:
  Q_OBJECT
  QVTK_OBJECT
...
public:
  ...
  qCjyxSubjectHierarchyVolumesPlugin(QObject* parent = nullptr);
  ~qCjyxSubjectHierarchyVolumesPlugin() override;
...
public:
  ...
  void showVolumeInAllViews(vtkDMMLScalarVolumeNode* node, int layer=vtkDMMLApplicationLogic::BackgroundLayer);

  /// Hide given volume from all layers of all slice views
  void hideVolumeFromAllViews(vtkDMMLScalarVolumeNode* node);
...
protected:
  QScopedPointer<qCjyxSubjectHierarchyVolumesPluginPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qCjyxSubjectHierarchyVolumesPlugin);
  Q_DISABLE_COPY(qCjyxSubjectHierarchyVolumesPlugin);
};
