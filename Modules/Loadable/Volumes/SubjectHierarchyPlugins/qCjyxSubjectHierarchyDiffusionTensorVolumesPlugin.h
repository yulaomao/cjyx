...
#ifndef __qCjyxSubjectHierarchyDiffusionTensorVolumesPlugin_h
#define __qCjyxSubjectHierarchyDiffusionTensorVolumesPlugin_h
...
class qCjyxSubjectHierarchyDiffusionTensorVolumesPluginPrivate;
class vtkDMMLScalarVolumeNode;

/// \ingroup Cjyx_QtModules_SubjectHierarchy_Plugins
class Q_CJYX_VOLUMES_SUBJECT_HIERARCHY_PLUGINS_EXPORT qCjyxSubjectHierarchyDiffusionTensorVolumesPlugin : public qCjyxSubjectHierarchyAbstractPlugin
{
public:
  Q_OBJECT
...
public:
  ...
  qCjyxSubjectHierarchyDiffusionTensorVolumesPlugin(QObject* parent = nullptr);
  ~qCjyxSubjectHierarchyDiffusionTensorVolumesPlugin() override;
...
protected:
  QScopedPointer<qCjyxSubjectHierarchyDiffusionTensorVolumesPluginPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qCjyxSubjectHierarchyDiffusionTensorVolumesPlugin);
  Q_DISABLE_COPY(qCjyxSubjectHierarchyDiffusionTensorVolumesPlugin);
};
