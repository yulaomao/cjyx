...
#ifndef __qCjyxDiffusionTensorVolumeDisplayWidgetPlugin_h
#define __qCjyxDiffusionTensorVolumeDisplayWidgetPlugin_h
...
public:
  qCjyxDiffusionTensorVolumeDisplayWidgetPlugin(QObject *_parent = nullptr);
