...
#ifndef __qCjyxLabelMapVolumeDisplayWidgetPlugin_h
#define __qCjyxLabelMapVolumeDisplayWidgetPlugin_h
...
public:
  qCjyxLabelMapVolumeDisplayWidgetPlugin(QObject *_parent = nullptr);
