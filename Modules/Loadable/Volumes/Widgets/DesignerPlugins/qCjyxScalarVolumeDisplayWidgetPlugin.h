...
#ifndef __qCjyxScalarVolumeDisplayWidgetPlugin_h
#define __qCjyxScalarVolumeDisplayWidgetPlugin_h
...
public:
  qCjyxScalarVolumeDisplayWidgetPlugin(QObject *_parent = nullptr);
