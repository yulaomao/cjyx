...
#ifndef __qCjyxSubjectHierarchyFolderPlugin_h
#define __qCjyxSubjectHierarchyFolderPlugin_h
...
class qCjyxSubjectHierarchyFolderPluginPrivate;
...
///    display settings of the folder. A special display node type vtkDMMLFolderDisplayNode
///    is used.
///
...
///
class Q_CJYX_MODULE_SUBJECTHIERARCHY_WIDGETS_EXPORT qCjyxSubjectHierarchyFolderPlugin : public qCjyxSubjectHierarchyAbstractPlugin
{
public:
  Q_OBJECT
  QVTK_OBJECT
...
public:
  ...
  qCjyxSubjectHierarchyFolderPlugin(QObject* parent = nullptr);
  ~qCjyxSubjectHierarchyFolderPlugin() override;
...
public:
  ...
  vtkDMMLDisplayNode* createDisplayNodeForItem(vtkIdType itemID);
...
protected:
  ...
  /// with a display node.
  vtkDMMLDisplayNode* displayNodeForItem(vtkIdType itemID)const;
...
protected:
  QScopedPointer<qCjyxSubjectHierarchyFolderPluginPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qCjyxSubjectHierarchyFolderPlugin);
  Q_DISABLE_COPY(qCjyxSubjectHierarchyFolderPlugin);
};
