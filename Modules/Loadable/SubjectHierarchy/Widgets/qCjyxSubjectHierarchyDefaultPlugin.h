...
#ifndef __qCjyxSubjectHierarchyDefaultPlugin_h
#define __qCjyxSubjectHierarchyDefaultPlugin_h
...
class qCjyxSubjectHierarchyDefaultPluginPrivate;
class QIcon;
...
class Q_CJYX_MODULE_SUBJECTHIERARCHY_WIDGETS_EXPORT qCjyxSubjectHierarchyDefaultPlugin : public qCjyxSubjectHierarchyAbstractPlugin
{
public:
  Q_OBJECT
...
public:
  ...
  qCjyxSubjectHierarchyDefaultPlugin(QObject* parent = nullptr);
  ~qCjyxSubjectHierarchyDefaultPlugin() override;
...
protected:
  QScopedPointer<qCjyxSubjectHierarchyDefaultPluginPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qCjyxSubjectHierarchyDefaultPlugin);
  Q_DISABLE_COPY(qCjyxSubjectHierarchyDefaultPlugin);
};
