...
#ifndef __qCjyxSubjectHierarchyScriptedPlugin_h
#define __qCjyxSubjectHierarchyScriptedPlugin_h
...
///
class Q_CJYX_MODULE_SUBJECTHIERARCHY_WIDGETS_EXPORT qCjyxSubjectHierarchyScriptedPlugin
  : public qCjyxSubjectHierarchyAbstractPlugin
{
  Q_OBJECT

public:
  typedef qCjyxSubjectHierarchyAbstractPlugin Superclass;
  qCjyxSubjectHierarchyScriptedPlugin(QObject* parent = nullptr);
  ~qCjyxSubjectHierarchyScriptedPlugin() override;
...
protected:
  QScopedPointer<qCjyxSubjectHierarchyScriptedPluginPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qCjyxSubjectHierarchyScriptedPlugin);
  Q_DISABLE_COPY(qCjyxSubjectHierarchyScriptedPlugin);
};
