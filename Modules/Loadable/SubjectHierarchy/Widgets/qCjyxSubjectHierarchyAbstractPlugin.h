...
#ifndef __qCjyxSubjectHierarchyAbstractPlugin_h
#define __qCjyxSubjectHierarchyAbstractPlugin_h
...
/// subject hierarchy items. To exercise the default implementations, a Default plugin \sa qCjyxSubjectHierarchyDefaultPlugin
/// has to be created.
///
...
///
class Q_CJYX_MODULE_SUBJECTHIERARCHY_WIDGETS_EXPORT qCjyxSubjectHierarchyAbstractPlugin : public QObject
{
  Q_OBJECT
...
public:
  ...
  qCjyxSubjectHierarchyAbstractPlugin(QObject* parent = nullptr);
  ~qCjyxSubjectHierarchyAbstractPlugin() override;
...
public:
  ...
  ///   qCjyxTerminologyItemDelegate::TerminologyRole        : string
  ///   qCjyxTerminologyItemDelegate::NameRole               : string
  ///   qCjyxTerminologyItemDelegate::NameAutoGeneratedRole  : bool
  ///   qCjyxTerminologyItemDelegate::ColorAutoGeneratedRole : bool
...
public:
  ...
  /// call \sa vtkDMMLSubjectHierarchyNode::CreateItem
  /// \param node Node to add to subject hierarchy
  /// \param parentItemID Parent item of the added node
  /// \return True if added successfully, false otherwise
  virtual bool addNodeToSubjectHierarchy(vtkDMMLNode* node, vtkIdType parentItemID);
  ...
  virtual bool showItemInView(vtkIdType itemID, vtkDMMLAbstractViewNode* viewNode, vtkIdList* allItemsToShow);
...
public:
  ...
  Q_INVOKABLE static qCjyxAbstractModuleWidget* switchToModule(QString moduleName);
...
private:
  qCjyxSubjectHierarchyAbstractPlugin(const qCjyxSubjectHierarchyAbstractPlugin&); // Not implemented
  void operator=(const qCjyxSubjectHierarchyAbstractPlugin&); // Not implemented
  friend class qDMMLSubjectHierarchyTreeView;
  friend class qCjyxSubjectHierarchyPluginLogic;
};
