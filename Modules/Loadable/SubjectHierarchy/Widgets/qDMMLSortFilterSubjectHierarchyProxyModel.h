...
#ifndef __qDMMLSortFilterSubjectHierarchyProxyModel_h
#define __qDMMLSortFilterSubjectHierarchyProxyModel_h
...
class Q_CJYX_MODULE_SUBJECTHIERARCHY_WIDGETS_EXPORT qDMMLSortFilterSubjectHierarchyProxyModel : public QSortFilterProxyModel
{
  Q_OBJECT
  QVTK_OBJECT
  ...
  /// All the nodes are visible (invalid item ID - vtkDMMLSubjectHierarchyNode::INVALID_ITEM_ID) by default
  ...
  /// This property controls which items are visible. The DMML node class name must be provided.
  /// An empty list means all the nodes are visible (default).
  Q_PROPERTY(QStringList nodeTypes READ nodeTypes WRITE setNodeTypes)
  /// This property controls the items to hide by DMML node type
...
public:
  ...
  qDMMLSortFilterSubjectHierarchyProxyModel(QObject *parent=nullptr);
  ~qDMMLSortFilterSubjectHierarchyProxyModel() override;
  ...
  /// Retrieve the index of the DMML scene (the root item) in the subject hierarchy tree
...
protected:
  QScopedPointer<qDMMLSortFilterSubjectHierarchyProxyModelPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qDMMLSortFilterSubjectHierarchyProxyModel);
  Q_DISABLE_COPY(qDMMLSortFilterSubjectHierarchyProxyModel);
  friend class qDMMLSubjectHierarchyTreeView;
};
