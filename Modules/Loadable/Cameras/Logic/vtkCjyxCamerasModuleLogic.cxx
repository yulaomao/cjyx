...
//---------------------------------------------------------------------------
vtkDMMLCameraNode* vtkCjyxCamerasModuleLogic
::GetViewActiveCameraNode(vtkDMMLViewNode* viewNode)
{
  ...
  vtkDMMLCameraNode* cameraNode = vtkDMMLCameraNode::SafeDownCast(
    this->GetDMMLScene()->GetSingletonNode(viewNode->GetLayoutName(), "vtkDMMLCameraNode"));
  return cameraNode;
}
