...
#ifndef __qCjyxSubjectHierarchyModelsPlugin_h
#define __qCjyxSubjectHierarchyModelsPlugin_h

// SubjectHierarchy includes
#include "qCjyxSubjectHierarchyAbstractPlugin.h"

#include "qCjyxModelsSubjectHierarchyPluginsExport.h"

class qCjyxSubjectHierarchyModelsPluginPrivate;

/// \ingroup Cjyx_QtModules_SubjectHierarchy_Plugins
class Q_CJYX_MODELS_SUBJECT_HIERARCHY_PLUGINS_EXPORT qCjyxSubjectHierarchyModelsPlugin : public qCjyxSubjectHierarchyAbstractPlugin
{
public:
  Q_OBJECT
...
public:
  ...
  qCjyxSubjectHierarchyModelsPlugin(QObject* parent = nullptr);
  ~qCjyxSubjectHierarchyModelsPlugin() override;
...
protected:
  QScopedPointer<qCjyxSubjectHierarchyModelsPluginPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qCjyxSubjectHierarchyModelsPlugin);
  Q_DISABLE_COPY(qCjyxSubjectHierarchyModelsPlugin);
};
