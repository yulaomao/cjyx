...
#include "qDMMLPlotChartPropertiesWidget_p.h"
...
//--------------------------------------------------------------------------
// qDMMLPlotViewViewPrivate methods

//---------------------------------------------------------------------------
qDMMLPlotChartPropertiesWidgetPrivate::qDMMLPlotChartPropertiesWidgetPrivate(qDMMLPlotChartPropertiesWidget& object)
  : q_ptr(&object)
{
...
//---------------------------------------------------------------------------
qDMMLPlotChartPropertiesWidgetPrivate::~qDMMLPlotChartPropertiesWidgetPrivate() = default;

//---------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidgetPrivate::setupUi(qDMMLWidget* widget)
{
  Q_Q(qDMMLPlotChartPropertiesWidget);

  this->Ui_qDMMLPlotChartPropertiesWidget::setupUi(widget);
  ...
  this->connect(this->plotSeriesComboBox, SIGNAL(nodeAddedByUser(vtkDMMLNode*)), this, SLOT(onPlotSeriesNodeAdded(vtkDMMLNode*)));

  QObject::connect(q, SIGNAL(dmmlSceneChanged(vtkDMMLScene*)), this->plotSeriesComboBox, SLOT(setDMMLScene(vtkDMMLScene*)));
}

// --------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidgetPrivate::updateWidgetFromDMML()
{
  Q_Q(qDMMLPlotChartPropertiesWidget);

  q->setEnabled(this->PlotChartNode != nullptr && q->dmmlScene() != nullptr);
  ...
  for (int idx = 0; idx < this->plotSeriesComboBox->nodeCount(); idx++)
    {
    vtkDMMLNode* node = this->plotSeriesComboBox->nodeFromIndex(idx);
  ...
  for (std::vector<std::string>::iterator it = plotSeriesNodesIDs.begin();
    ...
    {
    vtkDMMLPlotSeriesNode *plotSeriesNode = vtkDMMLPlotSeriesNode::SafeDownCast
      (q->dmmlScene()->GetNodeByID((*it).c_str()));
...
// --------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidget::setFontType(const QString &type)
{
  Q_D(qDMMLPlotChartPropertiesWidget);
  if (!d->PlotChartNode)
    {
    return;
    }
...
// --------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidget::setTitleFontSize(double size)
{
  Q_D(qDMMLPlotChartPropertiesWidget);
  if (!d->PlotChartNode)
    {
...
// --------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidget::setLegendFontSize(double size)
{
  Q_D(qDMMLPlotChartPropertiesWidget);
  if (!d->PlotChartNode)
    {
...
// --------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidget::setAxisTitleFontSize(double size)
{
  Q_D(qDMMLPlotChartPropertiesWidget);
  if (!d->PlotChartNode)
    {
...
// --------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidget::setAxisLabelFontSize(double size)
{
  Q_D(qDMMLPlotChartPropertiesWidget);
  if (!d->PlotChartNode)
    {
...
// --------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidgetPrivate::onPlotSeriesNodesSelected()
{
...
// --------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidgetPrivate::onPlotSeriesNodeAdded(vtkDMMLNode *node)
{
  Q_Q(qDMMLPlotChartPropertiesWidget);
  if (!this->PlotChartNode)
    {
...
// --------------------------------------------------------------------------
// qDMMLPlotChartPropertiesWidget methods

// --------------------------------------------------------------------------
qDMMLPlotChartPropertiesWidget::qDMMLPlotChartPropertiesWidget(QWidget* _parent) : Superclass(_parent)
  , d_ptr(new qDMMLPlotChartPropertiesWidgetPrivate(*this))
{
  Q_D(qDMMLPlotChartPropertiesWidget);
  d->setupUi(this);
...
// --------------------------------------------------------------------------
qDMMLPlotChartPropertiesWidget::~qDMMLPlotChartPropertiesWidget() = default;

//---------------------------------------------------------------------------
 vtkDMMLPlotChartNode* qDMMLPlotChartPropertiesWidget::dmmlPlotChartNode()const
{
  Q_D(const qDMMLPlotChartPropertiesWidget);
  return d->PlotChartNode;
}

//---------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidget::setDMMLPlotChartNode(vtkDMMLNode* node)
{
  Q_D(qDMMLPlotChartPropertiesWidget);
  vtkDMMLPlotChartNode* plotChartNode = vtkDMMLPlotChartNode::SafeDownCast(node);
  this->setDMMLPlotChartNode(plotChartNode);
}

//---------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidget::setDMMLPlotChartNode(vtkDMMLPlotChartNode* plotChartNode)
{
  Q_D(qDMMLPlotChartPropertiesWidget);
  ...
  d->qvtkReconnect(d->PlotChartNode, plotChartNode, vtkCommand::ModifiedEvent, d, SLOT(updateWidgetFromDMML()));
...
//---------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidget::setGridVisibility(bool show)
{
  Q_D(qDMMLPlotChartPropertiesWidget);
  if (!d->PlotChartNode)
  {
...
//---------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidget::setLegendVisibility(bool show)
{
  Q_D(qDMMLPlotChartPropertiesWidget);
  if (!d->PlotChartNode)
  {
...
//---------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidget::setTitle(const QString &str)
{
  Q_D(qDMMLPlotChartPropertiesWidget);
  if (!d->PlotChartNode)
  {
...
//---------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidget::setXAxisLabel(const QString &str)
{
  Q_D(qDMMLPlotChartPropertiesWidget);
  if (!d->PlotChartNode)
  {
...
//---------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidget::setYAxisLabel(const QString &str)
{
  Q_D(qDMMLPlotChartPropertiesWidget);
  if (!d->PlotChartNode)
  {
...
//---------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidget::setDMMLScene(vtkDMMLScene* newScene)
{
  Q_D(qDMMLPlotChartPropertiesWidget);
...
//---------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidget::setXAxisManualRangeEnabled(bool manual)
{
  Q_D(qDMMLPlotChartPropertiesWidget);
  if (!d->PlotChartNode)
    {
...
// --------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidget::setXAxisRangeMin(double rangeMin)
{
  Q_D(qDMMLPlotChartPropertiesWidget);
  if (!d->PlotChartNode)
    {
...
// --------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidget::setXAxisRangeMax(double rangeMax)
{
  Q_D(qDMMLPlotChartPropertiesWidget);
  if (!d->PlotChartNode)
    {
...
//---------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidget::setYAxisManualRangeEnabled(bool manual)
{
  Q_D(qDMMLPlotChartPropertiesWidget);
  if (!d->PlotChartNode)
    {
...
// --------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidget::setYAxisRangeMin(double rangeMin)
{
  Q_D(qDMMLPlotChartPropertiesWidget);
  if (!d->PlotChartNode)
    {
...
// --------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidget::setYAxisRangeMax(double rangeMax)
{
  Q_D(qDMMLPlotChartPropertiesWidget);
  if (!d->PlotChartNode)
    {
...
// --------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidget::setXAxisLogScale(bool logScale)
{
  Q_D(qDMMLPlotChartPropertiesWidget);
  if (!d->PlotChartNode)
    {
...
// --------------------------------------------------------------------------
void qDMMLPlotChartPropertiesWidget::setYAxisLogScale(bool logScale)
{
  Q_D(qDMMLPlotChartPropertiesWidget);
  if (!d->PlotChartNode)
    {
