...
#ifndef __qDMMLPlotChartPropertiesWidgetPlugin_h
#define __qDMMLPlotChartPropertiesWidgetPlugin_h
...
public:
  qDMMLPlotChartPropertiesWidgetPlugin(QObject *_parent = nullptr);
