...
#ifndef __qCjyxSubjectHierarchyPlotsPlugin_h
#define __qCjyxSubjectHierarchyPlotsPlugin_h

// SubjectHierarchy Plugins includes
#include "qCjyxSubjectHierarchyAbstractPlugin.h"

#include "qCjyxPlotsSubjectHierarchyPluginsExport.h"

class qCjyxSubjectHierarchyPlotsPluginPrivate;
class vtkDMMLPlotViewNode;
class vtkCjyxPlotsLogic;


/// \ingroup Cjyx_QtModules_SubjectHierarchy_Plugins
class Q_CJYX_PLOTS_SUBJECT_HIERARCHY_PLUGINS_EXPORT qCjyxSubjectHierarchyPlotsPlugin : public qCjyxSubjectHierarchyAbstractPlugin
{
public:
  Q_OBJECT
...
public:
  ...
  qCjyxSubjectHierarchyPlotsPlugin(QObject* parent = nullptr);
  ~qCjyxSubjectHierarchyPlotsPlugin() override;

public:

  /// Set plots module logic. Required for switching layouts and showing plot in layout.
  void setPlotsLogic(vtkCjyxPlotsLogic* plotsLogic);
...
protected:
  ...
  vtkDMMLPlotViewNode* getPlotViewNode()const;

protected:
  QScopedPointer<qCjyxSubjectHierarchyPlotsPluginPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qCjyxSubjectHierarchyPlotsPlugin);
  Q_DISABLE_COPY(qCjyxSubjectHierarchyPlotsPlugin);
};
