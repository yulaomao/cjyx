...
#ifndef __vtkDMMLMarkupsPlaneNode_h
#define __vtkDMMLMarkupsPlaneNode_h
...
/// \brief DMML node to represent a plane markup
...
class  VTK_CJYX_MARKUPS_MODULE_DMML_EXPORT vtkDMMLMarkupsPlaneNode : public vtkDMMLMarkupsNode
{
public:
  static vtkDMMLMarkupsPlaneNode *New();
  vtkTypeMacro(vtkDMMLMarkupsPlaneNode,vtkDMMLMarkupsNode);
  ...
  vtkDMMLCopyContentMacro(vtkDMMLMarkupsPlaneNode);
...
protected:
  ...
  vtkDMMLMarkupsPlaneNode();
  ~vtkDMMLMarkupsPlaneNode() override;
  vtkDMMLMarkupsPlaneNode(const vtkDMMLMarkupsPlaneNode&);
  void operator=(const vtkDMMLMarkupsPlaneNode&);
...
protected:
  ...
  friend class vtkCjyxPlaneWidget; // To directly access plane update functions
  friend class vtkCjyxPlaneRepresentation3D; // To directly access plane update functions
  friend class vtkCjyxPlaneRepresentation2D; // To directly access plane update functions
};
