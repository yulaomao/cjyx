...
//----------------------------------------------------------------------------
vtkDMMLNodeNewMacro(vtkDMMLMarkupsClosedCurveNode);

//----------------------------------------------------------------------------
vtkDMMLMarkupsClosedCurveNode::vtkDMMLMarkupsClosedCurveNode()
{
...
//----------------------------------------------------------------------------
vtkDMMLMarkupsClosedCurveNode::~vtkDMMLMarkupsClosedCurveNode() = default;

//---------------------------------------------------------------------------
double vtkDMMLMarkupsClosedCurveNode::GetClosedCurveSurfaceArea(vtkDMMLMarkupsClosedCurveNode* curveNode,
  vtkPolyData* inputSurface /*=nullptr*/, bool projectWarp /*=true*/)
{
  ...
  if (projectWarp)
    {
    success = vtkDMMLMarkupsClosedCurveNode::FitSurfaceProjectWarp(curvePointsWorld, surface);
    }
  else
    {
    success = vtkDMMLMarkupsClosedCurveNode::FitSurfaceDiskWarp(curvePointsWorld, surface);
    }
  if (!success)
    {
    return 0.0;
...
//---------------------------------------------------------------------------
bool vtkDMMLMarkupsClosedCurveNode::FitSurfaceProjectWarp(vtkPoints* curvePoints,
  vtkPolyData* surface, double vtkNotUsed(radiusScalingFactor)/*=1.0*/, vtkIdType numberOfInternalGridPoints/*=225*/)
{
  ...
  if (vtkDMMLMarkupsClosedCurveNode::IsPolygonClockwise(pointsOnPlane, cleanedCurvePointIds))
    {
  ...
  vtkNew<vtkDMMLMessageCollection> messages;
...
//---------------------------------------------------------------------------
bool vtkDMMLMarkupsClosedCurveNode::IsPolygonClockwise(vtkPoints* points, vtkIdList* pointIds/*=nullptr*/)
{
  if (!points)
    {
    return false;
...
//---------------------------------------------------------------------------
bool vtkDMMLMarkupsClosedCurveNode::FitSurfaceDiskWarp(vtkPoints* curvePoints, vtkPolyData* surface, double radiusScalingFactor/*=1.0*/)
{
