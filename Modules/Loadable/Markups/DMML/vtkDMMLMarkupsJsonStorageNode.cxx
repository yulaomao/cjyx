...
//---------------------------------------------------------------------------
vtkDMMLMarkupsJsonStorageNode::vtkInternal::vtkInternal(vtkDMMLMarkupsJsonStorageNode* external)
  : External(external)
{
}

//---------------------------------------------------------------------------
vtkDMMLMarkupsJsonStorageNode::vtkInternal::~vtkInternal()
{
}

//---------------------------------------------------------------------------
std::string vtkDMMLMarkupsJsonStorageNode::vtkInternal::GetCoordinateUnitsFromSceneAsString(vtkDMMLMarkupsNode* markupsNode)
{
  vtkDMMLUnitNode* unitNode = nullptr;
  if (markupsNode)
    {
...
//---------------------------------------------------------------------------
std::unique_ptr<rapidjson::Document> vtkDMMLMarkupsJsonStorageNode::vtkInternal::CreateJsonDocumentFromFile(const char* filePath)
{
  // Read document from file
  FILE* fp = fopen(filePath, "r");
  if (!fp)
    {
    vtkErrorToMessageCollectionWithObjectMacro(this->External, this->External->GetUserMessages(), "vtkDMMLMarkupsJsonStorageNode::ReadDataInternal",
...
//----------------------------------------------------------------------------
bool vtkDMMLMarkupsJsonStorageNode::vtkInternal::ReadVector(rapidjson::Value& item, double* v, int numberOfComponents/*=3*/)
{
  if (!item.IsArray())
    {
    return false;
...
//----------------------------------------------------------------------------
bool vtkDMMLMarkupsJsonStorageNode::vtkInternal::ReadControlPoints(rapidjson::Value& controlPointsArray, int coordinateSystem, vtkDMMLMarkupsNode* markupsNode)
{
  if (!markupsNode)
    {
    vtkErrorToMessageCollectionWithObjectMacro(this->External, this->External->GetUserMessages(),
      "vtkDMMLMarkupsJsonStorageNode::vtkInternal::ReadControlPoints",
  ...
  for (rapidjson::SizeType controlPointIndex = 0; controlPointIndex < controlPointsArray.Size(); ++controlPointIndex)
    ...
    vtkDMMLMarkupsNode::ControlPoint* cp = new vtkDMMLMarkupsNode::ControlPoint;
    ...
    if (controlPointItem.HasMember("positionStatus"))
      {
      int positionStatus = vtkDMMLMarkupsNode::GetPositionStatusFromString(controlPointItem["positionStatus"].GetString());
      if (positionStatus < 0)
        {
        vtkErrorToMessageCollectionWithObjectMacro(this->External, this->External->GetUserMessages(),
          "vtkDMMLMarkupsJsonStorageNode::vtkInternal::ReadControlPoints",
    ...
    if (controlPointItem.HasMember("position"))
      ...
      if (!this->ReadVector(positionItem, cp->Position))
        ...
        if (!controlPointItem.HasMember("positionStatus")
          || cp->PositionStatus == vtkDMMLMarkupsNode::PositionDefined)
          {
          vtkErrorToMessageCollectionWithObjectMacro(this->External, this->External->GetUserMessages(),
            "vtkDMMLMarkupsJsonStorageNode::vtkInternal::ReadControlPoints",
      ...
      cp->PositionStatus = vtkDMMLMarkupsNode::PositionUndefined;
      }
...
//----------------------------------------------------------------------------
bool vtkDMMLMarkupsJsonStorageNode::vtkInternal::ReadMeasurements(rapidjson::Value& measurementsArray, vtkDMMLMarkupsNode* markupsNode)
{
  if (!markupsNode)
    {
    vtkErrorToMessageCollectionWithObjectMacro(this->External, this->External->GetUserMessages(),
      "vtkDMMLMarkupsJsonStorageNode::vtkInternal::ReadMeasurements",
  ...
  for (rapidjson::SizeType measurementIndex = 0; measurementIndex < measurementsArray.Size(); ++measurementIndex)
    ...
    vtkSmartPointer<vtkDMMLMeasurement> measurement = markupsNode->GetMeasurement(measurementName);
    ...
    if (measurementItem.HasMember("units"))
      ...
      if (measurementItem.HasMember("value"))
        ...
        {
        measurement->ClearValue(vtkDMMLMeasurement::InsufficientInput);
...
//----------------------------------------------------------------------------
bool vtkDMMLMarkupsJsonStorageNode::vtkInternal::UpdateMarkupsNodeFromJsonValue(vtkDMMLMarkupsNode* markupsNode, rapidjson::Value& markupObject)
{
  if (!markupsNode)
    {
    vtkErrorToMessageCollectionWithObjectMacro(this->External, this->External->GetUserMessages(),
  ...
  /// Added for backwards compatibility with storage nodes created before vtkDMMLMarkupsPlaneStorageNode or additional plane types were implemented.
  /// This check must be done here to preserve compatibility with scenes saved before vtkDMMLMarkupsPlaneJsonStorageNode was added.
  ...
  if (planeNode && !markupObject.HasMember("planeType"))
    ...
    planeNode->SetPlaneType(vtkDMMLMarkupsPlaneNode::PlaneType3Points);
    }
  ...
  if (!coordinateSystemStr.empty())
    {
    int coordinateSystemFlag = vtkDMMLMarkupsStorageNode::GetCoordinateSystemFromString(coordinateSystemStr.c_str());
...
//----------------------------------------------------------------------------
bool vtkDMMLMarkupsJsonStorageNode::vtkInternal::UpdateMarkupsDisplayNodeFromJsonValue(
  vtkDMMLMarkupsDisplayNode* displayNode, rapidjson::Value& markupObject)
{
  if (!displayNode)
    {
    vtkErrorToMessageCollectionWithObjectMacro(this->External, this->External->GetUserMessages(),
      "vtkDMMLMarkupsJsonStorageNode::vtkInternal::UpdateMarkupsDisplayNodeFromJsonValue",
  ...
  if (displayItem.HasMember("glyphType"))
    {
    int glyphType = vtkDMMLMarkupsDisplayNode::GetGlyphTypeFromString(displayItem["glyphType"].GetString());
    if (glyphType >= 0)
      {
  ...
  if (displayItem.HasMember("snapMode"))
    {
    int snapMode = vtkDMMLMarkupsDisplayNode::GetSnapModeFromString(displayItem["snapMode"].GetString());
    if (snapMode >= 0)
      {
...
//----------------------------------------------------------------------------
bool vtkDMMLMarkupsJsonStorageNode::vtkInternal::WriteMarkup(
...
//----------------------------------------------------------------------------
bool vtkDMMLMarkupsJsonStorageNode::vtkInternal::WriteBasicProperties(
  rapidjson::PrettyWriter<rapidjson::FileWriteStream>& writer, vtkDMMLMarkupsNode* markupsNode)
{

  // Write markupsType (created from class name, stripping vtkDMMLMarkups and Node)
  std::string markupsType = markupsNode->GetClassName();
  if (vtksys::SystemTools::StringStartsWith(markupsType, "vtkDMMLMarkups"))
    {
    markupsType.erase(0, strlen("vtkDMMLMarkups"));
    }
  ...
  if (markupsType.empty())
    {
    vtkErrorToMessageCollectionWithObjectMacro(this->External, this->External->GetUserMessages(),
      "vtkDMMLMarkupsJsonStorageNode::vtkInternal::WriteBasicProperties",
...
//----------------------------------------------------------------------------
bool vtkDMMLMarkupsJsonStorageNode::vtkInternal::WriteControlPoints(
  rapidjson::PrettyWriter<rapidjson::FileWriteStream>& writer, vtkDMMLMarkupsNode* markupsNode)
{
  int coordinateSystem = this->External->GetCoordinateSystem();
  if (coordinateSystem != vtkDMMLStorageNode::CoordinateSystemRAS
    && coordinateSystem != vtkDMMLStorageNode::CoordinateSystemLPS)
    {
    vtkErrorToMessageCollectionWithObjectMacro(this->External, this->External->GetUserMessages(),
      "vtkDMMLMarkupsJsonStorageNode::vtkInternal::WriteControlPoints",
  ...
  for (int controlPointIndex = 0; controlPointIndex < numberOfControlPoints; controlPointIndex++)
    {
    vtkDMMLMarkupsNode::ControlPoint* cp = markupsNode->GetNthControlPoint(controlPointIndex);
    ...
    if(cp->PositionStatus == vtkDMMLMarkupsNode::PositionDefined)
      {
    ...
    writer.Key("positionStatus"); writer.String(vtkDMMLMarkupsNode::GetPositionStatusAsString(cp->PositionStatus));
...
//----------------------------------------------------------------------------
bool vtkDMMLMarkupsJsonStorageNode::vtkInternal::WriteMeasurements(
  rapidjson::PrettyWriter<rapidjson::FileWriteStream> &writer, vtkDMMLMarkupsNode* markupsNode)
{
  ...
  for (int measurementIndex = 0; measurementIndex < numberOfMeasurements; measurementIndex++)
    {
    vtkDMMLMeasurement* measurement = markupsNode->GetNthMeasurement(measurementIndex);
...
//----------------------------------------------------------------------------
bool vtkDMMLMarkupsJsonStorageNode::vtkInternal::WriteDisplayProperties(
  rapidjson::PrettyWriter<rapidjson::FileWriteStream>& writer, vtkDMMLMarkupsDisplayNode* markupsDisplayNode)
{
  if (!markupsDisplayNode)
    {
    vtkErrorWithObjectMacro(this->External, "vtkDMMLMarkupsJsonStorageNode::vtkInternal::WriteDisplayProperties failed: invalid display node");
    return false;
    }
  writer.Key("display");
  writer.StartObject();
...
//----------------------------------------------------------------------------
void vtkDMMLMarkupsJsonStorageNode::vtkInternal::WriteVector(
...
//---------------------------------------------------------------------------
std::string vtkDMMLMarkupsJsonStorageNode::vtkInternal::GetMarkupsClassNameFromMarkupsType(std::string markupsType)
{
  std::string className = std::string("vtkDMMLMarkups") + markupsType + std::string("Node");
  return className;
}

//---------------------------------------------------------------------------
std::string vtkDMMLMarkupsJsonStorageNode::vtkInternal::GetMarkupsClassNameFromJsonValue(rapidjson::Value& markupObject)
{
...
//------------------------------------------------------------------------------
vtkDMMLNodeNewMacro(vtkDMMLMarkupsJsonStorageNode);

//----------------------------------------------------------------------------
vtkDMMLMarkupsJsonStorageNode::vtkDMMLMarkupsJsonStorageNode()
{
...
//----------------------------------------------------------------------------
vtkDMMLMarkupsJsonStorageNode::~vtkDMMLMarkupsJsonStorageNode() = default;

//----------------------------------------------------------------------------
void vtkDMMLMarkupsJsonStorageNode::WriteXML(ostream& of, int nIndent)
{
  Superclass::WriteXML(of,nIndent);
}

//----------------------------------------------------------------------------
void vtkDMMLMarkupsJsonStorageNode::ReadXMLAttributes(const char** atts)
{
  Superclass::ReadXMLAttributes(atts);
}

//----------------------------------------------------------------------------
void vtkDMMLMarkupsJsonStorageNode::PrintSelf(ostream& os, vtkIndent indent)
{
  Superclass::PrintSelf(os,indent);
}

//----------------------------------------------------------------------------
void vtkDMMLMarkupsJsonStorageNode::Copy(vtkDMMLNode *anode)
{
  Superclass::Copy(anode);
}

//----------------------------------------------------------------------------
bool vtkDMMLMarkupsJsonStorageNode::CanReadInReferenceNode(vtkDMMLNode *refNode)
{
  return refNode->IsA("vtkDMMLMarkupsNode");
}

//----------------------------------------------------------------------------
void vtkDMMLMarkupsJsonStorageNode::GetMarkupsTypesInFile(const char* filePath, std::vector<std::string>& outputMarkupsTypes)
{
...
//----------------------------------------------------------------------------
vtkDMMLMarkupsNode* vtkDMMLMarkupsJsonStorageNode::AddNewMarkupsNodeFromFile(const char* filePath, const char* nodeName/*=nullptr*/, int markupIndex/*=0*/)
{
  vtkDMMLScene* scene = this->GetScene();
  if (!scene)
    {
    vtkErrorToMessageCollectionMacro(this->GetUserMessages(),
      "vtkDMMLMarkupsJsonStorageNode::AddNewMarkupsNodeFromFile",
  ...
  vtkDMMLMarkupsNode* markupsNode = vtkDMMLMarkupsNode::SafeDownCast(scene->AddNewNodeByClass(className.c_str(), newNodeName));
  if (!markupsNode)
    {
    vtkErrorToMessageCollectionMacro(this->GetUserMessages(),
      "vtkDMMLMarkupsJsonStorageNode::AddNewMarkupsNodeFromFile",
  ...
  if (success && markupsNode)
    ...
    displayNode = vtkDMMLMarkupsDisplayNode::SafeDownCast(markupsNode->GetDisplayNode());
...
//----------------------------------------------------------------------------
int vtkDMMLMarkupsJsonStorageNode::ReadDataInternal(vtkDMMLNode *refNode)
{
  if (!refNode)
    {
    vtkErrorToMessageCollectionMacro(this->GetUserMessages(), "vtkDMMLMarkupsJsonStorageNode::ReadDataInternal",
  ...
  if (!markups.IsArray() || markups.GetArray().Size() < 1)
    {
    vtkErrorMacro("vtkDMMLMarkupsStorageNode::ReadDataInternal failed: cannot read " << refNode->GetClassName()
  ...
  vtkDMMLMarkupsNode* markupsNode = vtkDMMLMarkupsNode::SafeDownCast(refNode);
...
//----------------------------------------------------------------------------
int vtkDMMLMarkupsJsonStorageNode::WriteDataInternal(vtkDMMLNode *refNode)
{
  std::string fullName = this->GetFullNameFromFileName();
  if (fullName.empty())
    {
    vtkErrorToMessageCollectionMacro(this->GetUserMessages(), "vtkDMMLMarkupsJsonStorageNode::WriteDataInternal",
  ...
  if (refNode->IsA("vtkDMMLMarkupsNode"))
    {
    markupsNode = dynamic_cast <vtkDMMLMarkupsNode *> (refNode);
    }
...
//----------------------------------------------------------------------------
void vtkDMMLMarkupsJsonStorageNode::InitializeSupportedReadFileTypes()
{
...
//----------------------------------------------------------------------------
void vtkDMMLMarkupsJsonStorageNode::InitializeSupportedWriteFileTypes()
{
