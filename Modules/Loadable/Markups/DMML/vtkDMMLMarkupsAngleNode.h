...
#ifndef __vtkDMMLMarkupsAngleNode_h
#define __vtkDMMLMarkupsAngleNode_h
...
/// \brief DMML node to represent an angle markup
...
class  VTK_CJYX_MARKUPS_MODULE_DMML_EXPORT vtkDMMLMarkupsAngleNode : public vtkDMMLMarkupsNode
{
public:
  static vtkDMMLMarkupsAngleNode *New();
  vtkTypeMacro(vtkDMMLMarkupsAngleNode,vtkDMMLMarkupsNode);
  ...
  vtkDMMLCopyContentMacro(vtkDMMLMarkupsAngleNode);
...
protected:
  ...
  ~vtkDMMLMarkupsAngleNode() override;
  vtkDMMLMarkupsAngleNode(const vtkDMMLMarkupsAngleNode&);
  void operator=(const vtkDMMLMarkupsAngleNode&);
