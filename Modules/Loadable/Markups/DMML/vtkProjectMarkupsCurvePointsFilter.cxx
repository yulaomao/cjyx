...
//------------------------------------------------------------------------------
void vtkProjectMarkupsCurvePointsFilter::SetInputCurveNode(vtkDMMLMarkupsCurveNode* inputCurveNode)
{
...
//---------------------------------------------------------------------------
void vtkProjectMarkupsCurvePointsFilter::PointProjectionHelper::SetModel(vtkDMMLModelNode* model)
{
  this->Model = model;
}
...
bool vtkProjectMarkupsCurvePointsFilter::PointProjectionHelper::UpdateAll()
{
  ...
  vtkDMMLTransformNode* parentTransformNode = this->Model->GetParentTransformNode();
