...
#include <vtkDMMLMarkupsPlaneJsonStorageNode_Private.h>

//---------------------------------------------------------------------------
// vtkInternal methods

//---------------------------------------------------------------------------
vtkDMMLMarkupsPlaneJsonStorageNode::vtkInternalPlane::vtkInternalPlane(vtkDMMLMarkupsPlaneJsonStorageNode* external)
  : vtkDMMLMarkupsJsonStorageNode::vtkInternal(external)
{
}

//---------------------------------------------------------------------------
vtkDMMLMarkupsPlaneJsonStorageNode::vtkInternalPlane::~vtkInternalPlane() = default;

//----------------------------------------------------------------------------
bool vtkDMMLMarkupsPlaneJsonStorageNode::vtkInternalPlane::WriteMarkup(
  rapidjson::PrettyWriter<rapidjson::FileWriteStream>& writer, vtkDMMLMarkupsNode* markupsNode)
{
  ...
  success = success && this->WritePlaneProperties(writer, vtkDMMLMarkupsPlaneNode::SafeDownCast(markupsNode));
...
//----------------------------------------------------------------------------
bool vtkDMMLMarkupsPlaneJsonStorageNode::vtkInternalPlane::WritePlaneProperties(
  rapidjson::PrettyWriter<rapidjson::FileWriteStream>& writer, vtkDMMLMarkupsPlaneNode* planeNode)
{
  if (!planeNode)
    {
    return false;
...
//----------------------------------------------------------------------------
bool vtkDMMLMarkupsPlaneJsonStorageNode::vtkInternalPlane::UpdateMarkupsNodeFromJsonValue(vtkDMMLMarkupsNode* markupsNode, rapidjson::Value& markupsObject)
{
  vtkDMMLMarkupsPlaneNode* planeNode = vtkDMMLMarkupsPlaneNode::SafeDownCast(markupsNode);
  if (!planeNode)
    {
    vtkErrorWithObjectMacro(this->External,
      "vtkDMMLMarkupsPlaneJsonStorageNode::vtkInternalPlane::UpdateMarkupsNodeFromJsonDocument failed: invalid markupsNode");
    return false;
    }

  DMMLNodeModifyBlocker blocker(planeNode);
  ...
  if (markupsObject.HasMember("objectToBase"))
    ...
    if (!this->ReadVector(objectToBaseItem, objectToBase, 16))
      ...
      vtkErrorToMessageCollectionWithObjectMacro(this->External, this->External->GetUserMessages(),
        "vtkDMMLMarkupsPlaneJsonStorageNode::vtkInternal::UpdateMarkupsNodeFromJsonValue",
...
//------------------------------------------------------------------------------
vtkDMMLNodeNewMacro(vtkDMMLMarkupsPlaneJsonStorageNode);

//----------------------------------------------------------------------------
vtkDMMLMarkupsPlaneJsonStorageNode::vtkDMMLMarkupsPlaneJsonStorageNode()
{
  this->Internal = new vtkInternalPlane(this);
}

//----------------------------------------------------------------------------
vtkDMMLMarkupsPlaneJsonStorageNode::~vtkDMMLMarkupsPlaneJsonStorageNode() = default;

//----------------------------------------------------------------------------
bool vtkDMMLMarkupsPlaneJsonStorageNode::CanReadInReferenceNode(vtkDMMLNode *refNode)
{
  return refNode->IsA("vtkDMMLMarkupsPlaneNode");
}
