...
class vtkCjyxDijkstraGraphGeodesicPath;
...
class VTK_CJYX_MARKUPS_MODULE_DMML_EXPORT vtkCurveGenerator : public vtkPolyDataAlgorithm
{
public:
...
protected:
  ...
  vtkSmartPointer<vtkCjyxDijkstraGraphGeodesicPath> SurfacePathFilter;
