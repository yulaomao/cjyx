...
#ifndef __vtkCjyxDijkstraGraphGeodesicPath_h
#define __vtkCjyxDijkstraGraphGeodesicPath_h
...
class VTK_CJYX_MARKUPS_MODULE_DMML_EXPORT vtkCjyxDijkstraGraphGeodesicPath : public vtkDijkstraGraphGeodesicPath
{
public:
  vtkTypeMacro(vtkCjyxDijkstraGraphGeodesicPath, vtkDijkstraGraphGeodesicPath);
  static vtkCjyxDijkstraGraphGeodesicPath* New();
...
protected:
  ...
  /// Reimplemented to provide additional cost function types.
...
protected:
  vtkCjyxDijkstraGraphGeodesicPath();
  ~vtkCjyxDijkstraGraphGeodesicPath() override;
  vtkCjyxDijkstraGraphGeodesicPath(const vtkCjyxDijkstraGraphGeodesicPath&) = delete;
  void operator=(const vtkCjyxDijkstraGraphGeodesicPath&) = delete;
};
