...
//------------------------------------------------------------------------------
vtkStandardNewMacro(vtkCjyxDijkstraGraphGeodesicPath);

//------------------------------------------------------------------------------
vtkCjyxDijkstraGraphGeodesicPath::vtkCjyxDijkstraGraphGeodesicPath()
{
...
//------------------------------------------------------------------------------
vtkCjyxDijkstraGraphGeodesicPath::~vtkCjyxDijkstraGraphGeodesicPath() = default;

//------------------------------------------------------------------------------
void vtkCjyxDijkstraGraphGeodesicPath::PrintSelf(std::ostream &os, vtkIndent indent)
{
...
//------------------------------------------------------------------------------
const char* vtkCjyxDijkstraGraphGeodesicPath::GetCostFunctionTypeAsString(int costFunction)
{
  switch (costFunction)
    {
...
//------------------------------------------------------------------------------
int vtkCjyxDijkstraGraphGeodesicPath::GetCostFunctionTypeFromString(const char* costFunctionType)
{
  ...
  for (int i = 0; i < vtkCjyxDijkstraGraphGeodesicPath::COST_FUNCTION_TYPE_LAST; i++)
    {
    if (strcmp(costFunctionType, vtkCjyxDijkstraGraphGeodesicPath::GetCostFunctionTypeAsString(i)) == 0)
      {
...
//----------------------------------------------------------------------------
int vtkCjyxDijkstraGraphGeodesicPath::RequestData(
...
//------------------------------------------------------------------------------
double vtkCjyxDijkstraGraphGeodesicPath::CalculateStaticEdgeCost(vtkDataSet* inData, vtkIdType u, vtkIdType v)
{
