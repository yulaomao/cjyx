...
#ifndef __vtkDMMLMarkupsNode_h
#define __vtkDMMLMarkupsNode_h
...
///
/// Each markups node is associated with a vtkCjyxMarkupsWidget, which is responsible for
...
class  VTK_CJYX_MARKUPS_MODULE_DMML_EXPORT vtkDMMLMarkupsNode : public vtkDMMLDisplayableNode
{
  /// Make the storage node a friend so that ReadDataInternal can set the ControlPoint ids
  friend class vtkDMMLMarkupsStorageNode;
  friend class vtkDMMLMarkupsFiducialStorageNode;
  friend class vtkDMMLMarkupsJsonStorageNode;
...
public:
  ...
  vtkTypeMacro(vtkDMMLMarkupsNode,vtkDMMLDisplayableNode);
  ...
  /// coordinateSystemFlag = vtkDMMLStorageNode::CoordinateSystemRAS or vtkDMMLStorageNode::CoordinateSystemLPS
  /// multipleFlag = 1 for the whole list, 1 for the first selected control point
  void WriteCLI(std::vector<std::string>& commandLine,
                        std::string prefix, int coordinateSystem = vtkDMMLStorageNode::CoordinateSystemRAS,
                        int multipleFlag = 1) override;

  /// Copy node content (excludes basic data, such as name and node references).
  /// \sa vtkDMMLNode::CopyContent
  vtkDMMLCopyContentMacro(vtkDMMLMarkupsNode);
  ...
  vtkDMMLMeasurement* GetNthMeasurement(int id);
  vtkDMMLMeasurement* GetMeasurement(const char* name);
  void AddMeasurement(vtkDMMLMeasurement* measurement);
   ...
   */
  void SetNthMeasurement(int id, vtkDMMLMeasurement* measurement);
  ...
  /// \sa vtDMMLMarkupsNode::SetLocked
  ...
  /// \sa vtkDMMLDisplayableNode::SetDisplayVisibility
  /// \sa vtkDMMLDisplayNode::SetVisibility
  ...
  /// Any custom overrides of the interpolation modes are not persisted in DMML.
  ...
  vtkDMMLUnitNode* GetUnitNode(const char* quantity);
  ...
  {
    vtkWarningMacro("vtkDMMLMarkupsNode::RemoveAllMarkups method is deprecated, please use RemoveAllControlPoints instead");
  ...
  {
    vtkWarningMacro("vtkDMMLMarkupsNode::MarkupExists method is deprecated, please use ControlPointExists instead");
  ...
  {
    vtkWarningMacro("vtkDMMLMarkupsNode::GetNumberOfMarkups method is deprecated, please use GetNumberOfControlPoints instead");
    return this->GetNumberOfControlPoints();
  };
  /// \deprecated Use GetNumberOfControlPoints() instead.
  int GetNumberOfPointsInNthMarkup(int)
  {
    vtkWarningMacro("vtkDMMLMarkupsNode::GetNumberOfPointsInNthMarkup method is deprecated, please use GetNumberOfControlPoints instead");
    return this->GetNumberOfControlPoints();
  };
  ...
  {
    vtkWarningMacro("vtkDMMLMarkupsNode::GetMarkupPointVector method is deprecated, please use GetNthControlPointPositionVector instead");
  ...
  {
    vtkWarningMacro("vtkDMMLMarkupsNode::RemoveMarkup method is deprecated, please use RemoveNthControlPoint instead");
  ...
  {
    vtkWarningMacro("vtkDMMLMarkupsNode::SetNthControlPointPositionFromArray method is deprecated, please use SetNthControlPointPosition instead");
  ...
  {
    vtkWarningMacro("vtkDMMLMarkupsNode::SetNthControlPointPositionOrientationWorldFromArray method is deprecated,"
  ...
  {
    vtkWarningMacro("vtkDMMLMarkupsNode::GetCenterOfRotationVector method is deprecated, please use GetCenterOfRotation instead");
  ...
  {
    vtkWarningMacro("vtkDMMLMarkupsNode::SetCenterOfRotationFromArray method is deprecated, please use SetCenterOfRotation instead");
  ...
  {
    vtkWarningMacro("vtkDMMLMarkupsNode::SetNthControlPointOrientationFromArray method is deprecated, please use SetNthControlPointOrientation instead");
  ...
  {
    vtkWarningMacro("vtkDMMLMarkupsNode::GetNthMarkupAssociatedNodeID method is deprecated, please use GetNthControlPointAssociatedNodeID instead");
  ...
  {
    vtkWarningMacro("vtkDMMLMarkupsNode::SetNthMarkupAssociatedNodeID method is deprecated, please use SetNthControlPointAssociatedNodeID instead");
  ...
  {
    vtkWarningMacro("vtkDMMLMarkupsNode::GetNthMarkupID method is deprecated, please use GetNthControlPointID instead");
  ...
  {
    vtkWarningMacro("vtkDMMLMarkupsNode::GetNthMarkupLocked method is deprecated, please use GetNthControlPointLocked instead");
  ...
  {
    vtkWarningMacro("vtkDMMLMarkupsNode::SetNthMarkupLocked method is deprecated, please use SetNthControlPointLocked instead");
  ...
  {
    vtkWarningMacro("vtkDMMLMarkupsNode::GetNthMarkupLabel method is deprecated, please use GetNthControlPointLabel instead");
  ...
  {
    vtkWarningMacro("vtkDMMLMarkupsNode::SetNthMarkupLabel method is deprecated, please use SetNthControlPointLabel instead");
    this->SetNthControlPointLabel(n, label);
  };
  /// \deprecated Use GetControlPointLabelFormat instead.
  std::string GetMarkupLabelFormat()
  {
    vtkWarningMacro("vtkDMMLMarkupsNode::GetMarkupLabelFormat method is deprecated, please use GetControlPointLabelFormat instead");
  ...
  void SetMarkupLabelFormat(std::string format)
  {
    ...
    // vtkWarningMacro("vtkDMMLMarkupsNode::SetMarkupLabelFormat method is deprecated, please use SetControlPointLabelFormat instead");
  ...
  {
    vtkWarningMacro("vtkDMMLMarkupsNode::ReplaceListNameInMarkupLabelFormat method is deprecated, please use ReplaceListNameInControlPointLabelFormat instead");
    return this->ReplaceListNameInControlPointLabelFormat();
  };

protected:
  vtkDMMLMarkupsNode();
  ~vtkDMMLMarkupsNode() override;
  vtkDMMLMarkupsNode(const vtkDMMLMarkupsNode&);
  void operator=(const vtkDMMLMarkupsNode&);
  ...
  void OnTransformNodeReferenceChanged(vtkDMMLTransformNode* transformNode) override;
  ...
  friend class qCjyxMarkupsModuleWidget; // To directly access measurements
};
