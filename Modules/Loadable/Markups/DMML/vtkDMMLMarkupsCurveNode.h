...
#ifndef __vtkDMMLMarkupsCurveNode_h
#define __vtkDMMLMarkupsCurveNode_h
...
/// \brief DMML node to represent a curve markup
...
///
/// +------------------------------------------vtkMarkupsCurveNode-----------------------------------------------+
/// |  +-vtkDMMLMarkupsNode-+                                                             === : Display pipeline |
/// |  |                    |        +-vtkCurveGenerator-+                                                       |
...
class  VTK_CJYX_MARKUPS_MODULE_DMML_EXPORT vtkDMMLMarkupsCurveNode : public vtkDMMLMarkupsNode
{
public:
  static vtkDMMLMarkupsCurveNode *New();
  vtkTypeMacro(vtkDMMLMarkupsCurveNode,vtkDMMLMarkupsNode);
  ...
  vtkDMMLCopyContentMacro(vtkDMMLMarkupsCurveNode);
  ...
  /// Provides access to protected vtkDMMLMarkupsNode::SetControlPointLabelsWorld
  ...
  void SetCurveTypeToShortestDistanceOnSurface(vtkDMMLModelNode* modelNode=nullptr);
  ...
  /// \deprecated GetShortestDistanceSurfaceNodeReferenceDMMLAttributeName
  /// \sa GetSurfaceConstraintNodeReferenceDMMLAttributeName
  const char* GetShortestDistanceSurfaceNodeReferenceDMMLAttributeName() { return this->GetSurfaceConstraintNodeReferenceDMMLAttributeName(); }
  ...
  const char* GetSurfaceConstraintNodeReferenceDMMLAttributeName() { return "shortestDistanceSurfaceRef"; };
  ...
  void SetAndObserveShortestDistanceSurfaceNode(vtkDMMLModelNode* modelNode) { this->SetAndObserveSurfaceConstraintNode(modelNode); }
  /// \deprecated GetShortestDistanceSurfaceNode
  /// \sa GetSurfaceConstraintNode
  vtkDMMLModelNode* GetShortestDistanceSurfaceNode() { return this->GetSurfaceConstraintNode(); }

  ///@{
  /// Set/Get the model node that is used as the surface mesh for finding the shortest distance path on the surface mesh.
  void SetAndObserveSurfaceConstraintNode(vtkDMMLModelNode* modelNode);
  vtkDMMLModelNode* GetSurfaceConstraintNode();
  ///@}
  ...
  /// Uses the COST_FUNCTION_X enums from vtkCjyxDijkstraGraphGeodesicPath.
...
protected:
  ...
  ~vtkDMMLMarkupsCurveNode() override;
  vtkDMMLMarkupsCurveNode(const vtkDMMLMarkupsCurveNode&);
  void operator=(const vtkDMMLMarkupsCurveNode&);
