...
#ifndef __vtkDMMLMarkupsROINode_h
#define __vtkDMMLMarkupsROINode_h
...
/// \brief DMML node to represent an ROI markup
///
...
class  VTK_CJYX_MARKUPS_MODULE_DMML_EXPORT vtkDMMLMarkupsROINode : public vtkDMMLMarkupsNode
{
public:
  static vtkDMMLMarkupsROINode *New();
  vtkTypeMacro(vtkDMMLMarkupsROINode,vtkDMMLMarkupsNode);
  ...
  vtkDMMLCopyContentMacro(vtkDMMLMarkupsROINode);
  ...
  ///
  /// Legacy vtkDMMLAnnotationROINode methods
  ///

  //@{
  /// Legacy method from vtkDMMLAnnotationROINode
  ...
  /// Legacy method from vtkDMMLAnnotationROINode
  /// \sa GetPlanes(), GetPlanesWorld(), vtkDMMLAnnotationROINode::GetTransformedPlanes()
...
protected:
  int ROIType{vtkDMMLMarkupsROINode::ROITypeBox};
  ...
  vtkDMMLMarkupsROINode();
  ~vtkDMMLMarkupsROINode() override;
  vtkDMMLMarkupsROINode(const vtkDMMLMarkupsROINode&);
  void operator=(const vtkDMMLMarkupsROINode&);
};
