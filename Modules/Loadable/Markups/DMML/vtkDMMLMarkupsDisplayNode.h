...
// .NAME vtkDMMLMarkupsDisplayNode - DMML node to represent display properties for markups
// .SECTION Description
// vtkDMMLMarkupsDisplayNode nodes store display properties of markups,
// keeping elements that are applicable to all parts of the markups in this superclass
//

#ifndef __vtkDMMLMarkupsDisplayNode_h
#define __vtkDMMLMarkupsDisplayNode_h
...
class  VTK_CJYX_MARKUPS_MODULE_DMML_EXPORT vtkDMMLMarkupsDisplayNode : public vtkDMMLDisplayNode
{
public:
  static vtkDMMLMarkupsDisplayNode *New();
  vtkTypeMacro(vtkDMMLMarkupsDisplayNode,vtkDMMLDisplayNode);
  ...
  vtkDMMLCopyContentMacro(vtkDMMLMarkupsDisplayNode);
  ...
  int GetActiveComponentType(std::string context=vtkDMMLMarkupsDisplayNode::GetDefaultContextName());
  enum ComponentType
    {
    ComponentNone = 0,
  ...
  /// This property is computed on-the-fly and saved to file.
  /// \param context Name of the interaction context. By default it is empty string, meaning mouse
  int GetActiveComponentIndex(std::string context=vtkDMMLMarkupsDisplayNode::GetDefaultContextName());
  ...
  void SetActiveComponent(int componentType, int componentIndex,
                          std::string context=vtkDMMLMarkupsDisplayNode::GetDefaultContextName());
  ...
  int UpdateActiveControlPointWorld(int controlPointIndex, vtkDMMLInteractionEventData* eventData,
  ...
  /// \param context Name of the interaction context. By default it is empty string, meaning mouse
  int GetActiveControlPoint(std::string context=vtkDMMLMarkupsDisplayNode::GetDefaultContextName());
  ...
  static int GetMaximumGlyphType() { return vtkDMMLMarkupsDisplayNode::GlyphType_Last-1; };
  ...
  enum
    ...
    JumpToPointEvent, /**< request jump to a selected control point, request completed by markups logic,
                      event data is vtkDMMLInteractionEventData*/
    ActionEvent, /**< this event is invoked in on the display node if the widget performs WidgetEventAction action
                 (mapped to double-click interaction event by default), event data is vtkDMMLInteractionEventData */
    CustomActionEvent1, /**< this event is invoked in on the display node if the widget performs WidgetEventCustomAction1 action
                 ...
                 actions for a widget), event data is vtkDMMLInteractionEventData */
  ...
  vtkDMMLProceduralColorNode* GetLineColorNode();
...
protected:
  vtkDMMLMarkupsDisplayNode();
  ~vtkDMMLMarkupsDisplayNode() override;
  vtkDMMLMarkupsDisplayNode( const vtkDMMLMarkupsDisplayNode& );
  void operator= ( const vtkDMMLMarkupsDisplayNode& );
  ...
  virtual const char* GetLineColorNodeReferenceDMMLAttributeName();

  static const char* LineColorNodeReferenceRole;
  static const char* LineColorNodeReferenceDMMLAttributeName;
