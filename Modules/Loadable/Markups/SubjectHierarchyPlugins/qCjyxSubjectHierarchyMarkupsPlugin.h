...
#ifndef __qCjyxSubjectHierarchyMarkupsPlugin_h
#define __qCjyxSubjectHierarchyMarkupsPlugin_h

// SubjectHierarchy includes
#include "qCjyxSubjectHierarchyAbstractPlugin.h"

#include "qCjyxMarkupsSubjectHierarchyPluginsExport.h"

class qCjyxSubjectHierarchyMarkupsPluginPrivate;

/// \ingroup Cjyx_QtModules_SubjectHierarchy_Plugins
class Q_CJYX_MARKUPS_SUBJECT_HIERARCHY_PLUGINS_EXPORT qCjyxSubjectHierarchyMarkupsPlugin : public qCjyxSubjectHierarchyAbstractPlugin
{
public:
  Q_OBJECT
...
public:
  ...
  qCjyxSubjectHierarchyMarkupsPlugin(QObject* parent = nullptr);
  ~qCjyxSubjectHierarchyMarkupsPlugin() override;
...
protected:
  QScopedPointer<qCjyxSubjectHierarchyMarkupsPluginPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qCjyxSubjectHierarchyMarkupsPlugin);
  Q_DISABLE_COPY(qCjyxSubjectHierarchyMarkupsPlugin);
};
