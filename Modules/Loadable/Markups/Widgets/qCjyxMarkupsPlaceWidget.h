...
#ifndef __qCjyxMarkupsPlaceWidget_h
#define __qCjyxMarkupsPlaceWidget_h
...
#include "ui_qCjyxMarkupsPlaceWidget.h"
...
qCjyxMarkupsPlaceWidget : public qCjyxWidget
{
  Q_OBJECT
...
public:
  ...
  qCjyxMarkupsPlaceWidget(QWidget *parent=nullptr);
  ~qCjyxMarkupsPlaceWidget() override;
  ...
  Q_INVOKABLE vtkDMMLMarkupsFiducialNode* currentMarkupsFiducialNode() const;
  Q_INVOKABLE vtkDMMLMarkupsNode* currentMarkupsNode() const;
  ...
  {
    qWarning("qCjyxMarkupsPlaceWidget::deleteAllMarkupsOptionVisible method is deprecated, please use deleteAllControlPointsOptionVisible instead");
...
public slots:
  ...
  void setCurrentNode(vtkDMMLNode* currentNode);

  /// Set the currently selected markups node to be the active markups node in the Cjyx scene. Does not change place mode.
  ...
  {
  qWarning("qCjyxMarkupsPlaceWidget::deleteLastMarkup method is deprecated, please use deleteLastPoint instead");
  this->deleteLastPoint();
  };
  /// \deprecated Use deleteAllPoints instead.
  void deleteAllMarkups()
  {
  qWarning("qCjyxMarkupsPlaceWidget::deleteAllMarkups method is deprecated, please use deleteAllPoints instead");
  this->deleteAllPoints();
  };
  /// \deprecated Use setDeleteAllControlPointsOptionVisible instead.
  void setDeleteAllMarkupsOptionVisible(bool visible)
  {
  qWarning("qCjyxMarkupsPlaceWidget::setDeleteAllMarkupsOptionVisible method is deprecated, please use setDeleteAllControlPointsOptionVisible instead");
...
protected:
  QScopedPointer<qCjyxMarkupsPlaceWidgetPrivate> d_ptr;

  virtual void setup();

private:
  Q_DECLARE_PRIVATE(qCjyxMarkupsPlaceWidget);
  Q_DISABLE_COPY(qCjyxMarkupsPlaceWidget);
