/*==============================================================================
  ...
  Oslo University Hospital), based on qDMMLMarkupsOptionsWidgetsFactory.h by
...
#ifndef __qcjyxmarkupsfactory_h_
#define __qcjyxmarkupsfactory_h_
...
// -----------------------------------------------------------------------------------------
class qDMMLMarkupsAbstractOptionsWidget;
class qDMMLMarkupsOptionsWidgetsFactoryCleanup;

/// \ingroup CjyxRt_QtModules_Segmentations
/// \class qDMMLMarkupsOptionsWidgetsFactory
/// \brief Singleton class managing segment editor effect plugins
class Q_CJYX_MODULE_MARKUPS_WIDGETS_EXPORT qDMMLMarkupsOptionsWidgetsFactory : public QObject
{
  Q_OBJECT
...
public:
  ...
  Q_INVOKABLE static qDMMLMarkupsOptionsWidgetsFactory* instance();
...
public:
  ...
  Q_INVOKABLE bool registerOptionsWidget(qDMMLMarkupsAbstractOptionsWidget* widget);

  /// Unregisters an additional options widget.
  Q_INVOKABLE bool unregisterOptionsWidget(const QString& className);

  /// Unregisters an additional options widget.
  Q_INVOKABLE bool unregisterOptionsWidget(qDMMLMarkupsAbstractOptionsWidget* widget);
  ...
  Q_INVOKABLE qDMMLMarkupsAbstractOptionsWidget* createWidget(const QString& widgetClassName);
...
protected:
  QMap<QString, QPointer<qDMMLMarkupsAbstractOptionsWidget>> RegisteredWidgets;
...
private:
  qDMMLMarkupsOptionsWidgetsFactory(QObject* parent=nullptr);
  ~qDMMLMarkupsOptionsWidgetsFactory() override;

  Q_DISABLE_COPY(qDMMLMarkupsOptionsWidgetsFactory);
  friend class qDMMLMarkupsOptionsWidgetsFactoryCleanup;
  friend class PythonQtWrapper_qDMMLMarkupsOptionsWidgetsFactory; // Allow Python wrapping without enabling direct instantiation

private:
  /// Instance of the singleton
  static qDMMLMarkupsOptionsWidgetsFactory* Instance;
};

#endif // __qcjyxmarkupsfactory_h_
