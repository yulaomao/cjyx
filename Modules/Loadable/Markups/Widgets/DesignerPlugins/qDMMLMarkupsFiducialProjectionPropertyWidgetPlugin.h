...
#ifndef __qDMMLMarkupsFiducialProjectionPropertyWidgetPlugin_h
#define __qDMMLMarkupsFiducialProjectionPropertyWidgetPlugin_h
...
public:
  qDMMLMarkupsFiducialProjectionPropertyWidgetPlugin(QObject *_parent = nullptr);
