...
#ifndef __qCjyxMarkupsModuleWidget_h
#define __qCjyxMarkupsModuleWidget_h
...
class QShortcut;
class qDMMLMarkupsOptionsWidget;
class qCjyxMarkupsModuleWidgetPrivate;
class vtkDMMLMarkupsNode;
class vtkDMMLNode;
class vtkCjyxMarkupsLogic;

/// \ingroup Cjyx_QtModules_Markups
class Q_CJYX_QTMODULES_MARKUPS_EXPORT qCjyxMarkupsModuleWidget :
...
public:
  ...
  qCjyxMarkupsModuleWidget(QWidget *parent=nullptr);
  ~qCjyxMarkupsModuleWidget() override;
  ...
  /// Update the GUI elements related to the display properties from DMML, by
  /// getting the display node associated with the active markups node.
  /// \sa  updateWidgetFromDMML()
  ...
  vtkDMMLMarkupsNode* dmmlMarkupsNode();
  ...
  QList<qDMMLMarkupsOptionsWidget*>& additionalWidgets();

  Q_INVOKABLE void updateToolBar(vtkDMMLMarkupsNode* node);
...
public slots:
  ...
  /// Called from enter and on import/add dmml events to ask if the user
  /// wishes to convert annotation fiducial hierarchies into markups list nodes.
  /// \sa enter(), onDMMLSceneEndImportEvent(), onDMMLSceneEndBatchProcessEvent()
  ...
  void onActiveMarkupDMMLNodeChanged(vtkDMMLNode *markupsNode);
  ...
  void onActiveMarkupDMMLNodeAdded(vtkDMMLNode *markupsNode);
  ...
  /// Update the dmml node from the table
  ...
  QStringList getOtherMarkupNames(vtkDMMLNode *thisMarkup);
  ...
  /// Update internal list of markups options widgets from qDMMLMarkupsOptionsWidgetsFactory
  ...
  void onVisibilityOnAllMarkupsInListPushButtonClicked()
    {
    qWarning("qCjyxMarkupsModuleWidget::onVisibilityOnAllMarkupsInListPushButtonClicked method is deprecated, please use onVisibilityOnAllControlPointsInListPushButtonClicked instead");
  ...
  void onVisibilityOffAllMarkupsInListPushButtonClicked()
    {
    qWarning("qCjyxMarkupsModuleWidget::onVisibilityOffAllMarkupsInListPushButtonClicked method is deprecated, please use onVisibilityOffAllControlPointsInListPushButtonClicked instead");
  ...
  void onVisibilityAllMarkupsInListToggled()
    {
    qWarning("qCjyxMarkupsModuleWidget::onVisibilityAllMarkupsInListToggled method is deprecated, please use onVisibilityAllControlPointsInListToggled instead");
  ...
  void onLockAllMarkupsInListPushButtonClicked()
    {
    qWarning("qCjyxMarkupsModuleWidget::onLockAllMarkupsInListPushButtonClicked method is deprecated, please use onLockAllControlPointsInListPushButtonClicked instead");
  ...
  void onUnlockAllMarkupsInListPushButtonClicked()
    {
    qWarning("qCjyxMarkupsModuleWidget::onUnlockAllMarkupsInListPushButtonClicked method is deprecated, please use onUnlockAllControlPointsInListPushButtonClicked instead");
  ...
  void onLockAllMarkupsInListToggled()
    {
    qWarning("qCjyxMarkupsModuleWidget::onLockAllMarkupsInListToggled method is deprecated, please use onLockAllControlPointsInListToggled instead");
  ...
  void onSelectAllMarkupsInListPushButtonClicked()
    {
    qWarning("qCjyxMarkupsModuleWidget::onSelectAllMarkupsInListPushButtonClicked method is deprecated, please use onSelectAllControlPointsInListPushButtonClicked instead");
  ...
  void onDeselectAllMarkupsInListPushButtonClicked()
    {
    qWarning("qCjyxMarkupsModuleWidget::onDeselectAllMarkupsInListPushButtonClicked method is deprecated, please use onDeselectAllControlPointsInListPushButtonClicked instead");
  ...
  void onSelectedAllMarkupsInListToggled()
    {
    qWarning("qCjyxMarkupsModuleWidget::onSelectedAllMarkupsInListToggled method is deprecated, please use onSelectedAllControlPointsInListToggled instead");
  ...
  void onAddMarkupPushButtonClicked()
    {
    qWarning("qCjyxMarkupsModuleWidget::onAddMarkupPushButtonClicked method is deprecated, please use onAddControlPointPushButtonClicked instead");
  ...
  void onMoveMarkupUpPushButtonClicked()
    {
    qWarning("qCjyxMarkupsModuleWidget::onMoveMarkupUpPushButtonClicked method is deprecated, please use onMoveControlPointUpPushButtonClicked instead");
  ...
  void onMoveMarkupDownPushButtonClicked()
    {
    qWarning("qCjyxMarkupsModuleWidget::onMoveMarkupDownPushButtonClicked method is deprecated, please use onMoveControlPointDownPushButtonClicked instead");
  ...
  void onRestoreMarkupPushButtonClicked()
    {
    qWarning("qCjyxMarkupsModuleWidget::onRestoreMarkupPushButtonClicked method is deprecated, please use onRestoreControlPointPushButtonClicked instead");
  ...
  void onResetMarkupPushButtonClicked()
    {
    qWarning("qCjyxMarkupsModuleWidget::onResetMarkupPushButtonClicked method is deprecated, please use onResetControlPointPushButtonClicked instead");
  ...
  void onUnsetMarkupPushButtonClicked()
    {
    qWarning("qCjyxMarkupsModuleWidget::onUnsetMarkupPushButtonClicked method is deprecated, please use onUnsetControlPointPushButtonClicked instead");
  ...
  void onMissingMarkupPushButtonClicked()
    {
    qWarning("qCjyxMarkupsModuleWidget::onMissingMarkupPushButtonClicked method is deprecated, please use onMissingControlPointPushButtonClicked instead");
  ...
  void onDeleteMarkupPushButtonClicked(bool confirm=true)
    {
    qWarning("qCjyxMarkupsModuleWidget::onDeleteMarkupPushButtonClicked method is deprecated, please use onDeleteControlPointPushButtonClicked instead");
  ...
  void onDeleteAllMarkupsInListPushButtonClicked()
    {
    qWarning("qCjyxMarkupsModuleWidget::onDeleteAllMarkupsInListPushButtonClicked method is deprecated, please use onDeleteAllControlPointsInListPushButtonClicked instead");
    this->onDeleteAllControlPointsInListPushButtonClicked();
    };

protected:
  QScopedPointer<qCjyxMarkupsModuleWidgetPrivate> d_ptr;
...
private:
  Q_DECLARE_PRIVATE(qCjyxMarkupsModuleWidget);
  Q_DISABLE_COPY(qCjyxMarkupsModuleWidget);
};
