...
vtkStandardNewMacro(vtkCjyxPlaneRepresentation3D);
...
//----------------------------------------------------------------------
vtkCjyxPlaneRepresentation3D::vtkCjyxPlaneRepresentation3D()
{
...
//----------------------------------------------------------------------
vtkCjyxPlaneRepresentation3D::~vtkCjyxPlaneRepresentation3D() = default;

//-----------------------------------------------------------------------------
void vtkCjyxPlaneRepresentation3D::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------
bool vtkCjyxPlaneRepresentation3D::GetTransformationReferencePoint(double referencePointWorld[3])
{
  vtkDMMLMarkupsPlaneNode* planeNode = vtkDMMLMarkupsPlaneNode::SafeDownCast(this->GetMarkupsNode());
...
//----------------------------------------------------------------------
void vtkCjyxPlaneRepresentation3D::BuildPlane()
{
  vtkDMMLMarkupsPlaneNode* planeNode = vtkDMMLMarkupsPlaneNode::SafeDownCast(this->GetMarkupsNode());
  if (!planeNode || !planeNode->GetIsPlaneValid())
    {
...
//----------------------------------------------------------------------
void vtkCjyxPlaneRepresentation3D::UpdateFromDMML(vtkDMMLNode* caller, unsigned long event, void *callData /*=nullptr*/)
{
  ...
  if (this->MarkupsDisplayNode->GetActiveComponentType() != vtkDMMLMarkupsDisplayNode::ComponentPlane)
    {
  ...
  vtkDMMLMarkupsPlaneDisplayNode* planeDisplayNode = vtkDMMLMarkupsPlaneDisplayNode::SafeDownCast(this->MarkupsDisplayNode);
  if (planeDisplayNode)
    {
...
//----------------------------------------------------------------------
void vtkCjyxPlaneRepresentation3D::UpdateInteractionPipeline()
{
  // Final visibility handled by superclass in vtkCjyxMarkupsWidgetRepresentation
...
//----------------------------------------------------------------------
void vtkCjyxPlaneRepresentation3D::GetActors(vtkPropCollection *pc)
{
...
//----------------------------------------------------------------------
void vtkCjyxPlaneRepresentation3D::ReleaseGraphicsResources(
  vtkWindow *win)
{
...
//----------------------------------------------------------------------
int vtkCjyxPlaneRepresentation3D::RenderOverlay(vtkViewport *viewport)
{
...
//-----------------------------------------------------------------------------
int vtkCjyxPlaneRepresentation3D::RenderOpaqueGeometry(
...
//-----------------------------------------------------------------------------
int vtkCjyxPlaneRepresentation3D::RenderTranslucentPolygonalGeometry(
  vtkViewport *viewport)
{
...
//-----------------------------------------------------------------------------
vtkTypeBool vtkCjyxPlaneRepresentation3D::HasTranslucentPolygonalGeometry()
{
...
//----------------------------------------------------------------------
double *vtkCjyxPlaneRepresentation3D::GetBounds()
{
...
//----------------------------------------------------------------------
void vtkCjyxPlaneRepresentation3D::CanInteract(
...
//-----------------------------------------------------------------------------
void vtkCjyxPlaneRepresentation3D::CanInteractWithPlane(
  vtkDMMLInteractionEventData* interactionEventData,
  int& foundComponentType, int& foundComponentIndex, double& closestDistance2)
{
  // Create the tree
  ...
  if (interactionEventData->IsDisplayPositionValid())
    ...
    if (dist2Display < pixelTolerance * pixelTolerance && dist2Display < closestDistance2)
      ...
      foundComponentType = vtkDMMLMarkupsDisplayNode::ComponentPlane;
...
//-----------------------------------------------------------------------------
void vtkCjyxPlaneRepresentation3D::SetupInteractionPipeline()
{
...
//-----------------------------------------------------------------------------
vtkCjyxPlaneRepresentation3D::MarkupsInteractionPipelinePlane::MarkupsInteractionPipelinePlane(vtkCjyxMarkupsWidgetRepresentation* representation)
...
//-----------------------------------------------------------------------------
void vtkCjyxPlaneRepresentation3D::MarkupsInteractionPipelinePlane::GetHandleColor(int type, int index, double color[4])
{
  ...
  switch (index)
    {
    case vtkDMMLMarkupsPlaneDisplayNode::HandleLEdge:
    case vtkDMMLMarkupsPlaneDisplayNode::HandleREdge:
      currentColor = red;
      break;
    case vtkDMMLMarkupsPlaneDisplayNode::HandlePEdge:
    case vtkDMMLMarkupsPlaneDisplayNode::HandleAEdge:
      currentColor = green;
      break;
    default:
      break;
...
//----------------------------------------------------------------------
double vtkCjyxPlaneRepresentation3D::MarkupsInteractionPipelinePlane::GetHandleOpacity(int type, int index)
{
  vtkDMMLMarkupsPlaneNode* planeNode = vtkDMMLMarkupsPlaneNode::SafeDownCast(
  ...
  vtkDMMLMarkupsDisplayNode* displayNode = vtkDMMLMarkupsDisplayNode::SafeDownCast(planeNode->GetDisplayNode());

  double opacity = 1.0;
  if (displayNode && type == vtkDMMLMarkupsDisplayNode::ComponentScaleHandle && !displayNode->GetScaleHandleVisibility())
    {
    opacity = 0.0;
    }
  else if (type == vtkDMMLMarkupsDisplayNode::ComponentScaleHandle && index > vtkDMMLMarkupsPlaneDisplayNode::HandleAEdge)
    {
...
//-----------------------------------------------------------------------------
void vtkCjyxPlaneRepresentation3D::MarkupsInteractionPipelinePlane::CreateScaleHandles()
{
...
//-----------------------------------------------------------------------------
vtkCjyxPlaneRepresentation3D::HandleInfoList vtkCjyxPlaneRepresentation3D::MarkupsInteractionPipelinePlane::GetHandleInfoList()
{
...
//-----------------------------------------------------------------------------
void vtkCjyxPlaneRepresentation3D::MarkupsInteractionPipelinePlane::UpdateScaleHandles()
{
  vtkDMMLMarkupsPlaneNode* planeNode = vtkDMMLMarkupsPlaneNode::SafeDownCast(
    vtkCjyxMarkupsWidgetRepresentation::SafeDownCast(this->Representation)->GetMarkupsNode());
  if (!planeNode)
  ...
  scaleHandlePoints->SetPoint(vtkDMMLMarkupsPlaneDisplayNode::HandleLEdge, lEdge_World);
  scaleHandlePoints->SetPoint(vtkDMMLMarkupsPlaneDisplayNode::HandleREdge, rEdge_World);
  scaleHandlePoints->SetPoint(vtkDMMLMarkupsPlaneDisplayNode::HandleAEdge, aEdge_World);
  scaleHandlePoints->SetPoint(vtkDMMLMarkupsPlaneDisplayNode::HandlePEdge, pEdge_World);

  scaleHandlePoints->SetPoint(vtkDMMLMarkupsPlaneDisplayNode::HandleLPCorner, lpCorner_World);
  scaleHandlePoints->SetPoint(vtkDMMLMarkupsPlaneDisplayNode::HandleLACorner, laCorner_World);
  scaleHandlePoints->SetPoint(vtkDMMLMarkupsPlaneDisplayNode::HandleRACorner, raCorner_World);
  scaleHandlePoints->SetPoint(vtkDMMLMarkupsPlaneDisplayNode::HandleRPCorner, rpCorner_World);
...
//----------------------------------------------------------------------
void vtkCjyxPlaneRepresentation3D::MarkupsInteractionPipelinePlane::UpdateHandleVisibility()
{
  ...
  vtkDMMLMarkupsPlaneNode* planeNode = vtkDMMLMarkupsPlaneNode::SafeDownCast(displayNode->GetDisplayableNode());
  if (!planeNode)
    {
  ...
  if (scaleVisibilityArray)
    ...
    scaleVisibilityArray->SetValue(vtkDMMLMarkupsPlaneDisplayNode::HandleLEdge, scaleHandleVisibility && scaleHandleAxes[0]);
    scaleVisibilityArray->SetValue(vtkDMMLMarkupsPlaneDisplayNode::HandleREdge, scaleHandleVisibility && scaleHandleAxes[0]);
    scaleVisibilityArray->SetValue(vtkDMMLMarkupsPlaneDisplayNode::HandlePEdge, scaleHandleVisibility && scaleHandleAxes[1]);
    scaleVisibilityArray->SetValue(vtkDMMLMarkupsPlaneDisplayNode::HandleAEdge, scaleHandleVisibility && scaleHandleAxes[1]);

    bool viewPlaneScaleVisibility = scaleHandleVisibility && scaleHandleAxes[3];
    scaleVisibilityArray->SetValue(vtkDMMLMarkupsPlaneDisplayNode::HandleLPCorner, viewPlaneScaleVisibility);
    scaleVisibilityArray->SetValue(vtkDMMLMarkupsPlaneDisplayNode::HandleRPCorner, viewPlaneScaleVisibility);
    scaleVisibilityArray->SetValue(vtkDMMLMarkupsPlaneDisplayNode::HandleLACorner, viewPlaneScaleVisibility);
    scaleVisibilityArray->SetValue(vtkDMMLMarkupsPlaneDisplayNode::HandleRACorner, viewPlaneScaleVisibility);
    }
}

//----------------------------------------------------------------------
void vtkCjyxPlaneRepresentation3D::MarkupsInteractionPipelinePlane::GetInteractionHandleAxisWorld(int type, int index, double axisWorld[3])
{
  if (!axisWorld)
  {
  ...
  if (type == vtkDMMLMarkupsDisplayNode::ComponentTranslationHandle)
    ...
    switch (index)
      {
      case vtkDMMLMarkupsPlaneDisplayNode::HandleLEdge:
      case vtkDMMLMarkupsPlaneDisplayNode::HandleLACorner:
      case vtkDMMLMarkupsPlaneDisplayNode::HandleLPCorner:
        axisWorld[0] = -1.0;
        break;
      case vtkDMMLMarkupsPlaneDisplayNode::HandleREdge:
      case vtkDMMLMarkupsPlaneDisplayNode::HandleRACorner:
      case vtkDMMLMarkupsPlaneDisplayNode::HandleRPCorner:
        axisWorld[0] = 1.0;
        break;
      default:
        break;
