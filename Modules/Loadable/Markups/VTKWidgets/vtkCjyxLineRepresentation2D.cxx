...
vtkStandardNewMacro(vtkCjyxLineRepresentation2D);

//----------------------------------------------------------------------
vtkCjyxLineRepresentation2D::vtkCjyxLineRepresentation2D()
{
...
//----------------------------------------------------------------------
vtkCjyxLineRepresentation2D::~vtkCjyxLineRepresentation2D() = default;

//----------------------------------------------------------------------
void vtkCjyxLineRepresentation2D::UpdateFromDMML(vtkDMMLNode* caller, unsigned long event, void *callData /*=nullptr*/)
{
...
//----------------------------------------------------------------------
void vtkCjyxLineRepresentation2D::CanInteract(
...
//----------------------------------------------------------------------
void vtkCjyxLineRepresentation2D::GetActors(vtkPropCollection *pc)
{
...
//----------------------------------------------------------------------
void vtkCjyxLineRepresentation2D::ReleaseGraphicsResources(vtkWindow *win)
{
...
//----------------------------------------------------------------------
int vtkCjyxLineRepresentation2D::RenderOverlay(vtkViewport *viewport)
{
  int count=0;
...
//-----------------------------------------------------------------------------
int vtkCjyxLineRepresentation2D::RenderOpaqueGeometry(vtkViewport *viewport)
{
  int count=0;
  if (this->LineActor->GetVisibility())
    {
...
//-----------------------------------------------------------------------------
int vtkCjyxLineRepresentation2D::RenderTranslucentPolygonalGeometry(vtkViewport *viewport)
{
  int count=0;
  if (this->LineActor->GetVisibility())
    {
...
//-----------------------------------------------------------------------------
vtkTypeBool vtkCjyxLineRepresentation2D::HasTranslucentPolygonalGeometry()
{
...
//----------------------------------------------------------------------
double *vtkCjyxLineRepresentation2D::GetBounds()
{
  return nullptr;
}

//-----------------------------------------------------------------------------
void vtkCjyxLineRepresentation2D::PrintSelf(ostream& os, vtkIndent indent)
{
...
//-----------------------------------------------------------------------------
void vtkCjyxLineRepresentation2D::SetMarkupsNode(vtkDMMLMarkupsNode *markupsNode)
{
...
//-----------------------------------------------------------------------------
void vtkCjyxLineRepresentation2D::UpdateInteractionPipeline()
{
  if (!this->LineActor->GetVisibility())
    {
