...
//----------------------------------------------------------------------
vtkCjyxMarkupsWidgetRepresentation::ControlPointsPipeline::ControlPointsPipeline()
{
...
//----------------------------------------------------------------------
vtkCjyxMarkupsWidgetRepresentation::ControlPointsPipeline::~ControlPointsPipeline() = default;

//----------------------------------------------------------------------
vtkCjyxMarkupsWidgetRepresentation::vtkCjyxMarkupsWidgetRepresentation()
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::SetupInteractionPipeline()
{
...
//----------------------------------------------------------------------
int vtkCjyxMarkupsWidgetRepresentation::GetNumberOfControlPoints()
{
...
int vtkCjyxMarkupsWidgetRepresentation::GetNthControlPointDisplayPosition(int n, double displayPos[2])
{
  vtkDMMLMarkupsNode* markupsNode = this->GetMarkupsNode();
...
//----------------------------------------------------------------------
vtkDMMLMarkupsNode::ControlPoint* vtkCjyxMarkupsWidgetRepresentation::GetNthControlPoint(int n)
{
  vtkDMMLMarkupsNode* markupsNode = this->GetMarkupsNode();
  if (!markupsNode || n < 0 || n >= markupsNode->GetNumberOfControlPoints())
    {
...
//----------------------------------------------------------------------
int vtkCjyxMarkupsWidgetRepresentation::FindClosestPointOnWidget(
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::UpdateCenterOfRotation()
{
  vtkDMMLMarkupsNode* markupsNode = this->GetMarkupsNode();
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::SetMarkupsDisplayNode(vtkDMMLMarkupsDisplayNode *markupsDisplayNode)
{
  ...
  if (this->MarkupsDisplayNode)
    {
    markupsNode = vtkDMMLMarkupsNode::SafeDownCast(this->MarkupsDisplayNode->GetDisplayableNode());
    }
  this->SetMarkupsNode(markupsNode);
}

//----------------------------------------------------------------------
vtkDMMLMarkupsDisplayNode *vtkCjyxMarkupsWidgetRepresentation::GetMarkupsDisplayNode()
{
  return this->MarkupsDisplayNode;
}

//----------------------------------------------------------------------
vtkDMMLMarkupsNode *vtkCjyxMarkupsWidgetRepresentation::GetMarkupsNode()
{
  if (!this->MarkupsDisplayNode)
    {
    return nullptr;
    }
  return vtkDMMLMarkupsNode::SafeDownCast(this->MarkupsDisplayNode->GetDisplayableNode());
}

//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::SetMarkupsNode(vtkDMMLMarkupsNode *markupsNode)
{
  this->MarkupsNode = markupsNode;
}

//-----------------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::PrintSelf(ostream& os,
                                                      vtkIndent indent)
{
...
//-----------------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::CanInteract(
  vtkDMMLInteractionEventData* vtkNotUsed(interactionEventData),
...
//----------------------------------------------------------------------
bool vtkCjyxMarkupsWidgetRepresentation::GetTransformationReferencePoint(double referencePointWorld[3])
{
  vtkDMMLMarkupsNode* markupsNode = this->GetMarkupsNode();
  if (!markupsNode)
    {
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::BuildLine(vtkPolyData* linePolyData, bool displayPosition)
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::UpdateFromDMML(
    vtkDMMLNode* vtkNotUsed(caller), unsigned long event, void *vtkNotUsed(callData))
{
  ...
  if (!event || event == vtkDMMLTransformableNode::TransformModifiedEvent)
    {
    this->MarkupsTransformModifiedTime.Modified();
    }

  if (!event || event == vtkDMMLDisplayableNode::DisplayModifiedEvent)
    {
    // Update DMML data node from display node
    vtkDMMLMarkupsNode* markupsNode = nullptr;
    if (this->MarkupsDisplayNode)
      {
      markupsNode = vtkDMMLMarkupsNode::SafeDownCast(this->MarkupsDisplayNode->GetDisplayableNode());
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::UpdateInteractionPipeline()
{
  vtkDMMLMarkupsNode* markupsNode = this->GetMarkupsNode();
  if (!markupsNode || markupsNode->GetNumberOfControlPoints() < 1)
    {
...
//----------------------------------------------------------------------
bool vtkCjyxMarkupsWidgetRepresentation::GetAllControlPointsVisible()
{
  vtkDMMLMarkupsNode* markupsNode = this->GetMarkupsNode();
  if (!markupsNode)
    {
...
//----------------------------------------------------------------------
bool vtkCjyxMarkupsWidgetRepresentation::GetAllControlPointsSelected()
{
  vtkDMMLMarkupsNode* markupsNode = this->GetMarkupsNode();
  if (!markupsNode)
    {
...
//----------------------------------------------------------------------
double* vtkCjyxMarkupsWidgetRepresentation::GetWidgetColor(int controlPointType)
{
  ...
  if (this->MarkupsDisplayNode->GetFolderDisplayOverrideAllowed())
    {
    vtkDMMLDisplayableNode* displayableNode = this->MarkupsDisplayNode->GetDisplayableNode();
...
//----------------------------------------------------------------------
vtkPointPlacer* vtkCjyxMarkupsWidgetRepresentation::GetPointPlacer()
{
  return this->PointPlacer;
}

//----------------------------------------------------------------------
vtkPolyData* vtkCjyxMarkupsWidgetRepresentation::GetControlPointsPolyData(int controlPointType)
{
  if (controlPointType < 0 || controlPointType >= NumberOfControlPointTypes)
    {
    vtkErrorMacro("vtkCjyxMarkupsWidgetRepresentation::GetControlPointsPolyData failed: invalid controlPointType: " << controlPointType);
    return nullptr;
    }
...
//----------------------------------------------------------------------
vtkPolyData* vtkCjyxMarkupsWidgetRepresentation::GetLabelControlPointsPolyData(int controlPointType)
{
  if (controlPointType < 0 || controlPointType >= NumberOfControlPointTypes)
    {
    vtkErrorMacro("vtkCjyxMarkupsWidgetRepresentation::GetLabelControlPointsPolyData failed: invalid controlPointType: " << controlPointType);
    return nullptr;
    }
...
//----------------------------------------------------------------------
vtkStringArray* vtkCjyxMarkupsWidgetRepresentation::GetLabels(int controlPointType)
{
  if (controlPointType < 0 || controlPointType >= NumberOfControlPointTypes)
    {
    vtkErrorMacro("vtkCjyxMarkupsWidgetRepresentation::GetControlPointsPolyData failed: invalid controlPointType: " << controlPointType);
...
//-----------------------------------------------------------------------------
bool vtkCjyxMarkupsWidgetRepresentation::IsDisplayable()
{
  if (!this->MarkupsDisplayNode
    || !this->ViewNode
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::GetActors(vtkPropCollection* pc)
{
  if (this->InteractionPipeline)
    {
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::ReleaseGraphicsResources(vtkWindow* window)
{
  if (this->InteractionPipeline)
    {
...
//----------------------------------------------------------------------
int vtkCjyxMarkupsWidgetRepresentation::RenderOverlay(vtkViewport* viewport)
{
  int count = 0;
...
//----------------------------------------------------------------------
int vtkCjyxMarkupsWidgetRepresentation::RenderOpaqueGeometry(vtkViewport* viewport)
{
  int count = 0;
  if (this->InteractionPipeline && this->InteractionPipeline->Actor->GetVisibility())
    {
...
//----------------------------------------------------------------------
int vtkCjyxMarkupsWidgetRepresentation::RenderTranslucentPolygonalGeometry(vtkViewport* viewport)
{
  int count = 0;
  if (this->InteractionPipeline && this->InteractionPipeline->Actor->GetVisibility())
    {
...
//----------------------------------------------------------------------
vtkTypeBool vtkCjyxMarkupsWidgetRepresentation::HasTranslucentPolygonalGeometry()
{
  if (this->InteractionPipeline && this->InteractionPipeline->Actor->GetVisibility() &&
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::GetInteractionHandleAxisWorld(int type, int index, double axis[3])
{
  this->InteractionPipeline->GetInteractionHandleAxisWorld(type, index, axis);
}

//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::GetInteractionHandleOriginWorld(double origin[3])
{
  this->InteractionPipeline->GetInteractionHandleOriginWorld(origin);
}

//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::GetInteractionHandlePositionWorld(int type, int index, double position[3])
{
  this->InteractionPipeline->GetInteractionHandlePositionWorld(type, index, position);
}

//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::UpdateInteractionHandleSize()
{
  if (this->InteractionPipeline)
    {
...
//----------------------------------------------------------------------
vtkCjyxMarkupsWidgetRepresentation::MarkupsInteractionPipeline::MarkupsInteractionPipeline(vtkDMMLAbstractWidgetRepresentation* representation)
{
...
//----------------------------------------------------------------------
vtkCjyxMarkupsWidgetRepresentation::MarkupsInteractionPipeline::~MarkupsInteractionPipeline() = default;

//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::MarkupsInteractionPipeline::InitializePipeline()
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::MarkupsInteractionPipeline::CreateRotationHandles()
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::MarkupsInteractionPipeline::CreateTranslationHandles()
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::MarkupsInteractionPipeline::CreateScaleHandles()
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::MarkupsInteractionPipeline::UpdateHandleVisibility()
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::MarkupsInteractionPipeline::UpdateHandleColors()
{
  if (!this->ColorTable)
    {
    return;
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::MarkupsInteractionPipeline::GetHandleColor(int type, int index, double color[4])
{
  if (!color)
    {
    return;
...
//----------------------------------------------------------------------
double vtkCjyxMarkupsWidgetRepresentation::MarkupsInteractionPipeline::GetHandleOpacity(int type, int index)
{
  ...
  double opacity = 1.0;
  if (type == vtkDMMLMarkupsDisplayNode::ComponentTranslationHandle && index == 3)
    {
  ...
  else if (type == vtkDMMLMarkupsDisplayNode::ComponentTranslationHandle || type == vtkDMMLMarkupsDisplayNode::ComponentScaleHandle)
    {
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::MarkupsInteractionPipeline::GetViewPlaneNormal(double normal[3])
{
  if (!normal)
    {
    return;
...
//----------------------------------------------------------------------
vtkCjyxMarkupsWidgetRepresentation::HandleInfoList vtkCjyxMarkupsWidgetRepresentation::MarkupsInteractionPipeline::GetHandleInfoList()
{
  ...
  for (int i = 0; i < this->RotationHandlePoints->GetNumberOfPoints(); ++i)
    ...
    double color[4] = { 0 };
    this->GetHandleColor(vtkDMMLMarkupsDisplayNode::ComponentRotationHandle, i, color);
    HandleInfo info(i, vtkDMMLMarkupsDisplayNode::ComponentRotationHandle, handlePositionWorld, handlePositionLocal, color);
  ...
  for (int i = 0; i < this->TranslationHandlePoints->GetNumberOfPoints(); ++i)
    ...
    double color[4] = { 0 };
    this->GetHandleColor(vtkDMMLMarkupsDisplayNode::ComponentTranslationHandle, i, color);
    HandleInfo info(i, vtkDMMLMarkupsDisplayNode::ComponentTranslationHandle, handlePositionWorld, handlePositionLocal, color);
    handleInfoList.push_back(info);
    }
  ...
  for (int i = 0; i < this->ScaleHandlePoints->GetNumberOfPoints(); ++i)
    ...
    double color[4] = { 0 };
    this->GetHandleColor(vtkDMMLMarkupsDisplayNode::ComponentScaleHandle, i, color);
    HandleInfo info(i, vtkDMMLMarkupsDisplayNode::ComponentScaleHandle, handlePositionWorld, handlePositionLocal, color);
    handleInfoList.push_back(info);
    }
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::MarkupsInteractionPipeline::SetWidgetScale(double scale)
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::MarkupsInteractionPipeline::GetInteractionHandleOriginWorld(double originWorld[3])
{
  if (!originWorld)
    {
    return;
...
//----------------------------------------------------------------------
int vtkCjyxMarkupsWidgetRepresentation::GetGlyphTypeSourceFromDisplay(int glyphTypeDisplay)
{
  switch (glyphTypeDisplay)
    {
    case vtkDMMLMarkupsDisplayNode::GlyphTypeInvalid: return vtkMarkupsGlyphSource2D::GlyphNone;
    case vtkDMMLMarkupsDisplayNode::StarBurst2D: return vtkMarkupsGlyphSource2D::GlyphStarBurst;
    case vtkDMMLMarkupsDisplayNode::Cross2D: return vtkMarkupsGlyphSource2D::GlyphCross;
    case vtkDMMLMarkupsDisplayNode::CrossDot2D: return vtkMarkupsGlyphSource2D::GlyphCrossDot;
    case vtkDMMLMarkupsDisplayNode::ThickCross2D: return vtkMarkupsGlyphSource2D::GlyphThickCross;
    case vtkDMMLMarkupsDisplayNode::Dash2D: return vtkMarkupsGlyphSource2D::GlyphDash;
    case vtkDMMLMarkupsDisplayNode::Sphere3D: return vtkMarkupsGlyphSource2D::GlyphCircle;
    case vtkDMMLMarkupsDisplayNode::Vertex2D: return vtkMarkupsGlyphSource2D::GlyphVertex;
    case vtkDMMLMarkupsDisplayNode::Circle2D: return vtkMarkupsGlyphSource2D::GlyphCircle;
    case vtkDMMLMarkupsDisplayNode::Triangle2D: return vtkMarkupsGlyphSource2D::GlyphTriangle;
    case vtkDMMLMarkupsDisplayNode::Square2D: return vtkMarkupsGlyphSource2D::GlyphSquare;
    case vtkDMMLMarkupsDisplayNode::Diamond2D: return vtkMarkupsGlyphSource2D::GlyphDiamond;
    case vtkDMMLMarkupsDisplayNode::Arrow2D: return vtkMarkupsGlyphSource2D::GlyphArrow;
    case vtkDMMLMarkupsDisplayNode::ThickArrow2D: return vtkMarkupsGlyphSource2D::GlyphThickArrow;
    case vtkDMMLMarkupsDisplayNode::HookedArrow2D: return vtkMarkupsGlyphSource2D::GlyphHookedArrow;
    default:
      return -1;
    }
}
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::MarkupsInteractionPipeline::GetInteractionHandleAxis(int type, int index, double axis[3])
{
  ...
  else if (type == vtkDMMLMarkupsDisplayNode::ComponentTranslationHandle)
    {
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::MarkupsInteractionPipeline::GetInteractionHandleAxisWorld(int type, int index, double axisWorld[3])
{
  if (!axisWorld)
    {
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation::MarkupsInteractionPipeline::GetInteractionHandlePositionWorld(int type, int index, double positionWorld[3])
{
  if (!positionWorld)
    {
