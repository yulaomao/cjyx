...
std::map<vtkRenderer*, vtkSmartPointer<vtkFloatArray> > vtkCjyxMarkupsWidgetRepresentation3D::CachedZBuffers;

vtkCjyxMarkupsWidgetRepresentation3D::ControlPointsPipeline3D::ControlPointsPipeline3D()
{
...
vtkCjyxMarkupsWidgetRepresentation3D::ControlPointsPipeline3D::~ControlPointsPipeline3D() = default;

//----------------------------------------------------------------------
vtkCjyxMarkupsWidgetRepresentation3D::vtkCjyxMarkupsWidgetRepresentation3D()
{
  ...
  this->RenderCompletedCallback->SetCallback(vtkCjyxMarkupsWidgetRepresentation3D::OnRenderCompleted);
}

//----------------------------------------------------------------------
vtkCjyxMarkupsWidgetRepresentation3D::~vtkCjyxMarkupsWidgetRepresentation3D() = default;

//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation3D::UpdateNthPointAndLabelFromDMML(int vtkNotUsed(n))
{
  /*
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation3D::UpdateAllPointsAndLabelsFromDMML()
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation3D::CanInteract(
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation3D::CanInteractWithHandles(
  vtkDMMLInteractionEventData* interactionEventData,
  int& foundComponentType, int& foundComponentIndex, double& closestDistance2)
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation3D::CanInteractWithLine(
  vtkDMMLInteractionEventData* interactionEventData,
  int &foundComponentType, int &foundComponentIndex, double &closestDistance2)
{
  foundComponentType = vtkDMMLMarkupsDisplayNode::ComponentNone;
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation3D::UpdateFromDMML(vtkDMMLNode* caller, unsigned long event, void *callData /*=nullptr*/)
{
  ...
  if (event == )
    ...
    this->UpdateNthPointAndLabelFromDMML(n);
    }
  else*/
    {
    this->UpdateAllPointsAndLabelsFromDMML();
    }
}

//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation3D::GetActors(vtkPropCollection *pc)
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation3D::ReleaseGraphicsResources(
  vtkWindow *win)
{
...
//----------------------------------------------------------------------
int vtkCjyxMarkupsWidgetRepresentation3D::RenderOverlay(vtkViewport *viewport)
{
  vtkFloatArray* zBuffer = vtkCjyxMarkupsWidgetRepresentation3D::GetCachedZBuffer(this->Renderer);
    ...
    if (controlPoints->ControlPoints->GetNumberOfPoints() > 0)
      ...
      if (!this->MarkupsDisplayNode->GetOccludedVisibility())
        ...
        if (!zBuffer)
          ...
          vtkCjyxMarkupsWidgetRepresentation3D::CachedZBuffers[this->Renderer] = zBuffer;
          }
        else
          {
...
//-----------------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation3D::UpdateControlPointGlyphOrientation()
{
...
//-----------------------------------------------------------------------------
int vtkCjyxMarkupsWidgetRepresentation3D::RenderOpaqueGeometry(
...
//-----------------------------------------------------------------------------
int vtkCjyxMarkupsWidgetRepresentation3D::RenderTranslucentPolygonalGeometry(
  vtkViewport *viewport)
{
...
//-----------------------------------------------------------------------------
vtkTypeBool vtkCjyxMarkupsWidgetRepresentation3D::HasTranslucentPolygonalGeometry()
{
...
//-----------------------------------------------------------------------------
double *vtkCjyxMarkupsWidgetRepresentation3D::GetBounds()
{
...
//-----------------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation3D::PrintSelf(ostream& os,
                                                      vtkIndent indent)
{
...
//---------------------------------------------------------------------------
vtkFloatArray* vtkCjyxMarkupsWidgetRepresentation3D::GetCachedZBuffer(vtkRenderer* renderer)
{
  if (!renderer)
    {
  return nullptr;
    }
  if (vtkCjyxMarkupsWidgetRepresentation3D::CachedZBuffers.find(renderer) ==
    vtkCjyxMarkupsWidgetRepresentation3D::CachedZBuffers.end())
    {
    return nullptr;
    }
  return vtkCjyxMarkupsWidgetRepresentation3D::CachedZBuffers[renderer];
}

//---------------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation3D::OnRenderCompleted(vtkObject* caller, unsigned long vtkNotUsed(event), void* vtkNotUsed(clientData), void* vtkNotUsed(callData))
{
  vtkRenderer* renderer = vtkRenderer::SafeDownCast(caller);
  if (renderer && vtkCjyxMarkupsWidgetRepresentation3D::GetCachedZBuffer(renderer))
    {
    vtkCjyxMarkupsWidgetRepresentation3D::CachedZBuffers.erase(renderer);
    }
}

//-----------------------------------------------------------------------------
vtkCjyxMarkupsWidgetRepresentation3D::ControlPointsPipeline3D* vtkCjyxMarkupsWidgetRepresentation3D::GetControlPointsPipeline(int controlPointType)
{
  return reinterpret_cast<ControlPointsPipeline3D*>(this->ControlPoints[controlPointType]);
}

//-----------------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation3D::SetRenderer(vtkRenderer *ren)
{
...
//---------------------------------------------------------------------------
bool vtkCjyxMarkupsWidgetRepresentation3D::AccuratePick(int x, int y, double pickPoint[3], double pickNormal[3]/*=nullptr*/)
{
...
//----------------------------------------------------------------------
double vtkCjyxMarkupsWidgetRepresentation3D::GetViewScaleFactorAtPosition(double positionWorld[3], vtkDMMLInteractionEventData* interactionEventData)
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation3D::UpdateViewScaleFactor()
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation3D::UpdateControlPointSize()
{
  if (this->MarkupsDisplayNode->GetUseGlyphScale())
    {
...
//----------------------------------------------------------------------
bool vtkCjyxMarkupsWidgetRepresentation3D::GetNthControlPointViewVisibility(int n)
{
  vtkDMMLMarkupsNode* markupsNode = this->GetMarkupsNode();
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation3D::UpdateInteractionPipeline()
{
  vtkDMMLViewNode* viewNode = vtkDMMLViewNode::SafeDownCast(this->ViewNode);
  if (!viewNode)
    {
...
//-----------------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation3D::UpdateRelativeCoincidentTopologyOffsets(vtkMapper* mapper, vtkMapper* occludedMapper)
{
