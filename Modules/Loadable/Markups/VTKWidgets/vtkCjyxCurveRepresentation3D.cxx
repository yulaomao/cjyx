...
vtkStandardNewMacro(vtkCjyxCurveRepresentation3D);

//----------------------------------------------------------------------
vtkCjyxCurveRepresentation3D::vtkCjyxCurveRepresentation3D()
{
...
//----------------------------------------------------------------------
vtkCjyxCurveRepresentation3D::~vtkCjyxCurveRepresentation3D() = default;

//----------------------------------------------------------------------
void vtkCjyxCurveRepresentation3D::UpdateFromDMML(vtkDMMLNode* caller, unsigned long event, void *callData /*=nullptr*/)
{
  ...
  if (this->MarkupsDisplayNode->GetScalarVisibility())
    ...
    vtkProperty* activePipelineProperty =
      reinterpret_cast<vtkCjyxMarkupsWidgetRepresentation3D::ControlPointsPipeline3D*>(this->ControlPoints[Active])->Property;
    ...
    if (this->LineActor->GetVisibility())
      ...
      if (this->MarkupsDisplayNode->GetScalarRangeFlag() == vtkDMMLDisplayNode::UseDirectMapping)
        {
...
//----------------------------------------------------------------------
void vtkCjyxCurveRepresentation3D::GetActors(vtkPropCollection *pc)
{
...
//----------------------------------------------------------------------
void vtkCjyxCurveRepresentation3D::ReleaseGraphicsResources(
  vtkWindow *win)
{
...
//----------------------------------------------------------------------
int vtkCjyxCurveRepresentation3D::RenderOverlay(vtkViewport *viewport)
{
  int count=0;
...
//-----------------------------------------------------------------------------
int vtkCjyxCurveRepresentation3D::RenderOpaqueGeometry(
...
//-----------------------------------------------------------------------------
int vtkCjyxCurveRepresentation3D::RenderTranslucentPolygonalGeometry(
  vtkViewport *viewport)
{
  int count=0;
...
//-----------------------------------------------------------------------------
vtkTypeBool vtkCjyxCurveRepresentation3D::HasTranslucentPolygonalGeometry()
{
...
//----------------------------------------------------------------------
double *vtkCjyxCurveRepresentation3D::GetBounds()
{
...
//----------------------------------------------------------------------
void vtkCjyxCurveRepresentation3D::CanInteract(
...
//-----------------------------------------------------------------------------
void vtkCjyxCurveRepresentation3D::PrintSelf(ostream& os, vtkIndent indent)
{
...
//-----------------------------------------------------------------------------
void vtkCjyxCurveRepresentation3D::SetMarkupsNode(vtkDMMLMarkupsNode *markupsNode)
{
...
//----------------------------------------------------------------------
void vtkCjyxCurveRepresentation3D::CanInteractWithCurve(
  vtkDMMLInteractionEventData* interactionEventData,
