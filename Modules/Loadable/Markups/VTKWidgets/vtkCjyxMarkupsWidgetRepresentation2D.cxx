...
vtkCjyxMarkupsWidgetRepresentation2D::ControlPointsPipeline2D::ControlPointsPipeline2D()
{
...
vtkCjyxMarkupsWidgetRepresentation2D::ControlPointsPipeline2D::~ControlPointsPipeline2D() = default;

//----------------------------------------------------------------------
vtkCjyxMarkupsWidgetRepresentation2D::vtkCjyxMarkupsWidgetRepresentation2D()
{
...
//----------------------------------------------------------------------
vtkCjyxMarkupsWidgetRepresentation2D::~vtkCjyxMarkupsWidgetRepresentation2D() = default;

//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation2D::GetSliceToWorldCoordinates(const double slicePos[2],
                                                                        double worldPos[3])
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation2D::GetWorldToSliceCoordinates(const double worldPos[3], double slicePos[2])
{
  vtkDMMLSliceNode *sliceNode = this->GetSliceNode();
  if (!sliceNode)
    {
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation2D::UpdateAllPointsAndLabelsFromDMML(double labelsOffset)
{
...
//----------------------------------------------------------------------
double vtkCjyxMarkupsWidgetRepresentation2D::GetWidgetOpacity(int controlPointType)
{
...
//----------------------------------------------------------------------
vtkDMMLSliceNode *vtkCjyxMarkupsWidgetRepresentation2D::GetSliceNode()
{
  return vtkDMMLSliceNode::SafeDownCast(this->ViewNode);
}

//----------------------------------------------------------------------
int vtkCjyxMarkupsWidgetRepresentation2D::GetNthControlPointDisplayPosition(int n, double slicePos[2])
{
  vtkDMMLSliceNode *sliceNode = this->GetSliceNode();
  vtkDMMLMarkupsNode* markupsNode = this->GetMarkupsNode();
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation2D::SetNthControlPointSliceVisibility(int n, bool visibility)
{
...
//----------------------------------------------------------------------
bool vtkCjyxMarkupsWidgetRepresentation2D::GetNthControlPointViewVisibility(int n)
{
  vtkDMMLMarkupsNode* markupsNode = this->GetMarkupsNode();
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation2D::SetCenterSliceVisibility(bool visibility)
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation2D::UpdateFromDMML(vtkDMMLNode* caller, unsigned long event, void *callData/*=nullptr*/)
{
  ...
  this->UpdateAllPointsAndLabelsFromDMML(labelsOffset);

  this->VisibilityOn();
}

//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation2D::CanInteract(
  ...
  int &foundComponentType, int &foundComponentIndex, double &closestDistance2)
{
  ...
  if (markupsNode->GetNumberOfControlPoints() > 2 && this->CurveClosed && this->CenterVisibilityOnSlice)
    ...
    if (dist2 < maxPickingDistanceFromControlPoint2)
      ...
      foundComponentType = vtkDMMLMarkupsDisplayNode::ComponentCenterPoint;
  ...
  for (int i = 0; i < numberOfPoints; i++)
    ...
    if (dist2 < maxPickingDistanceFromControlPoint2 && dist2 < closestDistance2)
      {
      closestDistance2 = dist2;
      foundComponentType = vtkDMMLMarkupsDisplayNode::ComponentControlPoint;
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation2D::CanInteractWithHandles(
  vtkDMMLInteractionEventData* interactionEventData,
  int& foundComponentType, int& foundComponentIndex, double& closestDistance2)
{
  ...
  vtkCjyxMarkupsWidgetRepresentation::HandleInfoList handleInfoList = this->InteractionPipeline->GetHandleInfoList();
  for (vtkCjyxMarkupsWidgetRepresentation::MarkupsInteractionPipeline::HandleInfo handleInfo : handleInfoList)
    {
  ...
  if (!handlePicked)
    ...
    for (vtkCjyxMarkupsWidgetRepresentation::MarkupsInteractionPipeline::HandleInfo handleInfo : handleInfoList)
      {
      if (!handleInfo.IsVisible() || handleInfo.ComponentType != vtkDMMLMarkupsDisplayNode::ComponentTranslationHandle)
        {
        continue;
        }
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation2D::CanInteractWithLine(
  vtkDMMLInteractionEventData* interactionEventData,
  int &foundComponentType, int &foundComponentIndex, double &closestDistance2)
{
  foundComponentType = vtkDMMLMarkupsDisplayNode::ComponentNone;
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation2D::GetActors(vtkPropCollection *pc)
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation2D::ReleaseGraphicsResources(
  vtkWindow *win)
{
...
//----------------------------------------------------------------------
int vtkCjyxMarkupsWidgetRepresentation2D::RenderOverlay(vtkViewport *viewport)
{
...
//-----------------------------------------------------------------------------
int vtkCjyxMarkupsWidgetRepresentation2D::RenderOpaqueGeometry(
...
//-----------------------------------------------------------------------------
int vtkCjyxMarkupsWidgetRepresentation2D::RenderTranslucentPolygonalGeometry(
  vtkViewport *viewport)
{
...
//-----------------------------------------------------------------------------
vtkTypeBool vtkCjyxMarkupsWidgetRepresentation2D::HasTranslucentPolygonalGeometry()
{
...
//-----------------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation2D::PrintSelf(ostream& os, vtkIndent indent)
{
...
//-----------------------------------------------------------------------------
vtkCjyxMarkupsWidgetRepresentation2D::ControlPointsPipeline2D* vtkCjyxMarkupsWidgetRepresentation2D::GetControlPointsPipeline(int controlPointType)
{
  return reinterpret_cast<ControlPointsPipeline2D*>(this->ControlPoints[controlPointType]);
}

//---------------------------------------------------------------------------
bool vtkCjyxMarkupsWidgetRepresentation2D::IsControlPointDisplayableOnSlice(vtkDMMLMarkupsNode *markupsNode, int pointIndex)
{
  vtkDMMLSliceNode *sliceNode = this->GetSliceNode();
  if (!sliceNode)
    {
...
//---------------------------------------------------------------------------
bool vtkCjyxMarkupsWidgetRepresentation2D::IsPointBehindSlice(vtkDMMLMarkupsNode *markupsNode, int pointIndex)
{
  vtkDMMLSliceNode *sliceNode = this->GetSliceNode();
  if (!sliceNode)
    {
...
//---------------------------------------------------------------------------
bool vtkCjyxMarkupsWidgetRepresentation2D::IsPointInFrontSlice(vtkDMMLMarkupsNode *markupsNode, int pointIndex)
{
  vtkDMMLSliceNode *sliceNode = this->GetSliceNode();
  if (!sliceNode)
    {
...
//---------------------------------------------------------------------------
bool vtkCjyxMarkupsWidgetRepresentation2D::IsCenterDisplayableOnSlice(vtkDMMLMarkupsNode *markupsNode)
{
...
void vtkCjyxMarkupsWidgetRepresentation2D::GetWorldToDisplayCoordinates(double r, double a, double s, double * displayCoordinates)
{
  vtkDMMLSliceNode *sliceNode = this->GetSliceNode();
  if (!sliceNode)
    {
...
//---------------------------------------------------------------------------
// Convert world to display coordinates
void vtkCjyxMarkupsWidgetRepresentation2D::GetWorldToDisplayCoordinates(double * worldCoordinates, double * displayCoordinates)
{
...
//----------------------------------------------------------------------
bool vtkCjyxMarkupsWidgetRepresentation2D::GetAllControlPointsVisible()
{
  vtkDMMLMarkupsNode* markupsNode = this->GetMarkupsNode();
  if (!markupsNode)
    {
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation2D::UpdateDistanceColorMap(
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation2D::UpdatePlaneFromSliceNode()
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation2D::UpdateViewScaleFactor()
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation2D::UpdateControlPointSize()
{
...
//----------------------------------------------------------------------
double vtkCjyxMarkupsWidgetRepresentation2D::GetMaximumControlPointPickingDistance2()
{
...
//----------------------------------------------------------------------
double vtkCjyxMarkupsWidgetRepresentation2D::GetMaximumInteractionHandlePickingDistance2()
{
...
//----------------------------------------------------------------------
bool vtkCjyxMarkupsWidgetRepresentation2D::IsRepresentationIntersectingSlice(vtkPolyData* representation, const char* arrayName)
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation2D::SetupInteractionPipeline()
{
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation2D::UpdateInteractionPipeline()
{
...
//----------------------------------------------------------------------
vtkCjyxMarkupsWidgetRepresentation2D::MarkupsInteractionPipeline2D::MarkupsInteractionPipeline2D(vtkCjyxMarkupsWidgetRepresentation* representation)
...
//----------------------------------------------------------------------
void vtkCjyxMarkupsWidgetRepresentation2D::MarkupsInteractionPipeline2D::GetViewPlaneNormal(double viewPlaneNormal[3])
{
  if (!viewPlaneNormal)
    {
    return;
