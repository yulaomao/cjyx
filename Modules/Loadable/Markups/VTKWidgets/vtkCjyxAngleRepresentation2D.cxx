...
vtkStandardNewMacro(vtkCjyxAngleRepresentation2D);

//----------------------------------------------------------------------
vtkCjyxAngleRepresentation2D::vtkCjyxAngleRepresentation2D()
{
...
//----------------------------------------------------------------------
vtkCjyxAngleRepresentation2D::~vtkCjyxAngleRepresentation2D() = default;

//----------------------------------------------------------------------
bool vtkCjyxAngleRepresentation2D::GetTransformationReferencePoint(double referencePointWorld[3])
{
...
//----------------------------------------------------------------------
void vtkCjyxAngleRepresentation2D::BuildArc()
{
  vtkDMMLMarkupsAngleNode* markupsNode = vtkDMMLMarkupsAngleNode::SafeDownCast(this->GetMarkupsNode());
  ...
  bool longArc = (angle > 180.0 || angle < 0.0) && (markupsNode->GetAngleMeasurementMode() == vtkDMMLMarkupsAngleNode::OrientedPositive);
  ...
  if (markupsNode->GetAngleMeasurementMode() == vtkDMMLMarkupsAngleNode::OrientedPositive)
    {
...
//----------------------------------------------------------------------
void vtkCjyxAngleRepresentation2D::UpdateFromDMML(vtkDMMLNode* caller, unsigned long event, void *callData /*=nullptr*/)
{
...
//----------------------------------------------------------------------
void vtkCjyxAngleRepresentation2D::CanInteract(
...
//----------------------------------------------------------------------
void vtkCjyxAngleRepresentation2D::GetActors(vtkPropCollection *pc)
{
...
//----------------------------------------------------------------------
void vtkCjyxAngleRepresentation2D::ReleaseGraphicsResources(
  vtkWindow *win)
{
...
//----------------------------------------------------------------------
int vtkCjyxAngleRepresentation2D::RenderOverlay(vtkViewport *viewport)
{
  int count=0;
...
//-----------------------------------------------------------------------------
int vtkCjyxAngleRepresentation2D::RenderOpaqueGeometry(
...
//-----------------------------------------------------------------------------
int vtkCjyxAngleRepresentation2D::RenderTranslucentPolygonalGeometry(
  vtkViewport *viewport)
{
  int count=0;
  if (this->LineActor->GetVisibility())
...
//-----------------------------------------------------------------------------
vtkTypeBool vtkCjyxAngleRepresentation2D::HasTranslucentPolygonalGeometry()
{
...
//----------------------------------------------------------------------
double *vtkCjyxAngleRepresentation2D::GetBounds()
{
  return nullptr;
}

//-----------------------------------------------------------------------------
void vtkCjyxAngleRepresentation2D::PrintSelf(ostream& os, vtkIndent indent)
{
...
//-----------------------------------------------------------------------------
void vtkCjyxAngleRepresentation2D::SetMarkupsNode(vtkDMMLMarkupsNode *markupsNode)
{
...
//-----------------------------------------------------------------------------
void vtkCjyxAngleRepresentation2D::UpdateInteractionPipeline()
{
  vtkDMMLMarkupsNode* markupsNode = this->GetMarkupsNode();
  if (!markupsNode || markupsNode->GetNumberOfDefinedControlPoints(true) < 3)
    {
