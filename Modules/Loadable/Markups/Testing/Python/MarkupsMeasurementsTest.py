...
markupsMeasurementsTestDir = cjyx.app.temporaryPath + '/markupsMeasurementsTest'
...
markupsNode = cjyx.dmmlScene.AddNewNodeByClass('vtkDMMLMarkupsLineNode')
length = 34.12
...
cjyx.util.saveNode(markupsNode, markupsFilename)
...
markupsNode = cjyx.dmmlScene.AddNewNodeByClass('vtkDMMLMarkupsAngleNode')
...
markupsNode = cjyx.dmmlScene.AddNewNodeByClass('vtkDMMLMarkupsPlaneNode')
markupsNode.SetPlaneType(cjyx.vtkDMMLMarkupsPlaneNode.PlaneType3Points)
markupsNode.AddControlPoint(vtk.vtkVector3d(30, -22.4, 13.8))
...
markupsNode = cjyx.dmmlScene.AddNewNodeByClass('vtkDMMLMarkupsROINode')
