...
fidNode1 = cjyx.dmmlScene.AddNewNodeByClass("vtkDMMLMarkupsFiducialNode", "FidNode1")
...
fidNode2 = cjyx.dmmlScene.AddNewNodeByClass("vtkDMMLMarkupsFiducialNode", "FidNode2")
...
# Create scene view
numFidNodesBeforeStore = cjyx.dmmlScene.GetNumberOfNodesByClass('vtkDMMLMarkupsFiducialNode')
sv = cjyx.dmmlScene.AddNewNodeByClass("vtkDMMLSceneViewNode")
sv.StoreScene()

# add a third list that will get removed on restore
# second control point list
fidNode3 = cjyx.dmmlScene.AddNewNodeByClass("vtkDMMLMarkupsFiducialNode", "FidNode3")
...
numFidNodesAfterRestore = cjyx.dmmlScene.GetNumberOfNodesByClass('vtkDMMLMarkupsFiducialNode')
...
fid1AfterRestore = cjyx.dmmlScene.GetFirstNodeByName("FidNode1")
...
fid2AfterRestore = cjyx.dmmlScene.GetFirstNodeByName("FidNode2")
...
mfm = td.threeDView().displayableManagerByClassName("vtkDMMLMarkupsDisplayableManager")
h = mfm.GetHelper()
print('Helper = ', h)
