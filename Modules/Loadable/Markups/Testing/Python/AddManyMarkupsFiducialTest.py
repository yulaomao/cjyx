...
class AddManyMarkupsFiducialTestWidget(ScriptedLoadableModuleWidget):
    ...
    def setup(self):
        ...
        self.nodeTypeComboBox.addItem("vtkDMMLMarkupsFiducialNode")
        self.nodeTypeComboBox.addItem("vtkDMMLMarkupsLineNode")
        self.nodeTypeComboBox.addItem("vtkDMMLMarkupsAngleNode")
        self.nodeTypeComboBox.addItem("vtkDMMLMarkupsCurveNode")
        self.nodeTypeComboBox.addItem("vtkDMMLMarkupsClosedCurveNode")
        self.nodeTypeComboBox.addItem("vtkDMMLMarkupsROINode")
...
class AddManyMarkupsFiducialTestLogic(ScriptedLoadableModuleLogic):
    ...
    def run(self, nodeType, numberOfNodes=10, numberOfControlPoints=10, rOffset=0, usefewerModifyCalls=False, locked=False, labelsHidden=False):
        ...
        for nodeIndex in range(numberOfNodes):
            ...
            markupsNode = cjyx.dmmlScene.AddNewNodeByClass(nodeType)
...
class AddManyMarkupsFiducialTestTest(ScriptedLoadableModuleTest):
    ...
    def test_AddManyMarkupsFiducialTest1(self):
        ...
        logic = AddManyMarkupsFiducialTestLogic()
        logic.run('vtkDMMLMarkupsFiducialNode', numberOfNodes=1, numberOfControlPoints=100, rOffset=0)

        self.delayDisplay("Now running it while the Markups Module is open")
        m.moduleSelector().selectModule('Markups')
        logic.run('vtkDMMLMarkupsFiducialNode', numberOfNodes=1, numberOfControlPoints=100, rOffset=100)
