...
radiusMeasurement = cjyx.vtkDMMLStaticMeasurement()
...
closedCurveNode.GetDisplayNode().SetSnapMode(cjyx.vtkDMMLMarkupsDisplayNode.SnapModeUnconstrained)
areaMeasurement = closedCurveNode.GetMeasurement("area")
areaMeasurement.SetEnabled(True)
areaModelNode = cjyx.modules.models.logic().AddModel(areaMeasurement.GetMeshValue())
