...
int vtkDMMLMarkupsNodeTest1(int , char * [] )
{
  vtkNew<vtkDMMLMarkupsFiducialNode> node1;
  ...
  vtkNew<vtkDMMLStaticMeasurement> measurement1;
  ...
  // Get Nth Markup
  vtkDMMLMarkupsNode::ControlPoint *markup;
  for (int n = -1; n < 3; n++)
    {
  ...
  /// Associated node ids
  node1->SetNthControlPointAssociatedNodeID(2, std::string("vtkDMMLScalarVolumeNode1"));
  node1->Print(std::cout);
  CHECK_STD_STRING(node1->GetNthControlPointAssociatedNodeID(2), "vtkDMMLScalarVolumeNode1");
  ...
  node1->WriteCLI(commandLine1, prefix, vtkDMMLStorageNode::CoordinateSystemRAS);
  ...
  node1->WriteCLI(commandLine2, prefix, vtkDMMLStorageNode::CoordinateSystemLPS);
  ...
  node1->WriteCLI(commandLine3, prefix, vtkDMMLStorageNode::CoordinateSystemRAS, 0);
