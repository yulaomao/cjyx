...
int ComparePlane(double xAxisExpected_World[3], double yAxisExpected_World[3], double zAxisExpected_World[3],
  double originExpected_World[3], vtkDMMLMarkupsPlaneNode* planeNode, double epsilon)
{
...
int vtkDMMLMarkupsNodeTest4(int , char * [] )
{
  std::cout << "Testing vtkDMMLMarkupsPlaneNode" << std::endl;
  vtkNew<vtkDMMLScene> scene;

  vtkNew<vtkDMMLMarkupsPlaneNode> planeNode;
  scene->AddNode(planeNode);

  for (int planeType = vtkDMMLMarkupsPlaneNode::PlaneType3Points; planeType < vtkDMMLMarkupsPlaneNode::PlaneTypePlaneFit; ++planeType)
    {
