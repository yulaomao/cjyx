...
namespace
{
int TestMarkupsStorageNode(vtkDMMLMarkupsStorageNode* node1)
{
...
int vtkDMMLMarkupsStorageNodeTest1(int vtkNotUsed(argc), char * vtkNotUsed(argv)[] )
{
  // vtkDMMLMarkupsStorageNodeTest is an abstract class, therefore we test it
  // by instantiating child classes.
  vtkNew<vtkDMMLMarkupsJsonStorageNode> jsonStorage;
  vtkNew<vtkDMMLMarkupsFiducialStorageNode> fiducialStorage;
