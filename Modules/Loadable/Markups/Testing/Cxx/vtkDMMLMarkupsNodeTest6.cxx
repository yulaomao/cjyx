...
//----------------------------------------------------------------------------
int TestMarkupOrientation(std::vector<PointOrientation> originalOrientations, vtkDMMLMarkupsFiducialNode* markupsNode)
{
  ...
  for (auto pointOrientation : originalOrientations)
    ...
    vtkDMMLTransformNode::GetTransformBetweenNodes(markupsNode->GetParentTransformNode(), nullptr, transfromFromNodeToWorld);
...
//----------------------------------------------------------------------------
int vtkDMMLMarkupsNodeTest6(int, char* [])
{

  std::cout << "Testing vtkMarkupsNode orientation transformation" << std::endl;
  vtkNew<vtkDMMLScene> scene;

  vtkNew<vtkDMMLMarkupsFiducialNode> markupsNode;
  ...
  vtkNew<vtkDMMLTransformNode> linearTransformNode;
  ...
  vtkNew<vtkDMMLTransformNode> bSplineTransformNode;
