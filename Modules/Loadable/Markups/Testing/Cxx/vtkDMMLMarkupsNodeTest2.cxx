...
int vtkDMMLMarkupsNodeTest2(int , char * [] )
{
  ...
  if (node1->GetNumberOfControlPoints() > 0)
    {
    vtkDMMLMarkupsNode::ControlPoint* markup = node1->GetNthControlPoint(0);
  ...
  vtkDMMLMarkupsNode::ControlPoint* markupNull = node1->GetNthControlPointByID(nullptr);
  ...
  vtkDMMLMarkupsNode::ControlPoint* markupInvalid = node1->GetNthControlPointByID("Invalid");
