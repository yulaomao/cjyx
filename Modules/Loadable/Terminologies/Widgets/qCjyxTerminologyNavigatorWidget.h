...
#ifndef __qCjyxTerminologyNavigatorWidget_h
#define __qCjyxTerminologyNavigatorWidget_h
...
class qCjyxTerminologyNavigatorWidgetPrivate;
...
class Q_CJYX_MODULE_TERMINOLOGIES_WIDGETS_EXPORT qCjyxTerminologyNavigatorWidget : public qDMMLWidget
{
  Q_OBJECT
  QVTK_OBJECT
...
public:
  /// Constructor
  explicit qCjyxTerminologyNavigatorWidget(QWidget* parent = nullptr);
  /// Destructor
  ~qCjyxTerminologyNavigatorWidget() override;

#ifndef __VTK_WRAP__
  class Q_CJYX_MODULE_TERMINOLOGIES_WIDGETS_EXPORT TerminologyInfoBundle
  {
  public:
    TerminologyInfoBundle();
    TerminologyInfoBundle(vtkCjyxTerminologyEntry* entry, QString name, bool nameAutoGenerated, QColor color, bool colorAutoGenerated, QColor generatedColor);
    ~TerminologyInfoBundle();
    const TerminologyInfoBundle& operator=(const TerminologyInfoBundle& other);
    vtkCjyxTerminologyEntry* GetTerminologyEntry();
  ...
  private:
    vtkCjyxTerminologyEntry* TerminologyEntry;
  };
  ...
  Q_INVOKABLE bool terminologyEntry(vtkCjyxTerminologyEntry* entry);
  ...
  Q_INVOKABLE bool setTerminologyEntry(vtkCjyxTerminologyEntry* entry);
  ...
  Q_INVOKABLE static QString nameFromTerminology(vtkCjyxTerminologyEntry* entry);
  ...
  Q_INVOKABLE static QColor recommendedColorFromTerminology(vtkCjyxTerminologyEntry* entry);
...
protected:
  ...
  bool setCurrentCategory(vtkCjyxTerminologyCategory* category);
  ...
  bool setCurrentRegion(vtkCjyxTerminologyType* region);
  /// Set current region modifier to widget
  /// \return Flag indicating whether the given modifier was found in the combobox
  bool setCurrentRegionModifier(vtkCjyxTerminologyType* modifier);
...
protected:
  QScopedPointer<qCjyxTerminologyNavigatorWidgetPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qCjyxTerminologyNavigatorWidget);
  Q_DISABLE_COPY(qCjyxTerminologyNavigatorWidget);
};
