...
#include "ui_qCjyxTerminologyNavigatorWidget.h"
...
//-----------------------------------------------------------------------------
qCjyxTerminologyNavigatorWidget::TerminologyInfoBundle::TerminologyInfoBundle()
  {
  this->TerminologyEntry = vtkCjyxTerminologyEntry::New();
  }

//-----------------------------------------------------------------------------
qCjyxTerminologyNavigatorWidget::TerminologyInfoBundle::TerminologyInfoBundle(
  vtkCjyxTerminologyEntry* entry, QString name, bool nameAutoGenerated, QColor color, bool colorAutoGenerated, QColor generatedColor )
  : Name(name)
...
//-----------------------------------------------------------------------------
const qCjyxTerminologyNavigatorWidget::TerminologyInfoBundle&
  qCjyxTerminologyNavigatorWidget::TerminologyInfoBundle::operator=(
    const qCjyxTerminologyNavigatorWidget::TerminologyInfoBundle& other )
  {
...
//-----------------------------------------------------------------------------
vtkCjyxTerminologyEntry* qCjyxTerminologyNavigatorWidget::TerminologyInfoBundle::GetTerminologyEntry()
{
  return this->TerminologyEntry;
}

//-----------------------------------------------------------------------------
// qCjyxTerminologyNavigatorWidgetPrivate methods

//-----------------------------------------------------------------------------
class qCjyxTerminologyNavigatorWidgetPrivate: public Ui_qCjyxTerminologyNavigatorWidget
{
  Q_DECLARE_PUBLIC(qCjyxTerminologyNavigatorWidget);

protected:
  qCjyxTerminologyNavigatorWidget* const q_ptr;
public:
  qCjyxTerminologyNavigatorWidgetPrivate(qCjyxTerminologyNavigatorWidget& object);
  ~qCjyxTerminologyNavigatorWidgetPrivate();
  void init();

  /// Get terminology module logic
  static vtkCjyxTerminologiesModuleLogic* terminologyLogic();
  ...
  QColor recommendedColorForType(std::string terminologyName, vtkCjyxTerminologyCategory* category, vtkCjyxTerminologyType* type);
  ...
  QTableWidgetItem* findTableWidgetItemForCategory(vtkCjyxTerminologyCategory* category);
  /// Find item in (type or region) table widget corresponding to a given type
  QTableWidgetItem* findTableWidgetItemForType(QTableWidget* tableWidget, vtkCjyxTerminologyType* type);
  /// Find index in (type or region) modifier combobox corresponding to a given modifier
  /// \return -1 if not found
  int findComboBoxIndexForModifier(ctkComboBox* comboBox, vtkCjyxTerminologyType* modifier);
...
public:
  ...
  vtkCjyxTerminologyCategory* CurrentCategoryObject;
  ...
  QList<vtkSmartPointer<vtkCjyxTerminologyCategory> > SelectedCategoryObjects;
  /// Object containing the details of the current type
  vtkCjyxTerminologyType* CurrentTypeObject;
  /// Object containing the details of the current type modifier if any
  vtkCjyxTerminologyType* CurrentTypeModifierObject;
  ...
  vtkCjyxTerminologyType* CurrentRegionObject;
  /// Object containing the details of the current region modifier if any
  vtkCjyxTerminologyType* CurrentRegionModifierObject;
...
//-----------------------------------------------------------------------------
qCjyxTerminologyNavigatorWidgetPrivate::qCjyxTerminologyNavigatorWidgetPrivate(qCjyxTerminologyNavigatorWidget& object)
  : q_ptr(&object)
  , NoneItemName(QString("[ None ]"))
  , NameAutoGenerated(true)
  , ColorAutoGenerated(true)
  , GeneratedColor(vtkCjyxTerminologyType::INVALID_COLOR[0], vtkCjyxTerminologyType::INVALID_COLOR[1], vtkCjyxTerminologyType::INVALID_COLOR[2])
  , TerminologyComboboxPopulating(false)
  , AnatomicContextComboboxPopulating(false)
{
  this->CurrentCategoryObject = vtkCjyxTerminologyCategory::New();
  this->CurrentTypeObject = vtkCjyxTerminologyType::New();
  this->CurrentTypeModifierObject = vtkCjyxTerminologyType::New();

  this->CurrentRegionObject = vtkCjyxTerminologyType::New();
  this->CurrentRegionModifierObject = vtkCjyxTerminologyType::New();
}

//-----------------------------------------------------------------------------
qCjyxTerminologyNavigatorWidgetPrivate::~qCjyxTerminologyNavigatorWidgetPrivate()
{
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidgetPrivate::init()
{
  Q_Q(qCjyxTerminologyNavigatorWidget);
  this->setupUi(q);
  ...
  if (qCjyxApplication::application())
    {
    QSettings* settings = qCjyxApplication::application()->userSettings();
...
//-----------------------------------------------------------------------------
vtkCjyxTerminologiesModuleLogic* qCjyxTerminologyNavigatorWidgetPrivate::terminologyLogic()
{
  ...
  if (!app)
    ...
    qCritical() << Q_FUNC_INFO << ": Terminologies logic is not found (not a Cjyx core application instance)";
    return nullptr;
    }
  vtkCjyxTerminologiesModuleLogic* terminologiesLogic = vtkCjyxTerminologiesModuleLogic::SafeDownCast(app->moduleLogic("Terminologies"));
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidgetPrivate::resetCurrentCategory()
{
  if (this->CurrentCategoryObject)
    {
    this->CurrentCategoryObject->Delete();
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidgetPrivate::resetCurrentType()
{
  if (this->CurrentTypeObject)
    {
    this->CurrentTypeObject->Delete();
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidgetPrivate::resetCurrentTypeModifier()
{
  if (this->CurrentTypeModifierObject)
    {
    this->CurrentTypeModifierObject->Delete();
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidgetPrivate::setNameFromCurrentTerminology()
{
  Q_Q(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
QColor qCjyxTerminologyNavigatorWidgetPrivate::terminologyRecommendedColor()
{
  // Return 'invalid' color if type is not selected or the selected type has modifiers but no modifier is selected
  if ( !this->CurrentTypeObject ||
  ...
  unsigned char r = vtkCjyxTerminologyType::INVALID_COLOR[0];
  unsigned char g = vtkCjyxTerminologyType::INVALID_COLOR[1];
  unsigned char b = vtkCjyxTerminologyType::INVALID_COLOR[2];
  ...
  if ( r == vtkCjyxTerminologyType::INVALID_COLOR[0]
    && g == vtkCjyxTerminologyType::INVALID_COLOR[1]
    && b == vtkCjyxTerminologyType::INVALID_COLOR[2] )
    {
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidgetPrivate::setRecommendedColorFromCurrentTerminology()
{
  ...
  if (!color.isValid())
    ...
    this->ColorPickerButton_RecommendedRGB->setColor(QColor(vtkCjyxTerminologyType::INVALID_COLOR[0],
      vtkCjyxTerminologyType::INVALID_COLOR[1], vtkCjyxTerminologyType::INVALID_COLOR[2]));
...
//-----------------------------------------------------------------------------
QColor qCjyxTerminologyNavigatorWidgetPrivate::recommendedColorForType(
  std::string terminologyName, vtkCjyxTerminologyCategory* category, vtkCjyxTerminologyType* type)
{
  ...
  vtkCjyxTerminologiesModuleLogic* logic = this->terminologyLogic();
  if (!logic)
    {
  ...
  if (color.isValid()
    && ( colorArray[0] != vtkCjyxTerminologyType::INVALID_COLOR[0]
      || colorArray[1] != vtkCjyxTerminologyType::INVALID_COLOR[1]
      || colorArray[2] != vtkCjyxTerminologyType::INVALID_COLOR[2] ))
    {
    return color;
    }
  ...
  std::vector<vtkCjyxTerminologiesModuleLogic::CodeIdentifier> typeModifiers;
  vtkCjyxTerminologiesModuleLogic::CodeIdentifier categoryId = vtkCjyxTerminologiesModuleLogic::CodeIdentifierFromTerminologyCategory(category);
  vtkCjyxTerminologiesModuleLogic::CodeIdentifier typeId = vtkCjyxTerminologiesModuleLogic::CodeIdentifierFromTerminologyType(type);
  logic->GetTypeModifiersInTerminologyType(terminologyName.c_str(), categoryId, typeId, typeModifiers);
  vtkNew<vtkCjyxTerminologyType> typeModifierObject;
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidgetPrivate::resetCurrentRegion()
{
  if (this->CurrentRegionObject)
    {
    this->CurrentRegionObject->Delete();
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidgetPrivate::resetCurrentRegionModifier()
{
  if (this->CurrentRegionModifierObject)
    {
    this->CurrentRegionModifierObject->Delete();
...
//-----------------------------------------------------------------------------
QTableWidgetItem* qCjyxTerminologyNavigatorWidgetPrivate::findTableWidgetItemForCategory(vtkCjyxTerminologyCategory* category)
{
  if (!category)
    {
    return nullptr;
  ...
  foreach (QTableWidgetItem* item, items)
    {
    QString codingSchemeDesignator = item->data(qCjyxTerminologyNavigatorWidget::CodingSchemeDesignatorRole).toString();
    QString codeValue = item->data(qCjyxTerminologyNavigatorWidget::CodeValueRole).toString();
...
//-----------------------------------------------------------------------------
QTableWidgetItem* qCjyxTerminologyNavigatorWidgetPrivate::findTableWidgetItemForType(QTableWidget* tableWidget, vtkCjyxTerminologyType* type)
{
  if (!tableWidget || !type)
    {
    return nullptr;
...
//-----------------------------------------------------------------------------
int qCjyxTerminologyNavigatorWidgetPrivate::findComboBoxIndexForModifier(ctkComboBox* comboBox, vtkCjyxTerminologyType* modifier)
{
...
//-----------------------------------------------------------------------------
// qCjyxTerminologyNavigatorWidget methods

//-----------------------------------------------------------------------------
qCjyxTerminologyNavigatorWidget::qCjyxTerminologyNavigatorWidget(QWidget* _parent)
  : qDMMLWidget(_parent)
  , d_ptr(new qCjyxTerminologyNavigatorWidgetPrivate(*this))
{
  Q_D(qCjyxTerminologyNavigatorWidget);
  d->init();

  // Connect logic modified event (cannot call QVTK from private implementation)
  vtkCjyxTerminologiesModuleLogic* logic = qCjyxTerminologyNavigatorWidgetPrivate::terminologyLogic();
  if (logic)
    {
...
//-----------------------------------------------------------------------------
qCjyxTerminologyNavigatorWidget::~qCjyxTerminologyNavigatorWidget()
{
  Q_D(qCjyxTerminologyNavigatorWidget);
  if (qCjyxApplication::application())
    {
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::terminologyInfo(TerminologyInfoBundle &terminologyInfo)
{
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::setTerminologyInfo(TerminologyInfoBundle &terminologyInfo)
{
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
bool qCjyxTerminologyNavigatorWidget::terminologyEntry(vtkCjyxTerminologyEntry* entry)
{
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
bool qCjyxTerminologyNavigatorWidget::setTerminologyEntry(vtkCjyxTerminologyEntry* entry)
{
  Q_D(qCjyxTerminologyNavigatorWidget);
  ...
  // Select category
  vtkCjyxTerminologyCategory* categoryObject = entry->GetCategoryObject();
  if (!categoryObject)
    {
    return false; // The terminology is not invalid but empty
    }
  ...
  // Select type
  vtkCjyxTerminologyType* typeObject = entry->GetTypeObject();
  if (!typeObject)
    {
  ...
  vtkCjyxTerminologyType* typeModifierObject = entry->GetTypeModifierObject();
  ...
  if (categoryObject->GetShowAnatomy())
    ...
    // Select region
    vtkCjyxTerminologyType* regionObject = entry->GetAnatomicRegionObject();
    if (regionObject) // Optional
      {
      this->setCurrentRegion(regionObject);

      // Select region modifier
      vtkCjyxTerminologyType* regionModifierObject = entry->GetAnatomicRegionModifierObject();
...
//-----------------------------------------------------------------------------
QString qCjyxTerminologyNavigatorWidget::nameFromTerminology(vtkCjyxTerminologyEntry* entry)
{
  QString name;
  ...
  // Try to set name based on '3dCjyxLabel' field in terminology entry
  if ( entry->GetTypeObject()->GetCjyxLabel()
    && (!entry->GetTypeObject()->GetHasModifiers() || entry->GetTypeModifierObject()->GetCodeValue() == nullptr) )
    {
    name = entry->GetTypeObject()->GetCjyxLabel();
    }
  else if (entry->GetTypeModifierObject()->GetCjyxLabel())
    {
    name = entry->GetTypeModifierObject()->GetCjyxLabel();
    }
...
//-----------------------------------------------------------------------------
QString qCjyxTerminologyNavigatorWidget::nameFromCurrentTerminology()
{
  Q_D(qCjyxTerminologyNavigatorWidget);
  if ( !d->CurrentTypeObject ||
  ...
  return qCjyxTerminologyNavigatorWidget::nameFromTerminology(terminologyEntry);
}

//-----------------------------------------------------------------------------
QColor qCjyxTerminologyNavigatorWidget::recommendedColorFromTerminology(vtkCjyxTerminologyEntry* entry)
{
  QColor color;
...
//-----------------------------------------------------------------------------
QColor qCjyxTerminologyNavigatorWidget::recommendedColorFromCurrentTerminology()
{
  Q_D(qCjyxTerminologyNavigatorWidget);
  ...
  vtkCjyxTerminologyType* typeObject = d->CurrentTypeObject;
...
//-----------------------------------------------------------------------------
bool qCjyxTerminologyNavigatorWidget::anatomicRegionSectionVisible() const
{
  Q_D(const qCjyxTerminologyNavigatorWidget);

  return d->AnatomicalRegionExpandButton->isChecked();
}

//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::setAnatomicRegionSectionVisible(bool visible)
{
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
bool qCjyxTerminologyNavigatorWidget::overrideSectionVisible() const
{
  Q_D(const qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::setOverrideSectionVisible(bool visible)
{
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::populateTerminologyComboBox()
{
  Q_D(qCjyxTerminologyNavigatorWidget);

  d->ComboBox_Terminology->clear();

  vtkCjyxTerminologiesModuleLogic* logic = d->terminologyLogic();
  if (!logic)
    {
    return;
    }
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::populateCategoryTable()
{
  Q_D(qCjyxTerminologyNavigatorWidget);
  ...
  int index = 0;
  std::vector<vtkCjyxTerminologiesModuleLogic::CodeIdentifier>::iterator idIt;
  for (idIt=categories.begin(); idIt!=categories.end(); ++idIt, ++index)
    {
    vtkCjyxTerminologiesModuleLogic::CodeIdentifier addedCategoryId = (*idIt);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::populateTypeTable()
{
  Q_D(qCjyxTerminologyNavigatorWidget);
  ...
  QList<vtkCjyxTerminologyCategory*> selectedCategories;
  foreach (vtkSmartPointer<vtkCjyxTerminologyCategory> category, d->SelectedCategoryObjects)
    {
  ...
  std::vector<vtkCjyxTerminologiesModuleLogic::CodeIdentifier> types;
  QMap<int, int> typeIndexToCategoryIndexMap;
  int typeIndex = 0;
  int categoryIndex = 0;
  std::string searchTerm(d->SearchBox_Type->text().toUtf8().constData());
  std::vector<vtkCjyxTerminologiesModuleLogic::CodeIdentifier>::iterator idIt;
  foreach (vtkCjyxTerminologyCategory* category, selectedCategories)
    {
    std::vector<vtkCjyxTerminologiesModuleLogic::CodeIdentifier> typesInCategory;
    logic->FindTypesInTerminologyCategory(
      d->CurrentTerminologyName.toUtf8().constData(),
      vtkCjyxTerminologiesModuleLogic::CodeIdentifierFromTerminologyCategory(category),
    ...
    for (idIt=typesInCategory.begin(); idIt!=typesInCategory.end(); ++idIt)
      ...
      std::vector<vtkCjyxTerminologiesModuleLogic::CodeIdentifier>::iterator typeIt;
  ...
  typeIndex = 0;
  vtkNew<vtkCjyxTerminologyType> typeObject;
  for (idIt=types.begin(); idIt!=types.end(); ++idIt, ++typeIndex)
    {
    vtkCjyxTerminologiesModuleLogic::CodeIdentifier addedTypeId = (*idIt);
    ...
    vtkCjyxTerminologyCategory* category = selectedCategories[typeIndexToCategoryIndexMap[typeIndex]];
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::populateTypeModifierComboBox()
{
  Q_D(qCjyxTerminologyNavigatorWidget);
  ...
  logic->GetTypeModifiersInTerminologyType(
    d->CurrentTerminologyName.toUtf8().constData(),
    vtkCjyxTerminologiesModuleLogic::CodeIdentifierFromTerminologyCategory(d->CurrentCategoryObject),
    vtkCjyxTerminologiesModuleLogic::CodeIdentifierFromTerminologyType(d->CurrentTypeObject),
    typeModifiers );
  ...
  for (idIt=typeModifiers.begin(); idIt!=typeModifiers.end(); ++idIt, ++index)
    {
    vtkCjyxTerminologiesModuleLogic::CodeIdentifier addedTypeModifierId = (*idIt);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::setCurrentTerminology(QString terminologyName)
{
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::onTerminologySelectionChanged(int index)
{
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
bool qCjyxTerminologyNavigatorWidget::setCurrentCategory(vtkCjyxTerminologyCategory* category)
{
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::updateWidgetFromCurrentCategory()
{
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::onCategorySelectionChanged()
{
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
bool qCjyxTerminologyNavigatorWidget::setCurrentType(vtkCjyxTerminologyType* type)
{
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::onTypeSelected(QTableWidgetItem* currentItem, QTableWidgetItem* previousItem)
{
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::onTypeCellDoubleClicked(int row, int column)
{
  Q_UNUSED(row);
  Q_UNUSED(column);
...
//-----------------------------------------------------------------------------
bool qCjyxTerminologyNavigatorWidget::setCurrentTypeModifier(vtkCjyxTerminologyType* modifier)
{
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::onTypeModifierSelectionChanged(int index)
{
  Q_UNUSED(index);
  Q_D(qCjyxTerminologyNavigatorWidget);
  ...
  vtkSmartPointer<vtkCjyxTerminologyType> modifier = vtkSmartPointer<vtkCjyxTerminologyType>::New();
  if (index < 0)
    {
  ...
  if (index != 0 || !d->ComboBox_TypeModifier->itemData(index).isNull())
    ...
    vtkCjyxTerminologiesModuleLogic::CodeIdentifier modifierId(
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::onCategorySearchTextChanged(QString search)
{
  Q_UNUSED(search);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::onTypeSearchTextChanged(QString search)
{
  Q_UNUSED(search);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::onNameChanged(QString name)
{
  Q_UNUSED(name);
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::onResetNameClicked()
{
  Q_D(qCjyxTerminologyNavigatorWidget);
  d->setNameFromCurrentTerminology();
}
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::onColorChanged(QColor color)
{
  Q_UNUSED(color);
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::onResetColorClicked()
{
  Q_D(qCjyxTerminologyNavigatorWidget);
  d->setRecommendedColorFromCurrentTerminology();
}
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::onLoadTerminologyClicked()
{
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::onLoadAnatomicContextClicked()
{
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::copyContextToUserDirectory(QString filePath)
{
  Q_D(qCjyxTerminologyNavigatorWidget);
  vtkCjyxTerminologiesModuleLogic* logic = d->terminologyLogic();
  if (!logic)
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::populateAnatomicContextComboBox()
{
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::populateRegionTable()
{
  Q_D(qCjyxTerminologyNavigatorWidget);
  ...
  std::vector<vtkCjyxTerminologiesModuleLogic::CodeIdentifier> regions;
  ...
  for (idIt=regions.begin(); idIt!=regions.end(); ++idIt, ++index)
    {
    vtkCjyxTerminologiesModuleLogic::CodeIdentifier addedRegionId = (*idIt);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::populateRegionModifierComboBox()
{
  Q_D(qCjyxTerminologyNavigatorWidget);
  ...
  std::vector<vtkCjyxTerminologiesModuleLogic::CodeIdentifier> regionModifiers;
  logic->GetRegionModifiersInAnatomicRegion(
    d->CurrentAnatomicContextName.toUtf8().constData(),
    vtkCjyxTerminologiesModuleLogic::CodeIdentifierFromTerminologyType(d->CurrentRegionObject),
    regionModifiers );
  ...
  for (idIt=regionModifiers.begin(); idIt!=regionModifiers.end(); ++idIt, ++index)
    {
    vtkCjyxTerminologiesModuleLogic::CodeIdentifier addedRegionModifierId = (*idIt);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::setCurrentAnatomicContext(QString contextName)
{
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::onAnatomicContextSelectionChanged(int index)
{
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
bool qCjyxTerminologyNavigatorWidget::setCurrentRegion(vtkCjyxTerminologyType* region)
{
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::onRegionSelected(QTableWidgetItem* currentItem, QTableWidgetItem* previousItem)
{
  Q_UNUSED(previousItem)
  Q_D(qCjyxTerminologyNavigatorWidget);
  ...
  vtkCjyxTerminologiesModuleLogic::CodeIdentifier regionId(
    ...
    currentItem->data(CodeValueRole).toString().toUtf8().constData(),
    currentItem->text().toUtf8().constData() );
  vtkSmartPointer<vtkCjyxTerminologyType> region = vtkSmartPointer<vtkCjyxTerminologyType>::New();
...
//-----------------------------------------------------------------------------
bool qCjyxTerminologyNavigatorWidget::setCurrentRegionModifier(vtkCjyxTerminologyType* modifier)
{
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::onRegionModifierSelectionChanged(int index)
{
  Q_UNUSED(index);
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::onRegionSearchTextChanged(QString search)
{
  Q_UNUSED(search);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::onLogicModified()
{
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::anatomicalRegionExpandButtonUp()
{
  Q_D(qCjyxTerminologyNavigatorWidget);
...
//-----------------------------------------------------------------------------
void qCjyxTerminologyNavigatorWidget::anatomicalRegionExpandButtonDown()
{
  Q_D(qCjyxTerminologyNavigatorWidget);
  d->AnatomicalRegionExpandButton->setDown(true);
}
