...
#ifndef __qCjyxTerminologyItemDelegate_h
#define __qCjyxTerminologyItemDelegate_h
...
class Q_CJYX_MODULE_TERMINOLOGIES_WIDGETS_EXPORT qCjyxTerminologyItemDelegate : public QStyledItemDelegate
{
  Q_OBJECT

public:
  qCjyxTerminologyItemDelegate(QObject *parent = nullptr);
