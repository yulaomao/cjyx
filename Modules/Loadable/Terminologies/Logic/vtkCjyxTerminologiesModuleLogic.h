...
#ifndef __vtkCjyxTerminologiesModuleLogic_h
#define __vtkCjyxTerminologiesModuleLogic_h
...
class vtkCjyxTerminologyCategory;
class vtkCjyxTerminologyType;

/// \ingroup Cjyx_QtModules_Terminologies
class VTK_CJYX_TERMINOLOGIES_LOGIC_EXPORT vtkCjyxTerminologiesModuleLogic :
  public vtkCjyxModuleLogic
{
public:
  static vtkCjyxTerminologiesModuleLogic *New();
  vtkTypeMacro(vtkCjyxTerminologiesModuleLogic, vtkCjyxModuleLogic);
  ...
  /// Get terminology categories from a terminology as collection of \sa vtkCjyxTerminologyCategory container objects
  /// \param categories Output argument containing all the \sa vtkCjyxTerminologyCategory objects created
  ...
  /// \return Success flag
  bool GetCategoryInTerminology(std::string terminologyName, CodeIdentifier categoryId, vtkCjyxTerminologyCategory* categoryObject);
  ...
  /// \return Success flag
  bool GetNthCategoryInTerminology(std::string terminologyName, int categoryIndex, vtkCjyxTerminologyCategory* category);

  /// Get terminology types from a terminology category as collection of \sa vtkCjyxTerminologyType container objects
  /// \param typeCollection Output argument containing all the \sa vtkCjyxTerminologyType objects created
  ...
  /// \return Success flag
  bool GetTypeInTerminologyCategory(std::string terminologyName, CodeIdentifier categoryId, CodeIdentifier typeId, vtkCjyxTerminologyType* typeObject);
  /// Get number of types in the chosen category in a terminology
  int GetNumberOfTypesInTerminologyCategory(std::string terminologyName, vtkCjyxTerminologyCategory* category);
  ...
  /// \return Success flag
  bool GetNthTypeInTerminologyCategory(std::string terminologyName, vtkCjyxTerminologyCategory* category, int typeIndex, vtkCjyxTerminologyType* type);

  /// Get terminology type modifiers from a terminology type as collection of \sa vtkCjyxTerminologyType container objects
  /// \param typeModifierCollection Output argument containing all the \sa vtkCjyxTerminologyType objects created
  ...
  bool GetTypeModifierInTerminologyType(std::string terminologyName,
    CodeIdentifier categoryId, CodeIdentifier typeId, CodeIdentifier modifierId, vtkCjyxTerminologyType* typeModifier);
  /// Get number of type modifiers for the chosen category and type in a terminology
  int GetNumberOfTypeModifiersInTerminologyType(std::string terminologyName, vtkCjyxTerminologyCategory* category, vtkCjyxTerminologyType* type);
  /// Get a terminology type by index
  /// \param terminologyName input terminology name
  /// \param category input category
  ...
  /// \return Success flag
  bool GetNthTypeModifierInTerminologyType(std::string terminologyName, vtkCjyxTerminologyCategory* category, vtkCjyxTerminologyType* type, int typeModifierIndex, vtkCjyxTerminologyType* typeModifier);

  /// Get anatomic regions from an anatomic context as collection of \sa vtkCjyxTerminologyType container objects
  /// \param regionCollection Output argument containing all the \sa vtkCjyxTerminologyType objects created
  ...
  /// \return Success flag
  bool GetRegionInAnatomicContext(std::string anatomicContextName, CodeIdentifier regionId, vtkCjyxTerminologyType* regionObject);

  /// Get region modifiers from an anatomic region as collection of \sa vtkCjyxTerminologyType container objects
  /// \param regionModifierCollection Output argument containing all the \sa vtkCjyxTerminologyType objects created
  ...
  /// Find terminology type or type modifier based on '3dCjyxLabel' attribute
  /// \param terminologyName Terminology context in which the attribute is looked for
  /// \param cjyxLabel Attribute to look for
  /// \param entry Terminology entry populated if the attribute is found
  /// \return Flag indicating whether the attribute was found
  bool FindTypeInTerminologyBy3dCjyxLabel(std::string terminologyName, std::string cjyxLabel, vtkCjyxTerminologyEntry* entry);

  /// Convert terminology category object to code identifier
  static CodeIdentifier CodeIdentifierFromTerminologyCategory(vtkCjyxTerminologyCategory* category);
  /// Convert terminology type object to code identifier
  static CodeIdentifier CodeIdentifierFromTerminologyType(vtkCjyxTerminologyType* type);
  ...
  static std::string SerializeTerminologyEntry(vtkCjyxTerminologyEntry* entry);
  ...
  ///       (to vtkDMMLColorLogic::AddTermToTerminology)
  ...
  /// codeValue, codeMeaning triple), type, typeModifier, anatomicContextName, anatomicRegion, anatomicRegionModifier
  ///  \return Success flag
  bool DeserializeTerminologyEntry(std::string serializedEntry, vtkCjyxTerminologyEntry* entry);

  /// Assemble human readable info string from a terminology entry, for example for tooltips
  static std::string GetInfoStringFromTerminologyEntry(vtkCjyxTerminologyEntry* entry);
...
protected:
  ...
  ~vtkCjyxTerminologiesModuleLogic() override;
...
private:
  vtkCjyxTerminologiesModuleLogic(const vtkCjyxTerminologiesModuleLogic&) = delete;
  void operator=(const vtkCjyxTerminologiesModuleLogic&) = delete;
