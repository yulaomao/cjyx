...
//----------------------------------------------------------------------------
vtkStandardNewMacro(vtkCjyxTerminologiesModuleLogic);

//---------------------------------------------------------------------------
class vtkCjyxTerminologiesModuleLogic::vtkInternal
{
public:
  ...
  /// Populate \sa vtkCjyxTerminologyCategory from Json terminology
  bool PopulateTerminologyCategoryFromJson(rapidjson::Value& categoryObject, vtkCjyxTerminologyCategory* category);
  ...
  /// Populate \sa vtkCjyxTerminologyType from Json terminology
  bool PopulateTerminologyTypeFromJson(rapidjson::Value& typeObject, vtkCjyxTerminologyType* type);
  ...
  /// Populate \sa vtkCjyxTerminologyType from Json anatomic region
  bool PopulateRegionFromJson(rapidjson::Value& anatomicRegionObject, vtkCjyxTerminologyType* region);
...
//---------------------------------------------------------------------------
vtkCjyxTerminologiesModuleLogic::vtkInternal::vtkInternal() = default;

//---------------------------------------------------------------------------
vtkCjyxTerminologiesModuleLogic::vtkInternal::~vtkInternal()
{
...
//---------------------------------------------------------------------------
rapidjson::Value& vtkCjyxTerminologiesModuleLogic::vtkInternal::GetCodeInArray(CodeIdentifier codeId, rapidjson::Value &jsonArray, int &foundIndex)
{
...
//---------------------------------------------------------------------------
rapidjson::Value& vtkCjyxTerminologiesModuleLogic::vtkInternal::GetTerminologyRootByName(std::string terminologyName)
{
...
//---------------------------------------------------------------------------
rapidjson::Value& vtkCjyxTerminologiesModuleLogic::vtkInternal::GetCategoryArrayInTerminology(std::string terminologyName)
{
...
//---------------------------------------------------------------------------
rapidjson::Value& vtkCjyxTerminologiesModuleLogic::vtkInternal::GetCategoryInTerminology(std::string terminologyName, CodeIdentifier categoryId)
{
...
//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::vtkInternal::PopulateTerminologyCategoryFromJson(
  rapidjson::Value& categoryObject, vtkCjyxTerminologyCategory* category)
{
...
//---------------------------------------------------------------------------
rapidjson::Value& vtkCjyxTerminologiesModuleLogic::vtkInternal::GetTypeArrayInTerminologyCategory(std::string terminologyName, CodeIdentifier categoryId)
{
  if (categoryId.CodingSchemeDesignator.empty() || categoryId.CodeValue.empty())
    {
    return JSON_EMPTY_VALUE;
...
//---------------------------------------------------------------------------
rapidjson::Value& vtkCjyxTerminologiesModuleLogic::vtkInternal::GetTypeInTerminologyCategory(
...
//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::vtkInternal::PopulateTerminologyTypeFromJson(rapidjson::Value& typeObject, vtkCjyxTerminologyType* type)
{
  ...
  // e.g. "artery"
  rapidjson::Value::MemberIterator cjyxLabel = typeObject.FindMember("3dCjyxLabel");
  // e.g. "85756007"
  ...
  type->SetCjyxLabel(cjyxLabel != typeObject.MemberEnd() ? cjyxLabel->value.GetString() : nullptr);
  ...
  if (recommendedDisplayRGBValue != typeObject.MemberEnd()
    ...
    {
    type->SetRecommendedDisplayRGBValue( vtkCjyxTerminologyType::INVALID_COLOR[0],
                                         vtkCjyxTerminologyType::INVALID_COLOR[1],
                                         vtkCjyxTerminologyType::INVALID_COLOR[2] ); // 'Invalid' gray
    }
...
//---------------------------------------------------------------------------
rapidjson::Value& vtkCjyxTerminologiesModuleLogic::vtkInternal::GetTypeModifierArrayInTerminologyType(
  std::string terminologyName, CodeIdentifier categoryId, CodeIdentifier typeId)
{
  if (typeId.CodingSchemeDesignator.empty() || typeId.CodeValue.empty())
    {
...
//---------------------------------------------------------------------------
rapidjson::Value& vtkCjyxTerminologiesModuleLogic::vtkInternal::GetTypeModifierInTerminologyType(
...
//---------------------------------------------------------------------------
rapidjson::Value& vtkCjyxTerminologiesModuleLogic::vtkInternal::GetAnatomicContextRootByName(std::string anatomicContextName)
{
...
//---------------------------------------------------------------------------
rapidjson::Value& vtkCjyxTerminologiesModuleLogic::vtkInternal::GetRegionArrayInAnatomicContext(std::string anatomicContextName)
{
...
//---------------------------------------------------------------------------
rapidjson::Value& vtkCjyxTerminologiesModuleLogic::vtkInternal::GetRegionInAnatomicContext(std::string anatomicContextName, CodeIdentifier regionId)
{
...
//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::vtkInternal::PopulateRegionFromJson(rapidjson::Value& anatomicRegionObject, vtkCjyxTerminologyType* region)
{
  return this->PopulateTerminologyTypeFromJson(anatomicRegionObject, region);
}

//---------------------------------------------------------------------------
rapidjson::Value& vtkCjyxTerminologiesModuleLogic::vtkInternal::GetRegionModifierArrayInRegion(std::string anatomicContextName, CodeIdentifier regionId)
{
  if (regionId.CodingSchemeDesignator.empty() || regionId.CodeValue.empty())
    {
    return JSON_EMPTY_VALUE;
...
//---------------------------------------------------------------------------
rapidjson::Value& vtkCjyxTerminologiesModuleLogic::vtkInternal::GetRegionModifierInRegion(
...
//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::vtkInternal::ConvertSegmentationDescriptorToTerminologyContext(
  rapidjson::Document& descriptorDoc, rapidjson::Document& convertedDoc, std::string contextName )
{
  ...
  while (index < segmentAttributesArray.Size())
    ...
    vtkCjyxTerminologiesModuleLogic::CodeIdentifier categoryId(
    ...
    vtkCjyxTerminologiesModuleLogic::CodeIdentifier typeId(
    ...
    if (segmentAttributes.HasMember("SegmentedPropertyTypeModifierCodeSequence"))
      ...
      vtkCjyxTerminologiesModuleLogic::CodeIdentifier typeModifierId(
...
//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::vtkInternal::ConvertSegmentationDescriptorToAnatomicContext(
  rapidjson::Document& descriptorDoc, rapidjson::Document& convertedDoc, std::string contextName)
{
  if (!descriptorDoc.IsObject() || contextName.empty())
    {
  ...
  while (index < segmentAttributesArray.Size())
    ...
    vtkCjyxTerminologiesModuleLogic::CodeIdentifier regionId(
    ...
    if (segmentAttributes.HasMember("AnatomicRegionModifierSequence"))
      ...
      vtkCjyxTerminologiesModuleLogic::CodeIdentifier regionModifierId(
...
//---------------------------------------------------------------------------
void vtkCjyxTerminologiesModuleLogic::vtkInternal::GetJsonCodeFromIdentifier(
...
//---------------------------------------------------------------------------
// vtkCjyxTerminologiesModuleLogic methods

//----------------------------------------------------------------------------
vtkCjyxTerminologiesModuleLogic::vtkCjyxTerminologiesModuleLogic()
{
...
//----------------------------------------------------------------------------
void vtkCjyxTerminologiesModuleLogic::PrintSelf(ostream& os, vtkIndent indent)
{
  this->Superclass::PrintSelf(os, indent);
}

//---------------------------------------------------------------------------
void vtkCjyxTerminologiesModuleLogic::SetDMMLSceneInternal(vtkDMMLScene* newScene)
{
...
//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::LoadContextFromFile(std::string filePath)
{
  ...
  if (!schema.compare(TERMINOLOGY_CONTEXT_SCHEMA) || !schema.compare(TERMINOLOGY_CONTEXT_SCHEMA_1))
    ...
    vtkCjyxTerminologiesModuleLogic::vtkInternal::SetDocumentInTerminologyMap(
...
//---------------------------------------------------------------------------
std::string vtkCjyxTerminologiesModuleLogic::LoadTerminologyFromFile(std::string filePath)
{
...
//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::LoadTerminologyFromSegmentDescriptorFile(std::string contextName, std::string filePath)
{
  FILE *fp = fopen(filePath.c_str(), "r");
  if (!fp)
    {
...
//---------------------------------------------------------------------------
void vtkCjyxTerminologiesModuleLogic::LoadDefaultTerminologies()
{
  std::string success("");
  success = this->LoadTerminologyFromFile(this->GetModuleShareDirectory() + "/SegmentationCategoryTypeModifier-CjyxGeneralAnatomy.term.json");
  if (success.empty())
    {
    vtkErrorMacro("LoadDefaultTerminologies: Failed to load terminology 'SegmentationCategoryTypeModifier-CjyxGeneralAnatomy'");
    }
...
//---------------------------------------------------------------------------
std::string vtkCjyxTerminologiesModuleLogic::LoadAnatomicContextFromFile(std::string filePath)
{
...
//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::LoadAnatomicContextFromSegmentDescriptorFile(std::string contextName, std::string filePath)
{
  FILE *fp = fopen(filePath.c_str(), "r");
  if (!fp)
    {
...
//---------------------------------------------------------------------------
void vtkCjyxTerminologiesModuleLogic::LoadDefaultAnatomicContexts()
{
  std::string success("");
...
//---------------------------------------------------------------------------
void vtkCjyxTerminologiesModuleLogic::LoadUserContexts()
{
...
//---------------------------------------------------------------------------
void vtkCjyxTerminologiesModuleLogic::GetLoadedTerminologyNames(std::vector<std::string> &terminologyNames)
{
  terminologyNames.clear();

  vtkCjyxTerminologiesModuleLogic::vtkInternal::TerminologyMap::iterator termIt;
...
//---------------------------------------------------------------------------
void vtkCjyxTerminologiesModuleLogic::GetLoadedTerminologyNames(vtkStringArray* terminologyNames)
{
  if (!terminologyNames)
    {
    return;
...
//---------------------------------------------------------------------------
void vtkCjyxTerminologiesModuleLogic::GetLoadedAnatomicContextNames(std::vector<std::string> &anatomicContextNames)
{
  anatomicContextNames.clear();

  vtkCjyxTerminologiesModuleLogic::vtkInternal::TerminologyMap::iterator anIt;
...
//---------------------------------------------------------------------------
void vtkCjyxTerminologiesModuleLogic::GetLoadedAnatomicContextNames(vtkStringArray* anatomicContextNames)
{
...
//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::GetCategoriesInTerminology(std::string terminologyName, std::vector<CodeIdentifier>& categories)
{
  return this->FindCategoriesInTerminology(terminologyName, categories, "");
}

//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::FindCategoriesInTerminology(std::string terminologyName, std::vector<CodeIdentifier>& categories, std::string search/*=""*/)
{
  categories.clear();
...
//---------------------------------------------------------------------------
int vtkCjyxTerminologiesModuleLogic::GetNumberOfCategoriesInTerminology(std::string terminologyName)
{
  rapidjson::Value& categoryArray = this->Internal->GetCategoryArrayInTerminology(terminologyName);
  if (categoryArray.IsNull())
    {
...
//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::GetNthCategoryInTerminology(std::string terminologyName, int categoryIndex, vtkCjyxTerminologyCategory* category)
{
  rapidjson::Value& categoryArray = this->Internal->GetCategoryArrayInTerminology(terminologyName);
  if (categoryArray.IsNull())
    {
...
//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::GetCategoryInTerminology(std::string terminologyName, CodeIdentifier categoryId, vtkCjyxTerminologyCategory* category)
{
  ...
  if (categoryObject.IsNull())
  {
    if (!categoryId.CodingSchemeDesignator.compare("SRT"))
      ...
      // that replaced them on 2020.03.17 in Cjyx@5ae556436.
      return false;
      }
...
//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::GetTypesInTerminologyCategory(std::string terminologyName, CodeIdentifier categoryId, std::vector<CodeIdentifier>& types)
{
  return this->FindTypesInTerminologyCategory(terminologyName, categoryId, types, "");
}

//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::FindTypesInTerminologyCategory(
...
//---------------------------------------------------------------------------
int vtkCjyxTerminologiesModuleLogic::GetNumberOfTypesInTerminologyCategory(std::string terminologyName, vtkCjyxTerminologyCategory* category)
{
...
//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::GetNthTypeInTerminologyCategory(std::string terminologyName, vtkCjyxTerminologyCategory* category,
  int typeIndex, vtkCjyxTerminologyType* type)
{
  CodeIdentifier categoryId = this->CodeIdentifierFromTerminologyCategory(category);
  rapidjson::Value& typeArray = this->Internal->GetTypeArrayInTerminologyCategory(terminologyName, categoryId);
  if (typeArray.IsNull())
...
//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::GetTypeInTerminologyCategory(
  std::string terminologyName, CodeIdentifier categoryId, CodeIdentifier typeId, vtkCjyxTerminologyType* type)
{
...
//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::GetTypeModifiersInTerminologyType(
...
//---------------------------------------------------------------------------
int vtkCjyxTerminologiesModuleLogic::GetNumberOfTypeModifiersInTerminologyType(
  std::string terminologyName, vtkCjyxTerminologyCategory* category, vtkCjyxTerminologyType* type)
{
  CodeIdentifier categoryId = this->CodeIdentifierFromTerminologyCategory(category);
...
//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::GetNthTypeModifierInTerminologyType(
  std::string terminologyName, vtkCjyxTerminologyCategory* category, vtkCjyxTerminologyType* type, int typeModifierIndex,
  vtkCjyxTerminologyType* typeModifier)
{
  CodeIdentifier categoryId = this->CodeIdentifierFromTerminologyCategory(category);
  CodeIdentifier typeId = this->CodeIdentifierFromTerminologyType(type);
  rapidjson::Value& typeModifierArray = this->Internal->GetTypeModifierArrayInTerminologyType(terminologyName, categoryId, typeId);
...
//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::GetTypeModifierInTerminologyType(
  std::string terminologyName, CodeIdentifier categoryId, CodeIdentifier typeId, CodeIdentifier modifierId, vtkCjyxTerminologyType* typeModifier)
{
...
//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::GetRegionsInAnatomicContext(std::string anatomicContextName, std::vector<CodeIdentifier>& regions)
{
  return this->FindRegionsInAnatomicContext(anatomicContextName, regions, "");
}

//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::FindRegionsInAnatomicContext(std::string anatomicContextName, std::vector<CodeIdentifier>& regions, std::string search)
{
  regions.clear();
...
//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::GetRegionInAnatomicContext(std::string anatomicContextName, CodeIdentifier regionId, vtkCjyxTerminologyType* region)
{
...
//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::GetRegionModifiersInAnatomicRegion(
...
//---------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::GetRegionModifierInAnatomicRegion(std::string anatomicContextName,
    CodeIdentifier regionId, CodeIdentifier modifierId, vtkCjyxTerminologyType* regionModifier)
{
...
//---------------------------------------------------------------------------
vtkCjyxTerminologiesModuleLogic::CodeIdentifier vtkCjyxTerminologiesModuleLogic::CodeIdentifierFromTerminologyCategory(vtkCjyxTerminologyCategory* category)
{
  if (!category)
    {
...
//---------------------------------------------------------------------------
vtkCjyxTerminologiesModuleLogic::CodeIdentifier vtkCjyxTerminologiesModuleLogic::CodeIdentifierFromTerminologyType(vtkCjyxTerminologyType* type)
{
  if (!type)
    {
    return CodeIdentifier("","","");
...
//-----------------------------------------------------------------------------
std::string vtkCjyxTerminologiesModuleLogic::SerializeTerminologyEntry(vtkCjyxTerminologyEntry* entry)
{
  if (!entry || !entry->GetTerminologyContextName())
    {
    vtkGenericWarningMacro("vtkCjyxTerminologiesModuleLogic::SerializeTerminologyEntry: Invalid terminology given");
    return "";
    }
...
//-----------------------------------------------------------------------------
std::string vtkCjyxTerminologiesModuleLogic::SerializeTerminologyEntry(
...
//-----------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::DeserializeTerminologyEntry(std::string serializedEntry, vtkCjyxTerminologyEntry* entry)
{
  if (!entry)
    {
    vtkGenericWarningMacro("vtkCjyxTerminologiesModuleLogic::DeserializeTerminologyEntry: Invalid terminology given");
    return false;
    }
  ...
  vtkCjyxTerminologiesModuleLogic::CodeIdentifier categoryId(categoryIds[0], categoryIds[1], categoryIds[2]);
  vtkSmartPointer<vtkCjyxTerminologyCategory> categoryObject = vtkSmartPointer<vtkCjyxTerminologyCategory>::New();
  ...
  vtkCjyxTerminologiesModuleLogic::CodeIdentifier typeId(typeIds[0], typeIds[1], typeIds[2]);
  vtkSmartPointer<vtkCjyxTerminologyType> typeObject = vtkSmartPointer<vtkCjyxTerminologyType>::New();
  ...
  if (typeModifierIds.size() == 3)
    {
    vtkCjyxTerminologiesModuleLogic::CodeIdentifier typeModifierId(typeModifierIds[0], typeModifierIds[1], typeModifierIds[2]);
    vtkSmartPointer<vtkCjyxTerminologyType> typeModifierObject = vtkSmartPointer<vtkCjyxTerminologyType>::New();
  ...
  if (regionIds.size() == 3)
    {
    vtkCjyxTerminologiesModuleLogic::CodeIdentifier regionId(regionIds[0], regionIds[1], regionIds[2]);
    vtkSmartPointer<vtkCjyxTerminologyType> regionObject = vtkSmartPointer<vtkCjyxTerminologyType>::New();
    ...
    if (regionModifierIds.size() == 3)
      {
      vtkCjyxTerminologiesModuleLogic::CodeIdentifier regionModifierId(regionModifierIds[0], regionModifierIds[1], regionModifierIds[2]);
      vtkSmartPointer<vtkCjyxTerminologyType> regionModifierObject = vtkSmartPointer<vtkCjyxTerminologyType>::New();
...
//-----------------------------------------------------------------------------
std::string vtkCjyxTerminologiesModuleLogic::GetInfoStringFromTerminologyEntry(vtkCjyxTerminologyEntry* entry)
{
  if (!entry)
    {
...
//-----------------------------------------------------------------------------
bool vtkCjyxTerminologiesModuleLogic::FindTypeInTerminologyBy3dCjyxLabel(std::string terminologyName, std::string cjyxLabel, vtkCjyxTerminologyEntry* entry)
{
  if (!entry)
    {
    vtkErrorMacro("FindTypeInTerminologyBy3dCjyxLabel: Invalid output terminology entry");
    return false;
    }
  if (cjyxLabel.empty())
    {
    vtkErrorMacro("FindTypeInTerminologyBy3dCjyxLabel: Empty 3dCjyxLabel attribute to look for");
    return false;
    }
  ...
  if (categoryArray.IsNull())
    {
    vtkErrorMacro("FindTypeInTerminologyBy3dCjyxLabel: Failed to find terminology '" << terminologyName << "'");
    return false;
    }
  ...
  while (categoryIndex < categoryArray.Size())
    ...
    if (category.IsObject())
      ...
      if (categoryName.IsString() && categoryCodingSchemeDesignator.IsString() && categoryCodeValue.IsString())
        ...
        if (typeArray.IsNull())
          {
          vtkErrorMacro("FindTypeInTerminologyBy3dCjyxLabel: Failed to find category '"
            << categoryId.CodeMeaning << "' in terminology '" << terminologyName << "'");
          ++categoryIndex;
          continue;
          }
        ...
        while (typeIndex < typeArray.Size())
          ...
          if (type.IsObject())
            ...
            if (typeName.IsString() && typeCodingSchemeDesignator.IsString() && typeCodeValue.IsString())
              ...
              rapidjson::Value::MemberIterator currentCjyxLabelIt = type.FindMember("3dCjyxLabel");
              if (currentCjyxLabelIt != type.MemberEnd() && !cjyxLabel.compare(currentCjyxLabelIt->value.GetString()))
                {
                // 3dCjyxLabel found in type
                found = true;
              ...
              while (typeModifierIndex < typeModifierArray.Size())
                ...
                if (typeModifier.IsObject())
                  ...
                  if (typeModifierName.IsString() && typeModifierCodingSchemeDesignator.IsString() && typeModifierCodeValue.IsString())
                    ...
                    CodeIdentifier typeModifierId(typeModifierCodingSchemeDesignator.GetString(),
                      typeModifierCodeValue.GetString(), typeModifierName.GetString());
                    rapidjson::Value::MemberIterator currentCjyxLabelIt = typeModifier.FindMember("3dCjyxLabel");
                    if (currentCjyxLabelIt != typeModifier.MemberEnd() && !cjyxLabel.compare(currentCjyxLabelIt->value.GetString()))
                      {
                      // 3dCjyxLabel found in type modifier
                      found = true;
                      foundCategoryId = categoryId;
                      foundTypeId = typeId;
              ...
              {
              vtkErrorMacro("FindTypeInTerminologyBy3dCjyxLabel: Invalid type '" << typeName.GetString() << "in category '"
                << categoryId.CodeMeaning << "' in terminology '" << terminologyName << "'");
              }
            }
          ++typeIndex;
        ...
        {
        vtkErrorMacro("FindTypeInTerminologyBy3dCjyxLabel: Invalid category '" << categoryName.GetString() << "' in terminology '" << terminologyName << "'");
        }
      }
    ++categoryIndex;
    } // For all categories
