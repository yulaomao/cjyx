...
//------------------------------------------------------------------------------
vtkStandardNewMacro(vtkCjyxTerminologyCategory);

//----------------------------------------------------------------------------
vtkCjyxTerminologyCategory::vtkCjyxTerminologyCategory()
{
...
//----------------------------------------------------------------------------
void vtkCjyxTerminologyCategory::Initialize()
{
...
//----------------------------------------------------------------------------
void vtkCjyxTerminologyCategory::PrintSelf(ostream& os, vtkIndent indent)
{
...
//----------------------------------------------------------------------------
void vtkCjyxTerminologyCategory::Copy(vtkCodedEntry* aCategory)
{
  if (!aCategory)
    {
    return;
  ...
  vtkCjyxTerminologyCategory *aTerminologyCategory =
      vtkCjyxTerminologyCategory::SafeDownCast(aCategory);
