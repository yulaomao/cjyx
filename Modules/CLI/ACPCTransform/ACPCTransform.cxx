...
int main(int argc, char * argv[])
{
  ...
  vtkNew<vtkDMMLMarkupsLineNode> acpcLineNode;
  if (!ACPC.empty())
    {
    vtkNew<vtkDMMLMarkupsJsonStorageNode> storageNode;
  ...
  vtkNew<vtkDMMLMarkupsFiducialNode> midlinePointsNode;
  if (!Midline.empty())
    {
    vtkNew<vtkDMMLMarkupsJsonStorageNode> storageNode;
  ...
  vtkNew<vtkDMMLLinearTransformNode> outputTransformNode;
