...
int main( int argc, char * argv[] )
{
  ...
  vtkNew<vtkDMMLScalarVolumeNode> referenceVolumeNode;
  vtkNew<vtkDMMLVolumeArchetypeStorageNode> referenceVolumeStorageNode;
  ...
  vtkNew<vtkDMMLLabelMapVolumeNode> outputVolumeNode;
  outputVolumeNode->SetAndObserveImageData(stencil->GetOutput());
  outputVolumeNode->SetIJKToRASMatrix(ijkToRASMatrix);

  vtkNew<vtkDMMLVolumeArchetypeStorageNode> outputVolumeStorageNode;
