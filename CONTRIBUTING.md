Contributing to Cjyx
======================

There are many ways to contribute to Cjyx, with varying levels of effort.  Do try to
...
do better.
  ...
  * Ask a question on the [Cjyx forum][cjyx-forum]
  * Use [Cjyx issues][cjyx-issues] to submit a feature request or bug, or add to the discussion on an existing issue
...
If you are new to Cjyx development and you don't have push access to the Cjyx
...
* consider potential backward compatibility breakage and discuss these on the
  [Cjyx forum][cjyx-forum]. For example, update of ITK, Python, Qt or VTK version, change to
...
Write your commit messages using the standard prefixes for Cjyx commit
messages:
...
commits, the message body should follow the following guidelines:
  ...
  9. If the commit refers to a topic discussed on the [Cjyx forum][cjyx-forum], or fixes
...
* If you do NOT have push access, a Cjyx core developer will integrate your PR. If
  you would like to speed up the integration, do not hesitate to send a note on
  the [Cjyx forum][cjyx-forum].
...
[3D Cjyx Improves Testing for Pull Requests Using Docker and CircleCI](https://blog.kitware.com/3d-slicer-improves-testing-for-pull-requests-using-docker-and-circleci/)
blog post.


#### Nightly tests

After changes are integrated, every evening at 10pm EST (3am UTC), Cjyx build bots (aka factories)
will build, test and package the Cjyx application and all its extensions on Linux, macOS
...
1. Given the topic of interest, initiate discussion on the [Cjyx forum][cjyx-forum].
...
4. Announce on the [Cjyx forum][cjyx-forum] the in-depth discussion of the topic for the
   [Cjyx Community hangout](https://discourse.slicer.org/c/community/hangout),
...
The Cjyx community is inclusive and welcomes anyone to work to become a core
developer and then a BDFL. This happens with hard work and approval of the existing
BDFL.

[cjyx-forum]: https://discourse.slicer.org
[cjyx-issues]: https://github.com/Slicer/Slicer/issues
