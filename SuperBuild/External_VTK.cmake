...
if((NOT DEFINED VTK_DIR OR NOT DEFINED VTK_SOURCE_DIR) AND NOT Cjyx_USE_SYSTEM_${proj})
  ...
  if(Cjyx_USE_PYTHONQT)
    ...
    list(APPEND EXTERNAL_PROJECT_OPTIONAL_VTK9_CMAKE_CACHE_ARGS
      -DVTK_PYTHON_VERSION:STRING=${Cjyx_REQUIRED_PYTHON_VERSION_MAJOR}
  ...
  # SplineDrivenImageCjyx remote module.
  list(APPEND EXTERNAL_PROJECT_OPTIONAL_VTK9_CMAKE_CACHE_ARGS
    -DVTK_MODULE_ENABLE_VTK_SplineDrivenImageCjyx:BOOL=YES
    )
  ...
  if("${Cjyx_VTK_RENDERING_BACKEND}" STREQUAL "OpenGL2")
    list(APPEND EXTERNAL_PROJECT_OPTIONAL_VTK9_CMAKE_CACHE_ARGS
  ...
  set(_git_tag)
  if("${Cjyx_VTK_VERSION_MAJOR}" STREQUAL "9")
    set(_git_tag "bccd2b8f7eff92ed08ef60b54ef60303861b5221") # cjyx-v9.1.20220125-efbe2afc2
    set(vtk_egg_info_version "9.1.20220125")
  else()
    message(FATAL_ERROR "error: Unsupported Cjyx_VTK_VERSION_MAJOR: ${Cjyx_VTK_VERSION_MAJOR}")
  endif()
  ...
  ExternalProject_Add(${proj}
    ...
    CMAKE_CACHE_ARGS
      ...
      -DVTK_INSTALL_RUNTIME_DIR:PATH=${Cjyx_INSTALL_BIN_DIR}
      -DVTK_INSTALL_LIBRARY_DIR:PATH=${Cjyx_INSTALL_LIB_DIR}
      -DVTK_INSTALL_ARCHIVE_DIR:PATH=${Cjyx_INSTALL_LIB_DIR}
      -DVTK_Group_Qt:BOOL=ON
      ...
      -DVTK_RENDERING_BACKEND:STRING=${Cjyx_VTK_RENDERING_BACKEND}
      -DVTK_SMP_IMPLEMENTATION_TYPE:STRING=${Cjyx_VTK_SMP_IMPLEMENTATION_TYPE}
      ${EXTERNAL_PROJECT_OPTIONAL_CMAKE_CACHE_ARGS}
      ${EXTERNAL_PROJECT_OPTIONAL_VTK${Cjyx_VTK_VERSION_MAJOR}_CMAKE_CACHE_ARGS}
    INSTALL_COMMAND ""
    DEPENDS
      ${${proj}_DEPENDENCIES}
    )
  ...
  if(Cjyx_USE_PYTHONQT AND NOT Cjyx_USE_SYSTEM_python)
    ...
    # vtk package as a wheel when listed as dependency in Cjyx extension.
    set(_vtk_egg_info_dir "${python_DIR}/${PYTHON_SITE_PACKAGES_SUBDIR}/vtk-${vtk_egg_info_version}-py${Cjyx_REQUIRED_PYTHON_VERSION_DOT}.egg-info")
  ...
  # pythonpath
    if(UNIX)
      set(${proj}_PYTHONPATH_LAUNCHER_BUILD
        ${VTK_DIR}/${_library_output_subdir}/python${Cjyx_REQUIRED_PYTHON_VERSION_DOT}/site-packages
        )
    else()
      set(${proj}_PYTHONPATH_LAUNCHER_BUILD
  ...
  if(NOT APPLE)
    ...
    # in a standard location using CMake/CjyxBlockInstallExternalPythonModules.cmake
    ...
    if(UNIX)
      set(${proj}_PYTHONPATH_LAUNCHER_INSTALLED
        <APPLAUNCHER_SETTINGS_DIR>/../${_library_install_subdir}/python${Cjyx_REQUIRED_PYTHON_VERSION_DOT}/site-packages
        )
    else()
      set(${proj}_PYTHONPATH_LAUNCHER_INSTALLED
