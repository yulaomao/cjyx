...
if(NOT DEFINED ${proj}_DIR AND NOT Cjyx_USE_SYSTEM_${proj})
  ...
  ExternalProject_SetIfNotDefined(
    Cjyx_${proj}_GIT_TAG
    "73b8e172d6615251ef851d883ef02f163e7075b2" # cjyx-v0.10.6-2016-04-22
    QUIET
    )
  ...
  ExternalProject_Add(${proj}
    ...
    CMAKE_CACHE_ARGS
      ...
      -DLIBRARY_INSTALL_DIR:PATH=${Cjyx_INSTALL_LIB_DIR}
      -DRUNTIME_INSTALL_DIR:PATH=${Cjyx_INSTALL_LIB_DIR}
      -DARCHIVE_INSTALL_DIR:PATH=${Cjyx_INSTALL_LIB_DIR}
      -DINCLUDE_INSTALL_DIR:PATH=${Cjyx_INSTALL_INCLUDE_DIR}
    INSTALL_COMMAND ""
    DEPENDS
      ${${proj}_DEPENDENCIES}
    )
...
# rules will be used to create the Cjyx package. However because JsonCpp
