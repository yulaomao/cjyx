...
")
  if(WIN32)
    file(APPEND ${_env_script}
"#------------------------------------------------------------------------------
# Added by '${CMAKE_CURRENT_LIST_FILE}' to ensure the function 'cjyx_dll_directories.add()'
...
")
  ...
  if(APPLE)
    ...
    # and with the Cjyx runtime, make all implicit symbols visible
    # on OSX.
...
")
  ...
  # required Lua, GTest etc. dependencies not in Cjyx SuperBuild
  ...
  ExternalProject_add(SimpleITK
    ...
    CMAKE_CACHE_ARGS
      ...
      -DBUILD_SHARED_LIBS:BOOL=${Cjyx_USE_SimpleITK_SHARED}
      -DBUILD_EXAMPLES:BOOL=OFF
      -DSimpleITK_BUILD_STRIP:BOOL=1
      -DSimpleITK_PYTHON_THREADS:BOOL=ON
      -DSimpleITK_INSTALL_ARCHIVE_DIR:PATH=${Cjyx_INSTALL_LIB_DIR}
      -DSimpleITK_INSTALL_LIBRARY_DIR:PATH=${Cjyx_INSTALL_LIB_DIR}
