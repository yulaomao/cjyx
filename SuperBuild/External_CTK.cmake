...
if(NOT DEFINED CTK_DIR AND NOT Cjyx_USE_SYSTEM_${proj})
  ...
  if(Cjyx_BUILD_MULTIMEDIA_SUPPORT AND Cjyx_USE_PYTHONQT)
  ...
  ExternalProject_Add(${proj}
    ...
    CMAKE_CACHE_ARGS
      ...
      -DCTK_BUILD_QTDESIGNER_PLUGINS:BOOL=${Cjyx_BUILD_QT_DESIGNER_PLUGINS}
      -DCTK_INSTALL_BIN_DIR:STRING=${Cjyx_INSTALL_BIN_DIR}
      -DCTK_INSTALL_LIB_DIR:STRING=${Cjyx_INSTALL_LIB_DIR}
      -DCTK_INSTALL_QTPLUGIN_DIR:STRING=${Cjyx_INSTALL_QtPlugins_DIR}
      ...
      -DCTK_APP_ctkDICOM:BOOL=${Cjyx_BUILD_DICOM_SUPPORT}
      -DCTK_LIB_DICOM/Core:BOOL=${Cjyx_BUILD_DICOM_SUPPORT}
      -DCTK_LIB_DICOM/Widgets:BOOL=${Cjyx_BUILD_DICOM_SUPPORT}
      -DCTK_USE_QTTESTING:BOOL=${Cjyx_USE_QtTesting}
      -DGIT_EXECUTABLE:FILEPATH=${GIT_EXECUTABLE}
      # PythonQt wrapping
      -DCTK_LIB_Scripting/Python/Core:BOOL=${Cjyx_USE_PYTHONQT}
      -DCTK_LIB_Scripting/Python/Core_PYTHONQT_USE_VTK:BOOL=${Cjyx_USE_PYTHONQT}
      -DCTK_LIB_Scripting/Python/Core_PYTHONQT_WRAP_QTCORE:BOOL=${Cjyx_USE_PYTHONQT}
      -DCTK_LIB_Scripting/Python/Core_PYTHONQT_WRAP_QTGUI:BOOL=${Cjyx_USE_PYTHONQT}
      -DCTK_LIB_Scripting/Python/Core_PYTHONQT_WRAP_QTUITOOLS:BOOL=${Cjyx_USE_PYTHONQT}
      -DCTK_LIB_Scripting/Python/Core_PYTHONQT_WRAP_QTNETWORK:BOOL=${Cjyx_USE_PYTHONQT}
      ...
      -DCTK_LIB_Scripting/Python/Widgets:BOOL=${Cjyx_USE_PYTHONQT}
      -DCTK_ENABLE_Python_Wrapping:BOOL=${Cjyx_USE_PYTHONQT}
