...
if(NOT DEFINED ITK_DIR AND NOT Cjyx_USE_SYSTEM_${proj})
  ...
  ExternalProject_SetIfNotDefined(
    Cjyx_${proj}_GIT_TAG
    "46a71c744d4856a5166df227e13c76e8c3ef55cc" # cjyx-v5.3rc03-2022-02-10-be81e62
    QUIET
    )
  ...
  if(Cjyx_USE_PYTHONQT OR Cjyx_BUILD_ITKPython)
    # XXX Ensure python executable used for ITKModuleHeaderTest
    #     is the same as Cjyx.
    #     This will keep the sanity check implemented in CjyxConfig.cmake
    #     quiet.
    list(APPEND EXTERNAL_PROJECT_OPTIONAL_CMAKE_CACHE_ARGS
  ...
  if(Cjyx_BUILD_ITKPython)
    ...
    # wrapping install rules enabling Cjyx to optionally
    # package ITK Wrapping in Cjyx installer by simply
    # toggling the Cjyx_INSTALL_ITKPython option.
    set(Cjyx_WRAP_ITK_INSTALL_COMPONENT_IDENTIFIER "Wrapping")
    mark_as_superbuild(Cjyx_WRAP_ITK_INSTALL_COMPONENT_IDENTIFIER:STRING)
    ...
    list(APPEND EXTERNAL_PROJECT_OPTIONAL_CMAKE_CACHE_ARGS
      ...
      -DWRAP_ITK_INSTALL_COMPONENT_IDENTIFIER:STRING=${Cjyx_WRAP_ITK_INSTALL_COMPONENT_IDENTIFIER}
  ...
  ExternalProject_Add(${proj}
    ...
    CMAKE_CACHE_ARGS
      ...
      -DITK_INSTALL_ARCHIVE_DIR:PATH=${Cjyx_INSTALL_LIB_DIR}
      -DITK_INSTALL_LIBRARY_DIR:PATH=${Cjyx_INSTALL_LIB_DIR}
      ...
      -DModule_SimpleITKFilters:BOOL=${Cjyx_USE_SimpleITK}
      -DModule_GenericLabelInterpolator:BOOL=ON
      -DModule_AdaptiveDenoising:BOOL=ON
      -DBUILD_SHARED_LIBS:BOOL=ON
      -DITK_INSTALL_NO_DEVELOPMENT:BOOL=ON
      -DKWSYS_USE_MD5:BOOL=ON # Required by CjyxExecutionModel
      -DITK_WRAPPING:BOOL=OFF #${BUILD_SHARED_LIBS} ## HACK:  QUICK CHANGE
      -DITK_WRAP_PYTHON:BOOL=${Cjyx_BUILD_ITKPython}
      ...
      -DModule_ITKIODCMTK:BOOL=${Cjyx_BUILD_DICOM_SUPPORT}
      # ZLIB
  ...
  # Since ITK Wrapping is installed in the Cjyx standard site-packages
