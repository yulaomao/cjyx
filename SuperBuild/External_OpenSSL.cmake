...
if(NOT DEFINED OPENSSL_LIBRARIES
   AND NOT (${_has_openssl_libraries}) AND NOT Cjyx_USE_SYSTEM_${proj})
...
You could either:
 (1) disable SSL support configuring with option Cjyx_USE_PYTHONQT_WITH_OPENSSL:BOOL=OFF
 or
 (2) configure Cjyx providing your own version of OpenSSL that matches the version
...
include(\"${Cjyx_CMAKE_DIR}/ExternalProjectForNonCMakeProject.cmake\")
set(CMAKE_BINARY_DIR \"${CMAKE_BINARY_DIR}\")
set(ENV{VS_UNICODE_OUTPUT} \"\")
set(Cjyx_USE_SYSTEM_zlib ${Cjyx_USE_SYSTEM_zlib})
")
    if(APPLE)
      file(APPEND ${_env_script}
"# Hint OpenSSL that we prefer a 64-bit build.
  ...
  # This is required when building Cjyx using a cronjob where the
...
")
    ...
    ExternalProject_Add_Step(${proj} resolve_e_os2_symlink
      COMMAND ${CMAKE_COMMAND}
        ...
        -P ${Cjyx_SOURCE_DIR}/SuperBuild/OpenSSL_resolve_e_os2_symlink.cmake
      DEPENDEES configure
      DEPENDERS build
      )
