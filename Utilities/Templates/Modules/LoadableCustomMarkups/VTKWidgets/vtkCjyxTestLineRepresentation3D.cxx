...
//------------------------------------------------------------------------------
vtkStandardNewMacro(vtkCjyxTestLineRepresentation3D);

//------------------------------------------------------------------------------
vtkCjyxTestLineRepresentation3D::vtkCjyxTestLineRepresentation3D()
  :TargetOrgan(nullptr)
{
...
//------------------------------------------------------------------------------
vtkCjyxTestLineRepresentation3D::~vtkCjyxTestLineRepresentation3D() = default;

//------------------------------------------------------------------------------
void vtkCjyxTestLineRepresentation3D::PrintSelf(ostream& os, vtkIndent indent)
{
  Superclass::PrintSelf(os, indent);
}

//------------------------------------------------------------------------------
void vtkCjyxTestLineRepresentation3D::GetActors(vtkPropCollection* pc)
{
...
//------------------------------------------------------------------------------
void vtkCjyxTestLineRepresentation3D::ReleaseGraphicsResources(vtkWindow* win)
{
...
//------------------------------------------------------------------------------
int vtkCjyxTestLineRepresentation3D::RenderOverlay(vtkViewport* viewport)
{
...
//------------------------------------------------------------------------------
int vtkCjyxTestLineRepresentation3D::RenderOpaqueGeometry(vtkViewport* viewport)
{
...
//------------------------------------------------------------------------------
int vtkCjyxTestLineRepresentation3D::RenderTranslucentPolygonalGeometry(vtkViewport* viewport)
{
...
//------------------------------------------------------------------------------
vtkTypeBool vtkCjyxTestLineRepresentation3D::HasTranslucentPolygonalGeometry()
{
...
//----------------------------------------------------------------------
void vtkCjyxTestLineRepresentation3D::UpdateFromDMML(vtkDMMLNode* caller,
                                                           unsigned long event,
                                                           void *callData /*=nullptr*/)
{
 this->Superclass::UpdateFromDMML(caller, event, callData);
 ...
 vtkDMMLMarkupsTestLineNode* liverMarkupsTestLineNode=
   vtkDMMLMarkupsTestLineNode::SafeDownCast(this->GetMarkupsNode());
...
//------------------------------------------------------------------------------
void vtkCjyxTestLineRepresentation3D::BuildMiddlePoint()
{
...
//------------------------------------------------------------------------------
void vtkCjyxTestLineRepresentation3D::BuildSlicingPlane()
{
  vtkDMMLMarkupsNode* markupsNode = this->GetMarkupsNode();
  if (!markupsNode)
    {
