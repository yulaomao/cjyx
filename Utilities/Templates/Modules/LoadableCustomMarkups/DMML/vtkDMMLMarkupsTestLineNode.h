...
#ifndef __vtkdmmlmarkupstestlinenode_h_
#define __vtkdmmlmarkupstestlinenode_h_

#include <vtkDMMLMarkupsLineNode.h>

#include "vtkCjyxTemplateKeyModuleDMMLExport.h"

//-----------------------------------------------------------------------------
class VTK_CJYX_TEMPLATEKEY_MODULE_DMML_EXPORT vtkDMMLMarkupsTestLineNode
: public vtkDMMLMarkupsLineNode
{
public:
  static vtkDMMLMarkupsTestLineNode* New();
  vtkTypeMacro(vtkDMMLMarkupsTestLineNode, vtkDMMLMarkupsLineNode);
  ...
  vtkDMMLCopyContentDefaultMacro(vtkDMMLMarkupsTestLineNode);
...
protected:
  vtkDMMLMarkupsTestLineNode();
  ~vtkDMMLMarkupsTestLineNode() override;
  vtkDMMLMarkupsTestLineNode(const vtkDMMLMarkupsTestLineNode&);
  void operator=(const vtkDMMLMarkupsTestLineNode&);

private:
  vtkPolyData *TargetOrgan = nullptr;
};

#endif //vtkdmmlmarkupstestlinenode_h_
