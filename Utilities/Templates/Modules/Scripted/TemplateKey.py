...
"""
        ...
        cjyx.app.connect("startupCompleted()", registerSampleData)
...
class TemplateKeyWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setup(self):
        ...
        uiWidget = cjyx.util.loadUI(self.resourcePath('UI/TemplateKey.ui'))
        ...
        # These connections ensure that whenever user changes some settings on the GUI, that is saved in the DMML scene
        # (in the selected parameter node).
        self.ui.inputSelector.connect("currentNodeChanged(vtkDMMLNode*)", self.updateParameterNodeFromGUI)
        self.ui.outputSelector.connect("currentNodeChanged(vtkDMMLNode*)", self.updateParameterNodeFromGUI)
        self.ui.imageThresholdSliderWidget.connect("valueChanged(double)", self.updateParameterNodeFromGUI)
        self.ui.invertOutputCheckBox.connect("toggled(bool)", self.updateParameterNodeFromGUI)
        self.ui.invertedOutputSelector.connect("currentNodeChanged(vtkDMMLNode*)", self.updateParameterNodeFromGUI)
    ...
    def initializeParameterNode(self):
        ...
        if not self._parameterNode.GetNodeReference("InputVolume"):
            firstVolumeNode = cjyx.dmmlScene.GetFirstNodeByClass("vtkDMMLScalarVolumeNode")
            if firstVolumeNode:
...
class TemplateKeyLogic(ScriptedLoadableModuleLogic):
    ...
    def process(self, inputVolume, outputVolume, imageThreshold, invert=False, showResult=True):
        ...
        cliNode = cjyx.cli.run(cjyx.modules.thresholdscalarvolume, None, cliParams, wait_for_completion=True, update_display=showResult)
