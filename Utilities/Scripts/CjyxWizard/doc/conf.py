#
# CjyxWizard documentation build configuration file, created by
...
htmlhelp_basename = 'CjyxWizarddoc'
...
latex_documents = [
    ('index', 'CjyxWizard.tex', 'CjyxWizard Documentation',
     author, 'manual'),
]
...
man_pages = [
    ('index', 'cjyxwizard', 'CjyxWizard Documentation',
     [author], 1)
]
...
texinfo_documents = [
    ('index', 'CjyxWizard', 'CjyxWizard Documentation',
     author, 'CjyxWizard', 'One line description of project.',
     'Miscellaneous'),
]
