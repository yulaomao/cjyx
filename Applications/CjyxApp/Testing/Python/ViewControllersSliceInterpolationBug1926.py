...
class ViewControllersSliceInterpolationBug1926Test(ScriptedLoadableModuleTest):
    ...
    def test_ViewControllersSliceInterpolationBug19261(self):
        ...
        ln = cjyx.util.getNode(pattern='vtkDMMLLayoutNode*')
        ...
        redLogic = cjyx.app.layoutManager().sliceWidget('Red').sliceLogic()
        ...
        redWidget = cjyx.app.layoutManager().sliceWidget('Red')
