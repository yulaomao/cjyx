...
class BRAINSFitRigidRegistrationCrashIssue4139(ScriptedLoadableModule):
    ...
    Cjyx does not crash in vtkITKTransformConverter after completing BRAINSFit rigid registration.
...
class BRAINSFitRigidRegistrationCrashIssue4139Test(ScriptedLoadableModuleTest):
    ...
    def test_BRAINSFitRigidRegistrationCrashIssue4139(self):
        ...
        outputTransform = cjyx.vtkDMMLLinearTransformNode()
        cjyx.dmmlScene.AddNode(outputTransform)

        outputVolume = cjyx.vtkDMMLScalarVolumeNode()
        cjyx.dmmlScene.AddNode(outputVolume)
        ...
        cmdLineNode = cjyx.cli.runSync(cjyx.modules.brainsfit, parameters=parameters)
