...
class SliceLinkLogicTest(ScriptedLoadableModuleTest):
    ...
    def test_SliceLinkLogic1(self):
        ...
        volumeNode = cjyx.util.getNode(pattern="FA")
        ...
        ln = cjyx.dmmlScene.GetFirstNodeByClass('vtkDMMLLayoutNode')
        ...
        logic = cjyx.app.layoutManager().sliceWidget('Compare1').sliceLogic()
        ...
        compareNode2 = cjyx.util.getNode('vtkDMMLSliceNodeCompare2')
        compareCNode2 = cjyx.util.getNode('vtkDMMLSliceCompositeNodeCompare2')
        self.assertEqual(compareCNode2.GetForegroundVolumeID(), volumeNode.GetID())
        compareNode3 = cjyx.util.getNode('vtkDMMLSliceNodeCompare3')
        compareCNode3 = cjyx.util.getNode('vtkDMMLSliceCompositeNodeCompare3')
