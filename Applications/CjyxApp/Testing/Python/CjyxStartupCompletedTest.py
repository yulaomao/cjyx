...
if __name__ == '__main__':
    ...
    try:
        ...
        copyfile(currentDirPath + '/CjyxStartupCompletedTestHelperModule.py',
                 temporaryModuleDirPath + '/CjyxStartupCompletedTestHelperModule.py')
        ...
        os.environ['CJYX_STARTUP_COMPLETED_TEST_OUTPUT'] = test_output_file
        if debug:
            print("CJYX_STARTUP_COMPLETED_TEST_OUTPUT=%s" % test_output_file)
