...
#
class CjyxBoundsTest(ScriptedLoadableModule):
...
# CjyxBoundsTest
#
class CjyxBoundsTestWidget(ScriptedLoadableModuleWidget):
    """
    """
...
#
class CjyxBoundsTestLogic(ScriptedLoadableModuleLogic):
    """
    """


class CjyxBoundsTestTest(ScriptedLoadableModuleTest):
    """
    """
    ...
    def test_Model(self):
        ...
        modelNode = cjyx.dmmlScene.AddNode(cjyx.vtkDMMLModelNode())
    ...
    def test_Segmentation(self):
        ...
        segmentationLogic = cjyx.modules.segmentations.logic()
