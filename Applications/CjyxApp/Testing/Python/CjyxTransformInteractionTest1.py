...
#
# CjyxTransformInteractionTest1
#


class CjyxTransformInteractionTest1(ScriptedLoadableModule):
...
#
# CjyxTransformInteractionTest1Widget
#


class CjyxTransformInteractionTest1Widget(ScriptedLoadableModuleWidget):
    """
    """
...
#
# CjyxTransformInteractionTest1Logic
#


class CjyxTransformInteractionTest1Logic(ScriptedLoadableModuleLogic):
    """
    """
    ...
    def addTransform(self):
        ...
        """
        transformNode = cjyx.dmmlScene.AddNode(cjyx.vtkDMMLTransformNode())
        transformDisplayNode = cjyx.dmmlScene.AddNode(cjyx.vtkDMMLTransformDisplayNode())
    ...
    def getModel3DDisplayableManager(self):
        ...
        for i in range(managers.GetNumberOfItems()):
            ...
            if obj.IsA('vtkDMMLLinearTransformsDisplayableManager3D'):
                return obj
        return None


class CjyxTransformInteractionTest1Test(ScriptedLoadableModuleTest):
    """
    """
    ...
    def test_3D_interactionDefaults(self):
        ...
        """
        logic = CjyxTransformInteractionTest1Logic()
        ...
        cjyx.app.layoutManager().layout = cjyx.vtkDMMLLayoutNode.CjyxLayoutOneUp3DView
    ...
    def test_3D_interaction2Models(self):
        ...
        centeredCubeNode = cjyx.dmmlScene.AddNode(cjyx.vtkDMMLModelNode())
        ...
        movedCubeNode = cjyx.dmmlScene.AddNode(cjyx.vtkDMMLModelNode())
    ...
    def test_3D_interactionSerialization(self):
        ...
        tempSceneDir = tempfile.mkdtemp('', 'InteractionSerialization', cjyx.app.temporaryPath)
        sceneFile = os.path.join(tempSceneDir, 'scene.mrb')
        cjyx.util.saveScene(sceneFile)
        cjyx.dmmlScene.RemoveNode(tNode)
        cjyx.dmmlScene.RemoveNode(tdNode)
        cjyx.dmmlScene.Clear(0)

        # Re-load scene and check values
        cjyx.util.loadScene(sceneFile)
        tNode = cjyx.util.getNode('Transform')
    ...
    def test_3D_boundsUpdateROI(self):
        ...
        # Setup
        roiNode = cjyx.dmmlScene.AddNode(cjyx.vtkDMMLAnnotationROINode())
