...
class RSNAVisTutorialWidget(ScriptedLoadableModuleWidget):
    ...
    def onReload(self, moduleName="RSNAVisTutorial"):
        ...
        """
        globals()[moduleName] = cjyx.util.reloadScriptedModule(moduleName)
...
class RSNAVisTutorialTest(ScriptedLoadableModuleTest):
    ...
    def test_Part1DICOM(self, enableScreenshotsFlag=0, screenshotScaleFactor=1):
        ...
        try:
            ...
            layoutManager.setLayout(cjyx.vtkDMMLLayoutNode.CjyxLayoutConventionalWidescreenView)
            ...
            abdomenVolume = cjyx.dmmlScene.GetFirstNodeByName('6: CT_Thorax_Abdomen')
            volumeRenderingWidgetRep.setDMMLVolumeNode(abdomenVolume)
            self.takeScreenshot('VolumeRendering-SelectVolume', 'Select the volume 6: CT_Thorax_Abdomen', -1)

            presetsScene = cjyx.modules.volumerendering.logic().GetPresetsScene()
            ctCardiac3 = presetsScene.GetFirstNodeByName('CT-Cardiac3')
            volumeRenderingWidgetRep.dmmlVolumePropertyNode().Copy(ctCardiac3)
            ...
            annotationROI = cjyx.dmmlScene.GetFirstNodeByName('AnnotationROI')
    ...
    def test_Part2Head(self, enableScreenshotsFlag=0, screenshotScaleFactor=1):
        ...
        try:
            ...
            clip = cjyx.util.getNode(pattern='vtkDMMLClipModelsNode1')
