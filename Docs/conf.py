#!/usr/bin/env python3
#
# 3D Cjyx documentation build configuration file, created by
...
project = '3D Cjyx'
copyright = '2020, Cjyx Community'
author = 'Cjyx Community'
...
if os.environ.get('EXCLUDE_API_REFERENCE', False) == 'True':
    ...
    exclude_patterns.append('developer_guide/cjyx.rst')
    exclude_patterns.append('developer_guide/dmml.rst')
...
html_logo = '_static/images/3D-Cjyx-Mark.png'
...
latex_documents = [
    (master_doc, '3DCjyx.tex', '3D Cjyx Documentation',
     'Cjyx Community', 'manual'),
]
...
man_pages = [
    (master_doc, '3Dcjyx', '3D Cjyx Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, '3DCjyx', '3D Cjyx Documentation',
     author, '3DCjyx', 'One line description of project.',
     'Miscellaneous'),
]
...
# not part of the Cjyx repository (e.g., BRAINS toolkit) are stored in
