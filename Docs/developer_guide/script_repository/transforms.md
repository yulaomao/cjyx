...
transformNode.AddObserver(cjyx.vtkDMMLTransformNode.TransformModifiedEvent, onTransformNodeModified)
```
...
rotationTransformNodeObserver = rotationTransformNode.AddObserver(cjyx.vtkDMMLTransformNode.TransformModifiedEvent, updateFinalTransform)
centerOfRotationMarkupsNodeObserver = centerOfRotationMarkupsNode.AddObserver(cjyx.vtkDMMLMarkupsNode.PointModifiedEvent, updateFinalTransform)
...
# Automatic update when point is moved or transform is modified
rotationTransformNodeObserver = rotationTransformNode.AddObserver(cjyx.vtkDMMLTransformNode.TransformModifiedEvent, updateFinalTransform)
rotationAxisMarkupsNodeObserver = rotationAxisMarkupsNode.AddObserver(cjyx.vtkDMMLMarkupsNode.PointModifiedEvent, updateFinalTransform)
...
### Convert between ITK and Cjyx linear transforms
...
...
vtkDMMLVolumeNode* transformableNode = ...; // or vtkDMMLModelNode*...
transformableNode->SetAndObserveTransformNodeID( transformNode->GetID() );
```
...
transformNode = cjyx.vtkDMMLTransformNode()
...
```cpp
vtkDMMLTransformNode* transformNode1 = ...;
vtkDMMLTransformNode* transformNode2 = ...;
transformNode2->SetAndObserveTransformNodeID(transformNode1->GetID());
