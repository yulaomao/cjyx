...
# sequenceNode = cjyx.util.getNodesByClass("vtkDMMLSequenceNode")
...
```python
sequenceNode = cjyx.dmmlScene.GetFirstNodeByClass("vtkDMMLSequenceNode")
...
sequenceNodes = cjyx.util.getNodesByClass("vtkDMMLSequenceNode")
mergedSequenceNode = cjyx.dmmlScene.AddNewNodeByClass("vtkDMMLSequenceNode", "Merged sequence")
...
for sequenceNode in sequenceNodes:
  ...
  cjyx.dmmlScene.RemoveNode(sequenceNode)

# Create a sequence browser node for the new merged sequence
mergedSequenceBrowserNode = cjyx.dmmlScene.AddNewNodeByClass("vtkDMMLSequenceBrowserNode", "Merged")
...
```python
# inputs
volumeSequenceProxyNode = cjyx.dmmlScene.GetFirstNodeByClass("vtkDMMLScalarVolumeNode")
...
segmentModelNode = cjyx.dmmlScene.AddNewNodeByClass('vtkDMMLModelNode')
...
cjyx.dmmlScene.RemoveNode(segmentModelNode)
```
