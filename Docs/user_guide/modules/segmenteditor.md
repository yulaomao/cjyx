...
See examples for creating and modifying segmentation nodes and using segment editor effects from your own modules in [Cjyx script repository](../../developer_guide/script_repository.md#segmentations)
