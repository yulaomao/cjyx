...
By default, a single-component image is loaded as scalar volume. To make Cjyx interpret an image as labelmap volume, either of these options can be used:
...
Alternatively you can load and manipulate the data directly using functionality in the core Cjyx modules:
