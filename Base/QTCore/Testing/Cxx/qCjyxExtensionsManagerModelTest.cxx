...
// ----------------------------------------------------------------------------
class qCjyxExtensionsManagerModelTester: public QObject
{
  Q_OBJECT
  typedef qCjyxExtensionsManagerModelTester Self;
...
private:
  ...
  QString cjyxVersion(const QString& operatingSystem, int extensionId);

  bool prepareJson(const QString& jsonFile, qCjyxExtensionsManagerModel::ServerAPI serverAPI);

  void installHelper(qCjyxExtensionsManagerModel *model, const QString &os, int extensionId, const QString &tmp);

  bool uninstallHelper(qCjyxExtensionsManagerModel *model, const QString& extensionName);
...
private slots:
  ...
  void testSetCjyxRevision();
  void testSetCjyxRevision_data();

  void testSetCjyxOs();
  void testSetCjyxOs_data();

  void testSetCjyxArch();
  void testSetCjyxArch_data();

  void testSetCjyxRequirements();
  void testSetCjyxRequirements_data();

  void testSetCjyxVersion();
  void testSetCjyxVersion_data();
};

Q_DECLARE_METATYPE(qCjyxExtensionsManagerModelTester::ExtensionIdType)
Q_DECLARE_METATYPE(QList<int>)
Q_DECLARE_METATYPE(QList<QString>)
Q_DECLARE_METATYPE(QList<QStringList>)

const QString qCjyxExtensionsManagerModelTester::LIB_DIR = Cjyx_LIB_DIR;

const QString qCjyxExtensionsManagerModelTester::CLIMODULES_LIB_DIR = Cjyx_CLIMODULES_LIB_DIR;
const QString qCjyxExtensionsManagerModelTester::QTLOADABLEMODULES_LIB_DIR = Cjyx_QTLOADABLEMODULES_LIB_DIR;
#ifdef Cjyx_USE_PYTHONQT
const QString qCjyxExtensionsManagerModelTester::QTLOADABLEMODULES_PYTHON_LIB_DIR = Cjyx_QTLOADABLEMODULES_PYTHON_LIB_DIR;
const QString qCjyxExtensionsManagerModelTester::QTSCRIPTEDMODULES_LIB_DIR = Cjyx_QTSCRIPTEDMODULES_LIB_DIR;
#endif

// ----------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModelTester::expectedExtensionNames()const
{
  return QStringList()
      << "ImageMaker"
      << "MarkupsToModel"
...
// ----------------------------------------------------------------------------
QString qCjyxExtensionsManagerModelTester::extensionNameFromExtenionId(int extensionId)
{
...
// ----------------------------------------------------------------------------
QString qCjyxExtensionsManagerModelTester::cjyxVersion(const QString& operatingSystem, int extensionId)
{
...
// ----------------------------------------------------------------------------
bool qCjyxExtensionsManagerModelTester::prepareJson(const QString& jsonFile,
  qCjyxExtensionsManagerModel::ServerAPI serverAPI)
{
  bool success = true;
  QDir tmp = QDir::temp();
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::installHelper(qCjyxExtensionsManagerModel * model,
                                                        const QString& os,
                                                        int extensionId,
                                                        const QString& tmp)
{
  ...
  QVERIFY2(this->prepareJson(QString(":/extension-%1-%2.json").arg(os).arg(extensionId), qCjyxExtensionsManagerModel::Girder_v1),
           QString("Failed to prepare json for extensionId: %1-%2").arg(os).arg(extensionId).toUtf8());

  qCjyxExtensionsManagerModel::ServerAPI serverAPI = qCjyxExtensionsManagerModel::Girder_v1;
  ...
  QString oldServerApiStr = qEnvironmentVariable("CJYX_EXTENSIONS_MANAGER_SERVER_API");
  qputenv("CJYX_EXTENSIONS_MANAGER_SERVER_API",
    qCjyxExtensionsManagerModel::serverAPIToString(serverAPI).toUtf8());
  ...
  qputenv("CJYX_EXTENSIONS_MANAGER_SERVER_API", oldServerApiStr.toUtf8());
  ...
  QCOMPARE(model->extensionMetadata(extensionName, /* source= */ qCjyxExtensionsManagerModel::MetadataServer),
...
// ----------------------------------------------------------------------------
bool qCjyxExtensionsManagerModelTester::uninstallHelper(qCjyxExtensionsManagerModel *model, const QString& extensionName)
{
...
// ----------------------------------------------------------------------------
bool qCjyxExtensionsManagerModelTester::resetTmp()
{
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::dumpExtensionMetatype(
...
// ----------------------------------------------------------------------------
qCjyxExtensionsManagerModelTester::ExtensionMetadataType
qCjyxExtensionsManagerModelTester::extensionMetadata(const QString &os, int extensionId, bool filtered, bool installed)
{
  int serverAPI = qCjyxExtensionsManagerModel::Girder_v1;
  ...
  QStringList keysToIgnore(qCjyxExtensionsManagerModel::serverKeysToIgnore(serverAPI));
  ...
  foreach(const QString& key, allMetadata.keys())
    ...
    metadata.insert(
          qCjyxExtensionsManagerModel::serverToExtensionDescriptionKey(serverAPI).value(key, key),
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::initTestCase()
{
  ...
  this->TemporaryDirName =
      QString("qCjyxExtensionsManagerModelTester.%1").arg(QTime::currentTime().toString("hhmmsszzz"));

  QSettings().clear();
}

// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::init()
{
}

// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::cleanup()
{
  QSettings().clear();
}

// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::cleanupTestCase()
{
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testDefaults()
{
  qCjyxExtensionsManagerModel model;
  ...
  QCOMPARE(model.cjyxVersion(), QString(Cjyx_VERSION));
  ...
  QCOMPARE(model.cjyxRevision(), QString());
  QCOMPARE(model.cjyxOs(), QString());
  QCOMPARE(model.cjyxArch(), QString());
}

// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testServerUrl()
{
  ...
  model.setCjyxVersion(Cjyx_VERSION);
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testServerUrl_data()
{
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testServerKeysToIgnore()
{
  QFETCH(QStringList, expectedServerKeysToIgnore);
  QFETCH(qCjyxExtensionsManagerModel::ServerAPI, serverAPI);
  QCOMPARE(qCjyxExtensionsManagerModel::serverKeysToIgnore(serverAPI), expectedServerKeysToIgnore);
}

// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testServerKeysToIgnore_data()
{
  QTest::addColumn<QStringList>("expectedServerKeysToIgnore");
  QTest::addColumn<qCjyxExtensionsManagerModel::ServerAPI>("serverAPI");
  ...
  QTest::newRow("0") << (QStringList()
                         ...
                         << "name"
                         << "size")
                     << qCjyxExtensionsManagerModel::Girder_v1;
}

// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testServerToExtensionDescriptionKey()
{
  QFETCH(qCjyxExtensionsManagerModel::ServerAPI, serverAPI);

  QHash<QString, QString> serverToExtensionDescriptionKey =
      qCjyxExtensionsManagerModel::serverToExtensionDescriptionKey(serverAPI);
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testServerToExtensionDescriptionKey_data()
{
  ...
  expected.insert("meta.app_revision", "cjyx_revision");
  ...
  QTest::newRow("1") << expected.keys() << expected.values() << qCjyxExtensionsManagerModel::Girder_v1;
  }
}

// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testRetrieveExtensionMetadata()
{
  ...
  QFETCH(QString, cjyxVersion);
  qCjyxExtensionsManagerModel model;
  model.setExtensionsSettingsFilePath(QSettings().fileName());
  model.setCjyxVersion(cjyxVersion);

  QString oldServerApiStr = qEnvironmentVariable("CJYX_EXTENSIONS_MANAGER_SERVER_API");
  qputenv("CJYX_EXTENSIONS_MANAGER_SERVER_API", qCjyxExtensionsManagerModel::serverAPIToString(serverAPI).toUtf8());
  model.updateExtensionsMetadataFromServer(/* force= */ true, /* waitForCompletion= */ true);
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testRetrieveExtensionMetadata_data()
{
  QTest::addColumn<qCjyxExtensionsManagerModel::ServerAPI>("serverAPI");
  QTest::addColumn<QString>("extensionName");
  QTest::addColumn<QString>("jsonFile");
  QTest::addColumn<QString>("cjyxVersion");
  QTest::addColumn<QVariantMap>("expectedResult");

  int extensionId = 0;
  QTest::newRow("1") << qCjyxExtensionsManagerModel::Girder_v1
                     << this->extensionNameFromExtenionId(extensionId)
                     << QString(":/extension-%1-%2.json").arg(Cjyx_OS_LINUX_NAME).arg(extensionId)
                     << this->cjyxVersion(Cjyx_OS_LINUX_NAME, extensionId)
                     << Self::extensionMetadata(Cjyx_OS_LINUX_NAME, extensionId, /* filtered= */ true);
}

// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testFilterExtensionMetadata()
{
  ...
  ExtensionMetadataType filteredExtensionMetadata =
      qCjyxExtensionsManagerModel::filterExtensionMetadata(inputExtensionMetadata, serverAPI);
  QCOMPARE(filteredExtensionMetadata, expectedExtensionMetadata);
}

// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testFilterExtensionMetadata_data()
{
  QTest::addColumn<QVariantMap>("inputExtensionMetadata");
  QTest::addColumn<QVariantMap>("expectedExtensionMetadata");
  QTest::addColumn<qCjyxExtensionsManagerModel::ServerAPI>("serverAPI");

  QTest::newRow("0") << Self::extensionMetadata(Cjyx_OS_WIN_NAME, 0)
                     << Self::extensionMetadata(Cjyx_OS_WIN_NAME, 0, /* filtered= */ true)
                     << qCjyxExtensionsManagerModel::Girder_v1;
}

// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testExtractExtensionArchive()
{
  QVERIFY(this->resetTmp());
  ...
  qCjyxExtensionsManagerModel model;
  model.setCjyxRevision(cjyxRevision);
  model.setCjyxVersion(cjyxVersion);
  model.setCjyxOs(operatingSystem);
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testExtractExtensionArchive_data()
{
  QTest::addColumn<QString>("inputExtensionName");
  QTest::addColumn<QString>("inputArchiveFile");
  QTest::addColumn<QString>("cjyxVersion");
  QTest::addColumn<QString>("cjyxRevision");
  ...
  QTest::addColumn<bool>("readOnlyDestinationPath");
  {
    ...
    expectedFiles << "ImageMaker/lib/Cjyx-5.1/cli-modules/ImageMaker";
    expectedFiles << "ImageMaker/lib/Cjyx-5.1/cli-modules/libImageMakerLib.so";
    {
      QTest::newRow("linux-0-success")
                               << "ImageMaker"
                               << QString(":/extension-%1-0.tar.gz").arg(Cjyx_OS_LINUX_NAME)
                               << this->cjyxVersion(Cjyx_OS_LINUX_NAME, 0)
                               << "30987"
                               << expectedFiles
                               << Cjyx_OS_LINUX_NAME
  ...
  }
  {
    ...
    expectedFiles << "ImageMaker";
    expectedFiles << "ImageMaker/lib/Cjyx-5.1/cli-modules/ImageMaker";
    expectedFiles << "ImageMaker/lib/Cjyx-5.1/cli-modules/libImageMakerLib.dylib";
    {
      QTest::newRow("macosx-0-success")
                                << "ImageMaker"
                                << QString(":/extension-%1-0.tar.gz").arg(Cjyx_OS_MAC_NAME)
                                << this->cjyxVersion(Cjyx_OS_MAC_NAME, 0)
                                << "30987"
                                << expectedFiles
                                << Cjyx_OS_MAC_NAME
                                << true /* expectedExtractSuccess */
  ...
  }
  {
    ...
    expectedFiles << "MarkupsToModel/lib/Cjyx-5.1/qt-loadable-modules/libqCjyxMarkupsToModelModule.dylib";
    expectedFiles << "MarkupsToModel/lib/Cjyx-5.1/qt-loadable-modules/libvtkCjyxMarkupsToModelModuleLogic.dylib";
    expectedFiles << "MarkupsToModel/lib/Cjyx-5.1/qt-loadable-modules/libvtkCjyxMarkupsToModelModuleDMML.dylib";
    expectedFiles << "MarkupsToModel/lib/Cjyx-5.1/qt-loadable-modules/vtkCjyxMarkupsToModelModuleLogicPython.so";
    expectedFiles << "MarkupsToModel/lib/Cjyx-5.1/qt-loadable-modules/vtkCjyxMarkupsToModelModuleDMMLPython.so";
    {
      QTest::newRow("macosx-1-success")
                                << "MarkupsToModel"
                                << QString(":/extension-%1-1.tar.gz").arg(Cjyx_OS_MAC_NAME)
                                << this->cjyxVersion(Cjyx_OS_MAC_NAME, 1)
                                << "30987"
                                << expectedFiles
                                << Cjyx_OS_MAC_NAME
                                << true /* expectedExtractSuccess */
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testWriteAndParseExtensionDescriptionFile()
{
  QVERIFY(this->resetTmp());

  QFETCH(ExtensionMetadataType, metadata);

  QVERIFY(qCjyxExtensionsManagerModel::writeExtensionDescriptionFile(this->Tmp.filePath("ImageMaker.s4ext"), metadata));

  ExtensionMetadataType parsedMetadata =
      qCjyxExtensionsManagerModel::parseExtensionDescriptionFile(this->Tmp.filePath("ImageMaker.s4ext"));
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testWriteAndParseExtensionDescriptionFile_data()
{
  ...
  metadata.insert("cjyx_revision", "30987");
  QTest::newRow("0-ImageMaker") << metadata;
}

// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testInstallExtension()
{
  QVERIFY(this->resetTmp());
  ...
  QString operatingSystem = Cjyx_OS_LINUX_NAME;
  QString architecture("amd64");
  QString cjyxRevision("30987");
  QString cjyxVersion = "5.1";

  qCjyxExtensionsManagerModel model;
  model.setExtensionsSettingsFilePath(QSettings().fileName());
  model.setCjyxRequirements(cjyxRevision, operatingSystem, architecture);
  model.setCjyxVersion(cjyxVersion);
  ...
  QSignalSpy spyCjyxRequirementsChanged(&model, SIGNAL(cjyxRequirementsChanged(QString,QString,QString)));
  ...
  QCOMPARE(spyCjyxRequirementsChanged.count(), 0);
  QCOMPARE(model.installedExtensionsCount(), expectedInstalledExtensionNames.count());
}

// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testUninstallExtension()
{
  QVERIFY(this->resetTmp());
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testScheduleExtensionForUninstall()
{
  QVERIFY(this->resetTmp());
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testScheduleExtensionForUninstall_data()
{
  QTest::addColumn<QString>("operatingSystem");
  ...
  QTest::newRow("1")
      << operatingSystem << architecture << cjyxRevision
      << (QList<int>() << 0 << 1 << 2)
      << (QStringList())
      << (QStringList());
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testCancelExtensionScheduledForUninstall()
{
  QVERIFY(this->resetTmp());
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testCancelExtensionScheduledForUninstall_data()
{
  QTest::addColumn<QString>("operatingSystem");
  QTest::addColumn<QString>("architecture");
  QTest::addColumn<QString>("cjyxRevision");
  ...
  QTest::newRow("1")
      << Cjyx_OS_LINUX_NAME << architecture << cjyxRevision
      << (QList<int>() << 0 << 1 << 2)
      << (QStringList() << this->expectedExtensionNames().at(0) << this->expectedExtensionNames().at(2))
      << (QStringList())
      << 0
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testUpdateModel()
{
  QVERIFY(this->resetTmp());
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testIsExtensionInstalled()
{
  QVERIFY(this->resetTmp());
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testIsExtensionInstalled_data()
{
  QTest::addColumn<QString>("operatingSystem");
  QTest::addColumn<QString>("architecture");
  QTest::addColumn<QString>("cjyxRevision");
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testInstalledExtensionsCount()
{
  QVERIFY(this->resetTmp());
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testInstalledExtensionsCount_data()
{
  QTest::addColumn<QString>("operatingSystem");
  QTest::addColumn<QString>("architecture");
  QTest::addColumn<QString>("cjyxRevision");
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testInstalledExtensions()
{
  QVERIFY(this->resetTmp());
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testInstalledExtensions_data()
{
  QTest::addColumn<QString>("operatingSystem");
  QTest::addColumn<QString>("architecture");
  QTest::addColumn<QString>("cjyxRevision");
  ...
  QTest::newRow("0 installed") << operatingSystem << architecture << cjyxRevision
                               << (QList<int>()) << expectedInstalledExtensionNames;

  expectedInstalledExtensionNames = this->expectedExtensionNames();
  std::sort(expectedInstalledExtensionNames.begin(), expectedInstalledExtensionNames.end());

  QTest::newRow("3 installed") << operatingSystem << architecture << cjyxRevision
  ...
  QTest::newRow("2 installed") << operatingSystem << architecture << cjyxRevision
  ...
  QTest::newRow("1 installed") << operatingSystem << architecture << cjyxRevision
                               << (QList<int>() << 0) << expectedInstalledExtensionNames;
}

// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testIsExtensionEnabled()
{
  QVERIFY(this->resetTmp());
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testIsExtensionEnabled_data()
{
  QTest::addColumn<QString>("operatingSystem");
  QTest::addColumn<QString>("architecture");
  QTest::addColumn<QString>("cjyxRevision");
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testSetExtensionsSettingsFilePath()
{
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testSetExtensionsSettingsFilePath_data()
{
  QVERIFY(this->resetTmp());
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testExtensionAdditionalPathsSettingsUpdated()
{
  QSettings().setValue("Extensions/ServerUrl", QUrl::fromLocalFile(this->Tmp.absolutePath()));
  QSettings().setValue("Extensions/InstallPath", this->Tmp.absolutePath());
  ...
  if (extensionIdToUninstall >= 0)
    {
    model.setCjyxVersion(this->cjyxVersion(operatingSystem, extensionIdToUninstall));
  ...
  if (extensionIdToInstall >= 0)
    {
    model.setCjyxVersion(this->cjyxVersion(operatingSystem, extensionIdToInstall));
    this->installHelper(&model, operatingSystem, extensionIdToInstall, this->Tmp.absolutePath());
    }
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testExtensionAdditionalPathsSettingsUpdated_data()
{
  QVERIFY(this->resetTmp());
  ...
  {
    int extensionId = 0;
    QString climodules_lib_dir = QString(Self::CLIMODULES_LIB_DIR).replace(Cjyx_VERSION, this->cjyxVersion(operatingSystem, extensionId));
  ...
  {
    int extensionId = 1;
    QString qtloadablemodules_lib_dir = QString(Self::QTLOADABLEMODULES_LIB_DIR).replace(Cjyx_VERSION, this->cjyxVersion(operatingSystem, extensionId));
  ...
  {
    int extensionId = 2;
    QString qtscriptedmodules_lib_dir = QString(Self::QTSCRIPTEDMODULES_LIB_DIR).replace(Cjyx_VERSION, this->cjyxVersion(operatingSystem, extensionId));
  ...
  operatingSystem = Cjyx_OS_MAC_NAME;
  architecture = "amd64";
  cjyxRevision = "30987";
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testExtensionExtensionsSettingsUpdated()
{
  QSettings().setValue("Extensions/ServerUrl", QUrl::fromLocalFile(this->Tmp.absolutePath()));
  QSettings().setValue("Extensions/InstallPath", this->Tmp.absolutePath());
  ...
  if (extensionIdToUninstall.second >= 0)
    {
    model.setCjyxVersion(this->cjyxVersion(extensionIdToUninstall.first, extensionIdToUninstall.second));
  ...
  if (extensionIdToInstall.second >= 0)
    {
    model.setCjyxVersion(this->cjyxVersion(extensionIdToInstall.first, extensionIdToInstall.second));
  ...
  QStringList currentLibraryPath =
      qCjyxExtensionsManagerModel::readArrayValues(extensionsSettings, "LibraryPaths", "path");
  QCOMPARE(currentLibraryPath, libraryPaths);

  QStringList currentPaths =
      qCjyxExtensionsManagerModel::readArrayValues(extensionsSettings, "Paths", "path");
  QCOMPARE(currentPaths, paths);

  QStringList currentPythonPaths =
      qCjyxExtensionsManagerModel::readArrayValues(extensionsSettings, "PYTHONPATH", "path");
  QCOMPARE(currentPythonPaths, pythonPaths);
}

// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testExtensionExtensionsSettingsUpdated_data()
{
  QVERIFY(this->resetTmp());
  ...
  {
    int extensionId = 0;
    QString lib_dir = QString(Self::LIB_DIR).replace(Cjyx_VERSION, this->cjyxVersion(operatingSystem, extensionId));
    QString climodules_lib_dir = QString(Self::CLIMODULES_LIB_DIR).replace(Cjyx_VERSION, this->cjyxVersion(operatingSystem, extensionId));
    QTest::newRow("linux-0-ImageMaker")
        << operatingSystem << architecture << cjyxRevision
...
namespace
{
typedef void (qCjyxExtensionsManagerModel::* QStringSetter)(const QString&);
typedef QString (qCjyxExtensionsManagerModel::* QStringGetter)()const;

// ----------------------------------------------------------------------------
void testRequirementsHelper(qCjyxExtensionsManagerModel * model,
                            ...
                            )
{
  ...
  QFETCH(int, expectedCjyxRequirementsChangedCount);

  QSignalSpy spyCjyxRequirementsChanged(model, SIGNAL(cjyxRequirementsChanged(QString,QString,QString)));
  QSignalSpy spyCjyxPropertyChanged(model, changedPropertySignal);
  ...
  QCOMPARE(spyCjyxRequirementsChanged.count(), expectedCjyxRequirementsChangedCount);
  QCOMPARE(spyCjyxPropertyChanged.count(), expectedCjyxRequirementsChangedCount);
}

} // end of anonymous namespace

// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testSetCjyxRevision()
{
  qCjyxExtensionsManagerModel model;
  testRequirementsHelper(&model,
                         &qCjyxExtensionsManagerModel::setCjyxRevision,
                         &qCjyxExtensionsManagerModel::cjyxRevision,
                         SIGNAL(cjyxRevisionChanged(QString))
                         );
}

// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testSetCjyxRevision_data()
{
  QTest::addColumn<QStringList>("valuesToSet");
  QTest::addColumn<QString>("expectedFinalValue");
  QTest::addColumn<int>("expectedCjyxRequirementsChangedCount");
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testSetCjyxOs()
{
  qCjyxExtensionsManagerModel model;
  testRequirementsHelper(&model,
                         &qCjyxExtensionsManagerModel::setCjyxOs,
                         &qCjyxExtensionsManagerModel::cjyxOs,
                         SIGNAL(cjyxOsChanged(QString)));
}

// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testSetCjyxOs_data()
{
  QTest::addColumn<QStringList>("valuesToSet");
  QTest::addColumn<QString>("expectedFinalValue");
  QTest::addColumn<int>("expectedCjyxRequirementsChangedCount");
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testSetCjyxArch()
{
  qCjyxExtensionsManagerModel model;
  testRequirementsHelper(&model,
                         &qCjyxExtensionsManagerModel::setCjyxArch,
                         &qCjyxExtensionsManagerModel::cjyxArch,
                         SIGNAL(cjyxArchChanged(QString)));
}

// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testSetCjyxArch_data()
{
  QTest::addColumn<QStringList>("valuesToSet");
  QTest::addColumn<QString>("expectedFinalValue");
  QTest::addColumn<int>("expectedCjyxRequirementsChangedCount");
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testSetCjyxRequirements()
{
  qCjyxExtensionsManagerModel model;
  QSignalSpy spyCjyxRequirementsChanged(&model, SIGNAL(cjyxRequirementsChanged(QString,QString,QString)));
  ...
  QFETCH(QList<int>, expectedCjyxRequirementsChangedCounts);
  QFETCH(QStringList, finalExpectedCjyxRequirement);

  QCOMPARE(requirementsToSetList.count(), expectedCjyxRequirementsChangedCounts.count());
  ...
  for(int setIdx = 0; setIdx < requirementsToSetList.count(); ++setIdx)
    ...
    model.setCjyxRequirements(set.at(0), set.at(1), set.at(2));
    QCOMPARE(spyCjyxRequirementsChanged.count(), expectedCjyxRequirementsChangedCounts.at(setIdx));
    }

  QCOMPARE(model.cjyxRevision(), finalExpectedCjyxRequirement.at(0));
  QCOMPARE(model.cjyxOs(), finalExpectedCjyxRequirement.at(1));
  QCOMPARE(model.cjyxArch(), finalExpectedCjyxRequirement.at(2));
}

// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testSetCjyxRequirements_data()
{
  QTest::addColumn<QList<QStringList> >("requirementsToSetList");
  QTest::addColumn<QList<int> >("expectedCjyxRequirementsChangedCounts");
  QTest::addColumn<QStringList>("finalExpectedCjyxRequirement");
...
// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testSetCjyxVersion()
{
  qCjyxExtensionsManagerModel model;
  ...
  QSignalSpy spyCjyxRequirementsChanged(&model, SIGNAL(cjyxRequirementsChanged(QString,QString,QString)));
  model.setCjyxVersion(valueToSet);
  QCOMPARE(model.cjyxVersion(), expectedFinalValue);
  QCOMPARE(spyCjyxRequirementsChanged.count(), 0);
}

// ----------------------------------------------------------------------------
void qCjyxExtensionsManagerModelTester::testSetCjyxVersion_data()
{
...
// ----------------------------------------------------------------------------
int qCjyxExtensionsManagerModelTest(int argc, char* argv[])
{
  qCjyxCoreApplication app(argc, argv);
  QTEST_DISABLE_KEYPAD_NAVIGATION
  qCjyxExtensionsManagerModelTester tc;
  return QTest::qExec(&tc, argc, argv);
}
#include "moc_qCjyxExtensionsManagerModelTest.cxx"
