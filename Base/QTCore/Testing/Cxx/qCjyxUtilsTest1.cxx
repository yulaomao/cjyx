...
bool createFile(int line, const QDir& dir, const QString& relativePath, const QString& fileName)
{
  ...
  out << "Generated by qCjyxUtilsTest1" << ctk::endl;
  file.close();
...
{
  bool res = qCjyxUtils::isPluginInstalled(path, applicationHomeDir);
...
bool isPluginBuiltInTest(int line, bool expectedResult,
                           const QString& path, const QString& applicationHomeDir)
{
  bool res = qCjyxUtils::isPluginBuiltIn(path, applicationHomeDir, QString::fromUtf8(Cjyx_REVISION));
  if (res != expectedResult)
    {
...
int isExecutableNameTest()
{
  ...
  foreach(const QString& executableName, executableNames)
    {
    CHECK_BOOL(qCjyxUtils::isExecutableName(executableName), true);
    }
  ...
  foreach(const QString& notExecutableName, notExecutableNames)
    {
    CHECK_BOOL(qCjyxUtils::isExecutableName(notExecutableName), false);
    }
  return EXIT_SUCCESS;
}
...
int isCLILoadableModuleTest()
{
  ...
  foreach (const QString& filePath, validFilePaths)
    {
    CHECK_BOOL(qCjyxUtils::isCLILoadableModule(filePath), true);
    }
  ...
  foreach (const QString& filePath, invalidFilePaths)
    {
    CHECK_BOOL(qCjyxUtils::isCLILoadableModule(filePath), false);
    }
  return EXIT_SUCCESS;
  }
...
int isLoadableModuleTest()
{
  ...
  validFilePaths << "qCjyxThresholdModule.dll"
                  << "qCjyxThresholdModule.DLL"
                  << "libqCjyxThresholdModule.dylib"
                  << "libqCjyxThresholdModule.so";
  foreach (const QString& filePath, validFilePaths)
    {
    CHECK_BOOL(qCjyxUtils::isLoadableModule(filePath), true);
    }

  invalidFilePaths << "libqCjyxThresholdModule.dll"
                    << "qCjyxThresholdModule.dylib"
                    << "qCjyxThresholdModule.so"
                    << "libqCjyxThresholdModule.xyz"
                    << "qCjyxModule.dll"
                    << "libQCjyxThresholdmodule.so"
                    << "QCjyxThresholdmodule.so";
  foreach (const QString& filePath, invalidFilePaths)
    {
    CHECK_BOOL(qCjyxUtils::isLoadableModule(filePath), false);
    }
  ...
  int executableExtensionTest()
  {
...
#endif
    QString executableExtension = qCjyxUtils::executableExtension();
    ...
    foreach (const QString& libraryName, libraryNames)
      {
      QString moduleName = qCjyxUtils::extractModuleNameFromLibraryName(libraryName);
  ...
  int extractModuleNameFromClassNameTest()
    {
    CHECK_QSTRING(qCjyxUtils::extractModuleNameFromClassName("qCjyxThresholdModule"), "Threshold");
    CHECK_QSTRING(qCjyxUtils::extractModuleNameFromClassName("qCjyxThresholdModuleModule"), "ThresholdModule");
    CHECK_QSTRING(qCjyxUtils::extractModuleNameFromClassName("qCjyxModuleThresholdModule"), "ModuleThreshold");
    return EXIT_SUCCESS;
    }
  ...
  int isPluginInstalledBuiltinTest()
  {
    ...
    QString temporaryDirName =
        QString("qCjyxUtilsTest1-tmp1.%1").arg(QTime::currentTime().toString("hhmmsszzz"));
    ...
    temporaryDirName =
        QString("qCjyxUtilsTest1-tmp2.%1").arg(QTime::currentTime().toString("hhmmsszzz"));
    ...
    temporaryDirName =
        QString("qCjyxUtilsTest1-tmp3.%1").arg(QTime::currentTime().toString("hhmmsszzz"));
    QDir tmp3 = QDir::temp();
    ...
    temporaryDirName =
        QString("qCjyxUtilsTest1-tmp4.%1").arg(QTime::currentTime().toString("hhmmsszzz"));
    QDir tmp4 = QDir::temp();
    ...
    QString macCjyxAppDir("/Applications/Cjyx.app");
    // Note: {Cjyx_EXTENSIONS_DIRBASENAME}.{Cjyx_REVISION} may temporarily differ from Cjyx_EXTENSIONS_DIRNAME
    // because they are defined in separate files (vtkCjyxConfigure.h and vtkCjyxVersionConfigure.h).
    // In this test we use the former method to get the extensions folder, as this is how
    // vtkCjyxApplicationLogic::IsPluginBuiltIn method determines the extension folder.
    QString macCjyxExtensionsPostfix = QString("/Contents/%1-%2/plugin.txt").arg(Cjyx_EXTENSIONS_DIRBASENAME).arg(Cjyx_REVISION);
    QString macCjyxAppExtensionsDir(macCjyxAppDir + macCjyxExtensionsPostfix);
    QString macRenamedCjyxAppDir("/Applications/Something.app");
    QString macRenamedCjyxAppExtensionsDir(macRenamedCjyxAppDir + macCjyxExtensionsPostfix);

    isPluginInstalledTest(__LINE__, true, macCjyxAppExtensionsDir, macCjyxAppDir);
    isPluginInstalledTest(__LINE__, true, macRenamedCjyxAppExtensionsDir, macRenamedCjyxAppDir);

    isPluginBuiltInTest(__LINE__, false, macCjyxAppExtensionsDir, macCjyxAppDir);
    isPluginBuiltInTest(__LINE__, false, macRenamedCjyxAppExtensionsDir, macRenamedCjyxAppDir);
#endif
    ...
    QDir tmp = QDir::temp();
    temporaryDirName =
        QString("qCjyxUtilsTest1-pathWithoutIntDir.%1").arg(QTime::currentTime().toString("hhmmsszzz"));
    ...
    QString currentPath = qCjyxUtils::pathWithoutIntDir(inputPath, subDirWithoutIntDir, currentIntDir);
    ...
    currentPath = qCjyxUtils::pathWithoutIntDir(inputPath, subDirWithoutIntDir, currentIntDir);
    if (currentPath != expectedPath || currentIntDir != expectedIntDir)
      {
      std::cerr << __LINE__ << " - Error in  pathWithoutIntDir()" << std::endl
                            << "currentPath = " << qPrintable(currentPath) << std::endl
    ...
    bool expected = true;
    bool current = qCjyxUtils::pathEndsWith(inputPath, relativePath);
    if (current != expected)
      {
    ...
    relativePath = "module";
    expected = true;
    current = qCjyxUtils::pathEndsWith(inputPath, relativePath);
    if (current != expected)
      {
      std::cerr << __LINE__ << " - Error in  pathEndsWith()" << std::endl
                            << "current = " << current << std::endl
  ...
  int setPermissionsRecursivelyTest()
    {
    QDir tmp = QDir::temp();
    QString temporaryDirName = QString("qCjyxUtilsTest1-setPermissionsRecursively.%1").arg(QTime::currentTime().toString("hhmmsszzz"));
    tmp.mkdir(temporaryDirName);
    tmp.cd(temporaryDirName);
    ...
    CHECK_BOOL(qCjyxUtils::setPermissionsRecursively(tmp.path(), QFile::ReadOwner, QFile::ReadOwner), true);
    ...
    CHECK_BOOL(qCjyxUtils::setPermissionsRecursively(tmp.path(), QFile::ReadOwner | QFile::ExeOwner, QFile::ReadOwner), true);
    ...
    CHECK_BOOL(qCjyxUtils::setPermissionsRecursively(tmp.path(),
  ...
  int replaceWikiUrlVersionTest()
    ...
    CHECK_QSTRING(
      qCjyxUtils::replaceWikiUrlVersion("https://wiki.slicer.org/slicerWiki/index.php/Documentation/Nightly/Extensions/SlicerToKiwiExporter", "4.4"),
    ...
    CHECK_QSTRING(
      qCjyxUtils::replaceWikiUrlVersion("https://wiki.slicer.org/slicerWiki/index.php/Documentation/Foo/Extensions/SlicerToKiwiExporter", "Bar"),
    ...
    CHECK_QSTRING(
      qCjyxUtils::replaceWikiUrlVersion("https://wiki.slicer.org/slicerWiki/index.php/Documentation/Foo/Extensions/SlicerToKiwiExporter/Foo", "Bar"),
    ...
    QString expectedOutput =
      ...
      "You will learn how to ...";
    CHECK_QSTRING(qCjyxUtils::replaceWikiUrlVersion(input, "Nightly"), expectedOutput);
    //! [replaceWikiUrlVersion example4]
  ...
  int replaceDocumentationUrlVersionTest()
    ...
    QString hostname = "cjyx.readthedocs.io";
    // Cjyx ReadTheDocs -> replacements are done

    CHECK_QSTRING(
      qCjyxUtils::replaceDocumentationUrlVersion("https://slicer.readthedocs.io/en/latest/user_guide/get_help.html", hostname, "5.0"),
      "https://slicer.readthedocs.io/en/5.0/user_guide/get_help.html");

    CHECK_QSTRING(
      qCjyxUtils::replaceDocumentationUrlVersion("https://slicer.readthedocs.io/en/stable/user_guide/get_help.html", hostname, "5.0"),
      "https://slicer.readthedocs.io/en/5.0/user_guide/get_help.html");

    CHECK_QSTRING(
      qCjyxUtils::replaceDocumentationUrlVersion("https://slicer.readthedocs.io/en/4.11/user_guide/get_help.html", hostname, "5.0"),
      "https://slicer.readthedocs.io/en/5.0/user_guide/get_help.html");

    CHECK_QSTRING(
      qCjyxUtils::replaceDocumentationUrlVersion("https://slicer.readthedocs.io/en/v4.11/user_guide/get_help.html", hostname, "v5.0"),
    ...
    CHECK_QSTRING(
      qCjyxUtils::replaceDocumentationUrlVersion("https://github.com/SlicerHeart/SlicerHeart#readme", hostname, "5.0"),
      "https://github.com/SlicerHeart/SlicerHeart#readme");

    CHECK_QSTRING(
      qCjyxUtils::replaceDocumentationUrlVersion("https://github.com/SlicerHeart/SlicerHeart/tree/4.6#readme", hostname, "5.0"),
      "https://github.com/SlicerHeart/SlicerHeart/tree/4.6#readme");

    CHECK_QSTRING(
      qCjyxUtils::replaceDocumentationUrlVersion("https://github.com/SlicerHeart/SlicerHeart/tree/v4.6#readme", hostname, "5.0"),
      "https://github.com/SlicerHeart/SlicerHeart/tree/v4.6#readme");

    CHECK_QSTRING(
      qCjyxUtils::replaceDocumentationUrlVersion("https://github.com/SlicerHeart/SlicerHeart/blob/4.6/README.md", hostname, "5.0"),
      "https://github.com/SlicerHeart/SlicerHeart/blob/4.6/README.md");

    CHECK_QSTRING(
      qCjyxUtils::replaceDocumentationUrlVersion("https://github.com/SlicerHeart/SlicerHeart/blob/main/README.md", hostname, "5.0"),
      "https://github.com/SlicerHeart/SlicerHeart/blob/main/README.md");

    CHECK_QSTRING(
      qCjyxUtils::replaceDocumentationUrlVersion("https://github.com/SlicerHeart/SlicerHeart/blob/master/README.md", hostname, "5.0"),
      "https://github.com/SlicerHeart/SlicerHeart/blob/master/README.md");

    CHECK_QSTRING(
      qCjyxUtils::replaceDocumentationUrlVersion("https://github.com/SlicerHeart/SlicerHeart/blob/latest/data/1.0/README.md", hostname, "5.0"),
