...
//-----------------------------------------------------------------------------
class AModuleWidgetRepresentation : public qCjyxAbstractModuleRepresentation
{
public:
...
//-----------------------------------------------------------------------------
class AModule: public qCjyxAbstractCoreModule
{
public:
...
//-----------------------------------------------------------------------------
int qCjyxAbstractCoreModuleTest1(int, char * [] )
{
  AModule module;
  ...
  {
    QScopedPointer<qCjyxAbstractModuleRepresentation> repr(module.widgetRepresentation());
    if (!repr)
      {
      std::cerr << "Line " << __LINE__
                << " - Problem with is/setWidgetRepresentationCreationEnabled methods:"
