...
#ifndef __qCjyxAbstractModuleRepresentation_h
#define __qCjyxAbstractModuleRepresentation_h
...
class Q_CJYX_BASE_QTCORE_EXPORT qCjyxAbstractModuleRepresentation : virtual public qCjyxObject
{
public:

  typedef qCjyxObject Superclass;
  qCjyxAbstractModuleRepresentation();
  ~qCjyxAbstractModuleRepresentation() override;
  ...
  qCjyxAbstractCoreModule* module()const;
  ...
  /// Preferably each module that defines a new DMML node class should also make sure there
  ...
  virtual bool setEditedNode(vtkDMMLNode* node, QString role = QString(), QString context = QString());
  ...
  /// this module).
  virtual double nodeEditable(vtkDMMLNode* node);
...
protected:
  ...
  vtkDMMLAbstractLogic* logic() const;

protected:
  QScopedPointer<qCjyxAbstractModuleRepresentationPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qCjyxAbstractModuleRepresentation);
  Q_DISABLE_COPY(qCjyxAbstractModuleRepresentation);

  /// Give access to qCjyxAbstractModule to the method
  /// qCjyxAbstractModuleRepresentation::setModule
  friend class qCjyxAbstractCoreModule;
