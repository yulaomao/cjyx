...
#ifndef __qCjyxCorePythonManager_h
#define __qCjyxCorePythonManager_h
...
class Q_CJYX_BASE_QTCORE_EXPORT qCjyxCorePythonManager : public ctkAbstractPythonManager
{
  Q_OBJECT
...
public:
  ...
  qCjyxCorePythonManager(QObject* parent=nullptr);
  ~qCjyxCorePythonManager() override;
