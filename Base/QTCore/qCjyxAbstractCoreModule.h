...
#ifndef __qCjyxAbstractCoreModule_h
#define __qCjyxAbstractCoreModule_h
...
class qCjyxAbstractModuleRepresentation;
...
#define qCjyxGetTitleMacro(_TITLE)               \
  static QString staticTitle() { return _TITLE; }  \
  QString title() const override { return _TITLE; }

/// \brief qCjyxAbstractCoreModule is the base class of any module in Cjyx.
//
...
/// derived classes.
/// A Cjyx module has a name and a title: The name is its UID, the title
/// displayed to the user.
/// When a DMML scene is set to the module, the module set the scene to the
/// UI widget and the logic.
class Q_CJYX_BASE_QTCORE_EXPORT qCjyxAbstractCoreModule : public QObject
{
  ...
  /// e.g. "Volumes", "Volume Rendering", "Welcome to Cjyx"...
  ...
  /// This property holds the URL of the module for the Cjyx wiki.
  ...
  Q_PROPERTY(QString cjyxWikiUrl READ cjyxWikiUrl)
  ...
  /// This property holds whether module is a built-in Cjyx module or
  ...
  /// qCjyxApplication::application()->registerNodeModule() method.
...
public:
  ...
  /// initialization must be done in qCjyxAbstractCoreModule::setup()
  qCjyxAbstractCoreModule(QObject *parent=nullptr);
  ~qCjyxAbstractCoreModule() override;

  virtual void printAdditionalInfo();

  /// Convenience method to return cjyx wiki URL
  QString cjyxWikiUrl()const{ return "https://www.slicer.org/w/index.php"; }

  /// Convenience method that returns a string that can be inserted into the application help text that contains
  /// link to the module's documentation in current Cjyx version's documentation on ReadTheDocs.
  ...
  void initialize(vtkCjyxApplicationLogic* appLogic);
  ...
  /// \sa isWidgetRepresentationCreationEnabled()
  qCjyxAbstractModuleRepresentation* createNewWidgetRepresentation();

  /// Get/Set the application logic.
  /// It must be set.
  void setAppLogic(vtkCjyxApplicationLogic* appLogic);
  ...
  /// A module logic is typically a vtkCjyxModuleLogic but not necessarily.
  Q_INVOKABLE vtkDMMLAbstractLogic* logic();
  ...
  /// Returns path if any
  /// \todo Ideally this function should be added within the qCjyxLoadableModule.
  QString path()const;
  ...
  /// Determine if this module is a built-in Cjyx module or one from an extension
...
public slots:
  ...
  /// Set the current DMML scene to the module, it is propagated to the logic
...
protected:
  ...
  virtual qCjyxAbstractModuleRepresentation* createWidgetRepresentation() = 0;

  /// Create and return the module logic
  /// Note: Only one instance of the logic will exist per module
  virtual vtkDMMLAbstractLogic* createLogic() = 0;

protected:
  QScopedPointer<qCjyxAbstractCoreModulePrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qCjyxAbstractCoreModule);
  Q_DISABLE_COPY(qCjyxAbstractCoreModule);
  friend class qCjyxAbstractModuleRepresentation;

  /// Internal method called by the destructor of qCjyxAbstractModuleRepresentation
  /// to remove the representation from the list.
  void representationDeleted(qCjyxAbstractModuleRepresentation *representation);
};
