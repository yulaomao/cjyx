...
// --------------------------------------------------------------------------
// qCjyxExtensionsManagerModelPrivate methods

//-----------------------------------------------------------------------------
class qCjyxExtensionsManagerModelPrivate
{
  Q_DECLARE_PUBLIC(qCjyxExtensionsManagerModel);
protected:
  qCjyxExtensionsManagerModel* const q_ptr;
...
public:
  ...
  typedef qCjyxExtensionsManagerModelPrivate Self;
  typedef qCjyxExtensionsManagerModel::ExtensionMetadataType ExtensionMetadataType;
  qCjyxExtensionsManagerModelPrivate(qCjyxExtensionsManagerModel& object);
  void init();
  ...
  qCjyxExtensionDownloadTask* downloadExtensionByName(const QString& extensionName);
  ...
  static QStringList isExtensionCompatible(
      const ExtensionMetadataType& metadata, const QString& cjyxRevision,
      const QString& cjyxOs, const QString& cjyxArch);
  ...
  QMap<qCjyxExtensionDownloadTask*, QString> ActiveTasks;
};

// --------------------------------------------------------------------------
qCjyxExtensionsManagerModelPrivate::qCjyxExtensionsManagerModelPrivate(qCjyxExtensionsManagerModel& object)
  : q_ptr(&object)
{
}

// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModelPrivate::init()
{
  Q_Q(qCjyxExtensionsManagerModel);

  this->CjyxVersion = Cjyx_VERSION;
  ...
  this->initializeColumnIdToNameMap(Self::CjyxRevisionColumn, "cjyx_revision");
  ...
  QObject::connect(q, SIGNAL(cjyxRequirementsChanged(QString,QString,QString)),
...
// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModelPrivate::debug(const QString& text) const
{
  this->log(text, ctkErrorLogLevel::Debug);
}

// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModelPrivate::info(const QString& text) const
{
  this->log(text, ctkErrorLogLevel::Info);
}

// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModelPrivate::warning(const QString& text) const
{
  this->log(text, ctkErrorLogLevel::Warning);
}

// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModelPrivate::critical(const QString& text) const
{
  this->log(text, ctkErrorLogLevel::Critical);
}

// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModelPrivate::log(const QString& text, ctkErrorLogLevel::LogLevels level) const
{
  Q_Q(const qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
int qCjyxExtensionsManagerModelPrivate::role(const QByteArray& roleName)
{
...
// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModelPrivate::saveExtensionsMetadataFromServerToCache()
{
  Q_Q(const qCjyxExtensionsManagerModel);

  // stores time of last update check for this Cjyx installation
...
// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModelPrivate::loadCachedExtensionsMetadataFromServer()
{
  Q_Q(const qCjyxExtensionsManagerModel);
  ...
  if (parseError.error != QJsonParseError::NoError)
    {
    this->warning(qCjyxExtensionsManagerModel::tr("Failed to parse %1: error at %2: %3")
...
// --------------------------------------------------------------------------
QFileInfoList qCjyxExtensionsManagerModelPrivate::extensionDescriptionFileInfos(const QString& extensionDescriptionPath)const
{
...
// --------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModelPrivate::dependenciesToInstall(const QStringList& directDependencies, QStringList &unresolvedDependencies)
{
  Q_Q(qCjyxExtensionsManagerModel);
  ...
  while (!dependencies.isEmpty())
    ...
    if (!q->isExtensionInstalled(dependencyName))
      ...
      const qCjyxExtensionsManagerModel::ExtensionMetadataType& dependencyMetadataOnServer = this->ExtensionsMetadataFromServer.value(dependencyName);
    ...
    qCjyxExtensionsManagerModel::ExtensionMetadataType dependencyMetadata = q->extensionMetadata(dependencyName);
...
// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModelPrivate::addExtensionModelRow(const ExtensionMetadataType &metadata)
{
...
// --------------------------------------------------------------------------
QStandardItem* qCjyxExtensionsManagerModelPrivate::extensionItem(const QString& extensionName, int column)const
{
  QList<QStandardItem*> foundItems =
      this->Model.findItems(extensionName, Qt::MatchExactly, Self::NameColumn);
  if (foundItems.count() != 1)
...
// --------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModelPrivate::columnNames()const
{
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModelPrivate::isExtensionsMetadataUpdateDue() const
{
  Q_Q(const qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModelPrivate::addExtensionPathToApplicationSettings(const QString& extensionName)
{
  Q_Q(qCjyxExtensionsManagerModel);
  QSettings settings(q->extensionsSettingsFilePath(), QSettings::IniFormat);
  QStringList additionalPaths = qCjyxCoreApplication::application()->toCjyxHomeAbsolutePaths(settings.value("Modules/AdditionalPaths").toStringList());
  QStringList newModulePaths = q->extensionModulePaths(extensionName);
  settings.setValue("Modules/AdditionalPaths",
    qCjyxCoreApplication::application()->toCjyxHomeRelativePaths(appendToPathList(additionalPaths, newModulePaths)));
}

// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModelPrivate::removeExtensionPathFromApplicationSettings(const QString& extensionName)
{
  Q_Q(qCjyxExtensionsManagerModel);
  QSettings settings(q->extensionsSettingsFilePath(), QSettings::IniFormat);
  QStringList additionalPaths = qCjyxCoreApplication::application()->toCjyxHomeAbsolutePaths(settings.value("Modules/AdditionalPaths").toStringList());
  settings.setValue("Modules/AdditionalPaths",
    qCjyxCoreApplication::application()->toCjyxHomeRelativePaths(removeFromPathList(additionalPaths, q->extensionModulePaths(extensionName))));
}

// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModelPrivate::addExtensionPathToLauncherSettings(const QString& extensionName)
{
  ...
  if (settings.status() != QSettings::NoError)
    {
    this->warning(qCjyxExtensionsManagerModel::tr("Failed to open extensions settings file %1").arg(this->ExtensionsSettingsFilePath));
    return;
    }
  qCjyxCoreApplication* app = qCjyxCoreApplication::application();

  QStringList libraryPath = app->toCjyxHomeAbsolutePaths(qCjyxExtensionsManagerModel::readArrayValues(settings, "LibraryPaths", "path"));
  qCjyxExtensionsManagerModel::writeArrayValues(settings,
                         app->toCjyxHomeRelativePaths(appendToPathList(libraryPath, this->extensionLibraryPaths(extensionName))),
                         "LibraryPaths", "path");

  QStringList paths = app->toCjyxHomeAbsolutePaths(qCjyxExtensionsManagerModel::readArrayValues(settings, "Paths", "path"));
  qCjyxExtensionsManagerModel::writeArrayValues(settings,
                         app->toCjyxHomeRelativePaths(appendToPathList(paths, this->extensionPaths(extensionName))),
                         "Paths", "path");

#ifdef Cjyx_USE_PYTHONQT
  QStringList pythonPaths = app->toCjyxHomeAbsolutePaths(qCjyxExtensionsManagerModel::readArrayValues(settings, "PYTHONPATH", "path"));
  qCjyxExtensionsManagerModel::writeArrayValues(settings,
                         app->toCjyxHomeRelativePaths(appendToPathList(pythonPaths, this->extensionPythonPaths(extensionName))),
                         "PYTHONPATH", "path");
#endif

  QStringList qtPluginPaths = app->toCjyxHomeAbsolutePaths(qCjyxExtensionsManagerModel::readArrayValues(settings, "QT_PLUGIN_PATH", "path"));
  qCjyxExtensionsManagerModel::writeArrayValues(settings,
                         app->toCjyxHomeRelativePaths(appendToPathList(qtPluginPaths, this->extensionQtPluginPaths(extensionName))),
                         "QT_PLUGIN_PATH", "path");
}

// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModelPrivate::removeExtensionPathFromLauncherSettings(const QString& extensionName)
{
  if (this->ExtensionsSettingsFilePath.isEmpty())
    {
    return;
  ...
  QStringList libraryPath = app->toCjyxHomeAbsolutePaths(qCjyxExtensionsManagerModel::readArrayValues(settings, "LibraryPaths", "path"));
  qCjyxExtensionsManagerModel::writeArrayValues(settings,
                         app->toCjyxHomeRelativePaths(removeFromPathList(libraryPath, this->extensionLibraryPaths(extensionName))),
                         "LibraryPaths", "path");

  QStringList paths = app->toCjyxHomeAbsolutePaths(qCjyxExtensionsManagerModel::readArrayValues(settings, "Paths", "path"));
  qCjyxExtensionsManagerModel::writeArrayValues(settings,
                         app->toCjyxHomeRelativePaths(removeFromPathList(paths, this->extensionPaths(extensionName))),
                         "Paths", "path");

#ifdef Cjyx_USE_PYTHONQT
  QStringList pythonPaths = app->toCjyxHomeAbsolutePaths(qCjyxExtensionsManagerModel::readArrayValues(settings, "PYTHONPATH", "path"));
  qCjyxExtensionsManagerModel::writeArrayValues(settings,
                         app->toCjyxHomeRelativePaths(removeFromPathList(pythonPaths, this->extensionPythonPaths(extensionName))),
                         "PYTHONPATH", "path");
#endif

  QStringList qtPluginPaths = app->toCjyxHomeAbsolutePaths(qCjyxExtensionsManagerModel::readArrayValues(settings, "QT_PLUGIN_PATH", "path"));
  qCjyxExtensionsManagerModel::writeArrayValues(settings,
                         app->toCjyxHomeRelativePaths(removeFromPathList(qtPluginPaths, this->extensionQtPluginPaths(extensionName))),
                         "QT_PLUGIN_PATH", "path");
}
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModelPrivate::checkExtensionsInstallDestinationPath(
    const QString& destinationPath, QString& error)const
{
  if (!QDir(destinationPath).exists())
    {
    error = qCjyxExtensionsManagerModel::tr("Extensions install directory does NOT exist: <strong>%1</strong>").arg(destinationPath);
    return false;
    }
  ...
  if (!destinationPathInfo.isReadable()
    ...
    {
    error = qCjyxExtensionsManagerModel::tr("Extensions install directory is expected to be "
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModelPrivate::checkExtensionSettingsPermissions(QString& error)const
{
  Q_Q(const qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModelPrivate::addExtensionSettings(const QString& extensionName)
{
...
// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModelPrivate::removeExtensionSettings(const QString& extensionName)
{
...
// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModelPrivate
...
// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModelPrivate::removeExtensionFromScheduledForUninstallList(const QString& extensionName)
{
  Q_Q(qCjyxExtensionsManagerModel);
  QSettings settings(q->extensionsSettingsFilePath(), QSettings::IniFormat);
...
// --------------------------------------------------------------------------
QString qCjyxExtensionsManagerModelPrivate::extractArchive(const QDir& extensionsDir, const QString& archiveFile)
{
  ...
  if(!success)
    {
    this->critical(qCjyxExtensionsManagerModel::tr("Failed to extract %1 into %2").arg(archiveFile).arg(extensionsDir.absolutePath()));
    return QString();
    }
  if(extracted_files.size() == 0)
    {
    this->warning(qCjyxExtensionsManagerModel::tr("Archive %1 doesn't contain any files").arg(archiveFile));
    return QString();
    }
...
// --------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModelPrivate::extensionLibraryPaths(const QString& extensionName)const
{
  Q_Q(const qCjyxExtensionsManagerModel);
  if (this->CjyxVersion.isEmpty())
    {
    return QStringList();
    }
  QString path = q->extensionInstallPath(extensionName);
  return appendToPathList(QStringList(), QStringList()
                   << path + "/" + QString(Cjyx_BIN_DIR).replace(Cjyx_VERSION, this->CjyxVersion)
                   << path + "/" + QString(Cjyx_LIB_DIR).replace(Cjyx_VERSION, this->CjyxVersion)
                   << path + "/" + QString(Cjyx_CLIMODULES_LIB_DIR).replace(Cjyx_VERSION, this->CjyxVersion)
                   << path + "/" + QString(Cjyx_QTLOADABLEMODULES_LIB_DIR).replace(Cjyx_VERSION, this->CjyxVersion)
                   << path + "/" + QString(Cjyx_THIRDPARTY_LIB_DIR)
                   );
}

// --------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModelPrivate::extensionQtPluginPaths(const QString& extensionName)const
{
  Q_Q(const qCjyxExtensionsManagerModel);
  if (this->CjyxVersion.isEmpty())
  {
  ...
  QString path = q->extensionInstallPath(extensionName);
  return appendToPathList(QStringList(), QStringList()
                   << path + "/" + QString(Cjyx_QtPlugins_DIR).replace(Cjyx_VERSION, this->CjyxVersion)
  );
}

// --------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModelPrivate::extensionPaths(const QString& extensionName)const
{
  Q_Q(const qCjyxExtensionsManagerModel);
  if (this->CjyxVersion.isEmpty())
    {
  ...
  QString path = q->extensionInstallPath(extensionName);
  return appendToPathList(QStringList(), QStringList()
                   << path + "/" + QString(Cjyx_CLIMODULES_BIN_DIR).replace(Cjyx_VERSION, this->CjyxVersion)
                   << path + "/" + QString(Cjyx_THIRDPARTY_BIN_DIR)
                   );
}

#ifdef Cjyx_USE_PYTHONQT
// --------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModelPrivate::extensionPythonPaths(const QString& extensionName)const
{
  Q_Q(const qCjyxExtensionsManagerModel);
  if (this->CjyxVersion.isEmpty())
    {
  ...
  QString path = q->extensionInstallPath(extensionName);
  return appendToPathList(QStringList(), QStringList()
                          << path + "/" + QString(Cjyx_QTSCRIPTEDMODULES_LIB_DIR).replace(Cjyx_VERSION, this->CjyxVersion)
                          << path + "/" + QString(Cjyx_QTLOADABLEMODULES_PYTHON_LIB_DIR).replace(Cjyx_VERSION, this->CjyxVersion)
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModelPrivate::validateExtensionMetadata(
...
// --------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModelPrivate::isExtensionCompatible(
    const ExtensionMetadataType& metadata, const QString& cjyxRevision,
    const QString& cjyxOs, const QString& cjyxArch)
{
  if (cjyxRevision.isEmpty())
    {
    return QStringList() << qCjyxExtensionsManagerModel::tr("cjyxRevision is not specified");
    }
  if (cjyxOs.isEmpty())
    {
    return QStringList() << qCjyxExtensionsManagerModel::tr("cjyxOs is not specified");
    }
  if (cjyxArch.isEmpty())
    {
    return QStringList() << qCjyxExtensionsManagerModel::tr("cjyxArch is not specified");
    }
  QStringList reasons;
  QString extensionCjyxRevision = metadata.value("cjyx_revision").toString();
  if (!extensionCjyxRevision.isEmpty() && cjyxRevision != extensionCjyxRevision)
    {
    reasons << qCjyxExtensionsManagerModel::tr("extensionCjyxRevision [%1] is different from cjyxRevision [%2]").arg(extensionCjyxRevision).arg(cjyxRevision);
    }
  QString extensionArch = metadata.value("arch").toString();
  if (!extensionArch.isEmpty() && cjyxArch != extensionArch)
    {
    reasons << qCjyxExtensionsManagerModel::tr("extensionArch [%1] is different from cjyxArch [%2]").arg(extensionArch).arg(cjyxArch);
    }
  QString extensionOs = metadata.value("os").toString();
  if (!extensionOs.isEmpty() && cjyxOs != extensionOs)
    {
    reasons << qCjyxExtensionsManagerModel::tr("extensionOs [%1] is different from cjyxOs [%2]").arg(extensionOs).arg(cjyxOs);
    }
  return reasons;
}

// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModelPrivate::initializeColumnIdToNameMap(int columnIdx, const char* columnName)
{
...
// --------------------------------------------------------------------------
// qCjyxExtensionsManagerModel methods

CTK_GET_CPP(qCjyxExtensionsManagerModel, bool, interactive, Interactive);
CTK_SET_CPP(qCjyxExtensionsManagerModel, bool, setInteractive, Interactive);

// --------------------------------------------------------------------------
qCjyxExtensionsManagerModel::qCjyxExtensionsManagerModel(QObject* _parent)
  : Superclass(_parent)
  , d_ptr(new qCjyxExtensionsManagerModelPrivate(*this))
{
  Q_D(qCjyxExtensionsManagerModel);
  d->init();
}

// --------------------------------------------------------------------------
qCjyxExtensionsManagerModel::~qCjyxExtensionsManagerModel() = default;

// --------------------------------------------------------------------------
int qCjyxExtensionsManagerModel::serverAPI() const
{
  int defaultServerAPI = Self::Girder_v1;
  QString serverApiStr = qEnvironmentVariable("CJYX_EXTENSIONS_MANAGER_SERVER_API", Self::serverAPIToString(defaultServerAPI));
  int serverAPI = Self::serverAPIFromString(serverApiStr);
  if (serverAPI == -1)
    {
    qWarning()
        << "Unknown value" << serverApiStr << "associated with CJYX_EXTENSIONS_MANAGER_SERVER_API env. variable. "
...
// --------------------------------------------------------------------------
QString qCjyxExtensionsManagerModel::serverAPIToString(int serverAPI)
{
  switch (serverAPI)
    {
...
// --------------------------------------------------------------------------
int qCjyxExtensionsManagerModel::serverAPIFromString(const QString& str)
{
...
// --------------------------------------------------------------------------
QUrl qCjyxExtensionsManagerModel::serverUrl()const
{
  QSettings settings(this->extensionsSettingsFilePath(), QSettings::IniFormat);
  return QUrl(qEnvironmentVariable("CJYX_EXTENSIONS_MANAGER_SERVER_URL", settings.value("Extensions/ServerUrl").toString()));
}

// --------------------------------------------------------------------------
QUrl qCjyxExtensionsManagerModel::frontendServerUrl()const
{
  QSettings settings(this->extensionsSettingsFilePath(), QSettings::IniFormat);
  QString url = qEnvironmentVariable("CJYX_EXTENSIONS_MANAGER_FRONTEND_SERVER_URL", settings.value("Extensions/FrontendServerUrl").toString());
  if (url.endsWith("/"))
    {
    url.chop(1);
    }
...
// --------------------------------------------------------------------------
QString qCjyxExtensionsManagerModel::extensionsInstallPath()const
{
  QSettings settings(this->extensionsSettingsFilePath(), QSettings::IniFormat);
  return qCjyxCoreApplication::application()->toCjyxHomeAbsolutePath(settings.value("Extensions/InstallPath").toString());
}

// --------------------------------------------------------------------------
QString qCjyxExtensionsManagerModel::extensionInstallPath(const QString& extensionName) const
{
...
// --------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModel::extensionModulePaths(const QString& extensionName)const
{
  Q_D(const qCjyxExtensionsManagerModel);
  QString path = this->extensionInstallPath(extensionName);
  return appendToPathList(QStringList(), QStringList()
                   << path + "/" Cjyx_CLIMODULES_SUBDIR // Search for 'Cjyx_INSTALL_CLIMODULES_BIN_DIR' in Cjyx/CMakeLists.txt
                   << path + "/" + QString(Cjyx_CLIMODULES_LIB_DIR).replace(Cjyx_VERSION, d->CjyxVersion)
                   << path + "/" + QString(Cjyx_QTLOADABLEMODULES_LIB_DIR).replace(Cjyx_VERSION, d->CjyxVersion)
#ifdef Cjyx_USE_PYTHONQT
                   << path + "/" + QString(Cjyx_QTSCRIPTEDMODULES_LIB_DIR).replace(Cjyx_VERSION, d->CjyxVersion)
#endif
                   );
}

// --------------------------------------------------------------------------
QString qCjyxExtensionsManagerModel::extensionDescriptionFile(const QString& extensionName) const
{
...
// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModel::setNewExtensionEnabledByDefault(bool value)
{
  Q_D(qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::newExtensionEnabledByDefault()const
{
  Q_D(const qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModel::setAutoUpdateCheck(bool enable)
{
  Q_D(qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::autoUpdateCheck()const
{
  Q_D(const qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModel::setAutoUpdateInstall(bool enable)
{
  Q_D(qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::autoUpdateInstall()const
{
  Q_D(const qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModel::setAutoInstallDependencies(bool enable)
{
  Q_D(qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::autoInstallDependencies()const
{
  Q_D(const qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
QString qCjyxExtensionsManagerModel::extensionDescription(const QString& extensionName)const
{
  Q_D(const qCjyxExtensionsManagerModel);
  ...
  int row = item->row();
  QString description = d->Model.data(d->Model.index(row, qCjyxExtensionsManagerModelPrivate::DescriptionColumn),
    qCjyxExtensionsManagerModelPrivate::DescriptionRole).toString();
  return description;
}

// --------------------------------------------------------------------------
qCjyxExtensionsManagerModel::ExtensionMetadataType qCjyxExtensionsManagerModel::extensionMetadata(
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::isExtensionLoaded(const QString& extensionName) const
{
  Q_D(const qCjyxExtensionsManagerModel);
  QStandardItem* item = d->extensionItem(extensionName, qCjyxExtensionsManagerModelPrivate::LoadedColumn);
  if (!item)
    {
    return false;
    }
  return item->data(qCjyxExtensionsManagerModelPrivate::LoadedRole).toBool();
}


// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::isExtensionInstalled(const QString& extensionName) const
{
  Q_D(const qCjyxExtensionsManagerModel);
  QStandardItem* item = d->extensionItem(extensionName, qCjyxExtensionsManagerModelPrivate::InstalledColumn);
  if (!item)
    {
    return false;
    }
  return item->data(qCjyxExtensionsManagerModelPrivate::InstalledRole).toBool();
}

// --------------------------------------------------------------------------
int qCjyxExtensionsManagerModel::installedExtensionsCount()const
{
  return this->installedExtensions().size();
}

// --------------------------------------------------------------------------
int qCjyxExtensionsManagerModel::numberOfInstalledExtensions()const
{
  return this->installedExtensionsCount();
}

// --------------------------------------------------------------------------
int qCjyxExtensionsManagerModel::managedExtensionsCount()const
{
  return this->managedExtensions().size();
}

// --------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModel::managedExtensions()const
{
  Q_D(const qCjyxExtensionsManagerModel);
  QStringList names;
  for(int rowIdx = 0; rowIdx < d->Model.rowCount(); ++rowIdx)
    {
    names << d->Model.item(rowIdx, qCjyxExtensionsManagerModelPrivate::NameColumn)->text();
    }
...
// --------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModel::installedExtensions()const
{
  Q_D(const qCjyxExtensionsManagerModel);
  QStringList names;
  for(int rowIdx = 0; rowIdx < d->Model.rowCount(); ++rowIdx)
    {
    QStandardItem* installedItem = d->Model.item(rowIdx, qCjyxExtensionsManagerModelPrivate::InstalledColumn);
    if (!installedItem)
      {
      // invalid item
      continue;
      }
    if (!installedItem->data(qCjyxExtensionsManagerModelPrivate::InstalledRole).toBool())
      {
      // not installed
      continue;
      }
...
// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModel::setExtensionBookmarked(const QString& extensionName, bool bookmark)
{
  Q_D(qCjyxExtensionsManagerModel);
  ...
  QStandardItem * item = const_cast<QStandardItem*>(
        d->extensionItem(extensionName, qCjyxExtensionsManagerModelPrivate::BookmarkedColumn));
  if (!item)
    {
  ...
  item->setData(bookmark, qCjyxExtensionsManagerModelPrivate::BookmarkedRole);
  item->setData(bookmark, Qt::DisplayRole);

  // Bookmarked status is shared between all Cjyx installations, therefore this flag is not saved into the
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::isExtensionBookmarked(const QString& extensionName)const
{
  Q_D(const qCjyxExtensionsManagerModel);
  QStandardItem* item = d->extensionItem(extensionName, qCjyxExtensionsManagerModelPrivate::BookmarkedColumn);
  if (!item)
    {
    return false;
    }
  return item->data(qCjyxExtensionsManagerModelPrivate::BookmarkedRole).toBool() == true;
}

// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModel::setExtensionEnabled(const QString& extensionName, bool value)
{
  Q_D(qCjyxExtensionsManagerModel);
  ...
  QStandardItem * item = const_cast<QStandardItem*>(
        d->extensionItem(extensionName, qCjyxExtensionsManagerModelPrivate::EnabledColumn));
  Q_ASSERT(item);
  item->setData(value, qCjyxExtensionsManagerModelPrivate::EnabledRole);
  item->setData(value, Qt::DisplayRole);
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::isExtensionEnabled(const QString& extensionName)const
{
  Q_D(const qCjyxExtensionsManagerModel);
  QStandardItem * item = d->extensionItem(extensionName, qCjyxExtensionsManagerModelPrivate::EnabledColumn);
  if (!item)
    {
    return false;
    }
  return item->data(qCjyxExtensionsManagerModelPrivate::EnabledRole).toBool() == true;
}

// --------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModel::scheduledForUpdateExtensions() const
{
  QSettings settings(this->extensionsSettingsFilePath(), QSettings::IniFormat);
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::isExtensionScheduledForUpdate(
...
// --------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModel::scheduledForUninstallExtensions() const
{
  QSettings settings(this->extensionsSettingsFilePath(), QSettings::IniFormat);
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::isExtensionScheduledForUninstall(
  const QString& extensionName)const
{
...
// --------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModel::bookmarkedExtensions()const
{
  QSettings settings;
  QStringList bookmarkedExtensions = settings.value("Extensions/Bookmarked").toStringList();
...
// --------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModel::enabledExtensions()const
{
  Q_D(const qCjyxExtensionsManagerModel);
  QStringList names;
  for(int rowIdx = 0; rowIdx < d->Model.rowCount(); ++rowIdx)
    {
    QString extensionName = d->Model.item(rowIdx, qCjyxExtensionsManagerModelPrivate::NameColumn)->text();
...
// --------------------------------------------------------------------------
qCjyxExtensionDownloadTask*
qCjyxExtensionsManagerModelPrivate::downloadExtensionByName(const QString& extensionName)
{
  Q_Q(qCjyxExtensionsManagerModel);

  this->debug(qCjyxExtensionsManagerModel::tr("Retrieving extension metadata for %1 extension").arg(extensionName));
  ...
  if (extensionMetadata.count() == 0)
    {
    this->critical(qCjyxExtensionsManagerModel::tr("Failed to get metadata from server for extension: %1").arg(extensionName));
    }

  QUrl downloadUrl(q->serverUrl());

  if (q->serverAPI() == qCjyxExtensionsManagerModel::Girder_v1)
    {
    ...
    this->debug(qCjyxExtensionsManagerModel::tr("Retrieving %1 extension files (extensionId: %2)").arg(extensionName).arg(item_id));
    ...
    this->debug(qCjyxExtensionsManagerModel::tr("Downloading %1 extension (item_id: %2, file_id: %3)").arg(extensionName).arg(item_id).arg(file_id));
  ...
  qCjyxExtensionDownloadTask* const task =
    new qCjyxExtensionDownloadTask(reply);
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::downloadAndInstallExtension(const QString& extensionId, bool installDependencies/*=true*/)
{
  Q_D(qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::downloadAndInstallExtensionByName(const QString& extensionName, bool installDependencies)
{
  Q_D(qCjyxExtensionsManagerModel);
  QString error;
  if (!d->checkExtensionSettingsPermissions(error))
  ...
  qCjyxExtensionDownloadTask* const task = d->downloadExtensionByName(extensionName);
  if (!task)
    {
  ...
  connect(task, SIGNAL(finished(qCjyxExtensionDownloadTask*)),
          this, SLOT(onInstallDownloadFinished(qCjyxExtensionDownloadTask*)));
  connect(task, SIGNAL(progress(qCjyxExtensionDownloadTask*, qint64, qint64)),
          this, SLOT(onInstallDownloadProgress(qCjyxExtensionDownloadTask*, qint64, qint64)));
  return true;
}

// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModel::onInstallDownloadProgress(
  qCjyxExtensionDownloadTask* task, qint64 received, qint64 total)
{
...
// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModel::onInstallDownloadFinished(
  qCjyxExtensionDownloadTask* task)
{
  Q_D(qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::installExtension(
  ...
  const QString& archiveFile, bool withDependencies/*=true*/)
{
  ...
  const QString& extensionIndexDescriptionFile =
    this->extensionsInstallPath() + "/" + extensionName + "/" + Cjyx_SHARE_DIR + "/" + extensionName + ".s4ext";
  ...
  if (extensionMetadata.isEmpty())
    ...
    // Fill in keys related to the target Cjyx platform
    extensionMetadata.insert("os", this->cjyxOs());
    extensionMetadata.insert("arch", this->cjyxArch());
    extensionMetadata.insert("cjyx_revision", this->cjyxRevision());
    }
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::updateExtensionsMetadataFromServer(bool force/*=false*/, bool waitForCompletion/*=false*/)
{
  Q_D(qCjyxExtensionsManagerModel);
  ...
  if (d->ExtensionsMetadataFromServerQueryUID.isNull())
    ...
    if (this->serverAPI() == qCjyxExtensionsManagerModel::Girder_v1)
      {
      ...
      parameters["app_revision"] = this->cjyxRevision();
      parameters["os"] = this->cjyxOs();
      parameters["arch"] = this->cjyxArch();
...
// --------------------------------------------------------------------------
QDateTime qCjyxExtensionsManagerModel::lastUpdateTimeExtensionsMetadataFromServer()
{
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::isExtensionUpdateAvailable(
  const QString& extensionName) const
{
  Q_D(const qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModel::availableUpdateExtensions() const
{
  Q_D(const qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::onExtensionsMetadataFromServerQueryFinished(const QUuid& requestId)
{
  Q_UNUSED(requestId);
  Q_D(qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModel::checkForExtensionsUpdates()
{
  Q_D(qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModel::onUpdateDownloadProgress(
  qCjyxExtensionDownloadTask* task, qint64 received, qint64 total)
{
  Q_D(qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModel::onUpdateDownloadFinished(
  qCjyxExtensionDownloadTask* task)
{
  Q_D(qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::scheduleExtensionForUpdate(
  const QString& extensionName)
{
  ...
  if (updateInfo.ArchiveName.isEmpty())
    ...
    connect(task, SIGNAL(finished(qCjyxExtensionDownloadTask*)),
            this, SLOT(onUpdateDownloadFinished(qCjyxExtensionDownloadTask*)));
    connect(task, SIGNAL(progress(qCjyxExtensionDownloadTask*,qint64,qint64)),
            this, SLOT(onUpdateDownloadProgress(qCjyxExtensionDownloadTask*,qint64,qint64)));
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::cancelExtensionScheduledForUpdate(
  const QString& extensionName)
{
  Q_D(qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModelPrivate::updateExtension(
  const QString& extensionName, const QString& archiveFile)
{
  ...
  if (!item)
    {
    critical(qCjyxExtensionsManagerModel::tr("Failed to update %1 extension").arg(extensionName));
    return false;
    }

  if (!q->isExtensionScheduledForUpdate(extensionName))
    {
    critical(qCjyxExtensionsManagerModel::tr("Failed to update %1 extension: it is not scheduled for update").arg(extensionName));
    return false;
    }
  ...
  const ExtensionMetadataType extensionMetadata =
    qCjyxExtensionsManagerModel::parseExtensionDescriptionFile(metadataPath);
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::scheduleExtensionForUninstall(const QString& extensionName)
{
  Q_D(qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::cancelExtensionScheduledForUninstall(const QString& extensionName)
{
  Q_D(qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::uninstallExtension(const QString& extensionName)
{
  Q_D(qCjyxExtensionsManagerModel);
  ...
  if (bookmarked)
    ...
    QStandardItem * item = const_cast<QStandardItem*>(
          d->extensionItem(extensionName, qCjyxExtensionsManagerModelPrivate::InstalledColumn));
    if (item)
      {
      item->setData(false, qCjyxExtensionsManagerModelPrivate::InstalledRole);
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModelPrivate::removeExtensionDescriptionFile(const QString& extensionName)
{
  Q_Q(qCjyxExtensionsManagerModel);
  bool success = true;
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::updateScheduledExtensions()
{
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::uninstallScheduledExtensions()
{
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::uninstallScheduledExtensions(QStringList& uninstalledExtensions)
{
  bool result = true;
...
// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModel::updateModel()
{
  Q_D(qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
CTK_GET_CPP(qCjyxExtensionsManagerModel, QString, extensionsSettingsFilePath, ExtensionsSettingsFilePath)

// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModel::setExtensionsSettingsFilePath(const QString& extensionsSettingsFilePath)
{
  Q_D(qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
CTK_GET_CPP(qCjyxExtensionsManagerModel, QString, cjyxRevision, CjyxRevision)

// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModel::setCjyxRevision(const QString& revision)
{
  this->setCjyxRequirements(revision, this->cjyxOs(), this->cjyxArch());
}

// --------------------------------------------------------------------------
CTK_GET_CPP(qCjyxExtensionsManagerModel, QString, cjyxOs, CjyxOs)

// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModel::setCjyxOs(const QString& os)
{
  this->setCjyxRequirements(this->cjyxRevision(), os, this->cjyxArch());
}

// --------------------------------------------------------------------------
CTK_GET_CPP(qCjyxExtensionsManagerModel, QString, cjyxArch, CjyxArch)

// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModel::setCjyxArch(const QString& arch)
{
  this->setCjyxRequirements(this->cjyxRevision(), this->cjyxOs(), arch);
}

// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModel::setCjyxRequirements(const QString& revision, const QString& os, const QString& arch)
{
  Q_D(qCjyxExtensionsManagerModel);
  if (d->CjyxRevision == revision && d->CjyxOs == os && d->CjyxArch == arch)
    {
    return;
    }
  QString previousCjyxRevision = d->CjyxRevision;
  d->CjyxRevision = revision;

  QString previousCjyxOs = d->CjyxOs;
  d->CjyxOs = os;

  QString previousCjyxArch = d->CjyxArch;
  d->CjyxArch = arch;

  if (previousCjyxRevision != d->CjyxRevision)
    {
    emit this->cjyxRevisionChanged(d->CjyxRevision);
    }
  if (previousCjyxOs != d->CjyxOs)
    {
    emit this->cjyxOsChanged(d->CjyxOs);
    }
  if (previousCjyxArch != d->CjyxArch)
    {
    emit this->cjyxArchChanged(d->CjyxArch);
    }
  emit this->cjyxRequirementsChanged(d->CjyxRevision, d->CjyxOs, d->CjyxArch);
}

// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModel::identifyIncompatibleExtensions()
{
  Q_D(const qCjyxExtensionsManagerModel);
  foreach(const QString& extensionName, this->installedExtensions())
    {
    QStringList reasons = this->isExtensionCompatible(extensionName, d->CjyxRevision, d->CjyxOs, d->CjyxArch);
    if (!reasons.isEmpty())
      {
...
// --------------------------------------------------------------------------
CTK_GET_CPP(qCjyxExtensionsManagerModel, QString, cjyxVersion, CjyxVersion)

// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModel::setCjyxVersion(const QString& cjyxVersion)
{
  Q_D(qCjyxExtensionsManagerModel);
  if (d->CjyxVersion == cjyxVersion)
    {
    return;
    }
  d->CjyxVersion = cjyxVersion;
  emit this->cjyxVersionChanged(cjyxVersion);
}

// --------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModel::isExtensionCompatible(
    const QString& extensionName, const QString& cjyxRevision,
    const QString& cjyxOs, const QString& cjyxArch) const
{
  ...
  return qCjyxExtensionsManagerModelPrivate::isExtensionCompatible(
        metadata, cjyxRevision, cjyxOs, cjyxArch);
}

// --------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModel::isExtensionCompatible(const QString& extensionName) const
{
  return this->isExtensionCompatible(
        extensionName, this->cjyxRevision(), this->cjyxOs(), this->cjyxArch());
}

// --------------------------------------------------------------------------
const QStandardItemModel * qCjyxExtensionsManagerModel::model()const
{
  Q_D(const qCjyxExtensionsManagerModel);
  return &d->Model;
}
...
// --------------------------------------------------------------------------
QHash<QString, QString> qCjyxExtensionsManagerModel::serverToExtensionDescriptionKey(int serverAPI)
{
  ...
  //  | CjyxRevisionColumn | cjyx_revision   |                    | meta.app_revision    |
  ...
  if (serverAPI == Self::Girder_v1)
    ...
    serverToExtensionDescriptionKey.insert("meta.app_revision", "cjyx_revision");
...
// --------------------------------------------------------------------------
qCjyxExtensionsManagerModel::ExtensionMetadataType
qCjyxExtensionsManagerModel::convertExtensionMetadata(const ExtensionMetadataType &extensionMetadata, int serverAPI)
{
...
// --------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModel::serverKeysToIgnore(int serverAPI)
{
  if (serverAPI == Self::Girder_v1)
    {
    return QStringList()
...
// --------------------------------------------------------------------------
qCjyxExtensionsManagerModel::ExtensionMetadataType
qCjyxExtensionsManagerModel::filterExtensionMetadata(const ExtensionMetadataType& extensionMetadata, int serverAPI)
{
...
// --------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModel::readArrayValues(
...
// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModel::writeArrayValues(QSettings& settings, const QStringList& values,
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::extractExtensionArchive(
    const QString& extensionName, const QString& archiveFile, const QString& destinationPath)
{
  ...
  //  Step1: <extensionName>/<archiveBaseName>[/<Cjyx_BUNDLE_LOCATION>/<Cjyx_EXTENSIONS_DIRBASENAME>-<cjyxRevision>/<extensionName>] -> <extensionName>-XXXXXX
  QString srcPathToCopy(srcPath);
  if (this->cjyxOs() == Cjyx_OS_MAC_NAME)
    {
    srcPathToCopy = srcPathToCopy + "/" Cjyx_BUNDLE_LOCATION "/" Cjyx_EXTENSIONS_DIRBASENAME "-"
        + this->cjyxRevision() + "/" + extensionName;
    }
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::writeExtensionDescriptionFile(const QString& file, const ExtensionMetadataType &metadata)
{
...
// --------------------------------------------------------------------------
qCjyxExtensionsManagerModel::ExtensionMetadataType
qCjyxExtensionsManagerModel::parseExtensionDescriptionFile(const QString& file)
{
  ExtensionMetadataType metadata;
...
// --------------------------------------------------------------------------
bool qCjyxExtensionsManagerModel::exportExtensionList(QString& exportFilePath)
{
  Q_D(qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModel::checkInstallPrerequisites() const
{
  Q_D(const qCjyxExtensionsManagerModel);
  QStringList errors;
  QString error;
...
// --------------------------------------------------------------------------
QStringList qCjyxExtensionsManagerModel::activeTasks() const
{
  Q_D(const qCjyxExtensionsManagerModel);
...
// --------------------------------------------------------------------------
void qCjyxExtensionsManagerModel::aboutToLoadExtensions()
{
  Q_D(qCjyxExtensionsManagerModel);
  ...
  for (int rowIdx = 0; rowIdx < d->Model.rowCount(); ++rowIdx)
    {
    QStandardItem* installedItem = d->Model.item(rowIdx, qCjyxExtensionsManagerModelPrivate::InstalledColumn);
    bool installed = installedItem->data(qCjyxExtensionsManagerModelPrivate::InstalledRole).toBool();
    QStandardItem* loadedItem = d->Model.item(rowIdx, qCjyxExtensionsManagerModelPrivate::LoadedColumn);
    loadedItem->setData(installed, qCjyxExtensionsManagerModelPrivate::LoadedRole);
    loadedItem->setData(installed, Qt::DisplayRole);
    // Save the loaded extension into a list in case we later do a full model update.
    if (installed)
      {
      d->LoadedExtensions << d->Model.item(rowIdx, qCjyxExtensionsManagerModelPrivate::NameColumn)->text();
      }
    }
}

// --------------------------------------------------------------------------
QUrl qCjyxExtensionsManagerModel::extensionsListUrl()const
{
  Q_D(const qCjyxExtensionsManagerModel);
  ...
  if (serverAPI == qCjyxExtensionsManagerModel::Girder_v1)
    {
    url.setPath(url.path() + QString("/catalog/All/%1/%2").arg(d->CjyxRevision).arg(d->CjyxOs));
    }
  else
    {
    qWarning() << Q_FUNC_INFO << " failed: missing implementation for serverAPI" << serverAPI;
