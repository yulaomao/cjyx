""" This module sets up root logging and loads the Cjyx library modules into its namespace."""
...
# -----------------------------------------------------------------------------
# Create cjyx.modules and cjyx.moduleNames

_createModule('cjyx.modules', globals(),
              """This module provides an access to all instantiated Cjyx modules.

The module attributes are the lower-cased Cjyx module names, the
associated value is an instance of ``qCjyxAbstractCoreModule``.
""")

_createModule('cjyx.moduleNames', globals(),
              """This module provides an access to all instantiated Cjyx module names.

The module attributes are the Cjyx modules names, the associated
value is the module name.
""")

# -----------------------------------------------------------------------------
# Load modules: Add VTK and PythonQt python module attributes into cjyx namespace
