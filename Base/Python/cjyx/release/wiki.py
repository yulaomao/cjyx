"""
This module allows to `version` Cjyx mediawiki documentation.
...
Assuming the new release of Cjyx is ``4.7``, the Cjyx wiki documentation
...
::
  ...
  This command-line tool allows to `version` Cjyx mediawiki documentation. It
  ...
  optional arguments:
    ...
    --password PASSWORD   password for 'UpdateBot' user. By default, try to get
                          password from 'CJYX_WIKI_UPDATEBOT_PWD' environment
                          variable.
...
::
  ...
  Redirect pages:
    ...
    Documentation/Release/CjyxApplication/HardwareConfiguration: 4.6
...
class Wiki:
    ...
    def __init__(self, username="UpdateBot", password=None):
        log.info("connecting")
        self.doc = mwdoc.Documentation('www.cjyx.org', '/w/')
    ...
    REDIRECT_PAGES = [
        ...
        "Documentation/Release/CjyxApplication/HardwareConfiguration"
    ]
...
def main():
    """This command-line tool allows to `version` Cjyx mediawiki documentation.
    ...
    parser.add_argument(
        "--password", type=str, default=os.environ.get('CJYX_WIKI_UPDATEBOT_PWD'),
        help="password for 'UpdateBot' user. By default, try to get password from "
        "'CJYX_WIKI_UPDATEBOT_PWD' environment variable."
    )
