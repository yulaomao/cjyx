...
#ifndef __qCjyxApplicationHelper_h
#define __qCjyxApplicationHelper_h
...
class Q_CJYX_BASE_QTAPP_EXPORT qCjyxApplicationHelper : public QObject
{
  Q_OBJECT
public:
  typedef QObject Superclass;
  typedef qCjyxApplicationHelper Self;

  qCjyxApplicationHelper(QObject * parent = nullptr);
  ~qCjyxApplicationHelper() override;
  ...
  static void setupModuleFactoryManager(qCjyxModuleFactoryManager * moduleFactoryManager);

  static void showDMMLEventLoggerWidget();
...
private:
  Q_DISABLE_COPY(qCjyxApplicationHelper);
};

#include "qCjyxApplicationHelper.txx"
