...
// ----------------------------------------------------------------------------
qCjyxCLIModuleWidgetEventPlayer::qCjyxCLIModuleWidgetEventPlayer(QObject *parent)
  : pqWidgetEventPlayer(parent)
{
}

// ----------------------------------------------------------------------------
bool qCjyxCLIModuleWidgetEventPlayer::playEvent(QObject *Object,
                                                  const QString &Command,
                                                  const QString &/*Arguments*/,
                                                  bool &Error)
{
  // But in the CLI module under Cjyx4 when we activate the button apply,
  ...
  qCjyxCLIModuleWidget* parent = nullptr;
  for(QObject* test = Object; parent == nullptr && test != nullptr; test = test->parent())
      {
      parent = qobject_cast<qCjyxCLIModuleWidget*>(test);
      }
