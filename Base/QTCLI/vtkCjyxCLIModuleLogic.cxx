...
typedef std::pair<vtkCjyxCLIModuleLogic *, vtkDMMLCommandLineModuleNode *> LogicNodePair;
class DMMLIDMap : public std::map<std::string, std::string> {};

//---------------------------------------------------------------------------
class vtkCjyxCLIRescheduleCallback : public vtkCallbackCommand
{
public:
  static vtkCjyxCLIRescheduleCallback *New()
  {
    return new vtkCjyxCLIRescheduleCallback;
  }
  ...
  void SetCLIModuleLogic(vtkCjyxCLIModuleLogic* logic)
  {
    this->CLIModuleLogic = logic;
  }
  vtkCjyxCLIModuleLogic* GetCLIModuleLogic()
  {
...
protected:
  vtkCjyxCLIRescheduleCallback()
  {
    this->CLIModuleLogic = nullptr;
    this->Delay = 0;
  }
  ~vtkCjyxCLIRescheduleCallback() override
  {
    this->SetCLIModuleLogic(nullptr);
  }

  vtkCjyxCLIModuleLogic* CLIModuleLogic;
  int Delay;
...
//
class vtkCjyxCLIOneShotCallbackCallback : public vtkCallbackCommand
{
public:
  static vtkCjyxCLIOneShotCallbackCallback *New()
  {
    return new vtkCjyxCLIOneShotCallbackCallback;
  }
  void Execute(vtkObject* caller, unsigned long eid, void *callData) override
  {
    if (callData)
  ...
  protected:
  vtkCjyxCLIOneShotCallbackCallback()  = default;
  ~vtkCjyxCLIOneShotCallbackCallback() override  = default;
};

//----------------------------------------------------------------------------
class vtkCjyxCLIModuleLogic::vtkInternal
{
public:
  ...
  typedef std::vector<std::pair<vtkMTimeType, vtkDMMLCommandLineModuleNode*> > RequestType;
  struct FindRequest
  {
    FindRequest(vtkDMMLCommandLineModuleNode* node)
      : Node(node)
      , LastRequestUID(0)
    {
    }
    ...
    bool operator()(const std::pair<vtkMTimeType, vtkDMMLCommandLineModuleNode*>& p)
    {
  ...
  void SetLastRequest(vtkDMMLCommandLineModuleNode* node, vtkMTimeType requestUID)
  {
  ...
  vtkMTimeType GetLastRequest(vtkDMMLCommandLineModuleNode* node)
  {
    RequestType::iterator it = std::find_if(
      this->LastRequests.begin(), this->LastRequests.end(), FindRequest(node));
  ...
  void StartRescheduleNodeEvents(vtkDMMLNode* node)
  {
    if (!node)
      {
      return;
  ...
  void StopRescheduleNodeEvents(vtkDMMLNode* node)
  {
    if (!node)
      {
      return;
  ...
  vtkSmartPointer<vtkCjyxCLIRescheduleCallback> RescheduleCallback;
  vtkSmartPointer<vtkCjyxCLIOneShotCallbackCallback>OneShotCallbackCallback;
};

//----------------------------------------------------------------------------
vtkStandardNewMacro(vtkCjyxCLIModuleLogic);

//----------------------------------------------------------------------------
vtkCjyxCLIModuleLogic::vtkCjyxCLIModuleLogic()
{
  ...
  this->Internal->RescheduleCallback =
    vtkSmartPointer<vtkCjyxCLIRescheduleCallback>::New();
  this->Internal->RescheduleCallback->SetCLIModuleLogic(this);
  this->Internal->OneShotCallbackCallback =
    vtkSmartPointer<vtkCjyxCLIOneShotCallbackCallback>::New();

  this->AddObserver(vtkCjyxCLIModuleLogic::RequestHierarchyEditEvent,
...
//----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::PrintSelf(ostream& os, vtkIndent indent)
{
  Superclass::PrintSelf(os, indent);
}

//-----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::SetDefaultModuleDescription(const ModuleDescription& description)
{
  this->Internal->DefaultModuleDescription = description;
}

//-----------------------------------------------------------------------------
const ModuleDescription& vtkCjyxCLIModuleLogic
...
//-----------------------------------------------------------------------------
vtkDMMLCommandLineModuleNode* vtkCjyxCLIModuleLogic::CreateNode()
{
  vtkDMMLCommandLineModuleNode* node = vtkDMMLCommandLineModuleNode::SafeDownCast(
    this->GetDMMLScene()->CreateNodeByClass("vtkDMMLCommandLineModuleNode"));
  node->SetName(this->GetDMMLScene()->GetUniqueNameByString(
...
//-----------------------------------------------------------------------------
vtkDMMLCommandLineModuleNode* vtkCjyxCLIModuleLogic::CreateNodeInScene()
{
  vtkDMMLCommandLineModuleNode* node = this->CreateNode();
...
//----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::DeleteTemporaryFilesOn ()
{
  this->SetDeleteTemporaryFiles(static_cast<int>(1));
}

//----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::DeleteTemporaryFilesOff ()
{
  this->SetDeleteTemporaryFiles(static_cast<int>(0));
}

//----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::SetDeleteTemporaryFiles(int value)
{
...
//----------------------------------------------------------------------------
int vtkCjyxCLIModuleLogic::GetDeleteTemporaryFiles() const
{
  return this->Internal->DeleteTemporaryFiles;
}

//----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::SetAllowInMemoryTransfer(int value)
{
...
//----------------------------------------------------------------------------
int vtkCjyxCLIModuleLogic::GetAllowInMemoryTransfer() const
{
  return this->Internal->AllowInMemoryTransfer;
}

//----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::RedirectModuleStreamsOn()
{
  this->SetRedirectModuleStreams(static_cast<int>(1));
}

//----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::RedirectModuleStreamsOff()
{
  this->SetRedirectModuleStreams(static_cast<int>(0));
}

//----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::SetRedirectModuleStreams(int value)
{
  vtkDebugMacro(<< this->GetClassName() << " (" << this << "): setting DeleteTemporaryFiles to " << value);
...
//----------------------------------------------------------------------------
int vtkCjyxCLIModuleLogic::GetRedirectModuleStreams() const
{
...
::ConstructTemporarySceneFileName(vtkDMMLScene *scene)
{
  std::string fname;
  ...
  fname = temporaryDirectory + "/" + pid + "_" + fname + ".dmml";
                             ...
                             CommandLineModuleType commandType)
{
  ...
  // DMML scene, then the node is encoded as cjyx:%p#%s where the
  // pointer is the address of the scene which contains the node
  // and the string is the DMML node ID.
  //
  // 2. If the consumer of the file is a Python module, it operates
  // in the process space of Cjyx.  The Python module can be given
  // DMML node ID's directly.
  //
  // 3. If the consumer of the file cannot communicate directly with
  // the DMML scene, then a real temporary filename is constructed.
  // The filename will point to the Temporary directory defined for
  // Cjyx. The filename will be unique to the process (multiple
  // running instances of cjyx will not collide).  The filename
  ...
  // instance of Cjyx).  This last point is an optimization to
  ...
  // than one module can run at the same time within the same Cjyx
  ...
  if (tag == "image")
    ...
    if ( commandType == CommandLineModule
      ...
      // module for which we can communicated directly with the DMML
      // tree.

      // Redefine the filename to be a reference to a cjyx node.

      // Must be large enough to hold cjyx:, #, an ascii
      // representation of the scene pointer and the DMML node ID.
      char *tname = new char[name.size() + 100];

      sprintf(tname, "cjyx:%p#%s", this->GetDMMLScene(), name.c_str());
...
//-----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::ApplyAndWait ( vtkDMMLCommandLineModuleNode* node, bool updateDisplay )
{
  // Just execute and wait.
  node->Register(this);
  node->SetAttribute("UpdateDisplay", updateDisplay ? "true" : "false");

  vtkCjyxCLIModuleLogic::ApplyTask ( node );
...
//-----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::KillProcesses()
{
...
//-----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::Apply ( vtkDMMLCommandLineModuleNode* node, bool updateDisplay )
{
  bool ret;

  vtkNew<vtkCjyxTask> task;
  ...
  task->SetTaskFunction(this, (vtkCjyxTask::TaskFunctionPointer)
                        &vtkCjyxCLIModuleLogic::ApplyTask,
                        node);
  ...
  if (!ret)
    ...
    node->SetStatus(vtkDMMLCommandLineModuleNode::Scheduled);
    }
}

//----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic
::SetDMMLApplicationLogic(vtkDMMLApplicationLogic* logic)
{
  vtkDMMLApplicationLogic* oldLogic = this->GetDMMLApplicationLogic();
  if (logic == oldLogic)
    {
    return;
    }
  ...
  if (oldLogic)
    ...
    vtkEventBroker::GetInstance()->RemoveObservations(
      oldLogic, vtkCjyxApplicationLogic::RequestProcessedEvent,
      this, this->GetDMMLLogicsCallbackCommand());
    }

  Superclass::SetDMMLApplicationLogic(logic);
  assert(logic == this->GetDMMLApplicationLogic());
  ...
  if (logic)
    ...
    vtkEventBroker::GetInstance()->AddObservation(
      logic, vtkCjyxApplicationLogic::RequestProcessedEvent,
      this, this->GetDMMLLogicsCallbackCommand());
    }
...
// void vtkCjyxCLIModuleLogic::LazyEvaluateModuleTarget(ModuleDescription& moduleDescriptionObject)
// {
...
//           entryPointAsString = std::string("cjyx:") + entryPointAsText;
//
...
// interface.  In the Cjyx architecture, the user interface can be
...
// modify a DMML node.
//
void vtkCjyxCLIModuleLogic::ApplyTask(void *clientdata)
{
  // check if DMML node is present
  ...
  vtkSmartPointer<vtkDMMLCommandLineModuleNode> node0;
  // node was registered when the task was scheduled so take reference to
  // release it when it goes out of scope
  node0.TakeReference(reinterpret_cast<vtkDMMLCommandLineModuleNode*>(clientdata));

  // Check to see if this node/task has been cancelled
  if (node0->GetStatus() == vtkDMMLCommandLineModuleNode::Cancelling ||
      node0->GetStatus() == vtkDMMLCommandLineModuleNode::Cancelled)
    {
    node0->SetOutputText("", false);
    node0->SetErrorText("", false);
    node0->SetStatus(vtkDMMLCommandLineModuleNode::Cancelled, false);
  ...
  node0->GetModuleDescription().GetProcessInformation()
    ->SetProgressCallback( vtkCjyxCLIModuleLogic::ProgressCallback,
                           &lnp );
  ...
  std::string::size_type pos = target.find("cjyx:");
  if (pos == 0)
    {
    sscanf(target.c_str(), "cjyx:%p", &entryPoint);
    }

  // Assume that the modules correctly report themselves
  if ( node0->GetModuleDescription().GetType() == "CommandLineModule" )
    {
    // vtkCjyxApplication::GetInstance()->InformationMessage
  ...
  // map to keep track of DMML Ids and filenames
  typedef std::map<std::string, std::string> DMMLIDToFileNameMap;
  DMMLIDToFileNameMap nodesToReload;
  DMMLIDToFileNameMap nodesToWrite;

  // map to keep track of the DMML Ids on the main scene to the DMML
  // Ids in the miniscene sent to the module
  DMMLIDMap sceneToMiniSceneMap;
  ...
  for (pgit = pgbeginit; pgit != pgendit; ++pgit)
    ...
    for (pit = pbeginit; pit != pendit; ++pit)
      ...
      if ((*pit).GetTag() == "image" || (*pit).GetTag() == "geometry"
        ...
        if (!this->GetDMMLScene()->GetNodeByID(id.c_str()) || id == "None")
          {
          continue;
          }
        ...
        if ((*pit).GetTag() == "pointfile")
          ...
          vtkDMMLNode *nodeToFlag = this->GetDMMLScene()->GetNodeByID(id.c_str());
          if (nodeToFlag)
            {
  ...
  MemoryTransferPossible.insert("vtkDMMLScalarVolumeNode");
  MemoryTransferPossible.insert("vtkDMMLLabelMapVolumeNode");
  MemoryTransferPossible.insert("vtkDMMLVectorVolumeNode");
  MemoryTransferPossible.insert("vtkDMMLDiffusionWeightedVolumeNode");
  MemoryTransferPossible.insert("vtkDMMLDiffusionTensorVolumeNode");

  DMMLIDToFileNameMap::const_iterator id2fn0;
  ...
  for (id2fn0 = nodesToWrite.begin();
    ...
    {
    vtkDMMLNode *nd
      = this->GetDMMLScene()->GetNodeByID( (*id2fn0).first.c_str() );

    vtkSmartPointer<vtkDMMLStorageNode> out = nullptr;
    vtkSmartPointer<vtkDMMLStorageNode> defaultOut = nullptr;

    vtkDMMLStorableNode *sn = dynamic_cast<vtkDMMLStorableNode *>(nd);
    if (sn)
      {

      if (!sn->IsA("vtkDMMLMarkupsNode"))
        {
        ...
        if (extension == ".fcsv")
          ...
          defaultOut.TakeReference(vtkDMMLStorageNode::SafeDownCast(
            this->GetDMMLScene()->CreateNodeByClass("vtkDMMLMarkupsFiducialStorageNode")));
          }
        else
          {
          defaultOut.TakeReference(sn->CreateDefaultStorageNode());
        ...
        vtkDMMLMarkupsStorageNode* markupsStorage = vtkDMMLMarkupsStorageNode::SafeDownCast(defaultOut);
        if (markupsStorage)
          {
    ...
    // DMMLIDImageIO, then we can change these conditions for the
    ...
    vtkDMMLTransformNode *tnd = vtkDMMLTransformNode::SafeDownCast(nd);
    if (tnd)
      {
      ...
      if (!extension.empty())
        {
        // if we start passing pointers to DMML transforms, then we'll
        ...
        if (extension == ".dmml")
          ...
          vtkDMMLNode *cp = miniscene->CopyNode(nd);
    ...
    vtkDMMLModelHierarchyNode *mhnd = vtkDMMLModelHierarchyNode::SafeDownCast(nd);
    if (mhnd)
      {
    ...
    if (out)
      {
      out->SetScene(this->GetDMMLScene());
  ...
  for (id2fn0 = nodesToReload.begin();
    ...
    vtkDMMLTransformNode *tnd
      = vtkDMMLTransformNode::SafeDownCast(nd);
    vtkDMMLModelHierarchyNode *mhnd
      = vtkDMMLModelHierarchyNode::SafeDownCast(nd);
    ...
    if (tnd || mhnd)
      ...
      vtkDMMLDisplayableNode *dable = vtkDMMLDisplayableNode::SafeDownCast(nd);
      if (dable)
        {
        vtkDMMLDisplayNode *dnd = dable->GetDisplayNode();
        if (dnd)
          {
          vtkDMMLNode *dcp = miniscene->CopyNode(dnd);

          vtkDMMLDisplayableNode *dablecp
            = vtkDMMLDisplayableNode::SafeDownCast(cp);
          vtkDMMLDisplayNode *d = vtkDMMLDisplayNode::SafeDownCast(dcp);
    ...
    if (commandType == SharedObjectModule &&
      ...
      // modify the node directly (via itkDMMLIDImageIO). We don't want any
  ...
  if (miniscene->GetNumberOfNodes() > 0)
    {
      ...
      {
        vtkDMMLNode* node = (vtkDMMLNode*) nodes->GetItemAsObject(n);

        vtkDMMLStorableNode* storable = vtkDMMLStorableNode::SafeDownCast(node);
        if (storable)
        {
    ...
    for (pit = pbeginit; pit != pendit; ++pit)
      ...
      if (hasFlag)
        ...
        if ((*pit).GetTag() == "image" || (*pit).GetTag() == "geometry"
          ...
          // established earlier
          DMMLIDToFileNameMap::const_iterator id2fn;
        ...
        if ((*pit).GetTag() == "point")
          ...
          vtkDMMLNode *node
            = this->GetDMMLScene()->GetNodeByID((*pit).GetValue().c_str());
          vtkDMMLDisplayableHierarchyNode *points = vtkDMMLDisplayableHierarchyNode::SafeDownCast(node);
          vtkDMMLDisplayableNode *markups = vtkDMMLDisplayableNode::SafeDownCast(node);
          if (markups && markups->IsA("vtkDMMLMarkupsNode"))
            {
            int multipleFlag = 1;
            ...
            for (unsigned int c = 0; c < numChildren; c++)
              ...
              // GetNthChildNode
              vtkDMMLHierarchyNode *nthHierarchyNode = points->GetNthChildNode(c);
              // then get the displayable node from that hierarchy node
              if (nthHierarchyNode)
                {
                vtkDMMLDisplayableHierarchyNode *nthDisplayableHierarchyNode = vtkDMMLDisplayableHierarchyNode::SafeDownCast(nthHierarchyNode);
        ...
        if ((*pit).GetTag() == "pointfile")
          ...
          if (markups && markups->IsA("vtkDMMLMarkupsNode"))
            {
            vtkDMMLStorageNode *dmmlStorageNode = markups->GetStorageNode();
            if (dmmlStorageNode)
              {
              vtkDMMLMarkupsStorageNode *markupsStorageNode = vtkDMMLMarkupsStorageNode::SafeDownCast(dmmlStorageNode);
        ...
        if ((*pit).GetTag() == "region")
          ...
          vtkDMMLNode *node
            = this->GetDMMLScene()->GetNodeByID((*pit).GetValue().c_str());
          vtkDMMLROIListNode *regions = vtkDMMLROIListNode::SafeDownCast(node);

          vtkDMMLDisplayableHierarchyNode *points = vtkDMMLDisplayableHierarchyNode::SafeDownCast(node);
          vtkDMMLDisplayableNode *roi = vtkDMMLDisplayableNode::SafeDownCast(node);
          ...
          else if (roi && (roi->IsA("vtkDMMLMarkupsROINode") || roi->IsA("vtkDMMLAnnotationROINode")))
            {
  ...
  for (iit = indexmap.begin(); iit != indexmap.end(); ++iit)
    ...
    if ((*iit).second.GetTag() != "image"
      ...
      if ((*iit).second.GetValue() != "")
        ...
        node0->SetStatus(vtkDMMLCommandLineModuleNode::Idle, false);
        this->GetApplicationLogic()->RequestModified( node0 );
        return;
        }
      }
      ...
      if (fname.size() > 0)
        ...
        node0->SetOutputText("", false);
        node0->SetErrorText(errorText, false);
        node0->SetStatus(vtkDMMLCommandLineModuleNode::CompletedWithErrors, false);
        this->GetApplicationLogic()->RequestModified( node0 );
        return;
        }
      }
  ...
  node0->SetOutputText("", false);
  node0->SetErrorText("", false);
  node0->SetStatus(vtkDMMLCommandLineModuleNode::Running, false);
  this->GetApplicationLogic()->RequestModified( node0 );
  if (commandType == CommandLineModule)
    {
    ...
    // loading the itkDMMLIDIOPlugin plugin because executable CLIs read images
    // from file and not from shared memory. Worst the plugin in the CLI
    // could clash by loading libraries (ITK, VTK, DMML) other than the
  ...
  else if (node0->GetStatus() != vtkDMMLCommandLineModuleNode::Cancelled
           && node0->GetStatus() != vtkDMMLCommandLineModuleNode::CompletedWithErrors)
    {
    node0->SetStatus(vtkDMMLCommandLineModuleNode::Completing, false);
    this->GetApplicationLogic()->RequestModified( node0 );
    }
  ...
  //
  //
  if (node0->GetStatus() == vtkDMMLCommandLineModuleNode::Completing)
    {
    // reload nodes
    for (id2fn0 = nodesToReload.begin(); id2fn0 != nodesToReload.end(); ++id2fn0)
      ...
      //
      DMMLIDMap::iterator mit = sceneToMiniSceneMap.find((*id2fn0).first);
      if (mit == sceneToMiniSceneMap.end())
        {
        ...
        if (commandType == SharedObjectModule)
          {
          vtkDMMLNode* node = this->GetDMMLScene()->GetNodeByID((*id2fn0).first);
  ...
  if (miniscene->GetNumberOfNodes() > 0)
    ...
    if (node0->GetStatus() == vtkDMMLCommandLineModuleNode::Completing)
      ...
      for (mit = sceneToMiniSceneMap.begin(); mit != sceneToMiniSceneMap.end();
        ...
        DMMLIDToFileNameMap::iterator rit = nodesToReload.find( (*mit).first );
    ...
    // Rewire the DMML scene as directed
    //
        ...
        if ((*pit).GetChannel() == "output"  && (*pit).GetReference().size() > 0)
          ...
          if (node0->GetModuleDescription().HasParameter((*pit).GetReference()))
            ...
            if (reference.size() > 0)
              ...
              vtkDMMLNode *refNode = this->GetDMMLScene()->GetNodeByID(reference.c_str());
              if (refNode)
                {
                if ((*pit).GetTag() == "transform")
                  ...
                  vtkDMMLTransformableNode *trefNode = vtkDMMLTransformableNode::SafeDownCast(refNode);
  ...
  if (node0->GetStatus() == vtkDMMLCommandLineModuleNode::Completing &&
    ...
    {
    node0->SetStatus(vtkDMMLCommandLineModuleNode::Completed, false);
    this->GetApplicationLogic()->RequestModified( node0 );
    }
}

//-----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::ProgressCallback ( void *who )
{
...
//-----------------------------------------------------------------------------
std::string
vtkCjyxCLIModuleLogic::FindHiddenNodeID(const ModuleDescription& d,
      ...
      if (d.HasParameter(p.GetReference()))
        ...
        if (p.GetTag() == "table")
          ...
          if (p.GetType() == "color")
            ...
            // get its color node
            vtkDMMLDisplayableNode *rn
              = vtkDMMLDisplayableNode::SafeDownCast(this->GetDMMLScene()
                                            ->GetNodeByID(reference.c_str()));
            if (rn)
              {
              vtkDMMLDisplayNode *dn = rn->GetDisplayNode();
              if (dn)
                {
...
//----------------------------------------------------------------------------
bool vtkCjyxCLIModuleLogic
::IsCommandLineModuleNodeUpdatingDisplay(vtkDMMLCommandLineModuleNode* node)const
{
...
//----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::SetDMMLSceneInternal(vtkDMMLScene * newScene)
{
...
//----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::OnDMMLSceneNodeAdded(vtkDMMLNode* node)
{
  if (node->IsA("vtkDMMLCommandLineModuleNode"))
    {
    vtkNew<vtkIntArray> events;
    events->InsertNextValue(vtkCommand::ModifiedEvent);
    events->InsertNextValue(
      vtkDMMLCommandLineModuleNode::AutoRunEvent);
...
//----------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::ProcessDMMLLogicsEvents(vtkObject* caller,
                                                      unsigned long event,
                                                      void * callData)
{
  if (caller->IsA("vtkCjyxApplicationLogic") &&
      event == vtkCjyxApplicationLogic::RequestProcessedEvent)
    {
...
//---------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic
::ProcessDMMLNodesEvents(vtkObject *caller, unsigned long event,
                         void *callData)
{
  vtkDMMLNode* node = vtkDMMLNode::SafeDownCast(caller);
  assert(node);
  // Observe only the CLI of the logic.
  vtkDMMLCommandLineModuleNode* cliNode =
    vtkDMMLCommandLineModuleNode::SafeDownCast(node);
  if (cliNode &&
    ...
    switch(event)
      ...
      case vtkCommand::ModifiedEvent:
        break;
      case vtkDMMLCommandLineModuleNode::AutoRunEvent:
        {
        ...
        bool autoRun = cliNode->GetAutoRun() &&
          cliNode->GetAutoRunMode() & vtkDMMLCommandLineModuleNode::AutoRunEnabledMask;
        ...
        if (requestTime != 0)
          {
          if (cliNode->GetAutoRunMode() & vtkDMMLCommandLineModuleNode::AutoRunOnAnyInputEvent)
            {
            autoRun = autoRun && (cliNode->GetInputMTime() <= requestTime);
            }
          if (cliNode->GetAutoRunMode() & vtkDMMLCommandLineModuleNode::AutoRunOnChangedParameter)
            {
...
//---------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic
::AutoRun(vtkDMMLCommandLineModuleNode* node)
{
  ...
  if (node->IsBusy())
    ...
    if (node->GetStatus() != vtkDMMLCommandLineModuleNode::Cancelling)
      {
  ...
  if (node->GetAutoRunMode() & vtkDMMLCommandLineModuleNode::AutoRunOnChangedParameter)
    {
    requestTime = std::max(requestTime, node->GetParameterMTime());
    }
  if (node->GetAutoRunMode() & vtkDMMLCommandLineModuleNode::AutoRunOnAnyInputEvent)
    {
  ...
  this->GetApplicationLogic()->InvokeEventWithDelay(
    ...
    node, vtkDMMLCommandLineModuleNode::AutoRunEvent,
    reinterpret_cast<void*>(requestTime));
}

//---------------------------------------------------------------------------
void vtkCjyxCLIModuleLogic::AddCompleteModelHierarchyToMiniScene(vtkDMMLScene *miniscene, vtkDMMLModelHierarchyNode *mhnd,
                                                                   DMMLIDMap *sceneToMiniSceneMap, std::set<std::string> &filesToDelete)
{
  if (!mhnd)
    {
    return;
  ...
  std::vector<vtkDMMLHierarchyNode*> hnodes;
  ...
  for (std::vector<vtkDMMLHierarchyNode*>::iterator it = hnodes.begin(); it != hnodes.end(); ++it)
    {
    vtkDMMLNode *tnd = *it;
    vtkDMMLModelHierarchyNode *tmhnd = vtkDMMLModelHierarchyNode::SafeDownCast(tnd);
    ...
    vtkDMMLNode *cp = miniscene->CopyNode(tnd);
    vtkDMMLModelHierarchyNode *mhcp  = vtkDMMLModelHierarchyNode::SafeDownCast(cp);

    // wire the parent relationship (again, we assume the parents appeared in the list before the children)
    vtkDMMLNode *p = tmhnd->GetParentNode();
    if (p)
      {
      // find parent in the sceneToMiniSceneMap
      DMMLIDMap::iterator mit = sceneToMiniSceneMap->find(p->GetID());
      if (mit != sceneToMiniSceneMap->end())
        {
    ...
    vtkDMMLDisplayNode *dnd = tmhnd->GetDisplayNode();
    if (dnd)
      {
      vtkDMMLNode *dcp = miniscene->CopyNode(dnd);
      vtkDMMLDisplayNode *d = vtkDMMLDisplayNode::SafeDownCast(dcp);
    ...
    vtkDMMLModelNode* mnd = vtkDMMLModelNode::SafeDownCast(tmhnd->GetDisplayableNode());
    if (mnd)
      {
      vtkDMMLNode *mcp = miniscene->CopyNode(mnd);

      vtkDMMLModelNode *tmcp = vtkDMMLModelNode::SafeDownCast(mcp);
      if (tmcp)
        {
        ...
        for (int i=0; i<ndn; i++)
          {
          vtkDMMLDisplayNode *mdnd = mnd->GetNthDisplayNode(i);
          if (mdnd)
            {
            vtkDMMLDisplayNode *d = vtkDMMLDisplayNode::SafeDownCast(miniscene->CopyNode(mdnd));
            tmcp->AddAndObserveDisplayNodeID(d->GetID());
            }
          }

        // add the storage node for the model to the miniscene
        vtkDMMLStorageNode *msnd = mnd->GetStorageNode();
        if (msnd)
          {
          vtkDMMLModelStorageNode *s = vtkDMMLModelStorageNode::SafeDownCast(miniscene->CopyNode(msnd));
...
//---------------------------------------------------------------------------
bool vtkCjyxCLIModuleLogic::SetDefaultParameterValue(const std::string& name, const std::string& value)
{
  return this->Internal->DefaultModuleDescription.SetParameterValue(name, value);
}

//---------------------------------------------------------------------------
std::string vtkCjyxCLIModuleLogic::GetDefaultParameterValue(const std::string& name) const
{
  return this->Internal->DefaultModuleDescription.GetParameterValue(name);
}

//---------------------------------------------------------------------------
int vtkCjyxCLIModuleLogic::GetCoordinateSystemFromString(const char* coordinateSystemStrPtr) const
{
  ...
  if (coordinateSystemStr.compare("ras") == 0)
    {
    coordinateSystem = vtkDMMLStorageNode::CoordinateSystemRAS;
    }
  else if (coordinateSystemStr.compare("lps") == 0)
    {
    coordinateSystem = vtkDMMLStorageNode::CoordinateSystemLPS;
    }
  else
    {
