...
// --------------------------------------------------------------------------
qCjyxStyle::~qCjyxStyle() = default;

//------------------------------------------------------------------------------
QStyle::SubControl qCjyxStyle::hitTestComplexControl(ComplexControl cc, const QStyleOptionComplex *opt,
...
// --------------------------------------------------------------------------
int qCjyxStyle::pixelMetric(PixelMetric metric, const QStyleOption * option,
...
// --------------------------------------------------------------------------
QRect qCjyxStyle::subControlRect(ComplexControl control, const QStyleOptionComplex *option,
...
//------------------------------------------------------------------------------
QPalette qCjyxStyle::standardPalette()const
{
...
//------------------------------------------------------------------------------
QPalette qCjyxStyle::standardLightPalette()const
{
...
//------------------------------------------------------------------------------
QPalette qCjyxStyle::standardDarkPalette()const
{
  QPalette palette = this->Superclass::standardPalette();
  // See https://doc.qt.io/qt-5/qpalette.html#ColorRole-enum
  // Central color roles
...
//------------------------------------------------------------------------------
int qCjyxStyle::styleHint(StyleHint hint, const QStyleOption *opt, const QWidget *widget,
...
//------------------------------------------------------------------------------
bool qCjyxStyle::eventFilter(QObject* obj, QEvent* event)
{
