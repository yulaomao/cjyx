#ifndef __qCjyxDataDialog_p_h
#define __qCjyxDataDialog_p_h
...
class qCjyxDataDialogPrivate
  : public QDialog
  , public Ui_qCjyxDataDialog
{
  Q_OBJECT
  Q_DECLARE_PUBLIC(qCjyxDataDialog);
public:
  explicit qCjyxDataDialogPrivate(qCjyxDataDialog* object, QWidget* _parent=nullptr);
  ~qCjyxDataDialogPrivate() override;

  void dragEnterEvent(QDragEnterEvent* event) override;
  void dropEvent(QDropEvent* event) override;

  QList<qCjyxIO::IOProperties> selectedFiles()const;
public slots:
  void addDirectory();
  void addFiles();
  void reset();
...
protected:
  ...
  void addFile(const QFileInfo& file, const QString& readerDescription=QString(), qCjyxIO::IOProperties* ioProperties=nullptr);
