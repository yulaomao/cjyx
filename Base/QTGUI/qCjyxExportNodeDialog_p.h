#ifndef __qCjyxExportNodeDialog_p_h
#define __qCjyxExportNodeDialog_p_h
...
#include "ui_qCjyxExportNodeDialog.h"

class vtkDMMLNode;
class vtkDMMLStorableNode;
class qCjyxFileWriterOptionsWidget;
...
public:
  ...
  NodeTypeWidgetSet(QWidget* parent, vtkDMMLStorableNode* storableNode, vtkDMMLScene* scene);
  ...
  void changeCurrentOptionsWidget(qCjyxFileWriterOptionsWidget*);
  ...
  // Get display name associated to the node type (e.g. if node type is "vtkDMMLScalarVolumeNode", display name is "Volume")
  // prototypeNode must be valid to use this.
  ...
  vtkDMMLStorableNode* prototypeNode;
  ...
  qCjyxFileWriterOptionsWidget* optionsWidget = nullptr; // The current options widget, if any, that should be on display by optionsStackedWidget


  // Mapping from formats to options widgets, to keep track of and reuse options widgets as they get created
  QHash<QString,qCjyxFileWriterOptionsWidget*> formatToOptionsWidget;
...
class qCjyxExportNodeDialogPrivate
  : public QDialog
  , public Ui_qCjyxExportNodeDialog
{
  Q_OBJECT
public:
  typedef qCjyxExportNodeDialogPrivate Self;
  explicit qCjyxExportNodeDialogPrivate(QWidget* _parent=nullptr);
  ~qCjyxExportNodeDialogPrivate() override;
  ...
  static QString forceFileNameExtension(const QString& fileName, const QString& extension, vtkDMMLNode* node);

  /// Return a reasonable default filename choice for \a node with extension \a extension. It is based on the node name.
  static QString defaultFilename(vtkDMMLNode* node, QString extension);
...
protected:
  ...
  QString recommendedFilename(vtkDMMLStorableNode*) const;
  ...
  QDir getSubjectHierarchyBasedDirectory(vtkDMMLStorableNode*) const;

  // Return the list of nodes to be exported, based on the status of RecursiveChildrenCheckBox
  const QList<vtkDMMLStorableNode*>& nodeList() const;
  ...
  vtkDMMLStorableNode* theOnlyNode() const;
  ...
  QList<vtkDMMLStorableNode*> NodesRecursive;
  QList<vtkDMMLStorableNode*> NodesNonrecursive;
  ...
  QList<vtkDMMLStorableNode*> NodesSelectedOnly;
