...
#ifndef __qCjyxIconEnginePlugin_h
#define __qCjyxIconEnginePlugin_h

// Qt includes
#include <ctkIconEnginePlugin.h>

// Cjyx includes
#include "qCjyxIconEnginePluginExport.h"
...
/// Medium subdirectory.
class Q_CJYX_BASE_QTGUI_ICON_ENGINE_EXPORT qCjyxIconEnginePlugin: public ctkIconEnginePlugin
{
  Q_OBJECT
public:
  qCjyxIconEnginePlugin(QObject* parent = nullptr);
};
