...
//----------------------------------------------------------------------------
vtkStandardNewMacro(vtkCjyxScriptedLoadableModuleLogic);

//---------------------------------------------------------------------------
class vtkCjyxScriptedLoadableModuleLogic::vtkInternal
{
public:
  vtkInternal();
  ~vtkInternal();
...
//  enum {
//    GetDMMLSceneEventsToObserveMethod = 0,
...
////---------------------------------------------------------------------------
//int vtkCjyxScriptedLoadableModuleLogic::vtkInternal::APIMethodCount = 2;

////---------------------------------------------------------------------------
//const char* vtkCjyxScriptedLoadableModuleLogic::vtkInternal::APIMethodNames[2] =
//{
...
//---------------------------------------------------------------------------
vtkCjyxScriptedLoadableModuleLogic::vtkInternal::vtkInternal()
{
...
//----------------------------------------------------------------------------
// vtkCjyxScriptedLoadableModuleLogic methods

//----------------------------------------------------------------------------
vtkCjyxScriptedLoadableModuleLogic::vtkCjyxScriptedLoadableModuleLogic()
{
...
//----------------------------------------------------------------------------
void vtkCjyxScriptedLoadableModuleLogic::PrintSelf(ostream& os, vtkIndent indent)
{
  this->vtkObject::PrintSelf(os, indent);
}

////---------------------------------------------------------------------------
//void vtkCjyxScriptedLoadableModuleLogic::SetDMMLSceneInternal(vtkDMMLScene* newScene)
//{
...
////---------------------------------------------------------------------------
//void vtkCjyxScriptedLoadableModuleLogic::ProcessDMMLSceneEvents(vtkObject *caller,
//                                                             unsigned long event,
//                                                             void *callData)
//{
...
////---------------------------------------------------------------------------
//void vtkCjyxScriptedLoadableModuleLogic::ProcessDMMLNodesEvents(vtkObject *caller,
//                                                              unsigned long event,
//                                                              void *callData)
//{
...
//---------------------------------------------------------------------------
bool vtkCjyxScriptedLoadableModuleLogic::SetPythonSource(const std::string& pythonSource)
{
