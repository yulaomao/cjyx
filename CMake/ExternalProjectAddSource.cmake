...
#!
#! Cjyx_RemoteModule_Add(<projectname>
#!     [DOWNLOAD_DIR <dir>]
#!     (
#!       URL <url> [URL_MD5 md5] |
#!       GIT_REPOSITORY <url> [GIT_TAG <tag>] |
...
#! by default to '${CMAKE_BINARY_DIR}/${projectname}' will be passed to Cjyx inner build.
#!
#! OPTION_NAME If specified, it adds an advanced option allowing to easily toggle the inclusion of the
#!             associated remote module. That option will be passed to the Cjyx inner build.
#!
...
#!        This happen in the Cjyx/Modules/Remote/CMakeLists.txt file.
#!
macro(Cjyx_Remote_Add projectname)
  set(options)
  ...
  if(_ep_OPTION_NAME)
    ...
    foreach(_option IN LISTS _ep_OPTION_DEPENDS)
      set(_prop_name "CJYX_REMOTE_${_option}_OPTION_DEPENDS")
    ...
    set_property(GLOBAL PROPERTY "CJYX_REMOTE_${_ep_OPTION_NAME}_OPTION_DEPENDS" ${_ep_OPTION_DEPENDS})
