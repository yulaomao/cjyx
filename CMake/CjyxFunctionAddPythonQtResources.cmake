set_property(GLOBAL PROPERTY _CJYX_PYTHON_RESOURCE_TARGETS)

function(cjyxFunctionAddPythonQtResources RESOURCE_NAMES)
  set(out_paths)
  ...
  foreach(in_path ${ARGN})
    ...
    add_custom_command(
      ...
      COMMAND ${PYTHON_EXECUTABLE}
        ${Cjyx_SOURCE_DIR}/Utilities/Scripts/qrcc.py
      ...
      DEPENDS ${Cjyx_SOURCE_DIR}/Utilities/Scripts/qrcc.py ${rc_depends}
      )
  ...
  get_property(resource_targets
    GLOBAL PROPERTY _CJYX_PYTHON_RESOURCE_TARGETS
    )
...
function(cjyxFunctionAddPythonQtResourcesTargets NAME)
  get_property(resource_files GLOBAL PROPERTY _CJYX_PYTHON_RESOURCE_TARGETS)
