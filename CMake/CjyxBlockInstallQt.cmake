...
# Find and install Qt
# -------------------------------------------------------------------------
set(QT_INSTALL_LIB_DIR ${Cjyx_INSTALL_LIB_DIR})
  ...
  if(UNIX)
    ...
    # XcbQpa
    cjyxInstallLibrary(FILE ${qt_root_dir}/lib/libQt5XcbQpa.so
    ...
    foreach(iculib IN ITEMS data i18n io le lx test tu uc)
      cjyxInstallLibrary(FILE ${qt_root_dir}/lib/libicu${iculib}.so
        DESTINATION ${QT_INSTALL_LIB_DIR} COMPONENT Runtime
        STRIP
        )
    endforeach()
    ...
    if(Cjyx_BUILD_QT_DESIGNER_PLUGINS)
      ...
      cjyxInstallLibrary(FILE ${qt_root_dir}/lib/libQt5DesignerComponents.so
        DESTINATION ${QT_INSTALL_LIB_DIR} COMPONENT Runtime
        STRIP
        )
    endif()
    ...
    if("Qt5::WebEngine" IN_LIST QT_LIBRARIES)
      install(PROGRAMS ${qt_root_dir}/libexec/QtWebEngineProcess
        DESTINATION ${Cjyx_INSTALL_ROOT}/libexec COMPONENT Runtime
        )
      cjyxStripInstalledLibrary(
        FILES "${Cjyx_INSTALL_ROOT}/libexec/QtWebEngineProcess"
        COMPONENT Runtime)
    ...
    install(DIRECTORY ${resources_dir}
      DESTINATION ${Cjyx_INSTALL_ROOT} COMPONENT Runtime
      )
    ...
    if("Qt5::WebEngine" IN_LIST QT_LIBRARIES)
      ...
      install(DIRECTORY ${translations_dir}
        DESTINATION ${Cjyx_INSTALL_ROOT}/share/QtTranslations/ COMPONENT Runtime
        )
    endif()

    # Configure and install qt.conf
    set(qt_conf_contents "[Paths]\nPrefix = ..\nPlugins = ${Cjyx_INSTALL_QtPlugins_DIR}\nTranslations = share/QtTranslations")
    install(
  ...
  elseif(WIN32)
    ...
    set(executable "${Cjyx_MAIN_PROJECT_APPLICATION_NAME}App-real.exe")
  ...
  if(Cjyx_BUILD_QT_DESIGNER_PLUGINS)
    install(PROGRAMS ${qt_root_dir}/bin/designer${CMAKE_EXECUTABLE_SUFFIX}
      DESTINATION ${Cjyx_INSTALL_ROOT}/bin COMPONENT Runtime
      RENAME designer-real${CMAKE_EXECUTABLE_SUFFIX}
      )
    cjyxStripInstalledLibrary(
      FILES "${Cjyx_INSTALL_ROOT}/bin/designer-real"
      COMPONENT Runtime)
  endif()
