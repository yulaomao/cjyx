...
function(CjyxReadApplicationProperties)
  set(options
    )
  set(oneValueArgs
    PROJECT_NAME
  ...
  # Sanity checks
  if(NOT EXISTS ${Cjyx_APPLICATIONS_DIR})
    message(FATAL_ERROR "Cjyx_APPLICATIONS_DIR is defined but corresponds to a nonexistent directory [${Cjyx_APPLICATIONS_DIR}]")
  endif()
  if(NOT EXISTS ${Cjyx_APPLICATIONS_DIR}/${MY_PROJECT_NAME})
    message(FATAL_ERROR "PROJECT_NAME corresponds to a nonexistent application directory [${Cjyx_APPLICATIONS_DIR}/${MY_PROJECT_NAME}]")
  endif()
  set(property_file ${Cjyx_APPLICATIONS_DIR}/${MY_PROJECT_NAME}/cjyx-application-properties.cmake)
  if(NOT EXISTS ${property_file})
    message(FATAL_ERROR "Couldn't find property file 'cjyx-application-properties.cmake' in directory [${Cjyx_APPLICATIONS_DIR}/${MY_PROJECT_NAME}]")
  endif()
