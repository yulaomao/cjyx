...
macro(simple_test testname)
  ...
  if("${Cjyx_LAUNCH_COMMAND}" STREQUAL "")
    message(FATAL_ERROR "error: Cjyx_LAUNCH_COMMAND variable is not set !")
  endif()
  ...
  ExternalData_add_test(${Cjyx_ExternalData_DATA_MANAGEMENT_TARGET} NAME ${testname}
           COMMAND ${Cjyx_LAUNCH_COMMAND} $<TARGET_FILE:${KIT}CxxTests> ${MY_DRIVER_TESTNAME} ${MY_UNPARSED_ARGUMENTS})
