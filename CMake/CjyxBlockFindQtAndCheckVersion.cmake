...
macro(__CjyxBlockFindQtAndCheckVersion_find_qt)
    find_package(Qt5 COMPONENTS ${Cjyx_REQUIRED_QT_MODULES})
  ...
  if(NOT ${_found_var})
    message(FATAL_ERROR "error: Qt ${Cjyx_REQUIRED_QT_VERSION} was not found on your system."
                        "${_error_details}")
  endif()

  # Check version
  if("${_major}.${_minor}.${_patch}" VERSION_LESS "${Cjyx_REQUIRED_QT_VERSION}")
    message(FATAL_ERROR "error: Cjyx requires at least Qt ${Cjyx_REQUIRED_QT_VERSION} "
  ...
  foreach(module ${Cjyx_REQUIRED_QT_MODULES})
...
set(expected_defined_vars
  Cjyx_REQUIRED_QT_VERSION
  Cjyx_REQUIRED_QT_MODULES
  )
...
__CjyxBlockFindQtAndCheckVersion_find_qt()

set(_project_name ${Cjyx_MAIN_PROJECT_APPLICATION_NAME})
