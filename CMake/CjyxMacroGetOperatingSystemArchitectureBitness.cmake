...
#
# CjyxMacroGetOperatingSystemArchitectureBitness(<var-prefix>)
...
include(${CMAKE_CURRENT_LIST_DIR}/CjyxBlockOperatingSystemNames.cmake)

macro(CjyxMacroGetOperatingSystemArchitectureBitness)
  set(options)
  ...
  if(CMAKE_SYSTEM_NAME STREQUAL "Windows")
    set(${MY_VAR_PREFIX}_OS "${Cjyx_OS_WIN_NAME}")

  elseif(CMAKE_SYSTEM_NAME STREQUAL "Linux")
    set(${MY_VAR_PREFIX}_OS "${Cjyx_OS_LINUX_NAME}")

  elseif(CMAKE_SYSTEM_NAME STREQUAL "Darwin")
    set(${MY_VAR_PREFIX}_OS "${Cjyx_OS_MAC_NAME}")
