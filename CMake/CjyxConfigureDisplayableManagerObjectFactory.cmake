...
#
# Configure Cjyx displayable manager VTK object factory
#
...
# scope. This tells CjyxMacroBuildModuleLogic to set Cjyx_EXPORT_HEADER_CUSTOM_CONTENT
# and define the associated ${TARGET_NAME}_AUTOINIT compilation flag.
#
function(CjyxConfigureDisplayableManagerObjectFactory)
  set(options
    NO_EXPORT
    )
  set(oneValueArgs
  ...
  if(DM_OBJECT_FACTORY_UNPARSED_ARGUMENTS)
    message(FATAL_ERROR "Unknown keywords given to CjyxConfigureDisplayableManagerObjectFactory(): \"${DM_OBJECT_FACTORY_UNPARSED_ARGUMENTS}\"")
  endif()
...
")
  ...
  configure_file(
    ${Cjyx_CMAKE_DIR}/vtkCjyxObjectFactory.h.in
    ${CMAKE_CURRENT_BINARY_DIR}/${vtk-module}ObjectFactory.h
    )
  configure_file(
    ${Cjyx_CMAKE_DIR}/vtkCjyxObjectFactory.cxx.in
