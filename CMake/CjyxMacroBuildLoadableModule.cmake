...
macro(cjyxMacroBuildLoadableModule)
  set(options
    NO_INSTALL
    NO_TITLE
    WITH_GENERIC_TESTS
  ...
  if(LOADABLEMODULE_UNPARSED_ARGUMENTS)
    message(FATAL_ERROR "Unknown keywords given to cjyxMacroBuildLoadableModule(): \"${LOADABLEMODULE_UNPARSED_ARGUMENTS}\"")
  endif()

  set(MY_EXPORT_HEADER_PREFIX qCjyx${LOADABLEMODULE_NAME}Module)
  ...
  # Define library name
  # --------------------------------------------------------------------------
  set(lib_name qCjyx${LOADABLEMODULE_NAME}Module)
  ...
  if(NOT EXISTS ${Cjyx_LOGOS_RESOURCE})
    message("Warning, Cjyx_LOGOS_RESOURCE doesn't exist: ${Cjyx_LOGOS_RESOURCE}")
  endif()
    ...
    QT5_ADD_RESOURCES(LOADABLEMODULE_QRC_SRCS ${Cjyx_LOGOS_RESOURCE})
  ...
  set_property(GLOBAL APPEND PROPERTY CJYX_MODULE_TARGETS ${lib_name})
  ...
  if(DEFINED Cjyx_DEVELOPMENT_INSTALL)
    if(NOT DEFINED ${LOADABLEMODULE_NAME}_DEVELOPMENT_INSTALL)
      set(${LOADABLEMODULE_NAME}_DEVELOPMENT_INSTALL ${Cjyx_DEVELOPMENT_INSTALL})
    endif()
  else()
    if(NOT DEFINED ${LOADABLEMODULE_NAME}_DEVELOPMENT_INSTALL)
  ...
  if(NOT LOADABLEMODULE_NO_INSTALL AND ${LOADABLEMODULE_NAME}_DEVELOPMENT_INSTALL)
    ...
    install(FILES
      ${headers}
      ${dynamicHeaders}
      DESTINATION ${Cjyx_INSTALL_QTLOADABLEMODULES_INCLUDE_DIR}/${LOADABLEMODULE_NAME} COMPONENT Development
      )
  endif()
  ...
  if(BUILD_TESTING AND LOADABLEMODULE_WITH_GENERIC_TESTS)
    ...
    CjyxMacroConfigureGenericCxxModuleTests(${LOADABLEMODULE_NAME}
    ...
    set_target_properties(${KIT}GenericCxxTests PROPERTIES RUNTIME_OUTPUT_DIRECTORY ${CMAKE_BINARY_DIR}/${Cjyx_BIN_DIR})
    ...
    foreach(testname ${KIT_GENERIC_TEST_NAMES})
      add_test(NAME ${testname}
               COMMAND ${Cjyx_LAUNCH_COMMAND} $<TARGET_FILE:${KIT}GenericCxxTests> ${testname})
...
macro(cjyxMacroBuildQtModule)
  ...
  #  "Macro 'cjyxMacroBuildQtModule' is deprecated: Use 'cjyxMacroBuildLoadableModule' instead."
  #  )
  ...
  cjyxMacroBuildLoadableModule(${QTMODULE_ARGS} ${QTMODULE_OPTIONS})
endmacro()
