...
#
function(cjyx_ctest_upload_url)
  set(options)
  ...
  _CjyxCTestUploadURL_compute_hash(hash "${MY_ALGO}" "${MY_FILEPATH}")
  ...
  set(url_file "${CTEST_BINARY_DIRECTORY}/cjyx_ctest_upload_url.url")
...
set(_CjyxCTestUploadURL_supported_algo "MD5|SHA1|SHA224|SHA256|SHA384|SHA512|SHA3_224|SHA3_256|SHA3_384|SHA3_512")

function(_CjyxCTestUploadURL_compute_hash var_hash algo file)
  # Adapted from helper function found in ExternalData CMake module.
  if("${algo}" MATCHES "^${_CjyxCTestUploadURL_supported_algo}$")
    file("${algo}" "${file}" hash)
