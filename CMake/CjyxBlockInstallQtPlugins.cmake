...
# "CjyxBlockInstallQtPlugins_subdirectories" variable should set externally to contain
...
if("${CjyxBlockInstallQtPlugins_subdirectories}" STREQUAL "")
  message(FATAL_ERROR "error: CjyxBlockInstallQtPlugins_subdirectories should be set to a list"
                      " of subdirectories like: iconengines, imageformats, sqldrivers ...")
endif()

if(NOT "${QT_PLUGINS_DIR}" STREQUAL "")

  foreach(plugins_subdirectory ${CjyxBlockInstallQtPlugins_subdirectories})
    ...
    foreach(qpi ${qt_plugins})
      install(PROGRAMS ${qpi}
        DESTINATION ${Cjyx_INSTALL_QtPlugins_DIR}/${plugins_subdirectory}
        COMPONENT RuntimePlugins
        )
      get_filename_component(qpi_libname ${qpi} NAME)
      cjyxStripInstalledLibrary(
        FILES "${Cjyx_INSTALL_QtPlugins_DIR}/${plugins_subdirectory}/${qpi_libname}"
        COMPONENT Runtime
        )
    endforeach()
