...
#
# This module will add a target named 'CjyxGenerateExtensionTemplates'.
#
...
if(GENERATE_EXTENSION_DESCRIPTION_FILE)
  ...
  execute_process(
    COMMAND ${Cjyx_BINARY_DIR}/bin/cjyxExtensionWizard
...
#-----------------------------------------------------------------------------
# Add 'CjyxGenerateExtensionTemplates' target

set(_template_dir ${Cjyx_SOURCE_DIR}/Extensions)
...
add_custom_target(CjyxGenerateExtensionTemplates
