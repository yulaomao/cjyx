macro(CjyxMacroBuildScriptedCLI)
  set(options
    NO_INSTALL
    VERBOSE
    )
  ...
  set(binary_dir "${CMAKE_BINARY_DIR}/${Cjyx_CLIMODULES_BIN_DIR}")
  ...
  if(NOT LOCAL_SEM_NO_INSTALL)
    install(
      FILES
        ${cli_script_file}
        ${cli_xml_file}
      DESTINATION "${Cjyx_INSTALL_CLIMODULES_BIN_DIR}"
      COMPONENT Runtime
      )
  endif()
  ...
  if(NOT DEFINED LOCAL_SEM_FOLDER)
    set(LOCAL_SEM_FOLDER "${CjyxExecutionModel_DEFAULT_CLI_TARGETS_FOLDER_PREFIX}${LOCAL_SEM_NAME}")
  endif()
