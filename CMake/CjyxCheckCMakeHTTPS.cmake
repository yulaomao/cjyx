...
function(cjyx_check_cmake_https)
  set(url "https://www.baidu.com")
  set(dest "${CMAKE_CURRENT_BINARY_DIR}/cjyx_check_cmake_https_output")

  set(msg "Checking if CMake supports https")
  message(STATUS "${msg}")

  if(NOT Cjyx_CMake_HTTPS_Supported)
    ...
    if(error_code)
      ...
      set(Cjyx_CMake_HTTPS_Supported TRUE CACHE INTERNAL "CMake supports HTTPS protocol")
    endif()
  endif()
