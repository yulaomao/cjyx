...
#
# Usage: The variable Cjyx_REQUIRED_C_FLAGS and Cjyx_REQUIRED_CXX_FLAGS
#        will set appropriately.
#

if(NOT DEFINED Cjyx_REQUIRED_C_FLAGS OR NOT DEFINED Cjyx_REQUIRED_CXX_FLAGS)

  include(CjyxFunctionCheckCompilerFlags)
  include(CjyxFunctionGetGccVersion)
  ...
  if(CMAKE_COMPILER_IS_GNUCXX)
    ...
    CjyxFunctionCheckCompilerFlags("-fdiagnostics-show-option" cflags)
    CjyxFunctionCheckCompilerFlags("-Wl,--no-undefined" cflags)

    cjyxFunctionGetGccVersion(${CMAKE_CXX_COMPILER} GCC_VERSION)
    # With older version of gcc supporting the flag -fstack-protector-all, an extra dependency to libssp.so
    # is introduced. If gcc is smaller than 4.4.0 and the build type is Release let's not include the flag.
    # Doing so should allow to build package made for distribution using older linux distro.
    if(GCC_VERSION VERSION_GREATER "4.4.0" OR (CMAKE_BUILD_TYPE STREQUAL "Debug" AND GCC_VERSION VERSION_LESS "4.4.0"))
      CjyxFunctionCheckCompilerFlags("-fstack-protector-all" cflags)
    endif()
    if(MINGW)
  ...
  set(Cjyx_REQUIRED_C_FLAGS ${tmp_c_flags})
  set(Cjyx_REQUIRED_CXX_FLAGS ${tmp_cxx_flags})
