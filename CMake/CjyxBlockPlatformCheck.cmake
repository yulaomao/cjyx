...
#
# Usage:
#   The check can be enabled/disabled by setting Cjyx_PLATFORM_CHECK to
#   True/False before including the block.
#

if(NOT DEFINED Cjyx_PLATFORM_CHECK)
  set(Cjyx_PLATFORM_CHECK true)
endif()

if(Cjyx_PLATFORM_CHECK)
  if(WIN32)
