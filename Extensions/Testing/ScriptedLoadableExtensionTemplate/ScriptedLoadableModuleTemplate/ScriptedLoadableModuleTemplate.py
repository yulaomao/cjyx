...
class ScriptedLoadableModuleTemplateWidget(ScriptedLoadableModuleWidget):
    ...
    def setup(self):
        ...
        self.inputSelector.nodeTypes = ["vtkDMMLScalarVolumeNode"]
        ...
        self.outputSelector.connect("currentNodeChanged(vtkDMMLNode*)", self.onSelect)
...
class ScriptedLoadableModuleTemplateLogic(ScriptedLoadableModuleLogic):
    ...
    def run(self, inputVolume, outputVolume, imageThreshold):
        ...
        if not self.isValidInputOutputData(inputVolume, outputVolume):
            cjyx.util.errorDisplay('Input volume is the same as output volume. Choose a different output volume.')
            return False
        ...
        cliNode = cjyx.cli.run(cjyx.modules.thresholdscalarvolume, None, cliParams, wait_for_completion=True)
