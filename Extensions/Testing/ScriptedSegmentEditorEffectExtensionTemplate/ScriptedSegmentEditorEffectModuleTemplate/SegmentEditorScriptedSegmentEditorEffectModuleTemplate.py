...
class SegmentEditorScriptedSegmentEditorEffectModuleTemplate(ScriptedLoadableModule):
    ...
    def __init__(self, parent):
        ...
        self.parent.acknowledgementText = "Supported by NA-MIC, NAC, BIRN, NCIGT, and the Cjyx Community. See https://www.slicer.org for details."
        cjyx.app.connect("startupCompleted()", self.registerEditorEffect)

    def registerEditorEffect(self):
        import qCjyxSegmentationsEditorEffectsPythonQt as qCjyxSegmentationsEditorEffects
        instance = qCjyxSegmentationsEditorEffects.qCjyxSegmentEditorScriptedEffect(None)
...
class SegmentEditorScriptedSegmentEditorEffectModuleTemplateTest(ScriptedLoadableModuleTest):
    ...
    def test_ScriptedSegmentEditorEffectModuleTemplate1(self):
        ...
        segmentEditorNode = cjyx.vtkDMMLSegmentEditorNode()
        cjyx.dmmlScene.AddNode(segmentEditorNode)
        segmentEditorWidget.setDMMLSegmentEditorNode(segmentEditorNode)
