...
#
# cjyxFunctionExtractExtensionDescription(EXTENSION_FILE <file> VAR_PREFIX <var-prefix>)
...
function(cjyxFunctionExtractExtensionDescription)
  set(options)
  ...
  foreach(name IN LISTS Cjyx_EXT_METADATA_NAMES)
    set(token_default_value "${Cjyx_EXT_METADATA_${name}_DEFAULT}")
...
function(cjyx_extract_extension_description_test)
  ...
  set(expected_DESCRIPTION "The CjyxToKiwiExporter module provides Cjyx user with any easy way to export models into a KiwiViewer scene file.")
  ...
  set(test_s4ext ${CMAKE_CURRENT_BINARY_DIR}/cjyx_extract_extension_description_without_depends_test.s4ext)
...
status ${expected_STATUS}")
  ...
  cjyxFunctionExtractExtensionDescription(
  ...
  set(test_s4ext ${CMAKE_CURRENT_BINARY_DIR}/cjyx_extract_extension_description_with_depends_test.s4ext)
  file(WRITE ${test_s4ext}
"build_subdirectory ${expected_BUILD_SUBDIRECTORY}
category ${expected_CATEGORY}
contributors ${expected_CONTRIBUTORS}
...
if(TEST_cjyx_extract_extension_description_test)
  cjyx_extract_extension_description_test()
endif()
