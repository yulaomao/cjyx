...
#
# It has been designed to be included in the build system of a Cjyx
# extension.
#
...
#  CJYX_EXTENSION_MANAGER_CLIENT_EXECUTABLE
#  CJYX_EXTENSION_MANAGER_URL
#  CJYX_EXTENSION_MANAGER_API_KEY
#
...
if(NOT PACKAGEUPLOAD)
  ...
  _seput_set_if_not_defined(CJYX_EXTENSION_MANAGER_CLIENT_EXECUTABLE "CJYX_EXTENSION_MANAGER_CLIENT_EXECUTABLE-NOTDEFINED")
  _seput_set_if_not_defined(CJYX_EXTENSION_MANAGER_URL "CJYX_EXTENSION_MANAGER_URL-NOTDEFINED")
  _seput_set_if_not_defined(CJYX_EXTENSION_MANAGER_API_KEY "CJYX_EXTENSION_MANAGER_API_KEY-NOTDEFINED" OBFUSCATE)
  ...
  CjyxMacroExtractRepositoryInfo(VAR_PREFIX EXTENSION SOURCE_DIR ${CMAKE_SOURCE_DIR})
...
# Setting the environment variable CJYX_EXTENSION_MANAGER_SKIP_PACKAGING_TARGET to
# any non empty value can be used when testing this module. It avoids to wait for a rebuild
# of the project.
set(_build_target 1)
if(NOT "$ENV{CJYX_EXTENSION_MANAGER_SKIP_PACKAGING_TARGET}" STREQUAL "")
  set(_build_target 0)
endif()
...
set(CMAKE_MODULE_PATH
  ${Cjyx_CMAKE_DIR}
  ${Cjyx_CMAKE_DIR}/../Extensions/CMake
  ${CMAKE_MODULE_PATH}
  )
...
foreach(p ${package_list})
  if(package_uploaded)
    ...
    message("Uploading [${package_name}] to [${CJYX_EXTENSION_MANAGER_URL}]")
    get_filename_component(package_directory ${p} DIRECTORY)
    set(error_file ${package_directory}/cjyx_extension_server_upload_errors.txt)
    execute_process(COMMAND
      ${CMAKE_COMMAND} -E env
        LC_ALL=en_US.UTF-8
        LANG=en_US.UTF-8
      ${CJYX_EXTENSION_MANAGER_CLIENT_EXECUTABLE}
        --api-url ${CJYX_EXTENSION_MANAGER_URL}/api/v1
        --api-key ${CJYX_EXTENSION_MANAGER_API_KEY}
          extension upload Cjyx ${p}
      ...
      RESULT_VARIABLE cjyx_extension_manager_upload_status
      ERROR_FILE ${error_file}
      )
    message(STATUS "cjyx_extension_manager_upload_status: ${cjyx_extension_manager_upload_status}")
    if(NOT cjyx_extension_manager_upload_status EQUAL 0)
      message(FATAL_ERROR "Failed to upload extension using ${CJYX_EXTENSION_MANAGER_CLIENT_EXECUTABLE}.
