...
include(UseCjyxMacros) # for cjyx_setting_variable_message
...
foreach(var ${optional_vars})
  cjyx_setting_variable_message(${var})
endforeach()
...
CjyxMacroExtractRepositoryInfo(VAR_PREFIX EXTENSION SOURCE_DIR ${EXTENSION_SOURCE_DIR})

# Set build name
string(CONCAT CTEST_BUILD_NAME
  "${Cjyx_REVISION}-${EXTENSION_NAME}-${EXTENSION_WC_TYPE}${EXTENSION_WC_REVISION}"
...
set(CTEST_DROP_SITE_CDASH TRUE)")
  ...
  configure_file(
    ${Cjyx_CMAKE_DIR}/CTestCustom.cmake.in
    ${ctestconfig_dest_dir}/CTestCustom.cmake
    COPYONLY
    )
endforeach()

set(track_qualifier_cleaned "${Cjyx_EXTENSIONS_TRACK_QUALIFIER}-")
...
"#Generated by CjyxBlockBuildPackageAndUploadExtension.cmake
${EXTENSION_NAME}_BUILD_CJYX_EXTENSION:BOOL=ON
...
Cjyx_EXTENSIONS_TRACK_QUALIFIER:STRING=${Cjyx_EXTENSIONS_TRACK_QUALIFIER}
