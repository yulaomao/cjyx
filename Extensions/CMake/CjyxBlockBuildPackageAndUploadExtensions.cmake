  ...
  set(Cjyx_QT_VERSION_MAJOR "${Qt5_VERSION_MAJOR}")
  set(Cjyx_QT_VERSION_MINOR "${Qt5_VERSION_MINOR}")

#-----------------------------------------------------------------------------
# Sanity checks
set(expected_defined_vars
  CMAKE_GENERATOR
  Cjyx_QT_VERSION_MAJOR
  Cjyx_QT_VERSION_MINOR
  Cjyx_EXTENSIONS_TRACK_QUALIFIER
  Cjyx_REVISION
  CTEST_DROP_SITE
  )
...
include(CjyxFunctionExtractExtensionDescription)
include(CjyxBlockUploadExtensionPrerequisites) # Common to all extensions

#-----------------------------------------------------------------------------
# Collect extension description file (*.s4ext)
#-----------------------------------------------------------------------------
file(GLOB s4extfiles "${Cjyx_EXTENSION_DESCRIPTION_DIR}/*.s4ext")
...
foreach(file ${s4extfiles})
  ...
  cjyxFunctionExtractExtensionDescription(EXTENSION_FILE ${file} VAR_PREFIX EXTENSION)
...
foreach(EXTENSION_NAME ${EXTENSION_LIST})
  ...
  set(file ${Cjyx_EXTENSION_DESCRIPTION_DIR}/${EXTENSION_NAME}.s4ext)
  ...
  if(Cjyx_SOURCE_DIR)
    set(EXTENSIONEP_ARG_EXTENSION_DEPENDS DEPENDS Cjyx ${EXTENSION_DEPENDS})
  else()
  ...
  elseif("${EXTENSION_EXT_SCM}" STREQUAL "local")
    ...
    if(NOT IS_ABSOLUTE ${EXTENSION_SOURCE_DIR})
      set(EXTENSION_SOURCE_DIR ${Cjyx_LOCAL_EXTENSIONS_DIR}/${EXTENSION_SOURCE_DIR})
    endif()
  ...
  include(CjyxBlockUploadExtension)
  if(Cjyx_UPLOAD_EXTENSIONS)
